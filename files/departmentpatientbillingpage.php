...
<br/><br/><br/>
<fieldset>  
    <legend align="center"><b>DEPARTMENT PAYMENTS: REVENUE CENTER</b></legend>
        <center>
            <table width = "50%">
            <tr>
                    <td style='text-align: center; height: 40px;' colspan="2">
                        <a href='credittransactionsapproval.php?<?php echo $Section; ?>Newapproval=NewapprovalThisPage'>
        ...
        NEW APPROVAL - ALL PATIENT APPROVAL MUST BE DONE HERE
            ...
            <?php //} ?>
                ...
                <tr>
                    ...
                    ?>
                        <a href='patient_sent_from_reception.php?<?php echo $Section; ?>credittransaction=credittransactionThisPage'>
                            <button style='width: 100%; height: 100%'>
                                Patient With Debts <span class="badge " style="background-color: red;"><?php echo $patient_debt; ?></span>
                            </button>
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td style='text-align: center; height: 40px;' colspan="2">
                        <a href='patientspaymentslist.php?PatientPaymentsList=PatientPaymentsListThisPage'>
                            <button style='width: 100%; height: 100%'>
                                <b>Patient Payment Preview</b>
                            </button>
                        </a>
                    </td>
                </tr>
