...
<?php
    ...
    $htm.="<fieldset>";
    $htm.="<legend align=center><b>CLINIC PERFORMANCE REPORT FOR DOCTOR ".$Doctor_Name."  FROM</b> <b style=''>".date('j F,Y H:i:s',strtotime($Date_From))."</b> <b>TO</b> <b style=''>".date('j F,Y H:i:s',strtotime($Date_To))."</b> </legend>";
        $htm.="<center>";
