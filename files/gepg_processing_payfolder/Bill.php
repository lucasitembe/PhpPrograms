...
class Bill
{
    ...
    header("Location: http://localhost/amana/view_bill.php?billId=".$billId);
    exit();
    ...
    function gepgBillSubReq($formRequest)
    {
        ...
        $generatedSignature = $this->signatureHandler->createSignature($xmlGepgReqContent, 'passpass', 'gepgclient', '/var/www/html/amana/keys/gepgclientprivatekey.pfx');
    ...
    function incomingBillResponse()
    {
        ...
        if($extractedString2){
            ...
            if ($this->signatureHandler->verifySignature($extractedSignature, $content,'passpass','gepg', '/var/www/html/amana/keys/gepgclientpubliccertificate.pfx')) {
    ...
    function updateBillPaymentInfo($value1,$value2,$value3,$value4,$value5,$value6,$value7,$value8,$value9,$value10,$value11,$value12,$value13,$value14,$value15,$value16,$value17)
    {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            $generatedSignature = $this->signatureHandler->createSignature($responseContent, 'passpass', 'gepgclient', '/var/www/html/amana/keys/gepgclientprivatekey.pfx');
