...
$display = '';
    ...
    if($Radiotherapy_ID > 0){
        ...
        $select_details = mysqli_query($conn, "SELECT Treatment_Phase, Tumor_Dose, Number_of_Fraction, Dose_per_Fraction, name_of_site, Number_of_Fields FROM tbl_radiotherapy_phases WHERE Radiotherapy_ID = '$Radiotherapy_ID' AND Treatment_Phase = '$Treatment_Phase'");
