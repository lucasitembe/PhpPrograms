    ...
    <center>
        ...
        <button style='width: 100%; height: 100%' onclick="return access_Denied();">
            ...
            <div class="button_alignment">
                ...
                <a href='oncologyworks.php?section=oncologyworks&oncologyworks=oncologyworks'>
                    <button style='width: 100%; height: 100%'>
                        Oncology Works
                    </button>
                </a>
...
<?php } ?>
    ...
    <?php } else { ?>
                ...
                <div class="button_alignment">
                    ...
                    <a href='engineering_works1.php?engineering_works=engineering_WorkThisPage'>
                        <button style='width: 100%; height: 100%'>
                            Engineering Works
                        </button>
                    </a>
                ...
                <!-- < ?php if (getButtonStatus("kitchen_works") == "visible") { ?> -->
                <div class="button_alignment">
                    <!-- < ?php if (isset($_SESSION['userinfo']['Pharmacy'])) { ?>
                    < ?php if ($_SESSION['userinfo']['Pharmacy'] == 'yes') { ?> -->
                    <a href='./kitchen_works.php?section=Kitchen&KitchenWorks=KitchenWorksThisPage'>
                        <button style='width: 100%; height: 100%'>
                            Kitchen Works
                        </button>
                    </a>
                ...
                <div class="button_alignment">
                    <a href='Surgery_performance_progress.php?TheaterCanAccess=TheaterCanAccessThisPage'>
                        <button style='width: 100%; height: 100%'>
                            Live Surgery Progress Status
                        </button>
                    </a>
                </div>
                <?php } ?>
                ...
                <div class="button_alignment">
                    <?php if (isset($_SESSION['userinfo']) || isset($_SESSION['userinfo'])) { ?>
                    <?php if (isset($_SESSION['userinfo'])) { ?>
                    <a href='physiotherapy_occupational_authentication_.php'>
                        <button style='width: 100%; height: 100%'>
                            Physiotherapy Works
                        </button>
                    </a>
                ...
                <div class="button_alignment">
                    ...
                    <!--<a href='pharmacyworkspage.php?section=Pharmacy&PharmacyWorks=PharmacyWorksThisPage'>-->
                    <a
                        href=http://localhost/Final_One/files/church_member_buy_item.php?RegisterPatient=RegisterPatientThisPage>
                        <button style='width: 100%; height: 100%'>
                            Physiotherapy Works
                        </button>
                    </a>
