...
<script language="javascript" type="text/javascript">
    function searchPatient(Patient_Name){
        document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=320px src='cecapcashpatientlist_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
...
<fieldset>  
            <legend align=center><b>CECAP CASH PATIENT LIST</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
		<iframe width='100%' height=320px src='cecapcashpatientlist_Iframe.php?Patient_Name='></iframe>
            </td>
        </tr>
            </table>
        </center>
