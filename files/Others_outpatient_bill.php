...
<table width="100%">
    <?php
        ...
        if($nm > 0){
            ...
            ?>
                <tr>
                    <td><a href="approve_outpatient_bill_others.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>&ApproveInvestigation=ApproveInvestigationThisPage&Transaction_Date_And_Time=<?= $Transaction_Date_And_Time ?>" style="text-decoration: none;"><?php echo ++$temp; ?></a></td>
