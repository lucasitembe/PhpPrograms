...
$htm.="<p align='center'><b>PROCEDURE PATIENTS REPORT <br/>FROM</b> <b style=''>" . $fromDate . "</b> <b>TO</b> <b style=''>" . $toDate . "</b><br/> "
  ...
  //die($select_data);
    ...
    while ($row = mysqli_fetch_array($select_data_result)) {
        ...
        //Get items
         ...
         . "JOIN tbl_patient_registration pr ON pr.Registration_ID=pc.Registration_ID "
         . " WHERE ilc.Transaction_Date_And_Time BETWEEN '$fromDate' AND '$toDate' AND ilc.Check_In_Type='Procedure'  AND pr.Registration_ID='$Registration_ID' ORDER BY ilc.Transaction_Date_And_Time ASC";
