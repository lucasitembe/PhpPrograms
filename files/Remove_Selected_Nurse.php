    ...
    ?>
        <tr>
            ...
            <td width="12%" style="text-align: center;">
                <input type="button" name="SelectedAssistantSurgeons" id="SelectedAssistantSurgeons" value="REMOVE" class="art-button-green" onclick="Remove_Nurse(<?php echo $dtz['Participant_ID']; ?>)">
            </td>
        </tr>
    <?php 
        }
