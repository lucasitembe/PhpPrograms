...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Doctors_Page_Outpatient_Work'] == 'yes'){ 
?>
    <a href='./doctorsperformancesummary.php?FinanceWork=FinanceWorkThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<fieldset>
    <center>
	<form action='doctorsperformancedetailsfilter.php?DoctorsPerformanceReportThisPage=ThisPage' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
    ...
    ?>
    <br>
    <legend align=center><b>PERFORMANCE DETAILS FOR DOCTOR </b><b style="color:blue;"><?php echo strtoupper($doctorName)?></b></legend>
        <iframe src="doctorsperformancedetails_Iframe.php?Employee_ID=<?php echo $doctorID;?>" width="100%" height="340px"></iframe>
</fieldset><br/>
<?php
