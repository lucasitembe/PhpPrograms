...
<a href='doctoremergencypage.php?RevenueCenterWork=RevenueCenterWorkThisPage' class='art-button-green' style='background: #800080; display: none;'>
            FOR EMERGENCY PATIENTS (TESTING ONLY)
        </a>
    ...
    <table width='100%'>
        <tr>
            <td style="text-align:center"> 
                ...
                <select name='Clinic_ID' id='Clinic_ID' style='text-align: center;width:15%;display:inline' onchange="filterPatient()"
                        >
...
<div id="verify_by_finger_print" class="hide">
...
function check_for_afyacard_configuration(Registration_ID,Patient_Payment_ID,Patient_Payment_Item_List_ID,Patient_Name){
    $.ajax({
        ...
        success:function(data){
           // alert(data)
            if(data=="enabled"){
                $("#from_finger_patient_name").html(Patient_Name);
                $("#from_finger_registration_id").html(Registration_ID);
                $("#verify_finger_print_btn_area").html("<label id='verify_finger_print_message' style='color:red'></label><input type='button' value='VERIFY FINGER PRINT' class='art-button pull-right' onclick='verify_finger_print_for_clinic_patient("+Registration_ID+","+Patient_Payment_ID+","+Patient_Payment_Item_List_ID+")'/>");

                $("#verify_by_finger_print").dialog({
                        title: 'VERIFY BY FINGER PRINT',
                        width: '50%',
                        height: 300,
                        modal: true,
                    });
//                verify_finger_print_for_clinic_patient(Registration_ID,Patient_Payment_ID,Patient_Payment_Item_List_ID);
            }else{
