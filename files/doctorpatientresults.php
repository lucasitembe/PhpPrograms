...
<?php
	...
	echo $_GET['Patient_Payment_ID']; exit;
...
<fieldset>
        <iframe id='srchfrm' src='doctorpatientresults_Iframe.php?Registration_ID=<?php echo $Registration_ID;?>' style='width: 100%; height:320px;'>
        </iframe>
</fieldset>
<!--END HERE-->
<?php
