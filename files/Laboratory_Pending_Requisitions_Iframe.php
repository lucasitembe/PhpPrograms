...
<?php
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        echo "<td width=4%><a href='Laboratory_Control_Requisition_Sessions.php?Requisition_ID=".$row['Requisition_ID']."&Pending_Requisition=True&Requisition=RequisitionThisPage' class='art-button-green' target='_parent'>&nbsp;&nbsp;&nbsp;Continue Process&nbsp;&nbsp;&nbsp;</a></td></tr>";
        $temp++;
    }
?>
</table>