<table width="100%">
	...
	<tr>
		...
		<td style="text-align: center" width="8%"><b>NO OF COSTUMER</b></td>
...
//			$get_Quantiry = mysqli_query($conn,"select ppl.Quantity, ppl.Price, ppl.Discount, pp.Billing_Type,ts.Exemption, pp.payment_type, pp.Fast_Track, pp.Pre_Paid  from tbl_patient_payment_item_list ppl LEFT JOIN tbl_employee em ON em.Employee_ID=ppl.Consultant_ID JOIN tbl_clinic_employee ce ON ce.Employee_ID=em.Employee_ID,
//	                                        tbl_item_category ic, tbl_item_subcategory isu, tbl_items i,tbl_patient_payments pp,tbl_sponsor as ts  where
//	                                        pp.Patient_Payment_ID = ppl.Patient_Payment_ID and
//	                                        ic.Item_Category_ID = isu.Item_Category_ID and
//	                                        isu.Item_Subcategory_ID = i.Item_Subcategory_ID and
...
//			echo "<td style='text-align: right;'>";
//				if($_SESSION['systeminfo']['price_precision']=='yes'){ echo number_format($Total_Cash + $Total_Credit+$Total_Msamaha, 2); }else{ echo number_format($Total_Cash + $Total_Credit+$Total_Msamaha); }
//			echo "&nbsp;&nbsp;&nbsp;</td>";
		}
?>
	<tr><td colspan="9"><hr></td></tr>
	<tr>
		...
		<!--<td style="text-align: right;"><b><?php if($_SESSION['systeminfo']['price_precision']=='yes'){ echo $Currency_Code.'&nbsp;'.number_format($Grand_Total_Credit + $Grand_Total_Cash+$Grand_Total_Msamaha, 2); }else{ echo $Currency_Code.'&nbsp;'.number_format($Grand_Total_Credit + $Grand_Total_Cash + $Grand_Total_Msamaha); } ?></b>&nbsp;&nbsp;&nbsp;</td>-->
	</tr>
<?php
	}
?>
