...
<?php
echo "<a href='pharmacycredits.php?" . $Section_Link . "InvestigationCredit=InvestigationCreditThisPage' class='art-button-green'>BACK</a>";
?>
    ...
    <script>
        function create_out_patient_bill(){
            ...
            if(confirm("Are you sure you want to create bill for this patient?")){
               $.ajax({
                   type: 'GET',
                    url: "create_and_approve_phamacy_out_patient_bill.php",
