...
?>
<a href="laboratory_main.php?Patient_Payment_Item_List_ID=<?php echo $Patient_Payment_Item_List_ID?>&Status_From=<?php echo $Status_From?>&item_id=&patient_id=<?php echo $Registration_ID?>&payment_id=<?php echo $Patient_Payment_ID?>" class="art-button-green">BACK</a>
<!--START HERE-->
<?php
...
<fieldset>
	<legend align="center"> <b>LABORATORY WORKS</b></legend>
        <center>
            ...
            <p><b>Laboratory Attachments</b></p>
        ...
        <table width='100%'>
            <tr>
			    ...
			    <input type='hidden' id='department_upload_submitted' name='department_upload_submitted' value='true'>
                    ...
                    <tr>
                        <td colspan=2>
                            <input type='submit' id='send' name='send' value='SAVE' class='art-button-green'/>
