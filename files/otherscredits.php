...
<fieldset>
    <table width=100%>
        <tr>
            <td width="20%">
                <input type="text" name="Patient_Name" id="Patient_Name" autocomplete="off" oninput="Search_Patient()" style="text-align: center;" placeholder="~~~ ~~~ Enter Patient Name ~~~ ~~~">
            </td>
            <td width="15%">
                <input type="text" name="Patient_Number" id="Patient_Number" autocomplete="off" oninput="Search_Patient_Via_Number()"  style="text-align: center;" placeholder="~~~ Enter Patient Number ~~~">
            </td>
            <td style="text-align: right;"><b>Sponsor Name</b></td>
            <td>

                <select name="Sponsor_ID" id="Sponsor_ID" style="width:100%">
    ...
    <table width="100%">
        ...
        if ($nm > 0) {
            while ($row = mysqli_fetch_array($get_details)) {
                ...
                ?>
                <tr>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo ++$temp; ?></td>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo strtoupper($row['Patient_Name']); ?></a></td>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo $row['Registration_ID']; ?></a></td>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo $row['Guarantor_Name']; ?></a></td>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo strtoupper($row['Gender']); ?></a></td>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo $age; ?></a></td>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo $row['Phone_Number']; ?></a></td>
                    <td><a href="approveothers.php?<?php echo $Section_Link; ?>Registration_ID=<?php echo $row['Registration_ID']; ?>&Payment_Cache_ID=<?php echo $row['Payment_Cache_ID']; ?>" style="text-decoration: none;"><?php echo $row['Member_Number']; ?></a></td>
                </tr>
                <?php
            }
        }
      ...
      document.getElementById('Patient_List_Area').innerHTML = '<div align="center" style="" id="progressStatus"><img src="images/ajax-loader_1.gif" width="" style="border-color:white "></div>';
        ...
        if (Start_Date != null && Start_Date != '' && End_Date != null && End_Date != '') {
            ...
            myObjectFilter.onreadystatechange = function () {
                ...
                if (myObjectFilter.readyState == 4 && myObjectFilter.status == 200) {
                    document.getElementById('Patient_List_Area').innerHTML = dataFilter;
                }
            }; //specify name of function that will handle server response........

            myObjectFilter.open('GET', 'Others_Credit_Filter.php?Section='+Section+'&Sponsor_ID=' + Sponsor_ID + '&Start_Date=' + Start_Date + '&End_Date=' + End_Date, true);
            myObjectFilter.send();
        } else {
...
<script type="text/javascript">
    function Search_Patient() {
        ...
        if(outpatient_bill_credit_trns_approval=="approve_outpatient_bill_transaction"){
            search_url="Others_outpatient_bill.php"; 
        }else{
            search_url="Others_Credit_Filter_Specific.php";
        }
        document.getElementById("Patient_Number").value = '';
...
<script type="text/javascript">
    function Search_Patient_Via_Number() {
        ...
        myObjectFilter.open('GET', 'Others_Credit_Filter_Specific.php?Section='+Section+'&Sponsor_ID=' + Sponsor_ID + '&Start_Date=' + Start_Date + '&End_Date=' + End_Date + '&Patient_Number=' + Patient_Number, true);
        myObjectFilter.send();
    }
</script>
