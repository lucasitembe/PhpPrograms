...
?>      <legend style='background-color:#006400;color:white;padding:5px;' align=right><b>List of requisitions</b></legend>
...
<?php
    ...
    $sql_select = mysqli_query($conn,"select rq.Requisition_Description, rq.Requisition_ID, rq.Created_Date_Time, rq.Store_Issue, rq.Store_Need, rq.Sent_Date_Time, sd.Sub_Department_Name from
                                ...
                                emp.employee_id = rq.employee_id and rq.requisition_status in ('submitted','edited','saved','Not Approved') and
                                rq.Sent_Date_Time between '$Start_Date' and '$End_Date' order by rq.Requisition_ID desc") or die(mysqli_error($conn));
