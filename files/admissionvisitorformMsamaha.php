...
if (isset($_SESSION['userinfo'])) {
    if ($_SESSION['userinfo']['Admission_Works'] == 'yes') {
        if (isset($_GET['location']) && $_GET['location'] == 'registered') {
            ...
            echo " <a href='msamahaToadmit.php?AdmissionNewPatient=AdmissionNewPatientThisPage' class='art-button-green'>
                        BACK
                    </a>";
        }
    }
...
<br/><br/>
<fieldset>
    <legend align="right"><b>PATIENT ADMISSION</b></legend><br/>
    <table width="100%">
        <tr>
...
<!--        <tr>
        ...
        <tr>
            <td colspan=4 style="text-align: right;">
                ...
                <input type="button" name="button" class="art-button-green" value="ADMIT PATIENT" onclick="Admit_Patient()">
            </td>
        </tr>
