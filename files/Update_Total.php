        ...
        if($Patient_Payment_Cache_ID != 0){
            ...
            if($num_of_rows > 0){
                ...
                <td style='text-align: right;'>
                    <b><h4 id='Total_Area'>Total : <?php echo (($_SESSION['systeminfo']['price_precision'] == 'yes') ? number_format($total, 2) : number_format($total)).'  '.$_SESSION['hospcurrency']['currency_code']; ?>&nbsp;&nbsp;&nbsp;</h4>
                </td>
                <td style='text-align: right;'>
