...
<script language="javascript" type="text/javascript">
    function seadentalPatient(Patient_Name){
        document.getElementById('Seadental_Iframe').innerHTML = "<iframe width='100%' height=320px src='dentalcashpatientlist_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
...
<fieldset>  
            <legend align=center><b>DENTAL CASH PATIENT LIST</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Seadental_Iframe'>
		<iframe width='100%' height=320px src='dentalcashpatientlist_Iframe.php?Patient_Name='></iframe>
            </td>
        </tr>
            </table>
        </center>
