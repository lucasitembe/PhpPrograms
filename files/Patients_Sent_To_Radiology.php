...
<fieldset style='margin-top:15px;'>
    <legend align="right" style="background-color:#006400;color:white;padding:5px;"><b>PATIENT SENT TO RADIOLOGY REPORT</b></legend>
    ...
    <div id="patientProcItemDiv" style="width:500px;height:300px; overflow-x: hidden;overflow-y:scroll; display:none" >
        ...
        <center> <a href="#" target="_blank" id="printItemsPreview" class="art-button-green">PRINT PATIENT RADIOLOGY ITEMS</a></center>
        ...
        <tr>
            <td>
                <div style="width:100%; height:380px;overflow-x: hidden;overflow-y: auto" id='Search_Iframe'>
                    <?php include 'Patients_Sent_To_Radiology_Iframe.php'; ?>
                </div>
            </td>
        </tr>
    </table>
...
<center>   
    <a href="print_patients_sent_to_radiology.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a></center>
...
<script>
    function Show_Items_Taken(Registration_ID, Patient_Name, fromdate, todate) {
        ...
        $('#printItemsPreview').attr('href', 'print_patient_sent_rad_item.php?Registration_ID=' + Registration_ID + '&fromdate=' + fromdate + '&todate=' + todate);

        $.ajax({
            type: 'GET',
            url: "getPatientSentRadItems.php",
...
<script type="text/javascript">
    $('#filterDate').click(function (e) {
        ...
        $('#printPreview').attr('href', 'print_patients_sent_to_radiology.php?fromDate=' + fromDate + '&toDate=' + toDate + '&sponsorID=' + sponsorID);

        $.ajax({
            type: 'POST',
            url: 'Patients_Sent_To_Radiology_Iframe.php',
