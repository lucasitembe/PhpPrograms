<?php
    ...
    $umrichini=  mysqli_real_escape_string($conn,$_GET['umrichini']);
    $umrizaidi=  mysqli_real_escape_string($conn,$_GET['umrizaidi']);
    $totalTegemewa=$umrichini+$umrizaidi;
  ...
  $twelveCLess=0;
  $twelveCGreater=0;
  $firstphase=mysqli_query($conn,"SELECT * FROM tbl_wazazi tw JOIN tbl_patient_registration tpr ON tw.Patient_No=tpr.Registration_ID WHERE tw.admission_date BETWEEN '$date1' AND '$date2'");
  $Today = Date("Y-m-d");
  while($result=  mysqli_fetch_assoc($firstphase)){
   ...
   if($result['VVU_uchungu']=='Positive' && $age < 20){
    ...
    if($result['kupumua']=='Mask' && $age < 20){
     ...
     $Asilimialess=round(($jifunguliaHFless/$umrichini*100),2);
     $Asilimiagreater=round(($jifunguliaHFgreter/$umrizaidi*100),2);
     $TotalAsilimia=round(($TotalHF/$totalTegemewa*100),2);
//     $TotalHF=$jifunguliaHFless+$jifunguliaHFgreter;
//              $totalTegemewa=$umrichini+$umrizaidi;
    $disp= "<div id='all'>";
    $disp.= "<div id='hudhurio1'>";
    $disp.= "<table style='width:100%'>";
    $disp.= "<tr><th>Namba</th><th>Maelezo</th><th>Umri < 20</th><th>Umri Miaka 20 na zaidi</th><th>Jumla</th></tr>";
    
     $disp.= "<tr><td style='text-align:center'>1</td><td>Waliotarajiwa kujifungua katika eneo la huduma</td><td style='text-align:center;width:350px'>$umrichini</td><td style='text-align:center;width:200px'>$umrizaidi</td><td style='text-align:center;width:200px'>$totalTegemewa</td></tr>";
     $disp.= "<tr><th style='text-align:center'>2</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Taarifa ya Waliojifungua</th></tr>";
     
      
    $disp.= "<tr><td style='text-align:center'>2a</td><td>Waliojifungulia katika kituo cha kutolea huduma za afya</td><td style='text-align:center'>$jifunguliaHFless</td><td style='text-align:center'>$jifunguliaHFgreter</td><td style='text-align:center'>$TotalHF</td>
    ...
    <tr><td style='text-align:center'></td><td><b><i>Asilimia ya waliojifungulia katika vituo vya kutolea huduma za afya(2a/1)*100</i></b></td><td style='text-align:center'><b><i><sapn id='huduma'>$Asilimialess</span></i></b></td><td style='text-align:center'><b><i>$Asilimiagreater</b></i></td><td style='text-align:center'><b><i>$TotalAsilimia</i></b></td>
   
    </tr>";
     
     $disp.= "<tr><th style='text-align:center'>3</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Taarifa kuhusu uchungu</th></tr>";
     
     
      $disp.= "<tr><td style='text-align:center'>3a</td><td>Waliojifungua baada ya saa 12 toka uchungu kuanza</td><td style='text-align:center'>$threeALess</td><td style='text-align:center'>$threeAGreater</td>
       
   
     <td style='text-align:center'>$Total3A</td></tr>";
         
      $disp.= "<tr><th style='text-align:center'>4</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Taarifa ya njia za kujifungua</th></tr>";
     
     
      
    $disp.= "<tr><td style='text-align:center'>4a</td><td>Kawaida (KW)</td><td style='text-align:center'>$fourALess</td><td style='text-align:center;'>$fourAGreater</td>
    ...
    $disp.= "<tr><th style='text-align:center'>5</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Matatizo kabla ya kujifungua</th></tr>";
    $disp.= "<tr><td style='text-align:center'>5a</td><td>APH</td><td style='text-align:center'>$fiveALess</td><td style='text-align:center'>$fiveAGreater</td>
     ...
     <td style='text-align:center'>$Total5I</td></tr>";
      ...
      $disp.= "<tr><th style='text-align:center'>6</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Matatizo wakati na baada ya kujifungua</th></tr>";
      $disp.= "<tr><td style='text-align:center'>6a</td><td>PPH</td><td style='text-align:center'>$sixALess</td><td style='text-align:center'>$sixAGreater</td>
    ...
    ";
     ...
     $disp.= "<tr><th style='text-align:center'>7</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>EmOC</th></tr>";
     $disp.= "<tr><td style='text-align:center'>7a</td><td>Amepewa Antibiotic</td><td style='text-align:center'>$sevenALess</td><td style='text-align:center'>$sevenAGreater</td>
    ...
    ";
     ...
     $disp.= "<tr><th style='text-align:center'>8</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>PMTCT</th></tr>";
     $disp.= "<tr><td style='text-align:center'>8a</td><td>Jumla waliopima VVU ANC</td><td style='text-align:center'>$eightALess</td><td style='text-align:center'>$eightAGreater</td>
    ...
    ";
     ...
     $disp.= "<tr><th style='text-align:center'>9</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Watoto waliozaliwa mmoja</th></tr>";
     $disp.= "<tr><td style='text-align:center'>9a</td><td>Jumla ya watoto waliozaliwa hai</td><td style='text-align:center'>$nineALess</td><td style='text-align:center'>$nineAGreater</td>
    ...
    ";
     ...
     $disp.= "<tr><th style='text-align:center'>10</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Watoto waliozaliwa mapacha</th></tr>";
     $disp.= "<tr><td style='text-align:center'>10a</td><td>Jumla ya watoto waliozaliwa hai</td><td style='text-align:center'>$twelveALess</td><td style='text-align:center'>$twelveAGreater</td>
    ...
    ";
     ...
     $disp.= "<tr><th style='text-align:center'>11</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Watoto waliosaidiwa kupumua</th></tr>";
     $disp.= "<tr><td style='text-align:center'>11a</td><td>Idadi ya watoto waliosaidiwa kupumua-suction</td><td style='text-align:center'>$elevenALess</td><td style='text-align:center'>$elevenAGreater</td>
     ...
     $disp.= "<tr><th style='text-align:center'>12</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Huduma nyinginezo</th></tr>";
     $disp.= "<tr><td style='text-align:center'>12a</td><td>Idadi ya watoto walionyonyeshwa ndani ya saa moja baada ya kuzaliwa</td><td style='text-align:center'>0</td><td style='text-align:center'>0</td>
