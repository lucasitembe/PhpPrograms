            ...
            <table width='99%' style="border:none !important; border-color:transparent !important;background-color:white;">
                <tr>
                    <td style="text-align:center">
                        <input type="text" autocomplete="off" style='text-align: center;width:15%;display:inline' id="start_date" placeholder="Start Date" value="<?= $Start_Date ?>" readonly="readonly"/>
                        <input type="text" autocomplete="off" style='text-align: center;width:15%;display:inline' id="end_date" placeholder="End Date" value="<?= $End_Date ?>" readonly="readonly"/>&nbsp;
                ...
                <tr>
                    <td>
                        ...
                        <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                            <?php include 'dialysiscreditpatientlist_Iframe_report.php'; ?>
                        </div>
                    </td>
                </tr>
            </table>
