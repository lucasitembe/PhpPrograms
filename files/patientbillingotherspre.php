        ...
        myObjectVerify.onreadystatechange = function (){
            ...
            if (myObjectVerify.readyState == 4) {
                ...
                if (feedback == 'yes'){
                    ...
                    if(r == true){
                        document.location = 'Patient_Billing_Others_Page_pre.php?Transaction_Type='+Transaction_Type+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID=NULL&Billing_Type='+Billing_Type;
                    }
                }else{
