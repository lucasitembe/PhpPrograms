...
$query2 = mysqli_query($conn,"SELECT sb.Item_Subcategory_ID,sb.Item_Subcategory_Name FROM `tbl_item_subcategory` sb INNER JOIN tbl_items i ON i.`Item_Subcategory_ID` = sb.`Item_Subcategory_ID` WHERE i.Consultation_Type='Procedure' GROUP BY i.`Item_Subcategory_ID` ORDER BY sb.Item_Subcategory_Name ") or die(mysqli_error($conn));
$dataSubCategory = '';
...
<fieldset style='margin-top:15px;'>
    <legend align="right" style="text-align:right;background-color:#006400;color:white;padding:5px;"><b>NUMBER OF PROCEDURE DONE REPORT</b></legend>
            ...
            <tr>
                <td>
                    <div style="width:100%; height:300px;overflow-x: hidden;overflow-y: auto"  id="Search_Iframe">
                        <?php include './number_of_test_taken_proc_iframe.php'; ?> 
                    </div>
                </td>
            </tr>
        </table>
...
<center> 
    <a href="print_number_of_test_taken_proc.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a>
</center> 
...
<script>
                        ...
                        function filterLabpatient() {
                            ...
                            $('#printPreview').attr('href', 'print_number_of_test_taken_proc.php?fromDate=' + fromDate + '&toDate=' + toDate + '&Sponsor=' + Sponsor + '&SubCategory=' + SubCategory);

                            $.ajax({
                                type: 'POST',
                                url: 'number_of_test_taken_proc_iframe.php',
