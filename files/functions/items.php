...
function Get_Item_Classification() {
    return array(
        ...
        array("Name" => "Stationeries Materials", "Description" => "Stationeries Materials"),
        array("Name" => "CLEANING MATERIALS", "Description" => "CLEANING MATERIALS"),
        array("Name" => "FOOD STUFFS", "Description" => "FOOD STUFFS"),
        array("Name" => "Crockery", "Description" => "Crockery"),
        array("Name" => "Bedding and Linen Materials", "Description" => "Bedding and Linen Materials"),
        array("Name" => "Dressing Material", "Description" => "Dressing Material"),
        array("Name" => "Medical & Nursing Materials", "Description" => "Medical & Nursing Materials"),
        array("Name" => "Uniform", "Description" => "Uniform"),
        array("Name" => "Furniture", "Description" => "Furniture"),
        array("Name" => "Building Materials", "Description" => "Building Materials"),
        array("Name" => "Plumbing Materials", "Description" => "Plumbing Materials"),
        array("Name" => "Electrical Material", "Description" => "Electrical Material"),
        array("Name" => "Orthopedic Materials", "Description" => "Orthopedic Materials"),
        array("Name" => "Gaseous and Medical Oxygen", "Description" => "Gaseous and Medical Oxygen"),
        array("Name" => "Fuel and Liquid", "Description" => "Fuel and Liquid"),
        array("Name" => "Spare Parts", "Description" => "Spare Parts"),
        array("Name" => "General Materials", "Description" => "General Materials"),
        array("Name" => "Anaesthesiology Materials", "Description" => "Anaesthesiology Materials"),
        array("Name" => "Hospital Equipments", "Description" => "Hospital Equipments"),
        array("Name" => "Hospital Machines", "Description" => "Hospital Machines"),
        array("Name" => "Suture Materials", "Description" => "Suture Materials"),
        array("Name" => "Instrument General Surgery", "Description" => "Instrument General Surgery"),
        array("Name" => "Instrument Orthopaedic", "Description" => "Instrument Orthopaedic"),
        array("Name" => "Instrument Ent and Ophthalmology", "Description" => "Instrument Ent and Ophthalmology"),
        array("Name" => "Instrument Obs and Gynaecology", "Description" => "Instrument Obs and Gynaecology"),
...
function Get_Item_ClassificationNonMedical() {
    return array(
        array("Name" => "Stationeries", "Description" => "Stationeries and Materials"),
        array("Name" => "Others", "Description" => "Others")
    );
}
...
function Get_Item_Consultation_Type() {
    return array(
        ...
        array("Name" => "Others", "Description" => "Others"),
        array("Name" => "Nuclearmedicine","Description" => "Nuclear Medicine")
    );
}
...
function Get_Selling_Price($Item_ID,$Sub_Department_ID){
    global $conn;
    $sql_check_if_aleardy_set_result=mysqli_query($conn,"SELECT Sponsor_ID FROM tbl_store_selling_price_setup WHERE Sub_Department_ID='$Sub_Department_ID'") or die(mysqli_error($conn)."opiiii");
       if(mysqli_num_rows($sql_check_if_aleardy_set_result)>0){
           ...
           $sql_get_selling_price_result=mysqli_query($conn,"SELECT Items_Price FROM tbl_item_price WHERE Sponsor_ID='$Sponsor_ID' AND Item_ID='$Item_ID'") or die(mysqli_error($conn)."uuuuhhhh");
