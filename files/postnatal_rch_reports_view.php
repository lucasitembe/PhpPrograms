...
if(isSet($_POST['d']))
{
  ...
  $MFtotoGreaterage=0;
  $MFtotoTotal=0;
  $firstphase=mysqli_query($conn,"SELECT * FROM tbl_postnal tp JOIN tbl_patient_registration tpr ON tp.Mother_ID=tpr.Registration_ID WHERE Hudhurio_Date BETWEEN '$date1' AND '$date2' GROUP BY tpr.Registration_ID");
  $Today = Date("Y-m-d");
    ...
    $age = $diff->y;
     ...
     if ($result['Hudhurio']=='Masaa 48' && $age < 20){
      ...
      if ($result['Hudhurio']=='Siku 3-7' && $age < 20){
       ...
       if (($result['Hudhurio']=='Masaa 48' && $result['Hudhurio']=='Siku 3-7' && $result['Hudhurio']=='Siku 3-7' && $result['Hudhurio']=='Siku 8-24' && $result['Hudhurio']=='Siku 29-42') && $age < 20){
       $mahudhurioyoteLessage++;
   
      } else if(($result['Hudhurio']=='Masaa 48' && $result['Hudhurio']=='Siku 3-7' && $result['Hudhurio']=='Siku 3-7' && $result['Hudhurio']=='Siku 8-24' && $result['Hudhurio']=='Siku 29-42') && $age>=20){
        $mahudhurioyoteGreaterage++;  
      };
      
      
      
       if (($result['Hudhurio_la_mtoto']=='Masaa 48' && $result['Hudhurio_la_mtoto']=='Siku 3-7' && $result['Hudhurio_la_mtoto']=='Siku 3-7' && $result['Hudhurio_la_mtoto']=='Siku 8-24' && $result['Hudhurio_la_mtoto']=='Siku 29-42') && $age < 20){
       $mahudhurioyotemtotoLessage++;
   
      } else if(($result['Hudhurio_la_mtoto']=='Masaa 48' && $result['Hudhurio_la_mtoto']=='Siku 3-7' && $result['Hudhurio_la_mtoto']=='Siku 3-7' && $result['Hudhurio_la_mtoto']=='Siku 8-24' && $result['Hudhurio_la_mtoto']=='Siku 29-42') && $age>=20){
        $mahudhurioyoteGreaterage++;  
      };
...
$grandMtotohudhurio=$TotalmtotoLess+$TotalmtotoGreater;
  ...
  echo "<div id='hudhurio1'>";
    ...
    echo "<tr><th>Namba</th><th>Maelezo</th><th>Umri < 20</th><th>Umri Miaka 20 na zaidi</th><th>Total</th></tr>";
     ...
     echo "<tr><td style='text-align:center'>1a</td><td>Waliohudhuria ndani ya saa 48</td><td><input type='text' readonly value='$hudhurioageless'></td><td><input type='text' readonly value='$hudhurioagegreater'></td><td><input type='text' readonly value='$totalhudhurio24hrs'></td>
    ...
    <tr><td style='text-align:center'>2</td><td>Waliomaliza mahudhurio yote(saa 48,siku 3-7,siku 8-28,siku 29-42)</td><td><input type='text' readonly value='$mahudhurioyoteLessage'></td><td><input type='text' readonly value='$mahudhurioyoteGreaterage'></td><td><input type='text' readonly value='$mahudhurioyoteTotal'></td>
    ...
    <tr><td style='text-align:center'>6</td><td>Wenye msamba ulioambukizwa/Ulioachia</td><td><input type='text' readonly value='$msambaLessage'></td><td><input type='text' readonly value='$msambaGreaterage'></td><td><input type='text' readonly value='$msambaTotal'></td>
     ...
     echo "<tr><th style='text-align:center'>8</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Waliojifungulia Nje ya kituo cha kutolea huduma za afya</th></tr>";
     
     
      echo "<tr><td style='text-align:center'>8a</td><td>Waliojifungua kabla ya kufika kituo cha kutolea huduma za afya (BBA)</td><td><input type='text' readonly value='$BBALessage'></td><td><input type='text' readonly value='$BBAGreaterage'></td>
...
";
      ...
      echo "<tr><th style='text-align:center'>9</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Uzazi wa Mpango</th></tr>";

      echo "<tr><td style='text-align:center'>9a</td><td>Idadi ya wateja waliopata ushauri nasaha mara moja</td><td><input type='text' readonly value='$FPLessage'></td><td><input type='text' readonly value='$FPGreaterage'></td>
    ...
    echo "<tr><th style='text-align:center'>10</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>PMTCT</th></tr>";
    echo "<tr><td style='text-align:center'>10a</td><td>Waliokuja postnatal wakiwa positive</td><td><input type='text' readonly value='$HPVVULessage'></td><td><input type='text' readonly value='$HPVVUGreaterage'></td>
...
";
      ...
      echo "<tr><th style='text-align:center'>11</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>MTOTO</th></tr>";
      echo "<tr><td style='text-align:center'>11a</td><td>Idadi ya watoto waliohudhuria Ndani ya saa 48</td><td><input type='text' readonly value='$hudhurioMtotoLessage'></td><td><input type='text' readonly value='$hudhurioMtotoGreaterage'></td>
    ...
    ";
     ...
     echo "<tr><td style='text-align:center'></td><td style='font-weight:bold;font-style:italic;'>Jumla ya Waliohudhuria ndani ya siku 7(11a+11b)</td><td><input type='text' style='font-weight:bold' readonly value='$TotalmtotoLess'></td><td><input type='text' style='font-weight:bold' readonly value='$TotalmtotoGreater'></td>
     
     <td><input type='text' style='font-weight:bold' readonly value='$grandMtotohudhurio'></td></tr>
     
     <tr><td style='text-align:center'>11c</td><td>Waliomaliza mahudhurio yote (saa 48, siku 3-7,siku 8-28,siku 29-42)</td><td><input type='text' readonly value='$mahudhurioyotemtotoLessage'></td><td><input type='text' readonly value='$mahudhurioyotemtotoGreaterage'></td>
     
     <td><input type='text' readonly value='$mahudhurioyotemtotoTotal'></td></tr>
    
    ";
     
     echo "<tr><th style='text-align:center'>12</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>HUDUMA KWA MTOTO</th></tr>";
     echo "<tr><td style='text-align:center'>12a</td><td>Idadi ya watoto waliopewa BCG</td><td><input type='text' readonly value='$BCGLessage'></td><td><input type='text' readonly value='$BCGGreaterage'></td>
    ...
    echo "<tr><th style='text-align:center'>13</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>UAMBUKIZO WA MTOTO</th></tr>";
    
    echo "<tr><td style='text-align:center'>13a</td><td>Idadi ya watoto wenye uambukizo mkali(septicaemia)</td><td><input type='text' readonly value='$septLessage'></td><td><input type='text' readonly value='$septGreaterage'></td>
    ...
    echo "<tr><th style='text-align:center'>16</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>ULISHAJI WA MTOTO</th></tr>";
    echo "<tr><td style='text-align:center'>16a</td><td>Watoto wachanga wanaonyonya maziwa ya mama pekee</td><td><input type='text' readonly value='$EFBtotoLessage'></td><td><input type='text' readonly value='$EFBtotoGreaterage'></td>
