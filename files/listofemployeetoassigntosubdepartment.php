...
<script language="javascript" type="text/javascript">
    function searchEmployee(Employee_Name){
        ...
        document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=380px src='search_list_Of_Employee_To_Assign_To_Sub_Department_Iframe.php?Employee_Name="+Employee_Name+is_hr+"'></iframe>";
    }
</script>
<br/><br/>
<center>
    <table width=40%>
        <tr>
            <td>
                <input type='text' name='Search_Employee' id='Search_Employee' autocomplete="off" onclick='searchEmployee(this.value)' onkeypress='searchEmployee(this.value)' placeholder='~~~~~~~~~~~~~~~~~~~~Search Employee Name~~~~~~~~~~~~~~~~~~~~~~~' style="text-align: center;">
            </td> 
        </tr>
...
<fieldset>  
        ...
        <center>
            <table width=100% border=1>
                <tr>
                    <td id='Search_Iframe'>
                        <?php echo "<iframe width='100%' height=380px src='List_Of_Employee_To_Assign_To_Sub_Department_Iframe.php".$is_hr."'></iframe>";?>
                    </td>
                </tr>
            </table>
        </center>
