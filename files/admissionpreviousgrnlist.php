<?php
    ...
    if(isset($_SESSION['userinfo'])){
	if($_SESSION['userinfo']['Admission_Works'] == 'yes'){
	    echo "<a href='admissionpreviousgrnlist.php?PreviousGrn=PreviousGrnThisPage' class='art-button-green'>PREVIOUS GRN</a>";
	}
    }
    
    if(isset($_SESSION['userinfo'])){
	if($_SESSION['userinfo']['Admission_Works'] == 'yes'){
	    echo "<a href='admissiongrnissuenote.php?GrnIssueNote=GrnIssueNoteThisPage' class='art-button-green'>BACK</a>";
	}
    }
?>
...
<fieldset style='overflow-y: scroll; height: 350px;' id='Previous_Fieldset_List'>
    <legend align=right><b>&nbsp;&nbsp;<?php if(isset($_SESSION['Admission_ID'])){ echo $Sub_Department_Name; }?>, GRN Against Issue Note, List Of Issues&nbsp;&nbsp;&nbsp;&nbsp;</b></legend>
	...
	<?php 
		...
		while($row = mysqli_fetch_array($sql_select)){
		    ...
		    echo '<tr><td style="text-align: center;">'.$temp.'</td>
			    ...
			    <a href="Control_Admission_Grn_Session.php?New_Grn=New&Issue_ID='.$row['Issue_ID'].'" class="art-button-green">&nbsp;&nbsp;&nbsp;Preview&nbsp;&nbsp;&nbsp;</a>
			    </td>
			</tr>';
                    $temp++;
		}
