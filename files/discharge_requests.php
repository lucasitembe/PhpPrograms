...
include("includes/connection.php");
    ...
    $select_details = mysqli_query($conn, "SELECT Admision_ID, Admission_Date_Time, Patient_Bill_ID FROM tbl_admission ad WHERE DATE(Admission_Date_Time) <= '2021-08-17' AND ad.Hospital_Ward_ID <> '1' AND ad.Admission_Status <> 'Discharged'") or die(mysqli_error($conn));
    $num = 1;
