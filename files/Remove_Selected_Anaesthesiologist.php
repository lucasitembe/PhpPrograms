<?php
    ...
    $delete = mysqli_query($conn,"delete from tbl_git_post_operative_participant where Participant_ID = '$Participant_ID'") or die(mysqli_error($conn));
