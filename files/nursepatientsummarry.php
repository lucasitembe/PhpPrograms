...
<br/>
<fieldset>  
    <legend align=center><b id="dateRange">CHECKED LIST SUMMARY <span class='dates'><?php echo date('Y-m-d')?></span> </b></legend>
    <center>
        <table width='100%' border='1'>
            <tr>
                <td >
                    <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'viewnursepatient01.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
<script>
    function filterPatient() {
        ...
        $.ajax({
            ...
            data: 'Date_From=' + Date_From + '&Date_To=' + Date_To + '&Patient_Name=' + Patient_Name+'&Sponsor=' + Sponsor,
