...
<fieldset style='margin-top:15px;'>
    <legend align="right" style="background-color:#006400;color:white;padding:5px;"><b>LABORATORY PATIENTS POSITIVE/NEGATIVE REPORT</b></legend>
        ...
        <tr>
            <td>
                <div style="width:100%; height:380px;overflow-x: hidden;overflow-y: auto" id='Search_Iframe'>
                    <?php include 'Positive_Negative_Iframe.php'; ?>
                </div>
            </td>
        </tr>
    </table>
...
<center>   
    <a href="Print_Positive_Negative.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a></center>
...
<script>
    function Show_Items_Taken(Registration_ID, Patient_Name, fromdate, todate) {
        ...
        $('#printItemsPreview').attr('href', 'Print_Positive_Negative.php?Registration_ID=' + Registration_ID + '&fromdate=' + fromdate + '&todate=' + todate);
...
<script type="text/javascript">
    $('#filterDate').click(function (e) {
        ...
        $('#printPreview').attr('href', 'Print_Positive_Negative.php?fromDate=' + fromDate + '&toDate=' + toDate);
        $.ajax({
            type: 'POST',
            url: 'Positive_Negative_Iframe.php',
