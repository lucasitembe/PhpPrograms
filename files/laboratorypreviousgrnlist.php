<?php
	...
	if($_SESSION['userinfo']['Laboratory_Works'] == 'yes'){
	    ...
	    echo "<a href='laboratorygrnissuenotelist.php?PharmacyGrnIssueNoteList=PharmacyGrnIssueNoteListThisPage' class='art-button-green'>NEW GRN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='background-color: red; border-radius: 8px; color: white; padding: 6px;'>".$number."</span></a>";
	}
    }
...
<center>
	...
	<tr> 
	    ...
	    <td style='text-align: center;' width=7%>
                <input name='Filter' type='button' value='FILTER' class='art-button-green' onclick='Laboratory_Get_List_Of_Issue_Notes()'>
            </td>
	</tr>
    </table>
</center>
	...
	<?php 
		...
		while($row = mysqli_fetch_array($sql_select)){
		    ...
		    echo '<tr><td style="text-align: center;">'.$temp.'</td>
			    ...
			    <a href="Control_Laboratory_Grn_Session.php?New_Grn=New&Issue_ID='.$row['Issue_ID'].'" class="art-button-green">&nbsp;&nbsp;&nbsp;Preview&nbsp;&nbsp;&nbsp;</a>
			    </td>
			</tr>';
                    $temp++;
		}
...
<script>
    function Laboratory_Get_List_Of_Issue_Notes() {
	...
	if (Start_Date != null && Start_Date != '' && End_Date != null && End_Date != '') {
	    ...
	    myObjectGetPreviousNote.open('GET','Laboratory_Get_List_Of_Issue_Notes.php?Start_Date='+Start_Date+'&End_Date='+End_Date,true);
