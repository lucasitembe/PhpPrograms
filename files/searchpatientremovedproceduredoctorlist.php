...
<fieldset style='margin-top:30px;'>
    <legend id="resultsconsultationLablist" style="font-weight: bold;font-size: 16px;background-color: #006400; padding:10px; color:white;width: auto;" align="right">MY PROCEDURE REMOVED PATIENTS LIST</legend>
    <center>
        <hr width="100%">
    </center>
            ...
            <tr>
                <td id='Search_Iframe'>
                    <div id="iframeDiv" style="height: 460px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'proceduredoctorlremovedist_iframe.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
if(isset($_GET['Section']) && $_GET['Section']=='Doctor'){
    ...
    $section="sectionpatnt=doctor_with_patnt&Registration_ID=".$_GET['Registration_ID']."&Patient_Payment_ID=".$_GET['Patient_Payment_ID']."&Patient_Payment_Item_List_ID=".$_GET['Patient_Payment_Item_List_ID']."";
        ...
        echo '<a href="doctorprocedurelist.php?'.$section.'" class="art-button-green">UNCONSULTED  PROCEDURE PATIENT LIST</a>';
...
<script>
    function filterLabpatient() {
        ...
        mm.open('GET', 'proceduredoctorlremovedist_iframe.php?filterlabpatientdate=true&Date_From=' + Date_From + '&Date_To=' + Date_To + '&Sponsor=' + Sponsor, true);
        mm.send();
    }
...
<script >
    function searchPatient(Patient_Name) {
        ...
        mm.open('GET', 'proceduredoctorlremovedist_iframe.php?Patient_Name=' + Patient_Name + '&searchPartient=true' + filterDate, true);
        mm.send();
