...
?>
<a href='prepaidpatientslist.php?Section=<?php echo $Section; ?>&PrePaidPatientsList=PrePaidPatientsListThisPage' class='art-button-green'>CURRENT PRE / POST PAID PATIENTS</a>
<a href='registerpatient.php?Section=<?php echo $Section; ?>&RegisterPatient=RegisterPatientThisPage' class='art-button-green'>ADD NEW PATIENT</a>
...
<fieldset style="overflow-y: scroll; height: 400px; background-color: white;" id="Patient_Area">
    <legend align="left"><b>PATIENTS LIST</b></legend>
    <table width = "100%">
<?php
    $temp = 0;
    ...
    if($num > 0){
        while ($data = mysqli_fetch_array($select)) {
            $link = '<a href="postpaidform.php?Registration_ID='.$data['Registration_ID'].'&Section='.$Section.'&PostPaid=PostPaidThisForm" style="text-decoration:none;">';
...
<script type="text/javascript">
    function Search_Patient(parameter){
        ...
        if(parameter == 'Patient_Name'){
            myObjectSearch.open('GET', 'Pre_Paid_Search_Patients.php?Sponsor_ID='+Sponsor_ID+'&Patient_Name='+Patient_Name+'&Section='+Section, true);            
        }else if(parameter == 'Patient_Number'){
            myObjectSearch.open('GET', 'Pre_Paid_Search_Patients.php?Sponsor_ID='+Sponsor_ID+'&Patient_Number='+Patient_Number+'&Section='+Section, true);
        }
        myObjectSearch.send();
    }
</script>
...
<script type="text/javascript">
    function Filter_Patient(){
        ...
        myObjectPr.open('GET', 'Pre_Paid_Search_Patients.php?Sponsor_ID='+Sponsor_ID+'&Section='+Section+'&Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name, true);            
        myObjectPr.send();
    }
</script>
