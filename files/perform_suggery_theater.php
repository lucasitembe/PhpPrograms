...
echo '<a href="Surgery_Appointments.php" class="art-button-green">BACK</a>';
...
<fieldset style='overflow-y: scroll; height: 300px; background-color: white;' id='Items_Fieldset'>
    <table width="100%">
        <?php
        $temp = 0;
        $select_surgery = mysqli_query($conn,"SELECT  i.Product_Name, pc.consultation_ID, ilc.Status, ilc.Transaction_Type, ilc.Patient_Payment_ID, pc.Billing_Type, ilc.Doctor_Comment,
                                        ...
                                        ilc.Status <> 'removed' AND ilc.Payment_Item_Cache_List_ID IN(SELECT Payment_Item_Cache_List_ID FROM tbl_surgery_appointment WHERE Final_Decision = 'Accepted')") or die(mysqli_error($conn));
...
//                        }
            ...
            echo "<center><br/><br/><br/><br/><h3>NO TEST SELECTED</h3></center>";
        }
