...
<fieldset >
    <legend align='right'><b>Pending Return Inward  ~ <?php if (isset($_SESSION['Storage'])) { echo $_SESSION['Storage']; } ?></b></legend>
...
<script>
    ...
    function Filter_Document() {
        ...
        if (Date_From != "" && Date_To != "") {
            ...
            myObject.open('GET', 'returninward_filter_pending_document.php?Date_From=' + Date_From
