...
<center><b>List of Removed Family Planning Services </b></center><link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
...
<?php
    ...
    if(isset($_SESSION['Family_Planning'])){
	$Sub_Department_Name = $_SESSION['Family_Planning'];
    }else{
	$Sub_Department_Name = '';
    }
    $total = 0;
	...
	echo "<td style='text-align: right;' width=8%><a href='AddFamily_PlanningItems.php?Payment_Item_Cache_List_ID=".$row['Payment_Item_Cache_List_ID']."&Payment_Cache_ID=".$row['Payment_Cache_ID']."' class='art-button-green' target='_Parent'>Re-Add</a></td>";
	...
	$temp++;
        ...
        echo "<tr><td colspan=6 style='text-align: right;'><b> TOTAL : ".number_format($total)."</b></td>
		    <td style='text-align: right;'>
			<a href='family_planningitems_Iframe.php?Transaction_Type=".$Transaction_Type."&Payment_Cache_ID=".$Payment_Cache_ID."' class = 'art-button'>Back To Service List</a></td></tr>";
    ?></table></center>