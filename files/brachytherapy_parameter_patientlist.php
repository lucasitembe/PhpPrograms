...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Patient_Record_Works'] == 'yes'){ 
?>
    <a href='brachytherapy_Menu.php?PatientRecords=PatientRecordsThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
   ...
   document.location = "./index.php";
    ...
    <script language="javascript" type="text/javascript">
        function searchPatient(){
            ...
            document.getElementById('Search_Iframe').src = 'brachytherapy_parameter_calculation_iframe.php?Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name+'&Phone_Number='+Phone_Number+'&section=<?php echo $section; ?>';
        }
    </script>
<script language="javascript" type="text/javascript">
...
<br>
<fieldset>  
            <legend align=center><b>BRACHYTHERAPY PARAMETER CALCULATION PATIENTS LIST</b></legend>
                <center>
                    <table width=100% border=0>
                        <tr>
                            <td style="border: 1px #ccc solid;">
                                <iframe id='Search_Iframe' width='100%' height="460px" src='brachytherapy_parameter_calculation_iframe.php?section=<?php echo $section; ?>'></iframe>
                            </td>
                        </tr>
                    </table>
                </center>
