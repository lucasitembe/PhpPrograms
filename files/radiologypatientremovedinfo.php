...
if (isset($_POST['process_procedure'])) {
            ...
            if ($status !== 'Select progress') {
                if ($status == 'served') {
                    ...
                    if (mysqli_num_rows($selectInfo)) {
                        ...
                        //$Sponsor_ID = $rows_info['Sponsor_ID'];
                        $Sponsor_Name = $rows_info['Guarantor_Name'];
                        $Branch_ID = $_SESSION['userinfo']['Branch_ID'];
                        $Claim_Form_Number = $rows_info['Claim_Form_Number'];

                        // die("select Folio_Number,pp.Sponsor_ID,Guarantor_Name,Claim_Form_Number,Billing_Type from tbl_patient_payments pp JOIN tbl_sponsor sp ON pp.Sponsor_ID=sp.Sponsor_ID  where Registration_ID = '" . $Registration_ID . "' AND Check_In_ID = '" . $Check_In_ID . "'  AND pp.Sponsor_ID = '" . $Sponsor_ID . "' order by Patient_Payment_ID desc limit 1");
    ...
    echo "<script type='text/javascript'>
                                ...
                                window.location='radiologypatientremovedinfo.php?" . $queryString . "'
                            </script>";
}
...
?>
<a href='searchpatientremovedradiologylist.php' class='art-button-green'>
    BACK
</a>
            ...
            <tr>
                ...
                <td style='text-align: right;'>
                    ...
                    if (isset($_GET['section']) && ($_GET['section'] == 'doctor' || $_GET['section'] == 'Doctorlist')) {
                        ...
                        ?> 
                        <a href="prview_rad_test.php?source=removed&<?php echo $_SERVER['QUERY_STRING'] ?>&billtype=<?php echo $Billing_Type ?>" id="preview"  target="_blank" class="art-button-green">PREVIEW</a>
                ...
                <tr>
                    <td>
                        ...
                        <div id="patientItemsList" style='height:200px;overflow-x:hidden; overflow-y:scroll;  '>
                            <?php include "radiologyremoved_iframe.php"; ?>
                        </div>
