...
?>
<a href="print_patient_file_scroll.php?Registration_ID=<?php echo $_GET['Registration_ID'] ?>" target="_blank" class="art-button-green">PRINT PATIENT FILE</a>
<a href="Patientfile_Record_Detail.php?Registration_ID=<?php echo $_GET['Registration_ID'] ?>&section=Patient&PatientFile=PatientFileThisForm" class="art-button-green">BACK</a>
...
echo '<fieldset style="width:99%;height:720px ;padding:5px;background-color:white;margin-top:20px;overflow-x:hidden;overflow-y:scroll">
