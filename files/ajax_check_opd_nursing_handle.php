<?php
    include("./includes/connection.php");
        session_start();
            ...
            $taarifa ='';
            $duty_ID = mysqli_fetch_assoc(mysqli_query($conn, "SELECT duty_ID FROM tbl_opd_nurse_duties WHERE Ward_Type = '$Ward_Type' AND select_round = '$select_round' AND duty_ward = '$ward_ID' AND Process_Status = 'pending' AND DATE(duty_handled) = CURDATE()"))['duty_ID'];
            if($duty_ID > 0){
...
";
                ...
                $taarifa .= 'NO REPORT WRITTEN FOR THIS SHIFT ON THIS WING & CLINIC';
            }
