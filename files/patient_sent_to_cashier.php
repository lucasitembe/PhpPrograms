...
?>
<a href="new_payment_method.php" class="art-button">BACK</a>
<style>
    .rows_list{
        cursor: pointer;
    }
...
<fieldset>
    <legend align='center'><b>LIST OF PATIENT SENT TO CASHIER / PENDING TRANSACTION</b></legend>
    <center>
        <table>
            <tr>
                ...
                <td><input type="button" value="FILTER" onclick="filter_list_of_patient_sent_to_cashier()" class="art-button"/></td>
                <!--<td><input type="button" value="Card/Mobile CONFIRM PAYMENT" onclick="confirm_mobile_payment()" class="art-button"/></td>-->
            </tr>
        </table>
    </center>
...
<script>
    ...
    function filter_list_of_patient_sent_to_cashier(){
        ...
        $.ajax({
            type:'POST',
            url:'ajax_patient_sent_to_cashier.php',
