...
<?php
    ...
    $select_doc=mysqli_query($conn,"SELECT * FROM tbl_employee WHERE Employee_Type='Doctor' AND Employee_ID='$Employee_ID'");
...
<?php
    ...
    $htm.="<fieldset>";
    $htm.="<legend align=center><b>PERFORMANCE REPORT FOR DOCTOR ".$Doctor_Name."  FROM</b> <b style=''>".date('j F,Y H:i:s',strtotime($Date_From))."</b> <b>TO</b> <b style=''>".date('j F,Y H:i:s',strtotime($Date_To))."</b> </legend>";
        $htm.="<center>";
		...
		/*echo "<tr>
		    ...
		    echo "<tr>
				<td colspan=4></td></tr>";*/
                            ...
                            $select_doctor_query=mysqli_query($conn,"SELECT  emp.Employee_ID,emp.Employee_Name,emp.Employee_Type FROM tbl_employee emp
                                                             WHERE Employee_Type='Doctor' AND emp.Employee_ID='$Employee_ID'");
                            $doctorSN=1;
                            while($select_doctor_query_row=mysqli_fetch_array($select_doctor_query)){//return employee details
                                ...
                                $select_patient_item_list=mysqli_query($conn,"SELECT * FROM tbl_consultation co,tbl_patient_payment_item_list ppl,tbl_patient_payments pp
								      ...
								      AND co.Consultation_Date_And_Time BETWEEN '$Date_From' AND '$Date_To'
