...
if (isset($_SESSION['userinfo'])) {
    if ($_SESSION['userinfo']['Doctors_Page_Inpatient_Work'] == 'yes') {
        ...
        if (isset($_SESSION['userinfo'])) {
            if ($_SESSION['userinfo']['Doctors_Page_Inpatient_Work'] == 'yes') {
                ?>
        <a href='./laboratoryresult_inpatient.php?<?php echo $_SERVER['QUERY_STRING']?>' class='art-button-green'>
                    BACK
                </a>
            <?php
            }
        ...
        <fieldset>
            <center style='background: #006400 !important;color: white;'>
                <b>DOCTORS WORKPAGE INPATIENT &nbsp;~~~&nbsp; PATIENT LABORATORY RESULT(S)</b>
            </center>
            <center>
                <table width=100%>
                    <tr>
        ...
        <fieldset>
            <div style="oveflow-x:hidden;overflow-y:scroll;height:230px">
        <?php include 'testResults_inpatient.php' ?>
            </div>
        </fieldset>    
        <hr> 
