...
?>
    ...
    <a href='doctorspharmacy.php?Consultation_Type=<?php
...
<fieldset id='frmaesearch'>
    <iframe src="./doctordetaileditemselect_Iframe.php?Item_Subcategory_ID=<?php echo $Item_Subcategory_ID;?>&Item_Category_ID=<?php echo $Item_Category_ID;?>&Consultation_Type=<?php echo $Consultation_Type;Patient_Payment_ID
