...
<table width='100%'>
		<tr>
		    <td style='border:0;text-align:right;width:20%;'><input type='submit' name='printPatientsVisitedToday' value='PRINT' class='art-button-green' style='width:10%;'/></td>
		</tr>
</table>		
	    </form>";
?>
