...
<script language="javascript" type="text/javascript">
    function searchPatient(){
        ...
        document.getElementById('Search_Iframe').innerHTML ="<iframe width='100%' height=380px src='search_list_patient_billing_Iframe3.php?Patient_Name="+Patient_Name+"&Patient_Number="+Patient_Number+"'></iframe>";
    }
</script>
<br/><br/>
<center>
...
<br>
<fieldset>  
    <legend align=center><b>PATIENT LIST FOR THEATER CONSENT FORM</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
		    <td id='Search_Iframe'>
			<iframe width='100%' height=380px src='search_list_patient_billing_Iframe3.php?Patient_Name='></iframe>
		    </td>
		</tr>
            </table>
        </center>
