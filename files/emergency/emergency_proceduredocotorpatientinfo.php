...
$doctorproce = '';
    ...
    echo "<a href='emergencyclinicalnotes.php?Registration_ID=" . $Registration_ID . "&Patient_Payment_ID=" . $Patient_Payment_ID . "&Patient_Payment_Item_List_ID=" . $Patient_Payment_Item_List_ID ."&consultation_ID=" . $consultation_ID ."' class='art-button-green'>BACK</a>";
