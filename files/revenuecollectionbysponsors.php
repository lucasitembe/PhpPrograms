	...
	<table width="100%">
		<tr>
            <td width="30%" style="text-align: center;">
                <input type="checkbox" name="Cash_Option" id="Cash_Option" value="yes">
                <label for="Cash_Option"><b>EXCEPT CASH SPONSOR</b></label>
            </td>
            <td width="30%" style="text-align: center;">
                <input type="checkbox" name="Msamaha_Option" id="Msamaha_Option" value="yes">
                <label for="Msamaha_Option"><b>EXCEPT MSAMAHA SPONSOR</b></label>
            </td>
...
<script>
    function filter_list(){
        ...
        var Cash_Option = 'no';
        var Msamaha_Option = 'no';

        if(document.getElementById("Cash_Option").checked){
            var Cash_Option = 'yes';
        }

        if(document.getElementById("Msamaha_Option").checked){
            var Msamaha_Option = 'yes';
        }
        ...
        if (Date_From != null && Date_From != '' && Date_To != null && Date_To != ''){
	        ...
	        myObject2.open('GET','Revenue_Collection_By_Sponsor.php?Date_From='+Date_From+'&Date_To='+Date_To+'&Billing_Type='+Billing_Type+'&Employee_ID='+Employee_ID+'&Sponsor_ID='+Sponsor_ID+'&Cash_Option='+Cash_Option+'&Msamaha_Option='+Msamaha_Option,true);
	        myObject2.send();
        }else{
...
<script type="text/javascript">
    function Preview_Report(){
        ...
        if (Date_From != null && Date_From != '' && Date_To != null && Date_To != ''){
            document.getElementById("Date_From").style = 'border: 2px solid black; text-align: center;';
            document.getElementById("Date_To").style = 'border: 2px solid black; text-align: center;';
            window.open("revenuecollectionbysponsorreport.php?Start_Date="+Date_From+"&End_Date="+Date_To+"&Billing_Type="+Billing_Type+"&Employee_ID="+Employee_ID+"&Sponsor_ID="+Sponsor_ID+'&Cash_Option='+Cash_Option+'&Msamaha_Option='+Msamaha_Option+"&RevenueCollectionBySponsorReport=RevenueCollectionBySponsorReportThisPage","_blank");
        }else{
            if(Date_From == '' || Date_From == null){
                document.getElementById("Date_From").style = 'border: 3px solid red; text-align: center;';
            }else{
