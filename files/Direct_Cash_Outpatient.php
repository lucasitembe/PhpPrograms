...
<script type="text/javascript">
	function Filter_Patients(){
        ...
        myObjectFilterPatient.open('GET','Direct_Cash_Oupatient_Filter.php?Sponsor_ID='+Sponsor_ID,true);
...
<script type="text/javascript">
	function Search_Patients(){
        ...
        myObjectSearchByName.open('GET','Direct_search_outpatient.php?Sponsor_ID='+Sponsor_ID+'&Patient_Name='+Patient_Name,true);
...
<script type="text/javascript">
	function Search_Patients_Via_Number(){
        ...
        myObjectSearchByNumber.open('GET','Direct_search_Outpatient_number.php?Registration_ID='+Registration_ID,true);
