...
<script language="javascript" type="text/javascript">
	...
	var Item_Category_ID = document.getElementById('Item_Category_ID').value;
        ...
        document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=420px src='sponsorallowzeroitems_Iframe.php?Item_Category_ID="+Item_Category_ID+"&Product_Name="+Product_Name+"&Sponsor_ID="+Sponsor_ID+"'></iframe>";
    }
</script>
<br/><br/>
<center>
...
<fieldset>  
        ...
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
		<iframe width='100%' height=440px src='sponsorallowzeroitems_Iframe.php?Product_Name=&Item_Category_ID=ALL'></iframe>
            </td>
        </tr>
            </table>
        </center>
