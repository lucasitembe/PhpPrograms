...
?>
    ...
    <script>
        function Preview_Stock_Details(){
            ...
            var URL = 'accountpayablereport_preview.php?Supplier_ID='+Supplier_ID
    ...
    <script>
        function Get_Items_List_Filtered(){
            ...
            myObject.open('GET','accountpayablereport_search.php?Supplier_ID='+Supplier_ID
