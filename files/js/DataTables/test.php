...
if (strtolower($Section) == 'reception' || strtolower($Section) == 'visitor') {
   ...
   echo "<a href='directdepartmentalpayments.php' class='art-button-green'>BACK</a>";
}else{
            ...
            <form action='#' method='post' name='myForm' id='myForm' onsubmit="return validateForm(); finger_print_status();" enctype="multipart/form-data">
                <tr>
                        ...
                        <table width=100%>
                                ...
                                <td colspan="2">
                                    <table style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="button" class="art-button-green"value="SEARCH" onclick="open_militaary_personnel_info()"/>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><input type='text' name='Member_Number' autocomplete='off' id='Member_Number' style="width: 150px;text-align: left;">
                                    <input type="button" value="NHIF-eVerify" id='eVerify_btn' onclick="verifyNHIF3('<?= $extenal_nhif_server_url ?>');" class="art-button-green" style="text-align: right;visibility: hidden;"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td id='gender_dom'>
                                    ...
                                    <select name='Gender' id='Gender' required='required' style='border-color: red' >
                                        <option selected='selected'></option>
                                        <option <?php if($patient_gender=="Male"){ echo "selected='selected'";}?>>Male</option>
                                        <option <?php if($patient_gender=="Female"){ echo "selected='selected'";}?>>Female</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td width=35%><table width=100%>
							...
							<tr>
								...
								<td>
                                <span style="width:79%">
                                    <select name="Leader" id="ten_cell_leader_name" style="width:60%;"></select>
                                    </span>
                                    <span style="width:20%">
                                ...
                                <td>
                                    <select name="Tribe" id="Tribe"  style="width:100%;">
                                        ...
                                        while ($tribeRow = mysqli_fetch_assoc($tribeResult)) {
                                            extract($tribeRow);
                                            ?>
                                       <option value="<?= $tribe_name; ?>"><?= $tribe_name; ?></option>
                                       <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <tr>
                                ...
                                <td >
                                  <input type="button" name="finger_print" value="Take Finger Print" class="art-button-green" onclick="open_finger_print_dialog();">
                                </td>
                              <?php }else{ ?>
                ...
                <tr>
                    <td colspan = 2 style = 'text-align: center;'>
                        ...
                        <input type = 'submit' name = 'submit' id = 'submit' value = '   SAVE   ' style = 'width: 30%' class = 'art-button' onclick = "Validate_Date()">
                        <input type = 'reset' name = 'clear' id = 'clear' value = ' CLEAR ' style = 'width: 30%' class = 'art-button' onclick = 'clearPatientPicture()'>
                        <input type = 'hidden' name = 'submittedAddNewPatientForm' style = 'width: 30%' value = 'true'/>
                    </td>
                </tr>
                <!--<tr>
                <td style = 'text-align: right;'>
                <br><input type = 'button' id = 'verify' name = 'verify' class = 'art-button' value = 'Member Number Status'>
...
<!-- add vllage -->
<!-- <div id="addvillage">
    <div style="margin-top:20px;"><input type="text" name="village_name" style="padding-left:10px;" placeholder="enter village name" id="village"></div>
    <div style="text-align:center;margin-top:15px;"><input type="button" class="art-button-green" id="save-village" value="Save"></div>
</div>

<div id="addward">
    <div style="margin-top:20px;"><input type="text" name="ward_name" style="padding-left:10px;" placeholder="Enter Ward Name" id="new_ward_name"></div>
    <div style="text-align:center;margin-top:15px;"><input type="button" class="art-button-green" id="save_new_village" value="Save"></div>
</div>

<div id="addleader">
    <div style="margin-top:20px;"><input type="text" name="leader_name" style="padding-left:10px;" placeholder="Enter Leader Name" id="new_leader_name"></div>
    <div style="text-align:center;margin-top:15px;"><input type="button" class="art-button-green" id="save_new_leader" value="Save"></div>
</div> -->
   ...
   echo $Member_Card_Expire_Date = mysqli_real_escape_string($conn,$_POST['Member_Card_Expire_Date']);
    ...
    if ($num_info > 0) {
      ...
      $Insert_Sql = "INSERT INTO tbl_patient_registration(
			Old_Registration_Number,Title,Patient_Name, Date_Of_Birth,Gender,Country,Region,District,Ward,ward_id,Tribe,
			Sponsor_ID,Member_Number,Member_Card_Expire_Date,Phone_Number,Email_Address,Occupation,Employee_Vote_Number,Emergence_Contact_Name,
			Emergence_Contact_Number,Relationship,Company,Employee_ID,Registration_Date_And_Time,District_ID,
      Registration_Date,Diseased,national_Id,Patient_Picture$Religion_ID$Denomination_ID,village,patient_type,rank,Status,service_no,
      dependancy_id,dependecny_service_no,military_unit,leader_id,ten_cell_leader_name)
			VALUES('$Old_Registration_Number','$Patient_Title','$Patient_Name','$Date_Of_Birth','$Gender','$Country','$region','$District','$Ward',
      (SELECT Ward_ID FROM tbl_ward WHERE ward_name= '$Ward' LIMIT 1 ),'$Tribe',(select Sponsor_ID from tbl_sponsor where Guarantor_Name = '$Guarantor_Name'),
			'$Member_Number',DATE('$Member_Card_Expire_Date'),'$Phone_Number','$Email','$Occupation','$Employee_Vote_Number','$Emergence_Contact_Name',
		  '$Emergence_Contact_Number','$Relationship','$Company','$Employee_ID','$Registration_Date_And_Time',
      (SELECT `District_ID` FROM `tbl_district` WHERE District_Name= '$District' LIMIT 1 ),(select now()),
      '$Diseased','$nationalId','$Patient_Picture'$religion$denomination,'$village','$patient_type','$military_rank','$active_status','$service_number',
      '$dependant_number','$dependent_service_number','$unit','$Leader',(select leader_name from tbl_leaders where leader_ID = '$Leader' LIMIT 1))";
    ...
    function open_militaary_personnel_info(){
       ...
       if(dependent_service_number==""){
        ...
        $.ajax({
            ...
            data:{dependent_service_number:dependent_service_number},
...
<script>
    $(document).ready(function () {//
        ...
        $("#addleader").dialog({autoOpen: false, width: '45%', height: 310, title: 'ADD NEW LEADER', modal: true, position: 'middle'})
        $("#addvillage").dialog({autoOpen: false, width: '45%', height: 310, title: 'ADD VILLAGE', modal: true, position: 'middle'})
        $("#addward").dialog({autoOpen: false, width: '45%', height: 310, title: 'ADD NEW WARD', modal: true, position: 'middle'})
        $("#militsry_personnel_information").dialog({autoOpen: false, width: '45%', height: 310, title: 'MILITARY PERSONEL INFORMATION', modal: true, position: 'middle'});
        $("#militsry_personnel_registration").dialog({autoOpen: false, width: '85%', height: 600, title: 'MILITARY PERSONEL REGISTRATION', modal: true, position: 'middle'});
    });
</script>
            <script>
...
//                $("#date2").attr('readonly', false);
    ...
    $("#save-village").click(function(){
        ...
        if(village.trim() !==''){
			...
			$.ajax({
				type:'GET',
				url:'addvillage.php',
				data:{villageName:village,Ward_ID:Ward_ID},
				success:function(data){
                    ...
                    if(feedback.result === 'exist'){
                        ...
                        $("#select-village").append("<option value='"+feedback.village_id+"'>"+feedback.village_name+"</option>");
		...
		if(village !== ''){
			if(leader.trim() !== ''){
				...
				$.ajax({
					type:'POST',
					url:'addLeader.php',
					data:{village:village,leader:leader},
					success:function(data){
                                            console.log(data)
                        var feedback = JSON.parse(data);
                        if(feedback.result === 'exist'){
		...
		if(district !== ''){
			if(ward.trim() !== ''){
				$.ajax({
					type:'POST',
					url:'addvillage.php',
					data:{wardName:ward,district:district},
					success:function(data){
						console.log("===>"+data);
						 var feedback = JSON.parse(data);
  ...
  function getVillage_Street(){
    ...
    $.ajax({
      url:'getvillage.php',
      type:'get',
      data:{From:'Get_Village',Ward_ID:Ward_ID},
      success:function(results){
  ...
  function getVillage_leader(){
    ...
    $.ajax({
      url:'getLeader.php',
      type:'get',
      data:{From:'Get_Village',village:village},
      success:function(results){
