...
<fieldset style='overflow-y: scroll; height: 350px;' id='Previous_Fieldset_List'>
    <legend align=right><b> <?php if(isset($_SESSION['Storage'])){ echo $_SESSION['Storage']; }?></b></legend>
    <?php
        if(isset($_SESSION['Storage'])){
            $Sub_Department_Name = $_SESSION['Storage'];
        }
        $sql_select = mysqli_query($conn,"select emp.Employee_Name from tbl_employee emp, tbl_quick_purchase_order qpo where
