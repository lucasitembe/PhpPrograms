...
<script language="javascript" type="text/javascript">
    function SerchEngineering(){
        ...
        myObjectPost.open('GET', 'jobclosure_list_engineering_iframe2.php?assigned_engineer='+assigned_engineer+'&section_required='+section_required+'&Mrv_Number='+Mrv_Number, true);
        myObjectPost.send();
    }
...
<fieldset>  
<legend align=center><b>JOB CLOSURE LIST</b></legend>
<!-- <fieldset> -->
