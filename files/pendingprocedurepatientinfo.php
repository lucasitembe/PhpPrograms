...
if (isset($_POST['process_procedure'])) {
    ...
    echo "<script type='text/javascript'>
                                ...
                                window.location='pendingprocedurepatientinfo.php?" . $queryString . "'
                            </script>";
}
...
if (isset($_SESSION['userinfo'])) {
    if (isset($_GET['section']) && $_GET['section'] == 'doctor') {
        ...
        ?>
        <a href='searchpatientpendingprocedurelist.php' class='art-button-green'>
            BACK
        </a>
        <?php
    }
                ...
                <tr>
                    <td>
                        ...
                        <div id="patientItemsList" style='height:200px;overflow-x:hidden;overflow-y:scroll;  '>
                            <?php include "procedurepending_iframe.php"; ?>
