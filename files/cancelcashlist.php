...
<!--    Datepicker script-->
	...
	function Search_Receipt_Number(Receipt_No) {
		...
		document.getElementById('Cancel_Receipt').innerHTML = "<iframe width='100%' height=400px src='cancel_patient_cash_billing_iframe.php?Receipt_No="+Receipt_No+"'></iframe>";
	    }
	}
    </script>
    <script>
...
?>
<fieldset>
    <legend align="right"><b>Cancel Cash Receipts</b></legend>
            ...
            <table width=100% border=1>
                <tr>
                    <td id="Cancel_Receipt">
                        <iframe width='100%' height=400px src="cancel_patient_cash_billing_iframe.php?Branch=<?php echo $Branch; ?>&Date_From=<?php echo $Date_From; ?>&Date_To=<?php echo $Date_To; ?>&Insurance=<?php echo $Insurance; ?>&Patient_Name =<?php echo $Patient_Name; ?>"></iframe>
                    </td>
                </tr>
            </table>
        </center>
