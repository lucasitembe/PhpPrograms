...
if (isset($_SESSION['userinfo'])) {
    if ($_SESSION['userinfo']['Revenue_Center_Works'] == 'yes') {
        ?>
        <a href='DirectCashsearchlistinpatientbilling.php?SearchListDirectCashPatientBilling=SearchListDirectCashPatientBillingThisPage' class='art-button-green'>
            BACK
        </a>
    <?php }
} ?>
                        ...
                        <table width=100%>
                            <tr>
                                <table width=100%>
                                    ...
                                    <tr>
                                        <td style="text-align: right;" id="Payment_Button_Area">
                                        ...
                                        <td colspan="3" style="text-align: right;" id="Total_Area">
             ...
             var finance_department_id = document.getElementById("finance_department_id").value;
                                    if(Clinic_ID==''|| Clinic_ID==null){
                                      ...
                                      if(clinic_location_id==''|| clinic_location_id==null){
                                        alert("Select Cash Deposit reason")
                                        exit;
                                    }
