            ...
            <tr>
                    ...
                    <fieldset>
                        ...
                        <table width=100%>
                                    ...
                                    <select name='itemtype' id='itemtype' required='required' onchange="Update_Option()">
                                        <?php
                                            ...
                                            foreach($Item_Type_List as $Item_Type) {
                                              if($Item_Type['Name'] != 'Pharmacy'){continue;}
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type='text' name='Product_Name' id='Product_Name' required='required' placeholder='Enter Brand Name' autocomplete='off'>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align:right;"><b>Generic Name</b></td>
                                <td colspan="2">
                                  <select name='Generic_Name' id='Generic_Name' required='required'>

                                  <?php
                                    $select_generic = mysqli_query($conn,"SELECT Item_ID, Product_Code,Product_Name FROM tbl_items WHERE Item_Type = 'Pharmacy' AND Classification = 'Pharmaceuticals'");
                                    while ($row = mysqli_fetch_assoc($select_generic)) {
                                      echo "<option value='".$row['Item_ID']."'>".$row['Product_Name']."</option>";
                                    }
                                   ?>
                                 </select>
                                    <!-- <input type='text' name='Generic_Name' id='Generic_Name' required='required' placeholder='Enter Generic Name' autocomplete='off' required="required"> -->
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <select name='Item_Classification' id='Item_Classification' required='required'>
                                        ...
                                        <?php
                                            ...
                                            foreach($Item_Classification as $Classification) {
                                              if($Classification['Description'] != 'Pharmaceuticals'){continue;}
                                    ...
                                    <select name='Item_Category' id='Item_Category' onchange='getSubcategory(this.value)' required='required'>
                                        ...
                                        <?php
                                            ...
                                            foreach($Item_Category_List as $Item_Category) {
                                              if($Item_Category['Item_Category_Name'] != 'MEDICINES AND CONSUMABLES'){continue;}
                                    ...
                                    <select name='Consultation_Type' id='Consultation_Type' required='required'>
                                        ...
                                        <?php
                                            ...
                                            foreach($Item_Consultation_Type as $Consultation_Type) {
                                              if($Consultation_Type['Name'] != 'Pharmacy'){continue;}
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type='checkbox' name='Can_Be_Sold' id='Can_Be_Sold' value='yes' checked='checked'>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type='checkbox' name='Can_Be_Stocked' id='Can_Be_Stocked' value='yes' checked='checked'>
                                </td>
                            </tr>
		      ...
		      <tr>
							...
							<tr>
                                ...
                                <td colspan="2">
                                    <input type='checkbox' name='Seen_On_Allpayments' id='Seen_On_Allpayments' value='yes' checked='checked'>
                                </td>
                            </tr>
                     <tr>
...
<?php
    if(isset($_POST['submittedAddNewItemForm'])){
        ...
        $Particular_Type = mysqli_real_escape_string($conn,$_POST['Particular_Type']);
		    ...
		    $Generic_ID = mysqli_real_escape_string($conn,$_POST['Generic_Name']);
	...
	if(isset($_POST['Free_Consultation_Item'])) {
        ...
        $Insert_New_Item = "INSERT INTO
                                ...
                                Ward_Round_Item, Can_Be_Sold, Can_Be_Stocked,Ct_Scan_Item,consultation_Item,Particular_Type,Seen_On_Allpayments,Free_Consultation_Item,Package_Type,Tax,Item_Origin,Generic_ID)
			                VALUES(
                                '$itemtype','$Product_Code','$Unit_Of_Measure',
                                '$Product_Name','$Item_Subcategory','$Item_Status','$Item_Classification',
					            '$Reoder_Level','$Consultation_Type','$Can_Be_Substituted_In_Doctors_Page',
					            '$Ward_Round_Item', '$Can_Be_Sold', '$Can_Be_Stocked','$Ct_Scan_Item','$consultation','$Particular_Type','$Seen_On_Allpayments','$Free_Consultation_Item','$Package_Type','$Tax_type','brand','$Generic_ID' )";
