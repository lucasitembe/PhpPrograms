                   ...
                   while($item_list_rows=mysqli_fetch_assoc($sql_select_patient_items_result)){
                      ...
                      echo "<tr>
                            ...
                            if(!empty($card_and_mobile_payment_transaction_id)){
                               $amount= number_format($item_quantity*($Price-$Discount));
                                 echo   "<td><input type='button' value='Print Code' class='art-button-green' onclick='print_sangira_code(\"$card_and_mobile_payment_transaction_id\",\"$amount\")'></td>";
                            }
                          echo "</tr>";
                      $count_sn++;
