...
<a href="viewappointmentPage.php?from_procedure=yes" class="art-button-green">VIEW PATIENT APPOINTMENT</a>
...
<fieldset style='margin-top:30px;'>
    <legend id="resultsconsultationLablist" style="font-weight: bold;font-size: 16px;background-color: #006400; padding:10px; color:white;width: auto;" align="right">UN CONSULTED PROCEDURE PATIENTS LIST</legend>
    <center>
        <hr width="100%">
    </center>
        ...
        <table  class="hiv_table" style="width:100%">
            <tr>
                ...
                <td style="text-align: center">
                    ...
                    <input type='text' autocomplete="off" name='Search_Patient' id='Search_Patient' style='text-align: center;width:17.5%;display:none' oninput='searchPatient(this.value)'  placeholder='~~~~~ Patient Name ~~~~~'>
                    <label style="font-size:20px">Enter Patient Number</label>
                    <input type='text' autocomplete="off" name='Search_Patient' id='Search_Patient' style='text-align: center;width:17.5%;display:inline' oninput='searchPatient_number(this.value)'  placeholder='~~~~~ Patient Number ~~~~~'>
                </td>
            </tr>
            <tr>
                <td id='Search_Iframe'>
                    <div id="iframeDiv" style="height: 460px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'procedurelist_iframe.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
<center>
    <?php
        echo '<a href="searchpatientremovedprocedurelist.php" class="art-button-green">REMOVED PROCEDURES</a>';
        echo '<a href="searchpatientpendingprocedurelist.php" class="art-button-green">PENDING / NOT APPLICABLE PROCEDURES</a>';
   ?>
</center> 
...
<script>
    function filterLabpatient() {
        ...
        mm.open('GET', 'procedurelist_iframe.php?filterlabpatientdate=true&Date_From=' + Date_From + '&Date_To=' + Date_To + '&Sponsor=' + Sponsor, true);
        mm.send();
    }
...
<script >
    ...
    function searchPatient_number(Registration_ID) {
        //alert(Employee_IDs);
        var Date_From = document.getElementById('Date_From').value;
        var Date_To = document.getElementById('Date_To').value;
        var Sponsor = document.getElementById('sponsorID').value;
        ...
        mm.onreadystatechange = AJAXP; //specify name of function that will handle server response....
        mm.open('GET', 'procedurelist_iframe.php?Registration_ID=' + Registration_ID + '&searchPartient=true' + filterDate, true);
        mm.send();
