...
?>
<a href='<?php echo $_SESSION['BackToDoctorPage2']; ?>' class='art-button-green'> BACK </a>
<?php $Supervisor_ID = $_SESSION['userinfo']['Employee_ID']; ?>
<br><br>

<fieldset style='margin-top:10px;'>
    <legend align="right" style="background-color:#006400;color:white;padding:5px;"><b>  RADIOLOGY RESULTS <?php if ($PatientType == 'in') { ?> - INPATIENTS <?php } else { ?> - OUTPATIENTS <?php } ?></b></legend>
...
//				Search_Iframe.innerHTML = "<iframe width='100%' height=350px src='RadiologyPatientsList_Served_Doctor.php?PatientType="+PatientType+"&Sub_Department_ID="+Sub_Department_ID+"&Patient_Name="+Patient_Name+"&DateFrom="+DateFrom+"&DateTo="+DateTo+"'></iframe>";
//			}
    </script>
                    ...
                    <input type="text" name="Search_Patient" id="Search_Patient" style="text-align: center;width:35%;display:inline" placeholder="~~~~~~~~~~~~~~~~~~~Search Patient Name~~~~~~~~~~~~~~~~~~" oninput="filterPatient()"  />
                                                ...
                                                <tr>
                                                    <td >
                                                        <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                                                            <?php include 'RadiologyPatientsList_Served_Doctor.php'; ?>
                                                        </div>
                                        ...
                                        <script>
                                            function filterPatient() {
                                                ...
                                                $.ajax({
                                                    type: 'GET',
                                                    url: 'RadiologyPatientsList_Served_Doctor.php',
