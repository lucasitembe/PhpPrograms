...
<a href="searchvisitorsfamilyplaningpatientlistforrch.php?section=Rch&RchWorks=RchWorksThisPage" class="art-button-green" >BACK</a>
...
<legend style="background-color:#006400;color:white;padding:2px;" align="right"><b>FOMU YA TAARIFA YA KITABU CHA 8: REJESTA YA UZAZI WA MPANGO</b></legend> 
...
<script type="text/javascript">				
	...
	$("#filt").click(function(){
		...
		$("#modal-rchload").show();	
                ...
                $.ajax({
                    type: "POST",
                    url: 'family_planing_rch_reports_view.php',
...
<script>
   $('#print_report').click(function(){
     ...
     window.open('PrintFamilyPlaning.php?from_date='+from_date+'&to_date='+to_date+'');  
   }); 
</script>