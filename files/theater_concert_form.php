...
<center>
                              <div class="button_container">
                                    ...
                                    <div class="button_alignment">
                                          <a href='theater_concert_form_sw.php?Registration_ID=<?= $Registration_ID; ?>&Product_Name=<?= $Product_Name; ?>&consultation_id=<?= $consultation_id; ?>&Payment_Item_Cache_List_ID=<?= $Payment_Item_Cache_List_ID ?>&PatientBilling=PatientBillingThisForm'>
                                              <button style='width: 100%; height: 100%'>
                                                  TOLEO LA KISWAHILI
                                              </button>
                                          </a>
...
<?php if ($Consent_ID > 0){ echo "<input type='text'  style='width: 370px; border-top: none; border-left: none; border-right: none; border-bottom: 2px solid #000; text-align: center; font-weight:bold;' value=".$surgeon."> of Lugalo Military Hospital, and his/her team to perform the procedure named: <input type='text'  style=' text-align: center; font-weight: bold; width: 700px; border-top: none; border-left: none; border-right: none; border-bottom: 2px solid #000;' value=".$procedure_taken.">"; 
}else{

?>
<select name="doctor" id="surgery_doctor" required><option value="<?php echo $Current_Employee_ID ?>" selected><?php echo $Current_Employee_Name ?></option><?php echo $select; ?></select> of Lugalo Military Hospital,<br/> and his/her team to perform the procedure named: <input type="text" class="text" name='Procedure_named' id='Procedure_named' value="<?php echo $Product_Name; ?>" style='width: 700px; border-top: none; border-left: none; border-right: none; border-bottom: 2px solid #000;'> <?php } ?>
  <!-- <span class="col-md-4"> -->
...
<input class="form_group" name="presense_of_students" value="Agree" type="radio" id="presense_of_students" <?php if($presense_of_students == "Agree") { echo "checked";}?> > Agree
<input class="form_group" name="presense_of_students" value="Disagree" type="radio" id="presense_of_students" <?php if($presense_of_students == "Disagree") {echo "checked";}?> > Disagree
</td>
<th width="25%" style='text-align: right;'>Photography for research/teaching:</th>
<td width="25%" style='text-align: left;'>
<input class="form_group" name="photography_on_surgery" value="Agree" type="radio" id="photography_on_surgery" <?php if($photography_on_surgery == "Agree") { echo "checked"; } ?> > Agree
<input class="form_group" name="photography_on_surgery" value="Disagree" type="radio" id="photography_on_surgery" <?php if($photography_on_surgery == "Disagree") { echo "checked"; } ?> > Disagre
</td>
</tr>
<tr>
<td colspan='4'><hr></td>
...
<tr>
<td colspan='4'>
<p>I have been explained the reasons for undergoing an amputation. I have been explained the Pros and Cons for undergoing an amputation of my body part. I understand that I have to undergo an Amputation of: <input type="text" class="text" name='Amptutation_of' id='Amptutation_of' value="<?php  if ($datazangu){ echo $Amptutation_of; } ?>" style='width: 700px; border-top: none; border-left: none; border-right: none; border-bottom: 2px solid #000;'> 
</td>
</tr>
<tr>
<th style='text-align: right;'>Consent for Amputation:</th>
<td width="25%" style='text-align: left;'>
<input class="form_group" name="consent_amputation" value="Agree" type="radio" id="consent_amputation" <?php if($consent_amputation == "Agree") { echo "checked"; } ?> > Agree
<input class="form_group" name="consent_amputation" value="Disagree" type="radio" id="consent_amputation" <?php if($consent_amputation == "Disagree") { echo "checked"; } ?> > Disagree
</td>
</tr>
<tr>
<td colspan='4'><hr></td>
...
<tr>
                ...
                <input type="text" name="relation" id='relation' placeholder="Relationship of Guardian/Proxy..." value="<?php if($Consent_ID > 0) {  echo $on_behalf_name; }?> ">
                </td>
                </tr>
                <tr>
