...
<?php
	...
	if(isset($_GET['Payment_Cache_ID']) && isset($_GET['Payment_Item_Cache_List_ID'])){
	    ...
	    $Supervisor_ID = $_SESSION['Rch_Supervisor']['Employee_ID'];
		...
		$select_from_cache = "SELECT * FROM tbl_item_list_cache il, tbl_items i
			...
			document.location = "rchclinicalnotes.php?Rchclinicalnotes=RchPageclinicalnotes&Patient_Payment_ID=<?php echo $Patient_Payment_ID;?>&Registration_ID=<?php echo $Registration_ID;?>";
		    </script>
		    <?php
	    }   
	}
...
<script type="text/javascript">
	...
	if(patientlist=='Outpatient cash'){
	    ...
	    document.location = "rchcreditpatientlist.php?RchCreditPatientlist=RchCreditPatientlistThispage";
...
<?php
    if(isset($_SESSION['userinfo'])){
	echo "<a href='rchworkspage.php?section=Rch&RchWorks=RchWorksThisPage' class='art-button-green'>BACK</a>";
    }
?>
<center>
...
<a href="powercharts_antinatal.php" class="art-button-green">Enter Patient Data</a>
<?php
    if(isset($_GET['Patient_Payment_ID'])){
	?>
