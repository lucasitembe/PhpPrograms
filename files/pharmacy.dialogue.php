    ...
    <fieldset style="flex: 70%;border:1px solid #ccc !important">
        <fieldset style="border:1px solid #ccc !important;background-color:#fff">
            <table style="background-color: #fff;" width='100%'>
                <tr>
                    <td width='40%'><input type="text" id="procedure_name__" readonly style="padding: 8px;" placeholder="Medicine Name"></td>
                    <td width='15%'>
                        <select id="sub_department_id" style="width: 100%;padding:8px">
                            <option value="">Select Pharmacy</option>
                            <?php foreach($Locations->getSubdepartmentLocation('Pharmacy') as $location) : ?>
