...
<a href='muumini.php?muuminiWork=muuminiWorkThisPage' class='art-button-green'>ADD NEW MEMBER</a>
...
<center>
    <table width=100%>
        <tr>
            <td width=20%>
                <input type='text' name='Search_Patient' id='Search_Patient' style='text-align: center;' oninput='searchPatient(this.value)'  placeholder='~~~~~~~~~~~~~  Jina la muumini ~~~~~~~~~~~~~~~~~~~' autocomplete="off">
            </td>
	    <td width=20%>
		<input type='text' name='Patient_Number' id='Patient_Number' style='text-align: center;' oninput='Search_Patient_Using_Number(this.value)'  placeholder='~~~~~~~~~~~  Namba ya muumini  ~~~~~~~~~~~~~~~' autocomplete="off">
	    </td>
	    <td width=20%>
		<input type='text' name='Phone_Number' id='Phone_Number' style='text-align:center;' oninput='Search_Patient_Phone_Number(this.value)' placeholder='~~~~~~~~~~~~~  Namba ya simu  ~~~~~~~~~~~~~~~' autocomplete="off">
	    </td>
        <td width=20%>
...
<br/>
<fieldset>  
            <legend align=center><b>Orodha Ya Waumini</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
                <iframe width='100%' height=400px src='waumini_waliosajiliwa_iframe.php'></iframe>
            </td>
        </tr>
            </table>
        </center>
