					...
					?>
                            ...
                            echo "<tr>
                                ...
                                for($i=0;$i<$res;$i++){
                                    ...
                                    $accountCategoryName=mysqli_real_escape_string($conn,$row['account_Category_Name']);
                                    $edit="Edit";
                                    $delete="Delete";
                                    //display the results
                                    echo "<tr>
                                            <td>".($i+1)."</td>
                                            <td>".$accountCategoryName."</td>
                                            <td><a href='editAccountCategoryinfo.php?accountCatID=$accountCategoryID'>".$edit."&nbsp;&nbsp;</a>|<a href='deleteAccountCategoryinfo.php?accountCatID=$accountCategoryID' onclick=\"return confirm('Are you sure you want to delete this category?');\");'>&nbsp;&nbsp;&nbsp;Delete</a></td>";
                                    echo "</tr>";
                                }   
                        ?>
                        </form></table>
