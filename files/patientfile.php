   ...
   document.location = "./index.php";
    ...
    <script language="javascript" type="text/javascript">
        function searchPatient(){
            ...
            document.getElementById('Search_Iframe').src = 'patientfile_Iframe2.php?Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name+'&Phone_Number='+Phone_Number;
        }
    </script>
<script language="javascript" type="text/javascript">
...
<center>
    <table width=100%>
        <tr>
            <td width=30%>
                <input type='text' name='Search_Patient' id='Search_Patient' style='text-align: center;' onclick='searchPatient()' onkeyup='searchPatient(this.value)' onkeypress='searchPatient()' placeholder='Search Patient Name'>
            </td>
            <td width=30%>
            ...
            <td width=30%>
                <input type='text' name='Phone_Number' id='Phone_Number' style='text-align: center;' onkeyup='searchPatient();' onkeypress="searchPatient()" onclick="searchPatient()" placeholder='Search Phone Number'>
            </td>
        </tr>
                    ...
                    <table width=100% border=0>
                        <tr>
                            <td style="border: 1px #ccc solid;">
                                <iframe id='Search_Iframe' width='100%' height="380px" src='patientfile_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>
                            </td>
                        </tr>
                    </table>
                </center>
