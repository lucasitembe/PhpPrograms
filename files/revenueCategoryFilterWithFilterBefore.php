...
<form action='revenueCategoryFilterWithFilterBefore.php?catID=<?php echo $catID;?>&RevenueCategoryFilterNoFilterBefore=ThisForm' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
    <table width=80%>
        <tr>
