...
<fieldset style='margin-top:15px;'>
    <legend align=right style="background-color:#006400;color:white;padding:5px;"><b>PATIENTS WITH PROCEDURE DONE REPORT</b></legend>
                ...
                <tr>
                    <td>
                        <div style="width:100%; height:390px;overflow-x: hidden;overflow-y: auto"  id="Search_Iframe">
                            <?php include 'patient_done_porcedure_iframe.php'; ?> 
                        </div>
                    </td>
                </tr>
            </table>
...
<center> 
    <a href="print_done_procedure.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a>
</center> 
...
<script>
    ...
    $('#filterDate').click(function(e){
       ...
       $('#printPreview').attr('href', 'print_done_procedure.php?fromDate=' + fromDate + '&toDate=' + toDate+ '&sponsorID=' + sponsorID);

        $.ajax({
            type:'POST',
            url:'patient_done_porcedure_iframe.php',
