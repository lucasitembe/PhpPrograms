...
if ($numberOfRecord > 0) {
    while ($row = mysqli_fetch_array($selectThisRecord)) {
        ...
        $can_view_perfomance_report = $row['can_view_perfomance_report'];
        $super_user=$row['super_user'];
		$Engineering_Works=$row['Engineering_Works'];
        $doctor_license = $row['doctor_license'];
        $can_acess_oncology_button=$row['can_acess_oncology_button'];
    ...
    <fieldset>
        ...
        <table width = 100%>
            ...
            <form action='#' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
                                ...
                                <td>
                                    ...
                                    <table width=100%>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name='Job_Code' id='Job_Code'>
                                                    ...
                                                    <option>Endoscopist_and_Anaesthesiologist</option>
                                                    <option>Endoscopist</option>
                                        ...
                                        <tr>
                                            ...
                                            <td width=70%>
                                                <select name='Employee_Type' id='Employee_Type'>
                                                    <option selected='selected'><?php echo $Employee_Type; ?></option>
                                                    <?php
                                                        ...
                                                        ?>
                                                    <!-- <option>Accountant</option><option>Billing Personnel</option>
                                            ...
                                            <td>
                                                <select name="kada">
                                                   <?php
                                                        ...
                                                        echo "<option value='$kada'>$kada_name</option>";
                                                    ?>
                                        ...
                                        <tr>
                                            <td>Phone Number</td>
                                            <td>
                                                <input type="text" value="<?= $Phone_Number ?>" id="Phone_Number"name="Phone_Number" placeholder="enter phone number">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Doctor License / MCT</td>
                                            <td>
                                                <input type="text" value="<?= $doctor_license ?>" id="doctor_license"name="doctor_license" placeholder="Enter Doctor License">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;">Employee PFNO
                                        </td>
                                            <td><input type='text' name='Employee_Number'  id='Employee_Number' placeholder='Enter Employee PFNO' value='<?= $Employee_Number ?>'></td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
                            ...
                            <table width = 100%>
                                ...
                                <tr>
                                    ...
                                    <td width=20%>
                                        ...
                                        ?>>
                                        <label for='Approval_Orders'>Can Approve Store Order</label>
                                    </td>
									<td width=20%>
										<input type='checkbox' name='Engineering_Works' id='Engineering_Works' value='yes' <?php
										if (strtolower($Engineering_Works) == 'yes') {
											echo "checked='checked'";
										}
										?>>
                                ...
                                <tr>
                                    <td width=20%>
                                        ...
                                        ?>>
                                        <label for='can_create'>Can Create Store Order</label>
                                    </td>
                                    <td width=20%>
                                        ...
                                        ?>>
                                        <label for='can_edit'>Can Edit Store Order</label>
                                    </td>
                                    <td width=20% >
                                ...
                                <tr>
                                    ...
                                    <td width=20% colspan="">
                                        <input type='checkbox' name='can_view_perfomance_report' id='can_view_perfomance_report' value='yes' <?php
                                        if (strtolower($can_view_perfomance_report)== 'yes') {
                                            echo "checked='checked'";
                                        }
                                        ?>>
                                        <label for='can_view_performance_report'>Can View Performance Report</label>
                                    </td>
                                    <td width=20%>
                                        <input type='checkbox' name='can_acess_oncology_button' id='can_acess_oncology_button' value='yes' <?php
                                        if (strtolower($can_acess_oncology_button)== 'yes') {
                                            echo "checked='checked'";
                                        }
                                        ?>>
                                        <label for='can_acess_oncology_button'>can acess oncology button </label>
                                    </td>
                                    <td>
                                        <button type="button" class="art-button-green" onclick="superuser_login_dialog()">OTHER PRIVILEGES</button>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                ...
                <?php
                    if($super_user=="yes"){
                       $is_super_user="style='display:none'";
                    }else{
                       $is_super_user="";
                    }
                ?>
...
<div id="superuserlogin" style="display:none;">
    <style type="text/css">
                #spu_lgn_tbl{
                    width:100%;
    ...
    <table  id="spu_lgn_tbl" cellspacing="10">
        <tr>
            <td>Username</td>
            <td>
                <input type="text" id="spu_lgn_username" placeholder="Enter username"/>
            </td>
        </tr>
        <tr>
            <td>Password</td>
            <td>
                <input type="password" id="spu_lgn_password" placeholder="Enter Password"/>
            </td>
        </tr>
        <tr>

            <td colspan="2"align="right">
                <input type="button"id="spu_lgn_btn" onclick="superuser_login()"class="art-button-green"value="Login"/>
            </td>
        </tr>
    </table>
</div>
<script>
    function superuser_login(){
      var spu_lgn_username=$("#spu_lgn_username").val()
      var spu_lgn_password=$("#spu_lgn_password").val()
      if(spu_lgn_username.length<=0&&spu_lgn_password.length<=0){
           $('#spu_lgn_username').css('border-color', 'red');
           $('#spu_lgn_password').css('border-color', 'red');
      }else if(spu_lgn_password.length<=0){
          $('#spu_lgn_password').css('border-color', 'red');
      }else if(spu_lgn_username.length<=0 ){
          $('#spu_lgn_username').css('border-color', 'red');
      }else{
          $('#spu_lgn_password').css('border-color', '');
          $('#spu_lgn_username').css('border-color', '');
        //  alert("imooo");
         var url="super_user_login.php";
          $.ajax({
              type:"POST",
              url:url,
              data:{spu_lgn_username:spu_lgn_username,spu_lgn_password:spu_lgn_password},
              beforesend:function(xhr){
                  alert("before send");
                  $("#spu_lgn_btn").val("Login...")
              },
              success:function(data){
                  if(data==1){
                      document.location="super_user_assign_prevalage.php?Employee_ID=<?= $Employee_ID ?>&EditEmployee=EditEmployeeThisForm";
                  }else{
              ...
              error:function(){
                 // alert("error");
                  $("#spu_lgn_btn").val("Error!try again")
              }
          });
      }
    }
    function superuser_login_dialog(){
          $("#superuserlogin").dialog({
                        title: 'SUPER USER AUTHENTICATION',
                        width: '35%',
                        height: 200,
                        modal: true,
                    });
...
if (isset($_POST['submittedEditUserPrivilegesForm'])) {
    ...
    if (strtolower($Current_Username) == strtolower($Admin_Username) && $Current_Password == $Admin_Password) {
        ...
        $can_view_perfomance_report = 'no';
		$Engineering_Works = 'no';
        $can_acess_oncology_button='no';
        ...
        if (isset($_POST['can_view_perfomance_report'])) {
            $can_view_perfomance_report = "yes";
        }
		if (isset($_POST['Engineering_Works'])) {
			$Engineering_Works = "yes";
		}
        if (isset($_POST['can_acess_oncology_button'])) {
            $can_acess_oncology_button = "yes";
        }

        $sql = "UPDATE tbl_privileges set
				Reception_Works = '$Reception_Works',can_acess_oncology_button='$can_acess_oncology_button', Revenue_Center_Works = '$Revenue_Center_Works',Patients_Billing_Works = '$Patients_Billing_Works',
				...
				Patient_Record_Works = '$Patient_Record_Works', Laboratory_Consulted_Patients = '$Laboratory_Consulted_Patients', Procedure_Works = '$Procedure_Works', Approval_Orders = '$Approval_Orders', Msamaha_Works = '$Msamaha_Works',can_create='$can_create',can_edit='$can_edit',can_view='$can_view',can_revk_bill_status='$can_revk_bill_status',can_view_demographic_revenue='$can_view_demographic_revenue',can_broadcast='$can_broadcast',can_do_offline_trans='$can_do_offline_trans',can_view_perfomance_report='$can_view_perfomance_report',Engineering_Works='$Engineering_Works',last_modified_by='".$_SESSION['userinfo']['Employee_ID']."' where employee_id = '$Employee_ID'";

        if (!mysqli_query($conn,$sql)) {
            die(mysqli_error($conn));
        } else {
            mysqli_query($conn,"UPDATE tbl_employee set
			    Employee_Name = '$Employee_Name2',kada='$kada',Phone_Number='$Phone_Number', Employee_Type = '$Employee_Type',
				Employee_Title = '$Job_Title2', Employee_Job_Code = '$Job_Code', doctor_license = '$doctor_license', 
					Department_id = (select Department_id from tbl_department where department_name = '$Employee_Department_Name')
					    where employee_id = '$Employee_ID'");

                        // $Employee_Name

            $Current_USer = $_SESSION['userinfo']['Employee_ID'];

            $Id = mysqli_fetch_assoc(mysqli_query($conn, "SELECT Id FROM `audit` WHERE Employee_Id = '$Current_USer' ORDER BY Id DESC LIMIT 1"))['Id'];
            $Activities = "Edited Employee ~ <b> ".$Employee_Name." </b>";
                if($Id > 0){
