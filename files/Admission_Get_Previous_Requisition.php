<?php
    ...
    if($num > 0){
        ...
        $Sub_Department_Name = 'saffa';
    }

    if(isset($_GET['Start_Date']) && isset($_GET['End_Date']) && $Start_Date != '' && $End_Date != '' && $Start_Date != null && $End_Date != null){
?>      <legend align=right><b>
    <?php if(isset($_SESSION['Admission_ID'])){ echo $Sub_Department_Name; }?>, Previous Requisitions Prepared By : <?php echo $Employee_Name; ?></b></legend>
