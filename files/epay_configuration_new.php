...
<?php
    ...
    ?>
<a href="revenuecenterconfigurationpage.php" class="art-button-green">BACK</a>
<?php 
            ...
            <center>
                <form action="" method="POST">
                    <table style="width: 100%;" class="table">
                        <tr>
                            <td style="width: 5%; text-align:right;"><h4>Collection Point</h4></td>
                            <td style="width: 15%">
                                <input type="text" name="collection" placeholder="Enter selection name" value="<?= $collection ?>"class="form-control"/>
                            </td>
                             <td style="width: 5%; text-align:right;"class='hide'><h4>Code</h4></td>
                            <td style="width: 6%"class='hide'>
                                <input type="text" name="code" placeholder="Enter selection Code" value="<?= $code ?>"class="form-control"/>
                            </td>
                             <td style="width: 5%; text-align:right;"class='hide'><h4>Client ID</h4></td>
                            <td style="width: 6%" class='hide'>
                                <input class='hide' type="text" name="client_id" placeholder="Enter selection Client ID" value="<?= $client_id ?>"class="form-control"/>
                            </td>
                             <td style="width: 5%; text-align:right;"class='hide'><h4>Pass</h4></td>
                            <td style="width: 6%"class='hide'>
                                <input class='hide' type="text" name="password" placeholder="Enter selection Pass" value="<?= $password ?>"class="form-control"/>
                            </td>
                             <td class='hide' style="width: 5%; text-align:right;"><h4>Timestamp</h4></td>
                            <td style="width: 6%"class='hide'>
                            ...
                            <td style="width: 5%; text-align:right;"class='hide'><h4>Url</h4></td>
                            <td style="width: 15%"class='hide'>
                ...
                <table style="width: 100%;background: #FFFFFF;" class="table table-bordered">
                    <tr>
                        ...
                        <th style="width:10%">COLLECTION POINT</th>
