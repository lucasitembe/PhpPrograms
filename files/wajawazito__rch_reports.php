...
<!--<a href="searchvisitorsWajawazitopatientlistforrch.php?section=Rch&RchWorks=RchWorksThisPage" class="art-button-green" >BACK</a>-->
...
<script type="text/javascript">				
	...
	$("#filt").click(function(){
		...
		$("#modal-rchload").show();	
                ...
                $.ajax({
                    type: "POST",
                    url: 'wajawazito_rch_reports_view.php',
...
<script>
   $('#print_report').click(function(){
     ...
     window.open('PrintWajawazito.php?from_date='+from_date+'&to_date='+to_date+'');  
   }); 
</script>