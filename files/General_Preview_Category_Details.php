...
<fieldset>
    <table width="100%">
        ...
        <tr>
            ...
            <td><?php echo strtoupper($Item_Category_Name); ?></td>
...
<fieldset style='overflow-y: scroll; height: 320px; background-color: white;' id=''>
    <?php
    if (strtolower($Section) == 'cashcredit') {
        include("./General_Category_details_Cash_Credit.php");
    } else if (strtolower($Section) == 'cash') {
        include("./General_Category_details_Cash.php");
    } else if (strtolower($Section) == 'credit') {
        include("./General_Category_details_Credit.php");
    } else if (strtolower($Section) == 'cancelled') {
        include("./General_Category_details_Cancelled.php");
    } else {
        include("./General_Category_details_Credit.php");
    }
    ?>
...
<fieldset>
    <table width="100%">
        <tr>
            <td style="text-align: center; color: #0079AE;"><b><i>CLICK SUB CATEGORY NAME TO VIEW DETAILS </i></b></td>
            <td width="25%" style="text-align: right;">
                <input type="button" class="art-button-green" value="PREVIEW REPORT" onclick="Preview_Sub_Category_Report('<?php echo $Section; ?>',<?php echo $Item_Category_ID; ?>)">
                <input type="button" class="art-button-green" value="CLOSE" onclick="Close_Sub_Category_Details()">
            </td>
        </tr>
    </table>
</fieldset>