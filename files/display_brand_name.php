...
<?php
       ...
       $sql_select_brand_namel_items_result=mysqli_query($conn,"SELECT Product_Name,Item_ID FROM tbl_items WHERE Consultation_Type='Pharmacy' LIMIT 50") or die(mysqli_error($conn));
