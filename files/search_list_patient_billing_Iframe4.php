...
while ($row = mysqli_fetch_array($select_Filtered_Donors)) {
    ...
    if ($num > 0) {
        ...
        echo "<td><a href='procedure_concert_form.php?Registration_ID=" . $row['Registration_ID'] . "&consultation_id=" . $consultation_id . "&Admision_ID=" . $Admision_ID . "&Payment_Item_Cache_List_ID=" . $Payment_Item_Cache_List_ID . "&Product_Name=" . $Product_Name . "&PatientRegistration=PatientRegistrationThisForm' target='_parent' style='text-decoration: none;'>" . ucwords(strtolower($row['Patient_Name'])) . "</a></td>";
