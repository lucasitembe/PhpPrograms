    ...
    <table width=50%><tr><td>
        <center>
			...
			<?php
			    ...
			    $delete="DELETE FROM tbl_account_subcategory WHERE account_Subcategory_ID='$accountSubcatID'";
			    //execute the query
			    $result=mysqli_query($conn,$delete);
			    if($result){
				$message=("<b style='color:red;font-size:14;font-family:verdana;'>Account subcategory successifully deleted.</b>".mysqli_error($conn));
			    }else{
