...
<fieldset style="margin-top:5px;"> 
    <legend style="background-color:#006400;color:white;padding:2px;" align="right"><b>RIPOTI YA MWEZI YA UFUATILIAJI WA WATOTO</b></legend> 
            ...
            $(function () {
                ...
                $("#filt").click(function () {
                    ...
                    if (err2 == 1 || err3 == 1) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: 'watoto_rch_reports_view.php',
...
?>
            ...
            <script>
                $('#print_report').click(function () {
                    ...
                    window.open('PrintWatoto.php?from_date=' + from_date + '&to_date=' + to_date + '');
                });
            </script>