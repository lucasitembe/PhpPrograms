...
if (isset($_SESSION['userinfo'])) {
    if ($_SESSION['userinfo']['Admission_Works'] == 'yes') {
        ?>
        <a href='registeredtoadmit.php' class='art-button-green'>
            BACK
        </a>
    <?php }
} ?>
            ...
            <form action='#' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
                    ...
                    <td width=35%>
                        <table width=100%>
                            <tr>
                                ...
                                <td><select name='Guarantor_Name' id='Guarantor_Name' required='required' style='border-color: red' onchange='MemberNumberMandate(this.value);
                                        setVerify(this.value);
                                        disable_member_number(this.value);'>
                                        <option selected='selected'></option>
                                        <?php
                                        $data = mysqli_query($conn,"select * from tbl_sponsor WHERE Guarantor_Name<>'MSAMAHA'");
                            ...
                            <tr>
                                ...
                                <td><input type='text' name='Date_Of_Birth' readonly="readonly" autocomplete='off' id='date2' style='border-color: red;width:70%' required='' />&nbsp;&nbsp;<input type='text' autocomplete='off' id='datetime' oninput='calculatedate(this.value)' style='width:25%;text-align:center' placeholder="enter age" maxlength="3" class="numberonly" /></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td colspan=2 style='text-align: center;'>
                        <input type='submit' name='submit' id='submit' value='   SAVE   ' style='width: 30%' class='art-button-green' onclick="return Validate_Date()">
...
//                $pf3_ID = $_POST['pf3_ID'];
             ...
             echo "<script type='text/javascript'>
                ...
                document.location = './admissionvisitorform.php?Registration_ID=" . $Registration_ID . "&AdmissionVisitorForm=AdmissionVisitorFormThisPage';
                </script>";
