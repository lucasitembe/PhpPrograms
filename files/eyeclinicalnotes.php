...
<?php
	...
	if(isset($_GET['Payment_Cache_ID']) && isset($_GET['Payment_Item_Cache_List_ID'])){
	    ...
	    $Supervisor_ID = $_SESSION['Eye_Supervisor']['Employee_ID'];
		...
		$select_from_cache = "SELECT * FROM tbl_item_list_cache il, tbl_items i
			...
			document.location = "eyeclinicalnotes.php?Eyeclinicalnotes=EyePageclinicalnotes&Patient_Payment_ID=<?php echo $Patient_Payment_ID;?>&Registration_ID=<?php echo $Registration_ID;?>";
		    </script>
		    <?php
	    }   
	}
...
<script type="text/javascript">
	...
	if(patientlist=='Outpatient cash'){
	    ...
	    document.location = "eyecreditpatientlist.php?EyeCreditPatientlist=EyeCreditPatientlistThispage";
...
<fieldset><legend align='right'><b>Eye Works</b></legend>
	<table width=100%>
		<tr>
