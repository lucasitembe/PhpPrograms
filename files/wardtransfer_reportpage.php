...
echo "<a href='wardtransferpage.php?section=&Admissionreports=AllReports&ActiveReports' class='art-button-green'>BACK
				  </a>";
?>
<style>
    select{
...
?>
    <fieldset style="background-color:white";>
        <legend align="center" style="background-color:#006400;color:white;padding:5px;"><b>PATIENTS TRANFERED</b></legend> 
     <center>
        <table width='99%' style="border:none !important; border-color:transparent !important;background-color:white;">
            <tr>
                <td style="text-align:center">
                    ...
                    <a href="patienttranserreport.php" id='print_preview' class='art-button-green' target='_blank'>PREVIEW DETAILS</a>
                </td>
            </tr>
        </table>
    </center>
                    ...
                    <tr>
                        <td>
                            <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                                <?php include 'wardtranferreports_iframe.php'; ?>
                            </div>
                        </td>
                    </tr>
                </table>
...
<script>
    function filterPatient(){
        ...
        $('#print_preview').attr('href','patienttranserreport.php?Patient_Name=' + Patient_Name + '&Date_From=' + Date_From + '&Date_To=' + Date_To + '&ward=' + ward + '&Gender=' + Gender + '&Branch_ID=' + Branch_ID+ '&Sponsor=' + Sponsor+'&row_num='+row_num);
        ...
        $.ajax({
            type: 'GET',
            url: 'wardtranferreports_iframe.php',
            data: 'Patient_Name=' + Patient_Name + '&Date_From=' + Date_From + '&Date_To=' + Date_To + '&ward=' + ward + '&Gender=' + Gender + '&Branch_ID=' + Branch_ID+ '&Sponsor=' + Sponsor+'&row_num='+row_num,
            cache: false,
