    ...
    <table width=80%>
        ...
        <tr>
            ...
            <td style='text-align: center;'>
                ...
                <a href="currentinpatientreportprint.php?Branch_ID=<?php echo $Branch_ID;?>&Gender=<?php echo $Gender;?>&Region=<?php echo $Region;?>&Hospital_Ward_ID=<?php echo $Hospital_Ward_ID;?>&start_age=<?php echo $start_age;?>&end_age=<?php echo $end_age;?>" class='art-button-green' target='_blank'>PREVIEW DETAILS</a>
            </td>
        </tr>
    </table>
    <table width=80%>
        ...
        <center>
            <table width=100% border=1>
                <tr>
                    <td>
                        <iframe width='100%' height=275px src="currentinpatientreport_iframe.php?Branch_ID=<?php echo $Branch_ID;?>&Gender=<?php echo $Gender;?>&Region=<?php echo $Region;?>&Hospital_Ward_ID=<?php echo $Hospital_Ward_ID;?>&start_age=<?php echo $start_age;?>&end_age=<?php echo $end_age;?>"></iframe>
                    </td>
                </tr>
            </table>
        </center>
