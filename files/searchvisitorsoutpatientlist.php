...
<a href='msamahapanel.php?RegisteredPatient=RegisterPatientThisPage&from=reception'  class='art-button-green'>MSAMAHA</a>
<a href='receptionworkspage.php?VisitorForm=VisitorFormThisPage' class='art-button-green'>BACK</a>
...
<script language="javascript" type="text/javascript">
    function alert_death(){
        alert("This Patient was Marked as DEAD, you can't Process this Patient");
    }
...
<script language="javascript" type="text/javascript">
    function Search_Patient_Using_Number(){
        Patient_Number = $("#Patient_Number").val();
        Patient_Name = $("#Search_Patient").val();
        Phone_Number = $("#Phone_Number").val();
        Old_Phone_Number = $("#Old_Phone_Number").val();
		// document.getElementById("Search_Patient").value = '';
		// document.getElementById("Phone_Number").value = '';

		document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe2.php?Patient_Number="+Patient_Number+"&Patient_Name="+Patient_Name+"&Phone_Number="+Phone_Number+"&Old_Phone_Number="+Old_Phone_Number+"'></iframe>";
    }
</script>
<script language="javascript" type="text/javascript">
...
<center>
    <table width=100%>
        <tr>
            <td width=20%>
                <input type='text' name='Search_Patient' id='Search_Patient' style='text-align: center;' oninput='Search_Patient_Using_Number()'  placeholder='~~~~~~~~~~~~~  Search Patient Name  ~~~~~~~~~~~~~~~~~~~' autocomplete="off">
            </td>
	    <td width=20%>
		<input type='text' name='Patient_Number' id='Patient_Number' style='text-align: center;' oninput='Search_Patient_Using_Number()'  placeholder='~~~~~~~~~~~  Search Patient Number  ~~~~~~~~~~~~~~~' autocomplete="off">
	    </td>
	    <td width=20%>
		<input type='text' name='Phone_Number' id='Phone_Number' style='text-align:center;' oninput='Search_Patient_Using_Number()' placeholder='~~~~~~~~~~~~~  Search Phone Number  ~~~~~~~~~~~~~~~' autocomplete="off">
	    </td>
        <td width=20%>
       <input type='text' name='Old_Phone_Number' id='Old_Phone_Number' style='text-align:center;' oninput='Search_Patient_Using_Number()' placeholder='~~~~~~~~~~~~~  Search Old Patient Number  ~~~~~~~~~~~~~~~' autocomplete="off">
        </td>
        </tr>
