...
<center>
	...
	<!--End datetimepicker-->
<fieldset>
            <legend align=center><b>PATIENTS REVISITED TODAY REPORT</b></legend>
        <center>
            <?php
   ...
   $currentDate=date('Y-m-d');
    ...
    if(mysqli_num_rows($select_patient) > 0){
        ...
        echo "<form action='printPatientsRevisitedToday.php?PrintPatientsRevisitedTodayThisPage' method='POST'>
		<tr>
        ...
        echo "<tr><td colspan='8' style='text-align:center'><b style='color:red'>No patient visited today</b></td></tr>";
    }
	    ?></table></center>
        </center>
</fieldset><br/>
