<?php
    ...
    $select_Filtered_Patients = mysqli_query($conn,"
				    select i.Item_ID, i.Item_Type, i.Status, i.Product_Name, ic.Item_Category_Name, isc.Item_Subcategory_Name
					from tbl_items i,tbl_item_subcategory isc, tbl_item_category ic
