...
<script src="css/jquery.js"></script>
	...
	if(isset($_GET['categoryID'])){
	    ...
	    //select cat name
	    $query="SELECT * FROM tbl_item_category WHERE Item_Category_ID='$categoryID'";
...
<fieldset>  
	...
	$cancelled=$row['cancelled'];
        echo "<tr><td>".($i+1)."</td>";
        echo "<td><a href='revenueCategoryDetails.php?categoryID=$catID&RevenueCategoryDetails=RevenueCategoryDetailsThisForm'  style='text-decoration: none;'>".$row['Item_Category_Name']."</a></td>";
