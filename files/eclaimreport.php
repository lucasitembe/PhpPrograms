...
$claim_year = '';
/*
$check_folio = mysqli_query($conn,"SELECT MONTH(sent_date) AS sent_date, Folio_No FROM tbl_claim_folio WHERE  Bill_ID = (SELECT Bill_ID FROM tbl_patient_payments WHERE Patient_Bill_ID = $Patient_Bill_ID and Billing_Process_Status = 'billed' limit 1)");
*/
...
$select_Transaction_Items = mysqli_query($conn,"
            select * from
				...
				t.item_id = ppl.item_id and pp.Check_In_ID = '$Check_In_ID'  and
...
while ($row = mysqli_fetch_array($select_Transaction_Items)) {
    ...
    $PatientPhone_Number = $row['Phone_Number'];
...
$select_category_details = mysqli_query($conn,"
				...
				t.item_id = ppl.item_id and ppl.status<>'removed'  and
...
$htm .= "<table width ='100%'>
			...
			I certify that I received the above named services. Name : <b>" . ucwords($Patient_Name) . "</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Signature :<b>" . $p_signature . "</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tel $PatientPhone_Number <br/><br/>
        ...
        Printed By  <b>". strtoupper($Employee_Name)."</b> at ".date('m/d/Y h:i:s a', time())."&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</span>
