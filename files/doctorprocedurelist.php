...
<?php
      ...
      ?>
   <a href='clinicalnotes.php?<?php echo 'Registration_ID='.$_GET['Registration_ID'].'&Patient_Payment_ID='.$_GET['Patient_Payment_ID'].'&Patient_Payment_Item_List_ID='.$_GET['Patient_Payment_Item_List_ID']?>' class='art-button-green'>
        BACK
    </a>
<?php
}
...
<fieldset style='margin-top:30px;'>
    <legend id="resultsconsultationLablist" style="font-weight: bold;font-size: 16px;background-color: #006400; padding:10px; color:white;width: auto;" align="right">PROCEDURE PATIENTS LIST</legend>
    <center>
        <hr width="100%">
    </center>
        ...
        <table  class="hiv_table" style="width:100%">
            <tr>
                ...
                <td style="text-align: center">
                    ...
                    <input type='text' autocomplete="off" name='Search_Patient' id='Search_Patient' style='text-align: center;width:35%;display:inline' onkeyup='searchPatient(this.value)'  placeholder='~~~~~~~~~~~~~  Global Search Patient Name  ~~~~~~~~~~~~~~~~~~~'>
                </td>
            </tr>
            <tr>
                <td id='Search_Iframe'>
                    <div id="iframeDiv" style="height: 460px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'proceduredoctorlist_iframe.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
if(isset($_GET['Section']) && $_GET['Section']=='Doctor'){
    ...
    $section="sectionpatnt=doctor_with_patnt&Registration_ID=".$_GET['Registration_ID']."&Patient_Payment_ID=".$_GET['Patient_Payment_ID']."&Patient_Payment_Item_List_ID=".$_GET['Patient_Payment_Item_List_ID']."";
}
        echo '<a href="searchpatientremovedproceduredoctorlist.php?'.$section.'" class="art-button-green">REMOVED PROCEDURES</a>';
        echo '<a href="searchpatientpendingproceduredoctorlist.php?'.$section.'" class="art-button-green">PENDING / NOT APPLICABLE PROCEDURES</a>';
   ?>
</center> 
...
<script>
    function filterLabpatient() {
        ...
        mm.open('GET', 'proceduredoctorlist_iframe.php?filterlabpatientdate=true&Date_From=' + Date_From + '&Date_To=' + Date_To + '&Sponsor=' + Sponsor, true);
        mm.send();
    }
...
<script >
    function searchPatient(Patient_Name) {
        ...
        mm.open('GET', 'proceduredoctorlist_iframe.php?Patient_Name=' + Patient_Name + '&searchPartient=true' + filterDate, true);
//        mm.open('GET', 'procedurelist_iframe.php?Patient_Name=' + Patient_Name + '&searchPartient=true' + filterDate, true);
        mm.send();
