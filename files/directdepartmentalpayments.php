...
?>
    <a href='registerpatient.php?from_directdepartmental=yes' class='art-button-green'>
        ADD NEW PATIENT
    </a>
<?php  } ?>
...
<script language="javascript" type="text/javascript">
    function searchPatient(Patient_Name) {
        ...
        if (Patient_Number != '' && Patient_Number != null) {
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='Departmental_search_list_patient_billing_Iframe2.php?<?php echo $location ?>Patient_Number=" + Patient_Number + "&Patient_Name=" + Patient_Name + "'></iframe>";
        } else {
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='Departmental_search_list_patient_billing_Iframe2.php?<?php echo $location ?>Patient_Name=" + Patient_Name + "'></iframe>";
        }
    }
</script>
<script language="javascript" type="text/javascript">
    function Search_Patient_Using_Number(Patient_Number) {
        ...
        if (Patient_Name != '' && Patient_Name != null) {
            ...
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='Departmental_search_list_patient_billing_Iframe2.php?<?php echo $location ?>Patient_Number=" + Patient_Number + "'></iframe>";
        }
    }
</script>
<script language="javascript" type="text/javascript">
                ...
                <tr>
                    <td id='Search_Iframe'>
                        <?php if (isset($_SESSION['systeminfo']['Direct_departmental_payments']) && strtolower($_SESSION['systeminfo']['Direct_departmental_payments']) == 'yes') { ?>
                            <iframe width='100%' height=400px src='Departmental_search_visitors_outpatient_list_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>
                        <?php } else { ?>
                            <iframe width='100%' height=400px src='Adhoc_Departmental_search_visitors_outpatient_list_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>
                        <?php } ?>
                    </td>
                </tr>
            </table>
