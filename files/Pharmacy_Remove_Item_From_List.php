<?php
    ...
    if(isset($_GET['Item_Cache_ID']) && ($_GET['Item_Cache_ID']!='') && isset($_GET['Registration_ID']) && ($_GET['Registration_ID'] != '') && $Employee_ID != 0){
        $delete = mysqli_query($conn,"delete from tbl_pharmacy_items_list_cache where Item_Cache_ID = '$Item_Cache_ID'") or die(mysqli_error($conn));
    }
   ...
   echo '<tr id="thead">
    ...
    while($row = mysqli_fetch_array($select_Transaction_Items)){
        echo "<tr><td style='text-align: right;'>".++$temp."</td>";
