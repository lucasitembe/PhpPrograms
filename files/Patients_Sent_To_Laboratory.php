...
<fieldset style='margin-top:15px;'>
    <legend align="right" style="background-color:#006400;color:white;padding:5px;"><b>PATIENT SENT TO LABORATORY REPORT</b></legend>
        ...
        <tr>
            <td>
                <div style="width:100%; height:380px;overflow-x: hidden;overflow-y: auto" id='Search_Iframe'>
                    <?php include 'Patients_Sent_To_Laboratory_Iframe.php'; ?>
                </div>
            </td>
        </tr>
    </table>
...
<center>   
    <a href="print_patients_sent_to_laboratory.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT PDF</a>
...
<script>
    ...
    function print_excell(){
            ...
            if(date_From == ""){
                ...
                window.open("patient_set_to_radiology_excel.php?date_From="+date_From+"&date_To="+date_To + "&sponsorID=" + sponsorID);
            }
        }
</script>
<script type="text/javascript">
    $('#filterDate').click(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'Patients_Sent_To_Laboratory_Iframe.php',
