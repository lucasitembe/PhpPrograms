   ...
   $currentDate=date('Y-m-d');
    ...
    if($branchID == 0){//no branch is selected
                if($regionID == 0){//if no region is selected  
                         $select_All = mysqli_query($conn,"SELECT * FROM tbl_patient_registration pr,tbl_check_in ci 
...
?>
    <tr>
        ...
        <td><span style="font-size:large;">Mahuzurio Wanaorudia</span></td>
        <td width="13%" style="text-align: center;">
            <table width="100%">
                <tr>
...
<table width="100%">
    <tr>
        <td style="text-align:right;width:30%;">
            <a href="printrevisitedPatientsVisitedPreviousDaysDetails.php?sponsorID=<?php echo $sponsorID ?>&branchID=<?php echo $branchID ?>&Region_ID=<?php echo $regionID ?>&District_ID=<?php echo $districtID ?>&ageFrom=<?php echo $ageFrom ?>&ageTo=<?php echo $ageTo ?>&Date_From=<?php echo $Date_From ?>&Date_To=<?php echo $Date_To ?>" target="_blank">
