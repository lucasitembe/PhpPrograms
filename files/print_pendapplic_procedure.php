...
if (isset($_GET['fromDate'])) {
    ...
    $filter = " WHERE ilc.Transaction_Date_And_Time BETWEEN '$fromDate' AND '$toDate' AND ilc.Check_In_Type='Procedure'";
    $filterPatient = " AND ilc.Transaction_Date_And_Time BETWEEN '$fromDate' AND '$toDate' AND ilc.Check_In_Type='Procedure'";
}
...
$htm = "<table width ='100%'  class='nobordertable'>
		    ...
		    <tr><td style='text-align: center;'><span><b>PATIENTS WITH PROCEDURE ACTIVE / PENDING / NOT DONE</b></span></td></tr>
