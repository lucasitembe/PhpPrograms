				...
				<table width="100%">
					<tr>
						...
						<td style="text-align: center; background-color: #eeeebb;" width="10%">
							<a href="outpatientnotespreviewsubreport.php?Notes_ID=<?php echo $data['Notes_ID']; ?>&PatientNotesPreviewSubReport=PatientNotesPreviewSubReportThisPage" target="_blank" style="text-decoration: none;"><button>Preview Report</button></a>
						</td>
					</tr>
						...
						<td colspan="6">
							<table width="100%">
								<tr>
									...
									<td><textarea style="width: 100%; height: 70px;" readonly="readonly"><?php echo $data['Notes']; ?></textarea></td>
								</tr>
							</table>
						</td>
					</tr>
