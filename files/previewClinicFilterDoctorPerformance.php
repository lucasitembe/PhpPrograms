...
<?php
    ...
    $htm.="<fieldset>";
    $htm.="<legend align=center><b>DOCTOR'S PERFORMANCE REPORT FROM</b> <b style=''>".date('j F,Y H:i:s',strtotime($Date_From))."</b> <b>TO</b> <b style=''>".date('j F,Y H:i:s',strtotime($Date_To))."</b> </legend>";
        $htm.="<center>";
				...
				<td colspan=4></td></tr>";*/
                            ...
                            while($select_doctor_query_row=mysqli_fetch_array($select_doctor_query)){//return employee details
                                ...
                                $select_patient_item_list=mysqli_query($conn,"
								      SELECT * FROM tbl_consultation co,tbl_clinic c,tbl_clinic_employee ce,tbl_patient_payment_item_list ppl,tbl_patient_payments pp 
