...
<?php
	...
	$sql_Select_Current_Patient = mysqli_query($conn,"select * from tbl_patient_payments_others pp
    ...
    <table width=100%>
        <tr>
            <td style='text-align: right;'>
                <a href='individualsummaryreportothers.php?Patient_Payment_ID=<?php echo $Patient_Payment_ID; ?>&IndividualSummaryReport=IndividualSummaryReportThisForm' class='art-button-green' target='_Blank'>Print Receipt</a>
            </td>
        </tr>
    </table>
</fieldset>
                ...
                <tr>
                    <td colspan=2>
                        <?php
                            ...
                            echo "<iframe src='Patient_Billing_Review_Iframe_Others.php?Registration_ID=".$Registration_ID."&Patient_Payment_ID=".$Patient_Payment_ID."' width='100%' height=240px></iframe>";
                        ?>				    				    
