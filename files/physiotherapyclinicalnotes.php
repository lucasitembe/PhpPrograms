	...
	if(isset($_SESSION['userinfo']['Physiotherapy_Works'])){
		...
		header("Location: ./index.php?InvalidPrivilege=yes");
                    ...
                    if(!isset($_SESSION['Physiotherapy_Supervisor'])){ 
                        header("Location: ./deptsupervisorauthentication.php?SessionCategory=Physiotherapy&InvalidSupervisorAuthentication=yes");
                    }
            }
	}else{
	    header("Location: ./index.php?InvalidPrivilege=yes");
...
<?php
	...
	if(isset($_GET['Payment_Cache_ID']) && isset($_GET['Payment_Item_Cache_List_ID'])){
	    ...
	    $Supervisor_ID = $_SESSION['Physiotherapy_Supervisor']['Employee_ID'];
		...
		$select_from_cache = "SELECT * FROM tbl_item_list_cache il, tbl_items i
			...
			document.location = "physiotherapyclinicalnotes.php?Physiotherapyclinicalnotes=PhysiotherapyPageclinicalnotes&Patient_Payment_ID=<?php echo $Patient_Payment_ID;?>&Registration_ID=<?php echo $Registration_ID;?>";
		    </script>
		    <?php
	    }   
	}
...
<script type="text/javascript">
	...
	if(patientlist=='Outpatient cash'){
	    ...
	    document.location = "physiotherapycreditpatientlist.php?PhysiotherapyCreditPatientlist=PhysiotherapyCreditPatientlistThispage";
...
<fieldset><legend align='right'><b>Physiotherapy Works</b></legend>
	<table width=100%>
		<tr>
