...
?>
    ...
    <a href='./revenuecenterprocedurelist.php?DepartmentPatientBilling=DepartmentPatientBillingThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<fieldset style='overflow-y: scroll; height: 400px; background-color:white' id='Patients_Fieldset_List'>
    <legend style="background-color:#006400;color:white" align="right"><b><?php echo strtoupper('Removed Procedure Payments ~ outpatient cash'); ?> </b></legend>
<?php
...
<script>
    function Patient_List_Search(){
        ...
        myObjectSearchPatient.open('GET','Procedure_Revenue_Center_List_Iframe_Removed.php?Patient_Name='+Patient_Name+'&Billing_Type='+Billing_Type+'&Patient_Type='+Patient_Type+'&Start_Date='+Start_Date+'&End_Date='+End_Date,true);
...
<script type="text/javascript">
    function Patient_List_Search_Via_Number(){
        ...
        myObjectSearchP.open('GET','Procedure_Revenue_Center_List_Iframe_Removed.php?Patient_Number='+Patient_Number+'&Billing_Type='+Billing_Type+'&Patient_Type='+Patient_Type+'&Start_Date='+Start_Date+'&End_Date='+End_Date,true);
