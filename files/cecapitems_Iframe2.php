...
<center><b>List of Removed Cecap Services </b></center><link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
...
<?php
	...
	echo "<td style='text-align: right;' width=8%><a href='AddCecapItems.php?Payment_Item_Cache_List_ID=".$row['Payment_Item_Cache_List_ID']."&Payment_Cache_ID=".$row['Payment_Cache_ID']."' class='art-button-green' target='_Parent'>Re-Add</a></td>";
	...
	$temp++;
        ...
        echo "<tr><td colspan=6 style='text-align: right;'><b> TOTAL : ".number_format($total)."</b></td>
		    <td style='text-align: right;'>
			<a href='cecapitems_Iframe.php?Transaction_Type=".$Transaction_Type."&Payment_Cache_ID=".$Payment_Cache_ID."' class = 'art-button'>Back To Service List</a></td></tr>";
    ?></table></center>