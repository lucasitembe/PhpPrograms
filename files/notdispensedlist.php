...
<script type="text/javascript">
    function Preview_Report() {
        ...
        // var Payment_Mode = document.getElementById("Payment_Mode").value;
        window.open('previewnotdispensedlist.php?Start_Date=' + Start_Date + '&End_Date=' + End_Date + '&Search_Patient=' + Search_Patient + '&Sponsor=' + Sponsor + '&Bill_Type=' + Bill_Type + '&Payment_Mode=' + Payment_Mode, '_blank');
    }
</script>
...
<script type="text/javascript">
    function filter_list() {
        ...
        // myObjectFilterList.open('GET', 'Not_Dispensed_Filter_List.php?Start_Date=' + Start_Date + '&End_Date=' + End_Date + '&Search_Patient=' + Search_Patient + '&Sponsor=' + Sponsor + '&employeeID=' + employeeID + '&Bill_Type=' + Bill_Type + '&Payment_Mode=' + Payment_Mode, true);

        myObjectFilterList.open('GET', 'Not_Dispensed_Filter_List.php?Start_Date=' + Start_Date + '&End_Date=' + End_Date + '&Search_Patient=' + Search_Patient + '&Sponsor=' + Sponsor + '&Bill_Type=' + Bill_Type + '&Payment_Mode=' + Payment_Mode , true);
