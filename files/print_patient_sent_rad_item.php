...
if (isset($_GET['fromdate'])) {
    ...
    $filter = " WHERE ilc.Transaction_Date_And_Time BETWEEN '$fromDate' AND '$toDate' AND ilc.Check_In_Type='Radiology' AND ilc.Status IN ('active','paid') AND pr.Registration_ID='$Registration_ID'";
