...
///////////////////////////////////////////////////////////////////////////////////////
    $query_string="section=".$_GET['section']."&Registration_ID=".$_GET['Registration_ID']."&Transaction_Type=".$_GET['Transaction_Type']."&Payment_Cache_ID=".$_GET['Payment_Cache_ID']."&NR=".$_GET['NR']."&Billing_Type=".$_GET['Billing_Type']."&Sub_Department_ID=".$_GET['Sub_Department_ID']."&RadiologyWorks=".$_GET['RadiologyWorks']."";
...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Setup_And_Configuration'] == 'yes'){ 
?>
    <a href='revenuecenterradiologylist.php?Billing_Type=OutpatientCash&RadiologyList=RadiologyListThisForm' class='art-button-green'>
        BACK
    </a>
<?php } } ?>
...
<!--<br/>-->
<fieldset>  
    <legend align=right><b>PATIENT PAYMENTS ~ <?php echo strtoupper($_GET['section']);?></b></legend>
        <center>
            <table width=100%> 
                <tr> 
                    <td>
			...
			<?php
			    if($Transaction_Status_Title == 'NOT PAID'){
                    ...
                    <?php }  if(isset($_SESSION['configData']) && $_SESSION['configData']['ShowCreateEpaymentBillOrMakePaymentButton']=='makepayment'){ ?>
                        ...
                        <?php }//end of checking payment button visibility
                         }
		...
		<tr>
			...
			<?php if(isset($_GET['Sub_Department_ID'])) { $Sub_Department_ID = $_GET['Sub_Department_ID']; }else{ $Sub_Department_ID = 0; } ?>
                        <div id="patientItemsList" style='height:200px;overflow-y:scroll;overflow-x:hidden'>
                            ...
                            <?php include "Patient_Billing_Radiology_Iframe.php";?>
                        </div>
...
<script>
    function open_gpg_dialog(){
      ...
      $.ajax({
          ...
          data:{Registration_ID:Registration_ID,Payment_Cache_ID:Payment_Cache_ID,Sub_Department_ID:Sub_Department_ID,Transaction_Type:Transaction_Type,Patient_Name:Patient_Name,Check_In_Type:'Radiology'},
...
<script type="text/javascript">
    ...
    function get_terminals(trans_type){
            ...
            if(result){
                 if (itemzero != '' && itemzero != null){
                    document.location = 'Patient_Billing_Radiology_Page.php?itemzero='+itemzero+'&Transaction_Type=<?php echo $Transaction_Type; ?>&Payment_Cache_ID=<?php echo $Payment_Cache_ID; ?>&Sub_Department_ID=<?php echo $Sub_Department_ID; ?>&Registration_ID=<?php echo $Registration_ID; ?>&Billing_Type=<?php echo $Temp_Billing_Type2; ?>'+'&manual_offline=manual';
                     ...
                     document.location = 'Patient_Billing_Radiology_Page.php?Payment_Cache_ID=<?php echo $Payment_Cache_ID; ?>&Transaction_Type=<?php echo $Transaction_Type; ?>&Sub_Department_ID=<?php echo $Sub_Department_ID; ?>&Registration_ID=<?php echo $Registration_ID; ?>&Billing_Type=<?php echo $Temp_Billing_Type2; ?>'+'&manual_offline=manual';
                 }
 }
        }else{
                $.ajax({
      ...
      function offline_transaction(amount_required,reg_id){
        ...
        var uri = '../epay/patientbillingradiologyOfflinePayment.php';
...
function openItemDialog(){
 ...
 function removeitem(item){
		...
		if(check){     
		 $.ajax({
			 type: 'POST',
			 url: "change_items_info_radiology.php",
...
<script>
    function Pay_Via_Mobile_Function(Payment_Cache_ID){
        ...
        myObjectGetDetails.open('GET','ePayment_Patient_Details_Departmental.php?Section=Radiology&Employee_ID='+Employee_ID+'&Registration_ID='+Registration_ID+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID,true);
...
<script type="text/javascript">
    function Confirm_Create_ePayment_Bill(){
        ...
        myObjectConfirm.open('GET','Confirm_ePayment_Patient_Details_Departmental.php?Section=Radiology&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID,true);
            ...
            if(Payment_Mode != null && Payment_Mode != ''){
                if(Payment_Mode == 'Bank_Payment'){
                    ...
                    if (Confirm_Message == true) {
                        document.location = 'Departmental_Bank_Payment_Transaction.php?Section=Radiology&Registration_ID='+Registration_ID+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Billing_Type='+Billing_Type;
                    }
