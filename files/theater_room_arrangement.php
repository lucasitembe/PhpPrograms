...
<fieldset>  
    <legend align=center><b>APPOINTED SURGERY LIST</b></legend>
...
<script language="javascript" type="text/javascript">
    ...
    function add_reason(Payment_Item_Cache_List_ID) {
        Surgeon_filled = $("#Surgeon_filled"+Payment_Item_Cache_List_ID).val();
        assign = 'Accept';
        reason = $("#reason").val();
        ...
        if(assign == 'Reject' && reason == undefined){
            ...
            if(confirm("Are You Sure Selected Surgeon Is the reght Surgeon for this Surgery?")){
                $.ajax({
                    type: "GET",
                    url: "ajax_set_Surgery_appointment.php",
                    data: {Payment_Item_Cache_List_ID:Payment_Item_Cache_List_ID,assign:assign,Employee_ID:Employee_ID,Surgeon_filled:Surgeon_filled},
                    cache: false,
    ...
    function filterPatient(){
        ...
        myObjectPost.open('GET', 'ajax_theater_room_arrangement.php?Current_Employee_ID='+Current_Employee_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name+'&Sponsor_ID='+Sponsor_ID+'&date_To='+date_To+'&date_From='+date_From+'&Surgical_Type='+Surgical_Type, true);
        myObjectPost.send();
    }
