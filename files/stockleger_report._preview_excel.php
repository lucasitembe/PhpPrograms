    ...
    if($no > 0){
      ...
      $htm .= "<table width='100%' border='1' style='font-size:12px;border-collapse: collapse;' cellpadding=5 cellspacing=10>
                ...
                <tr>
                    ...
                    <td width='12%' style='text-align: center'><b>RECIEVED</b></td>
                    <td width='11%' style='text-align: center'><b>ISSUED</b></td>
                    <td width='11%' style='text-align: center'><b>ADJUSTMENT</b></td>
    	...
    	while ($data = mysqli_fetch_array($select)) {
            ...
            if($controler == 'yes'){
               $htm .= "<tr><td colspan='8' style='text-align: right;'><b>B/F : ".$Pre_Balance."&nbsp;</b></td></tr>";
            ...
            if($Movement_Type == 'From External'){
              ...
              $htm .= " <tr><td> ".++$temp ."</td>
                    ...
                    <td style='text-align: center'>". ($data['Post_Balance'] - $data['Pre_Balance'])."</td>
                ...
                $Employee_ID = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Employee_ID FROM tbl_grn_without_purchase_order_approval_cache WHERE grn_without_id='$Document_Number'"))['Employee_ID'];
                $Name_employee = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Employee_Name FROM tbl_employee WHERE Employee_ID='$Employee_ID'"))['Employee_Name'];
...
//                $Store_Issue = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Employee_ID FROM tbl_requisition WHERE Requisition_ID='$Document_Number'"))['Store_Issue'];
                ...
                $Name_issues = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Employee_Name FROM tbl_employee WHERE Employee_ID='$Employee_ID'"))['Employee_Name'];
               ...
               $htm .=  " <tr><td>". ++$temp."</td>
                    ...
                    <td>". $data['Movement_Date']."</td>";
                      ...
                      $htm .=   "<td>
                       <a target='_blank' href='previousissuenotereport.php?Issue_ID={$data['Document_Number']}'>
                       Issue ({$Sub_Department_Name})</a>
                       </td>";
                  ...
                  $htm .= "<td>0</td>
                    ...
                    <td style='text-align: right'>". $data['Post_Balance']."&nbsp;&nbsp;</td>
                    <td style='text-align: right;'>Issue</td>
                    <td style='text-align: right;'>". $Name_issues."</td>
                </tr>";
          ...
          $htm .= "<tr><td>". ++$temp."</td>
                ...
                $Employee_ID_employee = mysqli_fetch_assoc(mysqli_query($conn, "SELECT Employee_ID FROM tbl_disposal WHERE Disposal_ID='$Document_Number'"))['Employee_ID'];
                $adjustment_narration = mysqli_fetch_assoc(mysqli_query($conn, "SELECT Disposal_Description FROM tbl_disposal WHERE Disposal_ID='$Document_Number'"))['Disposal_Description'];
                $Name_employee = mysqli_fetch_assoc(mysqli_query($conn, "SELECT Employee_Name FROM tbl_employee WHERE Employee_ID='$Employee_ID_employee'"))['Employee_Name'];
                $get_adjustment_reason = mysqli_fetch_assoc(mysqli_query($conn,"SELECT name,nature FROM tbl_disposal AS td, tbl_adjustment AS ta WHERE ta.id = td.reason_for_adjustment AND td.Disposal_ID = $Document_Number"));

                // $new_blc = 0;
                $get_adjustment_qty = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Quantity_Disposed FROM tbl_disposal_items WHERE Disposal_ID = '$Document_Number' AND Item_ID = $Item_ID"))['Quantity_Disposed'];

                if($get_adjustment_reason['nature'] == 'adjustment_minus'){
                    $new_adjustment_calc += ($data['Pre_Balance'] - $data['Post_Balance']);
                    $new_blc ="-".$get_adjustment_qty;
                    $new_adjustment_calc_neg += $get_adjustment_qty;
                }else{
                    $new_blc =$get_adjustment_qty;
                    $new_adjustment_calc_pos += $get_adjustment_qty;
                }
                ...
                <td>".$data['Document_Number']."</td>
                <td>".$data['Movement_Date']."</td>
                <td>".$adjustment_narration."</td>
                <td style='text-align: center;'>0</td>
                <td style='text-align: center;'>0</td>
                <td style='text-align: center;'>".$new_blc."</td>
                <td style='text-align: right'>".$data['Post_Balance']."&nbsp;&nbsp;</td>
                <td style='text-align: right;'>".$get_adjustment_reason['name']."</td>
                <td>$Name_employee</td>
            </tr>";
...
//                $Store_Issue = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Employee_ID FROM tbl_requisition WHERE Requisition_ID='$Document_Number'"))['Store_Issue'];
        ...
        $htm .="<tr><td colspan='4'><b>Grand Total For Last Stock Tacking</b></td>
                <td style='text-align: center;'>".$Total_inward."</td>
                <td style='text-align: center;'>".$Total_outward."</td>
                <td style='text-align: center;'>".$Grand_Balance."&nbsp;&nbsp;</td>
                </tr>";
     
    
        $htm .="<tr><td colspan='4'> <b></b> </td>
                <td style='text-align: center;'>".$All_total_inward."</td>
                <td style='text-align: center;'>". $All_total_outward."</td>
