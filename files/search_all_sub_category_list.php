...
<table class="table">
                        <?php 
                            $sql_select_category_result=mysqli_query($conn,"SELECT *FROM tbl_item_subcategory WHERE Item_Subcategory_Name LIKE '%$Item_Subcategory_Name%'") or die(mysqli_error($conn));
