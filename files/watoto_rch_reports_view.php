...
//        echo $age.'&'.$moth.'&'.$days.'<br />';
    ...
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>Namba</th><th style='width:40%'>Maelezo</th><th style='20%'></th><th style='25%'>Idadi</th></tr>";
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'></th><th style='width:40%'></th><th style='width:20%'></th>  <th style='width:25%'><table style='width:100%'><tr><th>ME</th><th>KE</th><th>Jumla</th></tr></table></th></tr>";


    echo "<tr><td style='text-align:center'>1</td><td>Idadi ya watoto walioandikishwa na kupewa vyeti vya kuzaliwa</td><td style='text-align:center'></td> <td style='text-align:center'><table style='width:100%'><tr><th>$birthcertme</th><th>$birthcertke</th><th>$Totalbirthcert</th></tr></table></td></tr>";

    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>2</th><th style='width:40%;text-align:left'>Aina ya Chanjo kwa umri</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "<tr><td style='text-align:center'>2a</td><td>BCG Umri mwaka < 1 (Ndani ya eneo la huduma)</td><td style='text-align:center'></td> <td style='text-align:center'><table style='width:100%'><tr><th>$twoAme</th><th>$twoAke</th><th>$TotaltwoA</th></tr></table></td></tr>
        ...
        ";
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>3</th><th style='width:40%;text-align:left'>Hali ya chanjo ya pepopunda kwa mama wakati wa kujifungua</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "<tr><td style='text-align:center'>3a</td><td>Waliokingwa</td><td style='text-align:center'></td> <td style='text-align:center'><table style='width:100%'><tr><th>$threeAme</th><th>$threeAke</th><th>$TotalthreeA</th></tr></table></td></tr>
    ...
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>4</th><th style='width:40%;text-align:left'>Mahudhurio na uwiano wa uzito,umri na urefu;umri mwaka 1 mpaka 5</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "
    ...
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>5</th><th style='width:40%;text-align:left'>Mahudhurio na uwiano wa uzito,umri na urefu;umri mwaka 1 mpaka 5</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "
    ...
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>6</th><th style='width:40%;text-align:left'>Nyongeza ya Vitamini A</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "<tr><td style='text-align:center'>6a</td><td>Watoto umri wa miezi 6</td><td style='text-align:center'></td> <td style='text-align:center'><table style='width:100%'><tr><th>$sixAme</th><th>$sixAke</th><th>$TotalsixA</th></tr></table></td></tr>
    ...
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>7</th><th style='width:40%;text-align:left'>Waliopewa Mebendazole/Albendazole</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "<tr><td style='text-align:center'>7a</td><td>Watoto umri wa mwaka 1 hadi 5</td><td style='text-align:center'></td> <td style='text-align:center'><table style='width:100%'><tr><th>$sevenAme</th><th>$sevenAke</th><th>$TotalsevenA</th></tr></table></td></tr>
             
        ";

    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>8</th><th style='width:40%;text-align:left'>Ulishaji wa Watoto Wachanga</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "<tr><td style='text-align:center'>8a</td><td>Watoto wachanga wanaonyonya maziwa ya mama pekee (EBF)</td><td style='text-align:center'></td> <td style='text-align:center'><table style='width:100%'><tr><th>$eightAme</th><th>$eightAke</th><th>$TotaleightA</th></tr></table></td></tr>
    ...
    echo "<tr style='background-color:#006400;color:white;padding:2px;text-align:left'><th style='width:5%'>9</th><th style='width:40%;text-align:left'>Taarifa za PMTCT/waliopewa hati punguzo</th><th style='width:20%'></th>  <th style='width:25%'></th></tr>";
    echo "<tr><td style='text-align:center'>9a</td><td>Watoto waliozaliwa na mama mwenye maambukizi ya VVU/watoto wenye HEID no</td><td style='text-align:center'></td> <td style='text-align:center'><table style='width:100%'><tr><th>$nineAme</th><th>$nineAke</th><th>$TotalnineA</th></tr></table></td></tr>
