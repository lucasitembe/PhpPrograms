...
<form name="myform" action="" method="POST">
	...
	<?php
          $display_table="<table width=100% class='row'> 
			...
			$query_data=mysqli_query($conn,"SELECT * FROM tbl_jobcards WHERE status='Certified' ORDER BY jobcard_ID DESC");
			...
			while($result_query=mysqli_fetch_array($query_data)){
				...
				<tr> <td><center>".$num.".</center></td>
					...
					<td>".$result_query['requesting_engineer']."</td>
                                        ...
                                        <td><a href='jobcard_view.php?Process_Jobcard=True&jobcard_ID=".$result_query['jobcard_ID']."' class='art-button-green'>AUTHORIZE JOB CARD</a></td>"
                                        ;
                        if(isset($_GET['lForm']))
