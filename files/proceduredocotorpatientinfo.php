...
if (isset($_POST['process_procedure'])) {
    ...
    echo "<script type='text/javascript'>
                                ...
                                window.location='proceduredocotorpatientinfo.php?" . $queryString . "'
                            </script>";
}
if (isset($_SESSION['userinfo']['Employee_ID'])) {
    $Employee_ID = $_SESSION['userinfo']['Employee_ID'];
...
if (strtolower($Session) == 'outpatient') {
    echo "<a href='clinicalnotes.php?Registration_ID=" . $Registration_ID . "&Patient_Payment_ID=" . $Patient_Payment_ID . "&Patient_Payment_Item_List_ID=" . $Patient_Payment_Item_List_ID . "&SearchListDirectCashPatientBilling=SearchListDirectCashPatientBillingThisPage' class='art-button-green'>BACK</a>";
