...
<fieldset style='overflow-y: scroll; height: 390px; background-color: white;' id='Grn_Fieldset_List'>
	<legend align=right><b>Previous Return Inwards</b></legend>
	    <?php
            $temp = 0;
		...
		$sql_select = mysqli_query($conn,"SELECT
                                   ...
                                   WHERE
                                      ...
                                      Inward_Status = 'submitted'") or die(mysqli_error($conn));
		...
		if($num > 0){
			...
			echo '<tr><td style="text-align: center;">'.++$temp.'</td>
                        ...
                        <td><a href="Control_Return_Inward_Sessions.php?Previous_Return_Inward=True&Return_Inward_ID='
                        .$row['Inward_ID'].'" class="art-button-green">Preview</a></td></tr>';
		    }
		}
		echo '</table>';
	    ?>
