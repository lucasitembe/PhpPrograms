...
///////override patient bill type according to inpatient or outpatient status
    ...
    function searchPatient(){
       ...
       // alert(Billing_Type)
        if(date_From != null && date_From != '' && date_To != null && date_To != ''){
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=380px src='Pharmacy_List_Iframe.php?Patient_Name="+Patient_Name+"&Billing_Type="+Billing_Type+"&date_From="+date_From+"&date_To="+date_To+"'></iframe>";
        }else{
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=380px src='Pharmacy_List_Iframe.php?Patient_Name="+Patient_Name+"&Billing_Type="+Billing_Type+"'></iframe>";
        }
    }
</script>
...
<script language="javascript" type="text/javascript">
    function Patient_List_Search2(){
        ...
        if(date_From != null && date_From != '' && date_To != null && date_To != ''){
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=380px src='Pharmacy_List_Iframe.php?Billing_Type="+Billing_Type+"&date_From="+date_From+"&date_To="+date_To+"&Patient_Number="+Patient_Number+"'></iframe>";
        }else{
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=380px src='Pharmacy_List_Iframe.php?Billing_Type="+Billing_Type+"&Patient_Number="+Patient_Number+"'></iframe>";
        }
    }
</script>
...
<fieldset>  
    <legend align='right'><b>PHARMACY WORKS <?php echo strtoupper($Page_Title).'  :'.strtoupper($Sub_Department_Name); ?> </b></legend>
        <center>
            ...
            <?php }else{ ?>
                <iframe width='100%' height=380px src='Pharmacy_List_Iframe.php?Billing_Type=<?php echo $Billing_Type; ?>'></iframe>
            <?php } ?>
            </td>
        </tr>
            </table>
