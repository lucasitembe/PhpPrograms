...
<!-- <a href="previous_martenal_condition.php?consultation_id=<?= $consultation_id; ?>&patient_id=<?= $patient_id; ?>&admission_id=<?= $admision_id ?>" class="art-button-green" target="_blank">PREVIEW RECORDS<?= $admision_id ?></a>
<a href="maternal_condition_previous_date.php?consultation_id=<?= $consultation_id; ?>&patient_id=<?= $patient_id; ?>&admission_id=<?= $admision_id ?>" class="art-button-green" >PREVIEW RECORDS2<?= $admision_id ?></a> -->
...
<center>
  <fieldset>
          <legend style="font-weight:bold"align=center>FETAL SIDE</legend>
          ...
          <div style="margin:0px;display:grid;grid-template-columns:1fr 1fr 1fr; gap:1em;margin-top:20px;">
              <div class="one">
                Date Of Birth<td><input type='date' id='date_birth' name="date_birth" class="form-control" >
              </div>
              <div class="two">
                Weight<input type="text" id="weight" name="weight" class="form-control">
              </div>
              <div class="three">
              ...
              <div class="four">
                Apgar<td><input type='text' id='apgar' name="apgar" class="form-control" >
              </div>
        
              <div class="five">
                Method Of Delivery<input type="text" id="method_delivery" name="method_delivery" class="form-control">
              </div>
              <div class="six">
                Method Of Resuscition<input type="text" id="method_resuscition" name="method_resuscition" class="form-control">
              </div>
          </div> -->
          ...
          <div style="margin:0px;display:grid;grid-template-columns:1fr 1fr 1fr; gap:1em;margin-top:20px;">
              <div class="one">
                  First Stage :Duration<td><input type='text' id='first_stage' name="first_stage" class="form-control" >
              </div>
        
              <div class="two">
                Second Stage :Duration<input type="text" id="second_stage" name="second_stage" class="form-control">
              </div>
              <div class="four">
                Third Stage :Duration<td><input type='text' id='third_stage' name="third_stage" class="form-control" >
              </div>
        
              <div class="five">
              Fourth Stage :Duration<input type="text" id="fourth_stage" name="fourth_stage" class="form-control">
              </div>
              <div class="six">
                Placenta And Membranes<input type="text" id="placenta_membrane" name="placenta_membrane" class="form-control">
              </div>
              <div class="seven">
                Blood Loss<input type="text" id="blood_loss" name="blood_loss" class="form-control">
              </div>
              <div class="eight">
                Reason For-PPH<td><input type='text' id='reason_pph' name="reason_pph" class="form-control" >
              </div>
        
              <div class="nine">
                Perineum<input type="text" id="perineum" name="perineum" class="form-control">
              </div>
              <div class="ten">
                Repair By<input type="text" id="repair_by" name="repair_by" class="form-control">
              </div>
              <div class="ten">
                Delivery By<input type="text" id="delivery_by" name="delivery_by" class="form-control">
              </div>
              <div class="ten">
                Supervision By<input type="text" id="supervision_by" name="supervision_by" class="form-control supervision_by">
              </div>
          </div>
