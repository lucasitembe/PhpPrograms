...
<!-- <a href="Exemption_employee_setup_report.php" class='art-button-green'>SETUP REPORT</a> -->
...
<script language="javascript" type="text/javascript"> 
    function searchPatient(Patient_Name){
		...
		document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe_2.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
<script language="javascript" type="text/javascript">
    function Search_Patient_Using_Number(Patient_Number){
		...
		document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe_2.php?Patient_Number="+Patient_Number+"'></iframe>";
    }
</script>
<script language="javascript" type="text/javascript">
	...
	if ((Patient_Name != '' && Patient_Name != null) && (Patient_Number != '' && Patient_Number != null)) {//All set
		document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe_2.php?Patient_Number="+Patient_Number+"&Patient_Name="+Patient_Name+"&Phone_Number="+Phone_Number+"'></iframe>";
	}else if((Patient_Name != '' && Patient_Name != null) && (Patient_Number == '' || Patient_Number == null)) {//Patient_Number not set
		document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe_2.php?Patient_Name="+Patient_Name+"&Phone_Number="+Phone_Number+"'></iframe>";
	}else if((Patient_Name == '' || Patient_Name == null) && (Patient_Number != '' && Patient_Number != null)){
	    document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe_2.php?Patient_Number="+Patient_Number+"&Phone_Number="+Phone_Number+"'></iframe>";	
	}else{
	    document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe_2.php?Phone_Number="+Phone_Number+"'></iframe>";
	}
    }
</script>
<script language="javascript" type="text/javascript">
    ...
    var Phone_Number = "";
        ...
        document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_list_patient_billing_Iframe_2.php?src=old&Patient_Number="+Patient_Number+"&Patient_Name="+Patient_Name+"&Phone_Number="+Phone_Number+"&Old_Patient_Number="+Old_Patient_Number+"'></iframe>";
...
<fieldset>  
        ...
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
		<iframe width='100%' height=400px src='search_msamaha_patient_list_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>
            </td>
        </tr>
            </table> 
        </center>
