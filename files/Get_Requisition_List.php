...
?>
 ...
 <legend style="background-color:#006400;color:white;padding:5px;" align=right><b>
    <?php if(isset($_SESSION['Procurement_ID'])){ echo $Sub_Department_Name; }?> ~ List Of Requisitions</b></legend>
    <br>
<?php
    $temp = 1;
