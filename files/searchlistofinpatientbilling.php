...
<script language="javascript" type="text/javascript">
    function searchPatient(Patient_Name){
        document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=380px src='search_list_inpatient_billing_Pre_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
<br/>
<center>
...
<fieldset>  
        ...
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
		<iframe width='100%' height=380px src='search_list_inpatient_billing_Pre_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>
            </td>
        </tr>
            </table>
        </center>
