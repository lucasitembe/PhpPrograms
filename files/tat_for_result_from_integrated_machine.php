    ...
    function filter_collected_specimen_patient(){
       ...
       if(subcategory_ID=="All"){
           $('#subcategory_ID').css("border","2px solid red");
            ...
            $.ajax({
                type:'POST',
                url:'list_of_patients_arleady_collected_specimen_frame2.php',
    ...
    function print_excell(){
       ...
       if(subcategory_ID=="All"){
           $('#subcategory_ID').css("border","2px solid red");
            ...
            window.open("TAT_for_result_Excell_Report.php?Date_From="+Date_From+"&Date_To="+Date_To + "&subcategory_ID=" + subcategory_ID + '&searchspecmen_id=' +searchspecmen_id + '&Patient_Name=' + Patient_Name + '&Registration_ID=' + Registration_ID);
        }
    }
