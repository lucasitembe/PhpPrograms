...
<?php
	...
	if($num_rows > 0 ){
        ...
        if($delete_details){
            ...
            $select_Transaction_Items = mysqli_query($conn,"select itm.Product_Name, rqi.Quantity_Required, rqi.Item_Remark, rqi.Requisition_Item_ID, rqi.Container_Qty, rqi.Items_Qty
