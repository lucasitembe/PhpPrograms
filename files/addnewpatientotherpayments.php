                ...
                <tr>
				    ...
				    <option>Mrs</option>
                            ...
                            <tr>
                                ...
                                <td><input type='text' name='Date_Of_Birth' autocomplete='off' readonly='readonly' id='date2' style='border-color: red' required='required'></td>
                            </tr>
                            <tr>
				    ...
				    <input type='text' autocomplete='off' name='Ward' id='Ward'>
                            ...
                            <tr>
                                <td style='text-align: right; color: red'><b>Emergency Contact Name</b></td>
                                <td><input type='text' name='Emergence_Contact_Name' autocomplete='off' style='border-color: red' id='Emergence_Contact_Name' required='required'></td>
                            </tr>
                            <tr>
                                <td style='text-align: right; color: red'><b>Emergency Contact Number</b></td>
                                <td><input type='text' name='Emergence_Contact_Number' autocomplete='off' style='border-color: red' id='Emergence_Contact_Number' required='required'></td>
                            </tr>
                            <tr>
	...
	$data = mysqli_query($conn,"select now() as Registration_Date_And_Time");
        ...
        $Insert_Sql = "insert into tbl_patient_registration(
                    Old_Registration_Number,Title,Patient_Name,
                        Date_Of_Birth,Gender,Region,District,Ward,
                            Sponsor_ID,
			...
			Patient_Name = '$Patient_Name' and
			    ...
			    document.location = './revenuecenterpatientbillingothers.php?Registration_ID=".$Registration_ID."&NR=true&Check_In_ID=".$Check_In_ID."&PatientBilling=PatientBillingThisForm';
			    </script>";*/
                    echo "<script type='text/javascript'>
			    alert('PARTIENT ADDED SUCCESSFUL');
			    document.location = './revenuecenterothersworkpage.php?Registration_ID=".$Registration_ID."&NR=true&Check_In_ID=".$Check_In_ID."&PatientBilling=PatientBillingThisForm';
			    </script>";		    
		}
