...
<?php
	...
	if(isset($_GET['Payment_Cache_ID']) && isset($_GET['Payment_Item_Cache_List_ID'])){
		...
		$select_from_cache = "SELECT * FROM tbl_item_list_cache il, tbl_items i
			...
			document.location = "family_planningclinicalnotes.php?Family_Planningclinicalnotes=Family_PlanningPageclinicalnotes&Patient_Payment_ID=<?php echo $Patient_Payment_ID;?>&Registration_ID=<?php echo $Registration_ID;?>";
		    </script>
		    <?php
	    }   
	}
...
<script type="text/javascript">
	...
	if(patientlist=='Outpatient cash'){
	    ...
	    document.location = "family_planningcreditpatientlist.php?Family_PlanningCreditPatientlist=Family_PlanningCreditPatientlistThispage";
...
<fieldset><legend align='right'><b>Family Planning Works</b></legend>
	<table width=100%>
		<tr>
		    ...
		    <td style="text-align:right;"><b>Visit Date</b></td><td><input type="text" name="" id="" readonly='readonly' value='<?php if(isset($Transaction_Date_And_Time)){ echo $Transaction_Date_And_Time; } ?>'></td>
		</tr>
		<tr>
...
<fieldset style=' height:220px; overflow:scroll;' >
	...
	<?php
	    if( isset($_GET['Patient_Payment_ID']) ){
		$select_items = "SELECT * FROM tbl_patient_payment_item_list ppl, tbl_items i
				   WHERE ppl.Patient_Payment_ID = '$Patient_Payment_ID'
				   AND i.Item_ID = ppl.Item_ID
				   AND i.Consultation_Type = 'Family Planning'";
...
<a href="powercharts_familyplanning.php" class="art-button-green">Enter Patient Data</a>
<?php
    if(isset($_GET['Patient_Payment_ID'])){
	?>
