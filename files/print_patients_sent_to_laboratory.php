  ...
  //die($select_data);
    ...
    while ($row = mysqli_fetch_array($select_data_result)) {
        ...
        //Get items
         ...
         . "JOIN tbl_patient_registration pr ON pr.Registration_ID=pc.Registration_ID "
         . " WHERE ilc.Transaction_Date_And_Time BETWEEN '$fromDate' AND '$toDate' AND ilc.Check_In_Type='Laboratory'  AND pr.Registration_ID='$Registration_ID' ORDER BY ilc.Transaction_Date_And_Time ASC";
