...
//    }
  ...
  <thead><tr style='background-color:#2387d0; color:white;'>
    ...
    //$output.="<table><tr><td colspan=8><hr></td></tr>
    //<tr><td colspan=5 style='text-align: right;'><b>Sub Total</b></td>
    ...
    //<td style='text-align: right;'><b>".(($_SESSION['systeminfo']['price_precision'] == 'yes') ? number_format($Cancelled_Total, 2) : number_format($Cancelled_Total))."</b></td></tr>
