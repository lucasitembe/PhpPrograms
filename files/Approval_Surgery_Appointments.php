...
<fieldset>  
    ...
    <div class="box box-primary" style="height: 540px;overflow-y: scroll;overflow-x: hidden">
        ...
        <tr style='background: #dedede; position: static !important;'>
                ...
                <th style='text-align: left;'>ANAESTHESIA TYPE</th>
...
<script language="javascript" type="text/javascript">
    ...
    function filterPatient(){
        ...
        myObjectPost.open('GET', 'Approval_Surgery_Appointments_filter.php?Current_Employee_ID='+Employee_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name+'&Sponsor_ID='+Sponsor_ID+'&date_To='+date_To+'&date_From='+date_From+'&Surgical_Type='+Surgical_Type, true);
        myObjectPost.send();
    }
