...
//			$htm .= '</td>'
	...
	if($_SESSION['systeminfo']['price_precision']=='yes'){ 
        ...
        if($_SESSION['systeminfo']['price_precision']=='yes'){ 
		$htm .= '<span style="font-size: x-small;">'.number_format($Grand_Total_Msamaha, 2).'</span>'; 
	} else{ 
		$htm .= '<span style="font-size: x-small;">'.number_format($Grand_Total_Msamaha).'</span>'; 
	}
	
//        $htm .= '</b></td><td style="text-align: right;"><b>';
//	
//	if($_SESSION['systeminfo']['price_precision']=='yes'){ 
//		$htm .= '<span style="font-size: x-small;">'.number_format($Grand_Total_Cash + $Grand_Total_Credit+$Grand_Total_Msamaha, 2).'</span>'; 
//	} else{
//		$htm .= '<span style="font-size: x-small;">'.number_format($Grand_Total_Cash + $Grand_Total_Credit+$Grand_Total_Msamaha).'</span>'; 
//	}
