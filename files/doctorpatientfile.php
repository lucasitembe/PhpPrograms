...
?>
    ...
    ?>
    <a href='doctorspageoutpatientwork.php?Registration_ID=<?php echo $Registration_ID; ?>&Patient_Payment_ID=<?php echo $Patient_Payment_ID; ?>&Patient_Payment_Item_List_ID=<?php echo $Patient_Payment_Item_List_ID; ?>&PatientBilling=PatientBillingThisForm' class='art-button-green'>
        BACK
    </a>
    <?php }else{
    ?>
	<a href='clinicalnotes.php?<?php if($Registration_ID!=''){echo "Registration_ID=$Registration_ID&"; } ?><?php
	if(isset($_GET['Patient_Payment_ID'])){
	    echo "Patient_Payment_ID=".$_GET['Patient_Payment_ID']."&";
	    }
...
<fieldset>
        <iframe id='srchfrm' src='doctorpatientfile_Iframe.php?Registration_ID=<?php echo $Registration_ID;?>&Patient_Payment_ID=<?php echo $Patient_Payment_ID; ?>&Patient_Payment_Item_List_ID=<?php echo $Patient_Payment_Item_List_ID; if(isset($_GET['doctorsworkpage'])){?>&doctorsworkpage=yes<?php }?>' style='width: 100%; height:320px;'>
        </iframe>
</fieldset>
<!--END HERE-->
<?php
