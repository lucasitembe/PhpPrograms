...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Doctors_Page_Outpatient_Work'] == 'yes'){ 
?>
    <a href='./individualdoctorsperformancesummary.php?DoctorsPerformanceReport=ThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<fieldset>
    ...
    <legend align=center><b>PERFORMANCE DETAILS FOR DOCTOR </b><b style="color:blue;"><?php echo strtoupper($doctorName)?></b></legend>
        <iframe src="individualdoctorsperformancedetails_Iframe.php?Employee_ID=<?php echo $doctorID;?>" width="100%" height="340px"></iframe>
</fieldset><br/>
<?php
