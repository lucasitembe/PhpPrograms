        ...
        <tr>
            <td>
                <div style="width:100%; height:380px;overflow-x: hidden;overflow-y: auto" id='Search_Iframe'>
                    <?php include 'Sample_Collection_Iframe.php'; ?>
                </div>
            </td>
        </tr>
    </table>
...
<center>   
    <!-- <a href="print_lab_patient.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a> -->
...
<script type='text/javascript'>
    ...
    $(document).ready(function () {
        $("#patientLabItemDiv").dialog({autoOpen: false, width: '90%', height: '300', title: 'Patient Laboratory Items', modal: true});
...
<script>
    function Show_Items_Taken(Registration_ID, Patient_Name, fromdate, todate) {
        ...
        $('#printItemsPreview').attr('href', 'print_lab_patient_item.php?Registration_ID=' + Registration_ID + '&fromdate=' + fromdate + '&todate=' + todate);
    ...
    function print_excell(){
            ...
            if(date_From == ""){
                ...
                window.open("Sample_Collection_Excell_Report.php?date_From="+date_From+"&date_To="+date_To + "&sponsorID=" + sponsorID);
            }
        }
...
<script type="text/javascript">
    $('#filterDate').click(function (e) {
        ...
        $('#printPreview').attr('href', 'print_lab_patient.php?fromDate=' + fromDate + '&toDate=' + toDate + '&sponsorID=' + sponsorID);

        $.ajax({
            type: 'POST',
            url: 'Sample_Collection_Iframe.php',
