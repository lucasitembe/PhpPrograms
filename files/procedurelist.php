...
//        $status="paid";
        ...
        if ($row['typeconsultant'] == "OTHERS_CONSULT") {
            ...
            if ($billing_type == 'Outpatient Cash' && $status == "active") {
                ...
                $statusMsg = "Not Paid";
            } elseif ($billing_type == 'Outpatient Credit' && $transaction_type == "credit" && $status == "active") {
                $statusMsg = "Not Bill";
        ...
        if ($statusMsg == 'Not Paid') {
            ...
            //echo "<td><a href='procedurepatientinfo.php?section=Procedure&Registration_ID=".$row['Registration_ID']."&Transaction_Type=".$row['Transaction_Type']."&Payment_Cache_ID=".$row['Payment_Cache_ID']."&NR=True&ProcedureWorks=ProcedureWorksThisPage'  >".$row['Transaction_Date_And_Time']."</td>";
        } else {
            if ($row['typeconsultant'] == "OTHERS_CONSULT") {
                $data .= "<td><a href='procedurepatientinfo.php?section=Procedure&typeconsultant=" . $row['typeconsultant'] . "&Registration_ID=" . $row['Registration_ID'] . "&Transaction_Type=" . $row['Transaction_Type'] . "&Payment_Cache_ID=" . $row['Payment_Cache_ID'] . "&NR=True&Billing_Type=" . $row['Billing_Type'] . "&Sub_Department_ID=" . $Sub_Department_ID . "&statusMsg=" . $statusMsg . "&ProcedureWorks=ProcedureWorksThisPage' target='_parent' style='text-decoration: none;'>" . ucwords(strtolower($row['Patient_Name'])) . "</a></td>";
...
<fieldset style="margin-top:10px; margin-top:20px">
    <legend align="center" style="padding:10px;background:#006400;color:white;text-align: center "><b>  ALL PATIENT PROCEDURE LIST</b><?php echo (isset($Date_From) && !empty($Date_From)) ? '<br/>From ' . $Date_From . ' To ' . $Date_To : '' ?>  </legend>
                ...
                <tr> 
                    ...
                    <td style="text-align:right;width:80px"><b>Date From<b></td>
                                ...
                                <td style="text-align:right;width:80px"><b>Date To<b></td>
                                            ...
                                            <hr width="100%">
                                            <p align="center">
                                                <a href="pendingprocedures.php"><button class="art-button-green" type="button">Pending Procedures</button></a>
                                            </p>
