...
$htm="<p align='center'><b>LABORATORY PATIENTS REPORT <br/>FROM</b> <b style=''>" . $date_From . "</b> <b>TO</b> <b style=''>" . $date_To . "</b><br/> "
        ...
        $htm .= '<center><table width =100% border=0 id="specimencollected" class="display fixTableHead">';
        $htm .= "
            <thead>
        ...
        if (!empty($date_To) && !empty($date_From)) {
            ...
            while ($row = mysqli_fetch_array($select_data_result)) {
                ...
                $htm .= "<td style='text-align:left '><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $patientName . "</span></td>";
                $htm .= "<td style='text-align:left'><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $row['Registration_ID'] . "</span></td>";
                $htm .= "<td style='text-align:left '><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $Guarantor_Name . "</span></td>";
                $htm .= "<td style='text-align:left '><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $Region . "</span></td>";
                $htm .= "<td style='text-align:left '><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $District . "</span></td>";
                $htm .= "<td style='text-align:left '><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $Gender . "</span></td>";
                $htm .= "<td style='text-align:left'><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $age . "</span></td>";
                // $htm .= "<td style='text-align:left; width:15%'>".$row['Specimen_Name']."</td>";
                $htm .= "<td style='text-align:left '><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $TimeCollected . "</span></td>";
                $htm .= "<td style='text-align:left '><span onclick='Show_Items_Taken(" . $Registration_ID . ",\"" . $patientName . "\",\"" . $fromDate . "\",\"" . $toDate . "\")' class='linkstyle' >" . $row['Consultant'] . "</span></td>
                        </tr>";
                $count++;
            }
        }
