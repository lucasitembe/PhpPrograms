...
<form action='revenueCategoryFilterNoFilterBefore.php?RevenueCategoryFilterNoFilterBefore=ThisForm' method='POST' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
    <table width=80%>
        <tr>
	    ...
	    <td style='border: 0;'>
		<input type="text" name="categoryID" value="<?php if(isset($_GET['categoryID'])){echo $catID;}?>">
	    </td>
            <!--<td style='text-align: center;'>
...
<fieldset>  
    ...
    $filterRevenue = mysqli_query($conn,"
				    SELECT *
				    FROM tbl_patient_registration pr, tbl_patient_payments pp, tbl_patient_payment_item_list ppl, tbl_items it, tbl_item_subcategory isc, tbl_item_category ic
