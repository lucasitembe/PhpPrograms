<?php
	...
	if($Sub_Department_ID != 100000000 && $Sub_Department_ID != null && $Sub_Department_ID != ''){
		...
		if($num == 0){
			$insert = mysqli_query($conn,"insert into tbl_stock_balance_sub_departments(Sub_Department_ID) values('$Sub_Department_ID')") or die(mysqli_error($conn));
		}
	}
?>
