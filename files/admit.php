...
//    header("Location: Admission_Supervisorauthentication.php?section=Admission&Authenticate=SuperUser&Activity=Active");
//}
...
if(!$_SESSION['Admission_Supervisor']['Employee_ID']){
    if($fromDoctorPage==='fromDoctorPage'){
      header("Location:deptsupervisorauthentication.php?SessionCategory=Admission&InvalidSupervisorAuthentication=yes&fromDoctorPage=fromDoctorPage");  
    }  else {
...
if (!isset($_GET['Check_In_ID'])) {
 $select_checkin = "SELECT Check_In_ID FROM tbl_check_in WHERE Registration_ID = '$Registration_ID' ORDER BY Check_In_ID DESC LIMIT 1";
...
if (isset($_POST['send_admition_form'])) {
    ...
    $New_return_admission = $_POST['New_return_admission'];
    $Admision_Ward_ID = $_POST['Hospital_Ward_ID'];
    $sql_check_if_admitted_result=mysqli_query($conn,"SELECT Admision_ID FROM tbl_admission WHERE Registration_ID='$Registration_ID' AND Admission_Status='Admitted' ORDER BY Admision_ID DESC LIMIT 1") or die(mysqli_error($conn));
    if(mysqli_num_rows($sql_check_if_admitted_result)>0){
        $Admision_ID=mysqli_fetch_assoc($sql_check_if_admitted_result)['Admision_ID'];
        $insert_query = "UPDATE tbl_admission SET Registration_ID='$Registration_ID', Check_In_ID = '$Check_In_ID',Admision_Ward_ID='$Admision_Ward_ID', Hospital_Ward_ID='$Hospital_Ward_ID',Bed_Name='$Bed_Name',
		    Admission_Employee_ID='$Admission_Employee_ID',Admission_Supervisor_ID='$Admission_Supervisor_ID',
		    Admission_Date_Time=(SELECT NOW()),Admission_Status='$Admission_Status',District='$District',
		    Ward='$Ward',Admission_Claim_Form_Number='$Admission_Claim_Form_Number',Folio_Number='$Folio_Number',New_return_admission='$New_return_admission',    Office_Area='$Office_Area',Office_Plot_Number='$Office_Plot_Number',Office_Street='$Office_Street',Office_Phone='$Office_Phone',
		    Kin_Name='$Kin_Name',Kin_Relationship='$Kin_Relationship',Kin_Phone='$Kin_Phone',Kin_Area='$Kin_Area',Kin_Street='$Kin_Street',Kin_Plot_Number='$Kin_Plot_Number',Kin_Address='$Kin_Address',Admission_Reason_ID='$Admission_Reason_ID',ward_room_id='$ward_room_id' WHERE Admision_ID='$Admision_ID'";
          ...
          $insert_query = "INSERT INTO tbl_admission(Registration_ID,Hospital_Ward_ID,Bed_Name,
		    ...
		    Kin_Name,Kin_Relationship,Kin_Phone,Kin_Area,Kin_Street,Kin_Plot_Number,Kin_Address,Admission_Reason_ID,ward_room_id,New_return_admission, Check_In_ID, Admision_Ward_ID)
   ...
   if (mysqli_query($conn,$insert_query)) {
    ...
    // $Patient_Bill_ID = mysqli_fetch_assoc(mysqli_query($conn, "SELECT Patient_Bill_ID FROM tbl_patient_bill WHERE Registration_ID = '$Registration_ID' AND Status = 'active' ORDER BY Patient_Bill_ID DESC LIMIT 1"))['Patient_Bill_ID'];

        $lastAdminstionID = mysqli_query($conn,"SELECT Admision_ID FROM tbl_admission
			WHERE Registration_ID = '$Registration_ID' AND Admission_Employee_ID='$Admission_Employee_ID' ORDER BY Admision_ID DESC LIMIT 1") or die(mysqli_error($conn));

        $Admision_ID = mysqli_fetch_assoc($lastAdminstionID)['Admision_ID'];
...
//echo $_GET['Check_In_ID'];
        ...
        $change_bed_status = "UPDATE tbl_beds SET Status = 'not available' WHERE Bed_ID = '$Bed_ID'";
        $bed_taken = mysqli_query($conn,$change_bed_status) or die(mysqli_error($conn));
        ...
        $change_admit_status = "UPDATE tbl_check_in_details SET Admit_Status = 'admitted' WHERE Registration_ID = '$Registration_ID' AND Check_In_ID = '$Check_In_ID'";
        $status_changed = mysqli_query($conn,$change_admit_status);
        ...
        if ($result = mysqli_query($conn,$select_admission_ID)) {
            ...
            $Query1= mysqli_query($conn,"SELECT itc.Payment_Cache_ID,Transaction_Type FROM tbl_item_list_cache itc JOIN tbl_payment_cache tpc ON itc.Payment_Cache_ID=tpc.Payment_Cache_ID WHERE tpc.consultation_id='$consultation_ID' AND itc.Status='active'");
            $number=  mysqli_num_rows($Query1);
            if($number>0){
                while($rp=mysqli_fetch_assoc($Query1)){
                   $Transaction_Type=$rp['Transaction_Type'];
                   
                       $update=  mysqli_query($conn,"UPDATE tbl_payment_cache SET Billing_Type='Inpatient $Transaction_Type' WHERE consultation_id='$consultation_ID' AND Payment_Cache_ID='".$rp['Payment_Cache_ID']."'") or die(mysqli_error($conn));
                }
             }
            
            ?>
            <script>
                alert('PATIENT ADMITED SUCCESSFULLY \n <?php  echo "ADMISSION NUMBER IS ". $row['Admision_ID']; ?> !');
				window.open('individual_admission_report.php?intent=print&Registration_ID=<?php echo $Registration_ID; ?>');
                var fromDoctorPage='<?php echo $fromDoctorPage;?>';
                if(fromDoctorPage==='fromDoctorPage'){
                    document.location = "./doctorspageoutpatientwork.php";
                }else{
                  document.location = "admissionworkspage.php?section=Admission&SearchListDirectCashPatientBilling=SearchListDirectCashPatientBillingThisPage";
...
if (isset($_POST['mortuary_send_admition_form'])) {
	...
	$insert_query = "INSERT INTO tbl_admission(Registration_ID,Hospital_Ward_ID,Bed_Name,
		    ...
		    Ward,Admission_Claim_Form_Number,Folio_Number,
		    Office_Area,Office_Plot_Number,Office_Street,Office_Phone,
		    Kin_Name,Kin_Relationship,Kin_Phone,Kin_Area,Kin_Street,Kin_Plot_Number,Kin_Address,Admission_Reason_ID, Check_In_ID)
	...
	if (mysqli_query($conn,$insert_query)) {
        ...
        $lastAdminstionID = mysqli_query($conn,"SELECT Admision_ID FROM tbl_admission
			WHERE Registration_ID = '$Registration_ID' AND Admission_Employee_ID='$Admission_Employee_ID' ORDER BY Admision_ID DESC LIMIT 1") or die(mysqli_error($conn).'oooooo');
	...
	Corpse_ID,
			...
			Police_Station,Police_Name,Police_Postal_Box,Admision_ID,Death_Certificate)
		    VALUES (
			'$Registration_ID',
			'$Case_Type',
			'$Place_Of_Death', 
			...
			'$Police_Station',
			'$Police_Name',
			'$Police_Postal_Box','$Admision_ID','$Death_Certificate')";
...
<script>
    window.setInterval(function () {
        ...
        notif.open('GET', 'GetNotification.php?tbl=' + tbl, true);
        notif.send();
...
<a href='searchlistofoutpatientadmission.php?section=<?php echo $section; ?>&ContinuePatientBilling=ContinuePatientBillingThisPage' class='art-button-green'>
    PATIENTS TO BE ADMITTED<span id='alert_here' style='background-color:red; padding:2px 5px 2px 5px; color:#fff; font-size:16px; border-radius:9px;<?php if ($patients == 0) echo "display:none;"; ?> '> <?php echo $patients; ?> </span>
</a>
...
if(isset($_GET['fromDoctorPage'])){
    ...
    echo "<a href='./doctorspageoutpatientwork.php' class='art-button-green'>BACK</a>";
}else{
    echo "<a href='searchlistofoutpatientadmission.php?section=&Continuesection=&PatientBilling=ContinuePatientBillingThisPage' class='art-button-green'>
    BACK
    </a>";   
}
...
<div id="patient">
	...
	<fieldset>
		<legend align='right'><b>ADMIT PATIENT</b></legend>
		<!--<br/>-->
					...
					<td>
						<table width='100%'>
							<tr>
								...
								<td width='16%'style='text-align:right;'><input type='text' name='Admission_Date_And_Time' id='Admission_Date_And_Time' value='<?php echo date('Y-m-d H:i:s'); ?>' disabled='disabled'></td>
							</tr> 
							<tr>
							...
							<input type='hidden' id='Admission_Employee_ID' name='Admission_Employee_ID' value='<?php echo $Employee_ID; ?>'>
                                                        <td style='text-align:right;'><b style="color:red;font-size:14px">Select Ward</b></td>
							<td id='Ward_Area_'>

								<select required='required'class="form-control" name='Hospital_Ward_ID' id='Hospital_Ward_ID'required="required" onchange="ward_nature(this.value)" >
									<option></option>
									 <?php
									if($Ward_suggested!==0){
										$Select_Department = mysqli_query($conn,"SELECT * FROM tbl_hospital_ward WHERE Hospital_Ward_ID='$Ward_suggested' AND ward_type='ordinary_ward'");
										...
										$Hospital_Ward_ID = $row['Hospital_Ward_ID'];
                                                                                ...
                                                                                ?>
										<option selected='selected' value='<?php echo $Hospital_Ward_ID; ?>'>
											<?php
										...
										<?php
                                                                                ...
                                                                                $Select_Department = mysqli_query($conn,"SELECT * FROM tbl_hospital_ward WHERE  ward_type='ordinary_ward'");
									} else if($Ward_suggested===0){
...
//										?>
                                ...
                                <tr>
                                    <td style='text-align:right;' colspan="5"><b style="color:red;font-size:14px">Select Room</b></td>
                                    <td>
                                        <select name="ward_room"  id="ward_room" onchange="get_ward_room_bed(this.value)">
                                                 <option selected='selected'></option>
                                                 <?php 
                                                 $sql_select_ward_rooms=mysqli_query($conn,"SELECT *FROM tbl_ward_rooms WHERE ward_id='$Ward_suggested'") or die(mysqli_error($conn));
                                                 if(mysqli_num_rows($sql_select_ward_rooms)>0){
                                                     while($room_rows=mysqli_fetch_assoc($sql_select_ward_rooms)){
                                                         ...
                                                         echo "<option value='$ward_room_id'>$room_name</option>";
                                                     }
                                                 }
                                                 ?>
                                        </select>
                                ...
                                <tr>
                                    <td style='text-align:right;' colspan="5"><b style="color:red;font-size:14px">Select Bed</b></td>
                                    <td>
				...
				<tr> 
					...
					<td><input type='text' name='Phone_Number1' id='Phone_Number1' disabled='disabled' value='<?php echo $Phone_Number; ?>'></td>
	...
	//                                    exit;
					if (isset($_SESSION['Admission_Supervisor'])) {
						if (isset($_SESSION['Admission_Supervisor']['Session_Master_Priveleges'])) {
							if ($_SESSION['Admission_Supervisor']['Session_Master_Priveleges'] = 'yes') {
								...
								?>
							<input type='hidden' id='Admission_Supervisor_ID' name='Admission_Supervisor_ID' value='<?php echo $_SESSION['Admission_Supervisor']['Employee_ID']; ?>'>
							<?php
						} else {
				...
				<td width='16%' style="text-align:right;">Admission Reason :</td><td>
					<select id='Admission_Reason_ID' name='Admission_Reason_ID' required='required' style='width:100%;padding: 5px'>
						<?php
				...
				<td width='16%' style="text-align:right;">Admission Type:</td><td>
					<select id='New_return_admission' name='New_return_admission' required='required' style='width:100%;padding: 5px; border:red;'>
                    
                            <?php 
                            $select_check_if_exist = mysqli_query($conn,"SELECT Registration_ID FROM  tbl_admission WHERE Registration_ID=$Registration_ID AND ward_room_id<>0");
                            
                                if(mysqli_num_rows($select_check_if_exist)>0){
                                ?> 
                                <option value=''></option>
	...
	<fieldset>
            <?php 
                ...
                $Kin_Name="";
                $Kin_Relationship="";
                $sql_select_kin_information_result=mysqli_query($conn,"SELECT Kin_Phone,Kin_Name,Kin_Relationship FROM tbl_admission WHERE Registration_ID='$Registration_ID' AND Admission_Status='Admitted'") or die(mysqli_error($conn));
                if(mysqli_num_rows($sql_select_kin_information_result)>0){
                    $kin_info_rows=mysqli_fetch_assoc($sql_select_kin_information_result);
                    $Kin_Phone=$kin_info_rows['Kin_Phone'];
                    $Kin_Name=$kin_info_rows['Kin_Name'];
                    $Kin_Relationship=$kin_info_rows['Kin_Relationship'];
                }
              ?>
		<table  width=100%>
			<tr>
				<td colspan=2><center><b>OFFICE/BUSSINESS/WORK ADDRESS</b></center></td>
			<td colspan=2><center><b style="color:red;font-size:14px">NEXT OF KIN NAME AND CONTACT<?= $Registration_ID ?></b></center></td>
			...
			<tr>
				...
				<td width='26%'><input type='text' id='Office_Area' name='Office_Area'></td>
                                ...
                                <td width='13%'style='text-align:right;'><b style="color:red;font-size:14px">Name :</b></td>
                                <td width='16%'><input type='text' id='Kin_Name' name='Kin_Name' value="<?= $Kin_Name ?>"required='required'></td>
			...
			<td><input type='text' id='Office_Plot_Number' name='Office_Plot_Number'></td>
                        ...
                        <td style='text-align:right;'><b style="color:red;font-size:14px">Relationship :</b></td>
                        <td><input type='text' id='Kin_Relationship' name='Kin_Relationship' value="<?= $Kin_Relationship ?>"required='required'></td>
			...
			<tr>
				...
				<td><input type='text' id='Office_Street' name='Office_Street'></td>
                                ...
                                <td style='text-align:right;'><b style="color:red;font-size:14px">Phone :</b></td>
                                <td><input type='text' id='Kin_Phone' name='Kin_Phone' value="<?= $Kin_Phone ?>" onkeyup="numberOnly(this)" required='required'></td>
			...
			<tr>
				...
				<td>
					<input type='text' id='Office_Phone' onkeyup="numberOnly(this)"  name='Office_Phone'>
					<input type='hidden' id='Ward_nature'   name='Ward_nature' value="">
				</td>
			...
			SELECT ToBe_Admitted_Reason FROM 
				...
				WHERE 
					...
					ToBe_Admitted = 'yes'
		";
			$ToBe_Admitted_Reason_qry = mysqli_query($conn,$ToBe_Admitted_Reason) or die(mysqli_error($conn));
			while ($tbar = mysqli_fetch_assoc($ToBe_Admitted_Reason_qry)) {
				$continuation_sheet = $tbar['ToBe_Admitted_Reason'];
			}
			?>	
			<tr>
				<td style='text-align:right;'>Continuation Sheet :</td>
				<td colspan="5">
					<textarea name="continuation_sheet" style="float:right; font-size:16px;" readonly="readonly" > <?php if (isset($continuation_sheet)) echo $continuation_sheet; ?></textarea>
				</td>
			</tr>
		</table>
	...
	<table width='100%'>
		<tr>
			...
			<td style='text-align:center'>
				...
				<input type='button' value='FOR MORTUARY ONLY'  class='art-button-green' onclick="Show_Morgue_Admit_Form()">
				<?php if (isset($_GET['Registration_ID'])) {
					?>
					<input type='button' value='PRINT WRISTBAND BARCODE' class='art-button-green' onclick="Print_Barcode_Payment()">
					<?php 
					 if($Can_admit_before_discharge=='no'){
					 
//					if($num_rows>0){
//						echo " <input type='button' value='ADMIT' class='art-button-green' onclick='admitexist()'>";
//					}else{
//						
//						echo " <input type='button' value='ADMIT' class='art-button-green' onclick='check_if_admited()'>";
//					}
					}else{
						echo " <input type='button' value='ADMIT' class='art-button-green' onclick='check_if_admited()'>";
					}
				...
				<?php } else {
					?>
					<input type='button' id='btnAdmit' value='ADMIT' class='art-button-green' onclick="alert('Choose Patient To Admit!');">
				<?php } ?>
			...
			<!-- ==================MORTUARY ===========================================================-->
	<div  style="display:none" id="morgue_form">
					...
					<table width=100%> 
						<tr> 
							...
							<td id='Ward_Area_'>
								...
								<select class="form-control" name='Hospital_Ward_ID' id='Hospital_Ward_ID_diseased' onchange="ward_nature_diseased(this.value)" >
									<option></option>
									 <?php
									if($Ward_suggested!==0){
										$Select_Department = mysqli_query($conn,"SELECT * FROM tbl_hospital_ward WHERE Hospital_Ward_ID='$Ward_suggested' AND ward_type='mortuary_ward'");
										while ($row = mysqli_fetch_array($Select_Department)) {
										$Ward_Name = $row['Hospital_Ward_Name'];
										$Hospital_Ward_ID = $row['Hospital_Ward_ID'];
                                                                                $Number_of_Beds = $row['Number_of_Beds'];
										...
										<?php
                                                                                ...
                                                                                $Select_Department = mysqli_query($conn,"SELECT * FROM tbl_hospital_ward WHERE ward_type='mortuary_ward'");
									} else if($Ward_suggested===0){
										//echo "<option selected='selected'></option>";
									  $Select_Department = mysqli_query($conn,"SELECT * FROM tbl_hospital_ward WHERE ward_type='mortuary_ward'");  
									}else{
	...
	//                                    $Select_Department = mysqli_query($conn,"SELECT * FROM tbl_hospital_ward");
								...
								<span id='bedNumber_M'>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="ward_room"  id="ward_room_diseased" onchange="get_ward_room_bed_diseased(this.value)">
                                                                 <option selected='selected'></option>
                                                                 <?php 
                                                                 $sql_select_ward_rooms=mysqli_query($conn,"SELECT *FROM tbl_ward_rooms WHERE ward_id='$Ward_suggested'") or die(mysqli_error($conn));
                                                                 if(mysqli_num_rows($sql_select_ward_rooms)>0){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="room_bed" id="room_bed_diseased" onchange="checkPatientNumber(this.value)">
                                                                 <option selected='selected'></option>
		...
		//                                    exit;
						...
						?>
                                                 <input type='text' hidden="hidden" id='Admission_Supervisor_ID' name='Admission_Supervisor_ID' value='<?php echo $_SESSION['userinfo']['Employee_ID']; ?>'>
						...
						<td width='16%' style="text-align:right;">Admission Reason :</td><td>
							<select id='Admission_Reason_ID' name='Admission_Reason_ID' required='required' style='width:100%;padding: 5px'>
								...
								?>
                                                ...
                                                <td>
                                                    <select id="new_sponsor"style="width:100%"name="new_sponsor_id">
                                                        <option value=""></option>
                                                        <?php 
			...
			<fieldset>
				<table  width='100%'>
					...
					<tr>
						...
						<td width='16%' ><input type='text' id='Corpse_Brought_By' name='Corpse_Brought_By' ></td>
						<td id='Police_Name1' style='text-align:right;'>Police Name</td>
						<td width='16%' ><input type='text'  id='Police_Name'name='Police_Name'></td>
					</tr>
					<tr>
						...
						<td width='16%' ><input type='text' id='Corpse_Kin_Relationship'  name='Corpse_Kin_Relationship' ></td>
						<td id='Police_Title1' style='text-align:right;'>Title :</td>
						<td width='16%' ><input type='text' id='Police_Title' name='Police_Title' ></td>
					...
					<!--span id="Nurse_On_Duty" style="display:none"-->
						...
						<td width='16%'><input type='text' id='Place_Of_Death' name='Place_Of_Death'></td>
					<!--/span-->
						<td id='Corpse_Kin_Phone1' style='text-align:right;'>Phone :</td>
						<td width='16%'><input type='text' id='Corpse_Kin_Phone' name='Corpse_Kin_Phone' onkeyup="numberOnly(this)" ></td>
						
						<td id='Police_Station1' style='text-align:right;'>Police Station :</td>
						<td width='16%' ><input type='text' id='Police_Station' name='Police_Station' ></td>
					...
					<tr>
						...
						<td   width='16%'><input type='text' id='Corpse_Kin_Address' name='Corpse_Kin_Address'></td>
						
						<td id='Police_No1' style='text-align:right;' >Police N<u>o</u> :</td>
						<td width='16%' ><input type='text'  id='Police_No'  name='Police_No' ></td>
					</tr>
					<tr>
						...
						<td width='16%'>
							...
							<option value="">---SELECT NURSE---</option>
								<?php
									$select_nurse = "SELECT * FROM  tbl_employee WHERE Employee_Type='Nurse'";
						...
						<td width='16%'  ><input type='text' id='Police_Phone'  name='Police_Phone' ></td>
					</tr>
					<tr>
						...
						<td width='16%'>
							...
							<input type='text'   disabled='disabled' value='<?php echo $Employee_Name; ?>'>
						</td>
						<td style='text-align:right;'></td>
						<td style='text-align:right;'></td>
						<td id='Police_Postal_Box1' style='text-align:right;'>Postal Box :</td>
						<td width='16%'  ><input type='text' id='Police_Postal_Box'  name='Police_Postal_Box' ></td>
					</tr>
					<tr>
						<td></td>
						<td></td>
						...
						<td width='16%'><input type='text' id='Police_Place'   name='Police_Place' ></td>
					</tr>
					<tr>
						<td></td>
						<td></td>
					...
					<tr>
						...
						<td width='16%'><input type='text' id='Postmortem_No'  name='Postmortem_No' ></td>
					</tr>
					<tr>
			...
			<table width='100%'>
				<tr>
					<td style='text-align:center'>
						<input type='button' value='FOR PATIENTS'  class='art-button-green' onclick="Show_Morgue_Admit_Form()">
						<input type='reset' value='CLEAR' class='art-button-green' >
...
<div id="Cancel_Admission_Confirm">
    ...
    <table width="100%">
        ...
        <tr>
            <td width="50%"><b>Patient Name : </b><?php echo ucwords(strtolower($Patient_Name)); ?></td>
            <td><b>Sponsor Name : </b><?php echo $Guarantor_Name; ?></td>
        </tr>
        <tr>
            <td width="50%"><b>Registration Number : </b><?php echo $Registration_ID; ?></td>
            <td><b>Member Number : </b><?php echo $Member_Number; ?></td>
        </tr>
        <tr>
            <td width="50%"><b>Patient Age : </b><?php echo $age; ?></td>
            <td><b>Employee Cancel : </b><?php echo ucwords(strtolower($Employee_Name)); ?></td>
        </tr>
        <tr><td colspan="4"><hr></td></tr>
        <tr>
...
<script>
 function validateForm(){
        var Hospital_Ward_ID=$("#Hospital_Ward_ID_diseased").val();
      //  var Other_Details=$("#Other_Details").val();
        ...
        var Corpse_Kin_Phone=$("#Corpse_Kin_Phone").val();
       ...
       // var Vehicle_No_In=$("#Vehicle_No_In").val();
        ...
        var room_bed=$("#room_bed_diseased").val();
        var ward_room=$("#ward_room_diseased").val();
        ...
        if(Hospital_Ward_ID==""){
            $('#Hospital_Ward_ID_diseased').focus();
            $("#Hospital_Ward_ID_diseased").css("border","3px solid red");
            return false;
        }else{
            $("#Hospital_Ward_ID_diseased").css("border",""); 
        }
//        if(Other_Details==""){
//            $('#Other_Details').focus();
...
//        }
        ...
        if(Corpse_Kin_Phone==""){
            $('#Corpse_Kin_Phone').focus();
            $("#Corpse_Kin_Phone").css("border","3px solid red");
            return false;
        }else{
            $("#Corpse_Kin_Phone").css("border",""); 
        }
...
//        }
        ...
        if(room_bed==""){
            $('#room_bed_diseased').focus();
            $("#room_bed_diseased").css("border","3px solid red");
            return false;
        }else{
            $("#room_bed_diseased").css("border",""); 
        }
        if(ward_room==""){
            $('#ward_room_diseased').focus();
            $("#ward_room_diseased").css("border","3px solid red");
            return false;
        }else{
            $("#ward_room_diseased").css("border",""); 
        }
        if(Date_Of_Death==""){
            $('#Date_Of_Death').focus();
...
<script>
    ...
    function admit() {
        ...
        var New_return_admission = document.getElementById('New_return_admission').value;
        if(New_return_admission==''){
            alert('Please admission Type.');
            $("#New_return_admission").css("border", "2px solid red");
            return false;
        }
        if (Hospital_Ward == '') {
...
<script type="text/javascript" language="javascript">
   ...
   function Get_Ward_Room_diseased(Hospital_Ward){
       $.ajax({
           type:'GET',
           url:'ward_room_selection_option.php',
           data:{ward_id:Hospital_Ward},
           success:function (data){
               $("#ward_room_diseased").html(data)
               $("#room_bed_diseased").html("")
           }
       });
   }
   ...
   function get_ward_room_bed_diseased(ward_room_id){
       var Hospital_Ward_ID=$("#Hospital_Ward_ID_diseased").val();
        $.ajax({
           type:'GET',
           url:'ward_bed_selection_option.php',
   ...
   function ward_nature_diseased(Hospital_Ward){
     ...
     if (window.XMLHttpRequest) {
         ...
         if(gender===data){
          Get_Ward_Room_diseased(Hospital_Ward);  
         } else if(gender!==data){
             if(data==='Both'){
              Get_Ward_Room_diseased(Hospital_Ward);   
             }else{
              alert('This patient cannot be admitted in the '+data+' ward');
              document.getElementById('bedNumber').innerHTML ='';
              document.getElementById('Hospital_Ward_ID_diseased').value ="";
              document.getElementById('Bed_ID').innerHTML ="<option selected='selected'></option>";
              return false;
             }
         }
...
<script>
 ...
 <script>
			...
			var winClose = popupwindow('barcode_admission/BCGcode39.php?Registration_ID=<?php echo $Registration_ID; ?>&Hospital_Ward='+Hospital_Ward+'&Bed_ID='+Bed_ID+'&LaboratoryTestSpecimenBacodedThisPage=ThisPage', 'Print Barcode', 330, 230);
                //winClose.close();
...
<script type="text/javascript" language="javascript">
    // function filterCase(that) {
        // if (that.value == "hospital") {
            // alert("check");
            // document.getElementById("Nurse_On_Duty").style.display = "table-cell";
            // document.getElementById("Nurse_On_Duty1").style.display = "table-cell";
            // document.getElementById("Death_Certificate").style.display = "table-cell";
            // document.getElementById("Death_Certificate1").style.display = "table-cell";
			// document.getElementById("Police_Phone").style.display = "none";
			// document.getElementById("Police_No").style.display = "none";
            // document.getElementById("Police_Phone1").style.display = "none";
			// document.getElementById("Police_No1").style.display = "none";
			// document.getElementById("police_case").style.display = "none";
			// document.getElementById("Police_Name").style.display = "none";
			// document.getElementById("Police_Name1").style.display = "none";
			// document.getElementById("Police_Postal_Box").style.display = "none";
			// document.getElementById("Police_Postal_Box1").style.display = "none";
			// document.getElementById("Police_Place").style.display = "none";
			// document.getElementById("Police_Place1").style.display = "none";
			// document.getElementById("Postmortem_Done_By").style.display = "none";
			// document.getElementById("Postmortem_Done_By1").style.display = "none";
			// document.getElementById("Postmortem_No").style.display = "none";
			// document.getElementById("Postmortem_No1").style.display = "none";
			// document.getElementById("Police_Title").style.display = "none";
			// document.getElementById("Police_Title1").style.display = "none";
			// document.getElementById("Police_Station").style.display = "none";
			// document.getElementById("Police_Station1").style.display = "none";
			// document.getElementById("home_case").style.display = "none";
			// document.getElementById("Corpse_Kin_Phone").style.display = "none";
			// document.getElementById("Corpse_Kin_Phone1").style.display = "none";
			// document.getElementById("Corpse_Kin_Relationship").style.display = "none";
			// document.getElementById("Corpse_Kin_Relationship1").style.display = "none";
			// document.getElementById("Corpse_Brought_By").style.display = "none";
			// document.getElementById("Corpse_Brought_By1").style.display = "none";
			// document.getElementById("Corpse_Kin_Address").style.display = "none";
			// document.getElementById("Corpse_Kin_Address1").style.display = "none";
        // } else if (that.value == "police")
		// {//alert("check");
            // document.getElementById("Police_Phone").style.display = "table-cell";
			// document.getElementById("Police_No").style.display = "table-cell";
            // document.getElementById("Police_Phone1").style.display = "table-cell";
			// document.getElementById("Police_No1").style.display = "table-cell";
			// document.getElementById("police_case").style.display = "table-cell";
			// document.getElementById("Police_Name").style.display = "table-cell";
			// document.getElementById("Police_Name1").style.display = "table-cell";
			// document.getElementById("Police_Postal_Box").style.display = "table-cell";
			// document.getElementById("Police_Postal_Box1").style.display = "table-cell";
			// document.getElementById("Police_Place").style.display = "table-cell";
			// document.getElementById("Police_Place1").style.display = "table-cell";
			// document.getElementById("Postmortem_Done_By").style.display = "table-cell";
			// document.getElementById("Postmortem_Done_By1").style.display = "table-cell";
			// document.getElementById("Postmortem_No").style.display = "table-cell";
			// document.getElementById("Postmortem_No1").style.display = "table-cell";
			// document.getElementById("Police_Title").style.display = "table-cell";
			// document.getElementById("Police_Title1").style.display = "table-cell";
			// document.getElementById("Police_Station").style.display = "table-cell";
			// document.getElementById("Police_Station1").style.display = "table-cell";
			// document.getElementById("Nurse_On_Duty").style.display = "none";
			// document.getElementById("Nurse_On_Duty1").style.display = "none";
            // document.getElementById("Death_Certificate").style.display = "none";
            // document.getElementById("Death_Certificate1").style.display = "none";
			// document.getElementById("home_case").style.display = "none";
			// document.getElementById("Corpse_Kin_Phone").style.display = "none";
			// document.getElementById("Corpse_Kin_Phone1").style.display = "none";
			// document.getElementById("Corpse_Kin_Relationship").style.display = "none";
			...
			// document.getElementById("Corpse_Kin_Address").style.display = "none";
			// document.getElementById("Corpse_Kin_Address1").style.display = "none";
        // } else if (that.value == "home"){
			// document.getElementById("home_case").style.display = "table-cell";
			// document.getElementById("Corpse_Kin_Phone").style.display = "table-cell";
			// document.getElementById("Corpse_Kin_Phone1").style.display = "table-cell";
			// document.getElementById("Corpse_Kin_Relationship").style.display = "table-cell";
			// document.getElementById("Corpse_Kin_Relationship1").style.display = "table-cell";
			// document.getElementById("Corpse_Brought_By").style.display = "table-cell";
			// document.getElementById("Corpse_Brought_By1").style.display = "table-cell";
			// document.getElementById("Corpse_Kin_Address").style.display = "table-cell";
			// document.getElementById("Corpse_Kin_Address1").style.display = "table-cell";
            // document.getElementById("Police_Phone").style.display = "none";
			// document.getElementById("Police_No").style.display = "none";
            // document.getElementById("Police_Phone1").style.display = "none";
			// document.getElementById("Police_No1").style.display = "none";
