<?php
    ...
    $filter = "pp.Payment_Date_And_Time between '$Start_Date' and '$End_Date' and ppl.Item_ID = '$Item_ID' and ";
   ...
   $finance_department_name=mysqli_fetch_assoc($sql_select_finance_department_name_result)['finance_department_name']; 
    ...
    if($Patient_Type == 'Inpatient'){
        ...
        if(strtolower($Section) == 'cash'){
            ...
            $filter .= "((Billing_Type = 'Outpatient Cash'nd Pre_Paid = '0') or Billing_Type = 'Outpatient Credit') and Transaction_status <> 'cancelled' and ";
        }
    }else{
        if(strtolower($Section) == 'cash'){
...
//            $filter .= "Transaction_status <> 'cancelled' and ";
	...
	$htm .= '<center><table width="100%">
                ...
                <tr><td style="text-align: center;"><span style="font-size: x-small;">ITEM NAME : '.$Product_Name.'</span></td></tr>
    ...
    $htm .= '</td></tr> '
            ...
            . '<tr><td style="text-align: center;"><span style="font-size: x-small;">DEPARTMENT NAME : '.strtoupper($finance_department_name).'</span></td></tr></table></center><br/>';


    if(strtolower($Section) == 'cashcredit'){
        include("./General_Cash_Credit_Item_Report.php");
    }else if(strtolower($Section) == 'cash'){
        
      include("./General_Cash_Item_Report.php");
     
    }else if(strtolower($Section) == 'credit'){
        include("./General_Credit_Item_Report.php");
    }else if(strtolower($Section) == 'cancelled'){
        include("./General_Cancelled_Item_Report.php");
    }else{
        include("./General_Credit_Item_Report.php");
    }
