...
<!--    Datepicker script-->
	...
	function Search_Receipt_Number(Receipt_No) {
		...
		document.getElementById('Edit_Receipt').innerHTML = "<iframe width='100%' height=400px src='edit_patient_direct_cash_billing_iframe.php?Receipt_No="+Receipt_No+"'></iframe>";
	    }
	}
    </script>
...
<fieldset>
    <legend align="right"><b>Edit Direct Cash Receipt</b></legend>
...
<br>
	...
	<center>
            <table width=100% border=1>
                <tr>
                    <td id="Edit_Receipt">
                        <iframe width='100%' height=400px src="edit_patient_direct_cash_billing_iframe.php?Branch=<?php echo $Branch; ?>&Date_From=<?php echo $Date_From; ?>&Date_To=<?php echo $Date_To; ?>&Insurance=<?php echo $Insurance; ?>&Patient_Name =<?php echo $Patient_Name; ?>"></iframe>
                    </td>
                </tr>
            </table>
        </center>
