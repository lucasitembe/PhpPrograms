<?php
	...
	if($Employee_ID != '' && $Payment_Item_Cache_List_ID != '' && $consultation_ID != 0){
	    ...
	    if($Temp_ID == 'Anal_lessor'){
        	...
        	$sql = "update tbl_ogd_post_operative_notes set Hepatic_Flexure = '$Temp_Data' where Ogd_Post_operative_ID = '$Ogd_Post_operative_ID'";
        }else if($Temp_ID == 'Ascending_Colon'){
        	$sql = "update tbl_ogd_post_operative_notes set Ascending_Colon = '$Temp_Data' where Ogd_Post_operative_ID = '$Ogd_Post_operative_ID'";
        }else if($Temp_ID == 'Caecum'){
        	$sql = "update tbl_ogd_post_operative_notes set Caecum = '$Temp_Data' where Ogd_Post_operative_ID = '$Ogd_Post_operative_ID'";
        }else if($Temp_ID == 'Terminal_Ileum'){
        	$sql = "update tbl_ogd_post_operative_notes set Terminal_Ileum = '$Temp_Data' where Ogd_Post_operative_ID = '$Ogd_Post_operative_ID'";
