...
if (isset($_POST['process_procedure'])) {
    ...
    echo "<script type='text/javascript'>
                                ...
                                window.location='pendingproceduredocotorpatientinfo.php?" . $queryString . "'
                            </script>";
}
...
?>
<a href='searchpatientpendingproceduredoctorlist.php?<?php echo $section ?>' class='art-button-green'>
    BACK
</a>
<?php
