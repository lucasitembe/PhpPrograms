...
?>
            ...
            $html.="<fieldset>";
            $html.="<legend><b>".$Doctor_Name." Clinic Performance Report From ".date('j F,Y H:i:s',strtotime($_GET['Date_From']))." TO ".date('j F,Y H:i:s',strtotime($_GET['Date_To']))."</b></legend>";
            $html.= "<center>";
