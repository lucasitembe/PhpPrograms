...
<script type="text/javascript">
    function Save_Information(){
        ...
        if(Consultation_ID != null && Consultation_ID != '' && Admision_ID != null && Admision_ID != '' && Assessment != null && Assessment != '' &&  Nursing_Diagnosis != null && Nursing_Diagnosis != '' &&  Goal != null && Goal != '' &&  Nursing_Interverntion != null && Nursing_Interverntion != '' && Evaluation != null && Evaluation != ''){
            ...
            myObjectSave.open('GET','Save_out_Patient_Progress_Info.php?Consultation_ID='+Consultation_ID+'&Admision_ID='+Admision_ID+'&Assessment='+Assessment+'&Nursing_Diagnosis='+Nursing_Diagnosis+'&Goal='+Goal+'&Nursing_Interverntion='+Nursing_Interverntion+'&Evaluation='+Evaluation+'&Registration_ID='+Registration_ID,true);
            myObjectSave.send();
        }
    }
</script>
...
<script type="text/javascript">
    function Update_Buttons(){
        ...
        myObjectUpdate.open('GET', 'outPatient_Progress_Update_Button.php?Registration_ID='+Registration_ID+"&Admision_ID="+Admision_ID, true);
        myObjectUpdate.send();
    }
</script>
...
<script type="text/javascript">
    function Preview_Information(){
        ...
        var Admision_ID = '<?php echo $Admision_ID; ?>';
        var consultation_ID = '<?php echo $Consultation_ID; ?>';
        window.open("outpatientprogresspreview.php?Registration_ID="+Registration_ID+"&Admision_ID="+Admision_ID+"&Consultation_ID="+consultation_ID+"&Employee_ID="+Employee_ID+"&PatientProgressReport=PatientProgressReportThisPage","_blank");
    }
</script>
...
<script type="text/javascript">
    function Preview(){
        ...
        myObjectPreview.open('GET', 'outPatient_Progress_Preview.php?Registration_ID='+Registration_ID+"&Admision_ID="+Admision_ID+"&Consultation_ID="+Consultation_ID, true);
...
<script type="text/javascript">
    function Preview_General_Report(){
        ...
        var Admision_ID = '<?php echo $Admision_ID; ?>';
        var Registration_ID = '<?php echo $Registration_ID; ?>';
        window.open("outpatientprogressgeneralreport.php?Registration_ID="+Registration_ID+"&Admision_ID="+Admision_ID+"&Consultation_ID="+Consultation_ID+"PatientProgressGeneralReport=PatientProgressGeneralReportThisPage","_blank");
    }
</script>
