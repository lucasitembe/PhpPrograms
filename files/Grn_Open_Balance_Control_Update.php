<?php
    ...
    if(isset($_GET['GetGrnNumber'])){
        ...
        if($Sub_Department_ID != 0 && $Sub_Department_ID != null && $Employee_ID != 0 && $Employee_ID != null){
            ...
            $select_Grn_Open_Balance_ID = mysqli_query($conn,"select Grn_Open_Balance_ID from tbl_grn_open_balance where
        ...
        if($Sub_Department_ID != 0 && $Sub_Department_ID != null && $Employee_ID != 0 && $Employee_ID != null){
            ...
            if($num > 0){
                ...
                if(isset($_GET['Grn_Description'])){
                    //update description
                    mysqli_query($conn,"update tbl_grn_open_balance set Grn_Open_Balance_Description = '$Grn_Description'
