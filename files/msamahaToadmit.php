...
<?php
    if(isset($_POST['submittedAddNewMsamahaPatientForm'])){
        ...
        $Patient_Middle_Name = mysqli_real_escape_string($conn,$_POST['Patient_Middle_Name']);
...
<?php	}else{
		...
		if(!mysqli_query($conn,$Insert_Sql)){
		    ...
		    $statusReg='';
			    ...
			    document.location = './admissionvisitorformMsamaha.php?Registration_ID=".$Registration_ID."&VisitorForm=VisitorFormThisPage';
			    </script>";
		}
	}
    }
...
?>
 <!--<a href='msamahalist2.php?RegisteredPatient=RegisterPatientThisPage' class='art-button-green'>
    ...
    <a href='registeredtoadmit.php?RegisteredPatient=RegisterPatientThisPage' class='art-button-green'>
      BACK
    </a>
      ...
      <fieldset style="width:92%;">
          ...
          <table width=100%>
               ...
               <tr>
                   ...
                   <td width="40%"> <input type='text' name='Jina_la_anayehadhimisha' required id='Jina_la_anayehadhimisha' >
                   </td>
              </tr>
             
               <tr>
                   <td style="text-align:right;"><b style='color: red'>Cheo</b></td>
                   <td width="40%"><input type='text' name='cheo_anayehadhimisha' id='cheo' required ></td>
              </tr>
              <tr>
                   <td style="text-align:right;"><b style='color: red'>Sahihi</b></td>
          ...
          <table width=100%>
               <tr>
                 <td colspan=2 style='text-align:center; ' width="40%">
                                    <input type='submit' name='submit' id='submit' value='   SAVE   ' class='art-button-green' onclick="return Validate_Date()">
