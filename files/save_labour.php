...
if (isset($_POST['action'])) {
    if ($_POST['action'] == 'save') {
        ...
        $insert = mysqli_query($conn,"INSERT INTO tbl_labour (admitted_from,reffered_from,danger_signs,patient_ID,partner_name,gravida,parity,current_children,abortion,lnmp,edd,ga,obste_history_1,obste_history_2,obste_history_3,visits,IPT_doses,TT_doses,ITN_doses,bloodgroup,last_Hb,pmtct,art,vdrl,labour_onset,membranes_rapture,fetal_mvt,general,pulse_rate,rufaasababu,maoni,date_time)
        VALUES ('$admitted_from','$reffered_from','$danger_signs','$patient_ID','$partner_name','$gravida','$parity','$current_children','$abortion','$lnmp','$edd','$ga','$obste_history_1','$obste_history_2','$obste_history_3','$visits','$IPT_doses','$TT_doses','$ITN_doses','$bloodgroup','$last_Hb','$pmtct','$art','$vdrl','$labour_onset','$membranes_rapture','$fetal_mvt','$general','$pulse_rate','$rufaasababu','$maoni','$today')");
        if ($insert) {
