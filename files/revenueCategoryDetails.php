...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['General_Ledger'] == 'yes'){ 
?>
    <a href='./revenueCategory.php?categoryID=<?php echo $_GET['categoryID'];?>FinanceWork=FinanceWorkThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<table width=100%>
		...
		<?php
			...
			if(isset($_GET['categoryID'])){
			 //echo $categoryID=$_POST['categoryID']."<br>";
...
<fieldset>  
            <legend align=center><b>REVENUE SUMMARY FOR <?php echo "<b style='color: blue;font-size:14px;'>".$category_Name."</b>";?> CATEGORIES</b></legend>
        <center>
            <?php
    ...
    $filterRevenue = mysqli_query($conn,"
				    SELECT *
				    FROM tbl_patient_registration pr, tbl_patient_payments pp,tbl_sponsor sp,tbl_branches br, tbl_patient_payment_item_list ppl, tbl_items it, tbl_item_subcategory isc, tbl_item_category ic
				    ...
				    AND pp.branch_id=br.Branch_ID AND
				    pp.Sponsor_ID=sp.Sponsor_ID AND
				    ic.Item_Category_ID ='$catID'
