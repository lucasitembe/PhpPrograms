...
?>
    <a href='revenuecenterothersUnpaidlist.php' class='art-button-green'>
        BACK
    </a>
<?php } } ?>
		...
		<tr>
			...
			<?php if(isset($_GET['Sub_Department_ID'])) { $Sub_Department_ID = $_GET['Sub_Department_ID']; }else{ $Sub_Department_ID = 0; } ?>
                        <div id="patientItemsList" style='height:200px;overflow-y:scroll;overflow-x:hidden'>
                            ...
                            <?php include "Patient_Billing_Unpaid_Others_Iframe.php";?>
                        </div>
                        </form>
    ...
    function Make_Payment_Laboratory() {
       ...
       // var datastring=$("form#saveDiscount").serialize();
        ...
        if (Confirm_Message == true) {
           document.location = 'Patient_Billing_Others_Page.php?Transaction_Type=<?php echo $Transaction_Type; ?>&Payment_Cache_ID=<?php echo $Payment_Cache_ID; ?>&Sub_Department_ID=<?php echo $Sub_Department_ID; ?>';
        }
    }
