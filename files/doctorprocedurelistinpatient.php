...
<fieldset style='margin-top:30px;'>
    <legend id="resultsconsultationLablist" style="font-weight: bold;font-size: 16px;background-color: #006400; padding:10px; color:white;width: auto;" align="right">MY PROCEDURE PATIENTS LIST</legend>
    <center>
        <hr width="100%">
    </center>
            ...
            <tr>
                <td id='Search_Iframe'>
                    <div id="iframeDiv" style="height: 460px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'proceduredoctorlistinpatient_iframe.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
if(isset($_GET['Section']) && $_GET['Section']=='Doctor'){
    ...
    $section="sectionpatnt=doctor_with_patnt&Registration_ID=".$_GET['Registration_ID']."&consultation_ID=".$_GET['consultation_ID']."&item_ID=". $_GET['item_ID']."&";
        ...
        echo '<a href="searchpatientpendingproceduredoctorlistinpatient.php?'.$section.'" class="art-button-green">PENDING / NOT APPLICABLE PROCEDURES</a>';
   ?>
</center> 
