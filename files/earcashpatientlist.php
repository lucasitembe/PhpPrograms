...
<script language="javascript" type="text/javascript">
    function seaearPatient(Patient_Name){
        document.getElementById('Seaear_Iframe').innerHTML = "<iframe width='100%' height=320px src='earcashpatientlist_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
...
<fieldset>  
            <legend align=center><b>EAR CASH PATIENT LIST</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Seaear_Iframe'>
		<iframe width='100%' height=320px src='earcashpatientlist_Iframe.php?Patient_Name='></iframe>
            </td>
        </tr>
            </table>
        </center>
