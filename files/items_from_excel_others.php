...
?>
<a href="items_from_excel_others.php" class="art-button-green">BACK</a>
<br/>
<br/>
<br/>
<div class="row">
            ...
            <div class="panel-body">
                <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control"name='Item_Classification' id='Item_Classification' required='required'>
...
<script>
    ...
    function validate_input(){
      ...
      if(Item_Classification==""){
          $("#Item_Classification").css("border","2px solid red");
      }else{
          $("#Item_Classification").css("border","");
      }
      if(item_type==""){
      ...
      if(excel_file!=""&&consultation_type!=""&&item_sub_category!=""&&Item_Category_ID!=""&&item_type!=""&&Item_Classification!=""){
   ...
   include("PHPExcel/IOFactory.php");
	...
	foreach($objPHPExcel->getWorksheetIterator()as $worksheet){
		...
		for($row=1;$row<=$highestRow;$row++){
            $Product_Code=mysqli_real_escape_string($conn,$worksheet->getCellByColumnAndRow(0,$row)->getValue());
			$Product_Name=mysqli_real_escape_string($conn,$worksheet->getCellByColumnAndRow(1,$row)->getValue());
			$Unit_Of_Measure=mysqli_real_escape_string($conn,$worksheet->getCellByColumnAndRow(2,$row)->getValue());
		...
		//check if the item with the same name exist
                ...
                if(mysqli_num_rows($sql_select_item_result)>0){
                    ...
                    $sql_insert_item_price1="INSERT INTO tbl_item_price(Item_ID,Items_Price,last_updated_by) VALUES('$Item_ID','$item_price','$Employee_ID') ON DUPLICATE KEY UPDATE Items_Price='$item_price',last_updated_by='$Employee_ID'";
                    $sql_insert_item_price_result1=mysqli_query($conn,$sql_insert_item_price1) or die(mysqli_error($conn));
                     ...
                     $sql_insert_items_result=mysqli_query($conn,"INSERT INTO tbl_items(Classification,Unit_Of_Measure,Product_Code,Item_Type,Product_Name,Item_Subcategory_ID,Consultation_Type) VALUES('$Item_Classification','$Unit_Of_Measure','$Product_Code','$item_type','$Product_Name','$item_sub_category','$consultation_type')") or die(mysqli_error($conn));  
                }
               ...
               if($sql_insert_items_result){
                        ...
                        $sql_insert_item_price="INSERT INTO tbl_item_price(Item_ID,Items_Price,last_updated_by) VALUES('$Item_ID','$item_price','$Employee_ID') ON DUPLICATE KEY UPDATE Items_Price='$item_price',last_updated_by='$Employee_ID'";
