...
<fieldset>
    <legend align='center'><b>LIST OF COMPLETE TRANSACTION WITH NO RECEIPT</b></legend>
    <center>
        <table>
            <tr>
    ...
    <div class="box box-primary" style="height: 400px;overflow-y: scroll;overflow-x: hidden">
        <table class="table">
            <tr>
                ...
                <td><b>Payed Reference/Sangila Number</b></td>
                <td><b>Banck Reference Number</b></td>
                <td><b>Amount</b></td>
                <td><b>Gender</b></td>
                <td><b>Sponsor</b></td>
                <td><b>Sent Date</b></td>
...
<script>
    function filter_list_of_patient_sent_to_cashier(){
        ...
        $.ajax({
            type:'POST',
            url:'ajax_banck_complete_pending_transaction.php',
