...
if (isset($_SESSION['userinfo'])) {
    if ($_SESSION['userinfo']['Doctors_Page_Outpatient_Work'] == 'yes') {
        ?>
<a href='./doctorspageinpatientwork.php?<?php echo $_SERVER['QUERY_STRING'] ?>' class='art-button-green'>
            BACK
        </a>
    <?php
    }
        ...
        <table width="100%" align="center">
            <tr>
                <td style="text-align: center">
                    ...
                    <input type="text" name="Patient_Name" id="Patient_Name" value="" style="text-align: center;width:35%;display:inline" placeholder="~~~~~~~~~~~~~~~~~~~Search Patient Name~~~~~~~~~~~~~~~~~~" oninput="filterPatient()"  />
                </td>
            </tr>
        </table>
    </center>
...
<?php include 'laboratoryresultsinpatient_Iframe.php'; ?>
                    </div>
...
<script>
    function filterPatient() {
        ...
        $.ajax({
            type: 'GET',
            url: 'laboratoryresultsinpatient_Iframe.php',
