...
<?php
    ...
    foreach($Return_Inward_Item_List as $Return_Inward_Item) {
        ...
        echo "<td> <input type='text'
                            ...
                            onkeypress=\"numberOnly(this); Update_Quantity_Returned(this.value,{$Return_Inward_Item['Inward_Item_ID']})\"
                            onkeyup=\"numberOnly(this); Update_Quantity_Returned(this.value,{$Return_Inward_Item['Inward_Item_ID']})\" />
                            </td>";

        echo "<td> <input type='text'
                            id='Item_Remark_{$Return_Inward_Item['Inward_Item_ID']}'
                            value='{$Return_Inward_Item['Item_Remark']}'
                            onkeypress=\"Update_Item_Remark(this.value,{$Return_Inward_Item['Inward_Item_ID']})\"
                            onkeyup=\"Update_Item_Remark(this.value,{$Return_Inward_Item['Inward_Item_ID']})\" />
                            </td>";

        echo "<td> <input type='button' name='Remove_Item' id='Remove_Item' value='X' class='art-button-green'
                            onclick='Confirm_Remove_Item(\"{$Return_Inward_Item['Product_Name']}\", {$Return_Inward_Item['Inward_Item_ID']})' />  </td>";
