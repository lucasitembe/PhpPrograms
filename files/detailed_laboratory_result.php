...
if(isset($_SESSION['userinfo'])){
    ...
    {
        echo "<a href='laboratory_result_details.php?Registration_ID=".$_GET['patient_id']."&Status_From=".filter_input(INPUT_GET, 'Status_From')."&Patient_Payment_ID=".filter_input(INPUT_GET,'payment_id')."&LaboratoryResultThisPage=ThisPage' class='art-button-green'>BACK</a>";
    }
    $already = false;                                                                                     }
...
<!--                </td>-->
                <td colspan="4" style="width:100%;padding-bottom:10px;padding-top:5px;font-weight:bold;font-size:16px;color:blue;">
                    <center>LABORATORY RESULTS</center>
                </td>
            </tr>
            <tr>
                <td colspan="4"><hr></td>
...
<!--            </tr>-->
            <tr bgcolor='#037cb0'>
                <td style='text-align: left;color: #ffffff;font-size: 14px;font-weight: bold'>
                    <?php echo $disp2['Product_Name']; ?>
                </td>
            </tr>
            <tr>
                    ...
                    <div   style="overflow-y:scroll;overflow-x:hidden;width:100%;height:350px;background-color:white;border:1px solid black;">
                        <table  border="0"  style="width:100%;margin-left:0px;margin-top:0px;margin-bottom:0px;border:1px solid #ccc;" class="hiv_table">
                            <tr  bgcolor="#eee">
                                ...
                                <th style="font-size:13px;">Validated By</th>
                            </tr>
...
tp.Lower_Value,tp.Operator,tp.Higher_Value "
                 ...
                 where Laboratory_Parameter_ID='".$disp['Laboratory_Parameter_ID']."' and Payment_Cache_ID='".filter_input(INPUT_GET, 'payment_id')."' and Item_ID='".filter_input(INPUT_GET, 'Item_ID')."'");
                            ...
                            <form name="" action="laboratory_result_process.php?pagename=results&Status_From=<?php echo filter_input(INPUT_GET, 'Status_From'); ?>&submited=submited&paymet_id=<?php echo filter_input(INPUT_GET, 'payment_id');
                            ...
                            ?>&Item_ID=<?php echo filter_input(INPUT_GET, 'Item_ID'); ?>" method="POST">
                                <tr bgcolor="#eee">
                                    ...
                                    <td style="color:blue;border:1px solid #ccc;"><?php echo $Laboratory_Parameter_Name; ?>
                                        <input disabled="disabled" name="Laboratory_Parameter_ID[]" value="<?php echo $Laboratory_Parameter_ID; ?>" type="hidden"></td>
                                    <td style="color:blue;border:1px solid #ccc;text-align:center;"><input name="Laboratory_Result[]" type="text" value="<?php if(isset($disp1)){ echo $Laboratory_Result;} ?>" readonly="readyonly "></td>
                                    <td style="color:blue;border:1px solid #ccc;text-align: center;"><?php echo $Unit_Of_Measure; ?></td>
            ...
            <a href='laboratory_result_modification_details.php?Status_From=".$_GET['Status_From']."&payment_id=".$_GET['payment_id']."&details_for=modification&Laboratory_Parameter_ID=".$Laboratory_Parameter_ID."&Item_ID=".$_GET['Item_ID']."&patient_id=".filter_input(INPUT_GET, 'patient_id')."'  style='color:red;'>M</a></span>";
        ...
        JOIN tbl_employee as e ON e.Employee_ID =s.Employee_ID
         where Patient_Cache_Results_ID='".$Patient_Payment_Result_ID."'");
                                    ...
                                    <td style="color:blue;border:1px solid #ccc;width:60px; text-align: center;"><center><?php if(isset($disp1) & isset($Laboratory_Result)){
                                    ...
                                    <td style="color:blue;border:1px solid #ccc;width:200px;text-align: center;"
                                        ><?php
            ...
            //                                //this is a modification,in any case change to the commented link below
            //                                echo "<a href='laboratory_result_modification_details.php?Status_From=".$_GET['Status_From']."&payment_id=".$_GET['payment_id']."&details_for=modification&Laboratory_Parameter_ID=".$Laboratory_Parameter_ID."&Item_ID=".$_GET['Item_ID']."&patient_id=".filter_input(INPUT_GET, 'patient_id')."'  style='color:blue;'>".$row5['Result_Datetime']."</a>";
            //                                //echo"<a href='laboratory_result_modification_details.php?Laboratory_Parameter_ID=".$Laboratory_Parameter_ID."&Item_ID=".filter_input(INPUT_GET, 'Item_ID')."&patient_id=".filter_input(INPUT_GET, 'patient_id')."'>".$row5['Result_Datetime']."(".$row5['Laboratory_Result'].")</a>";
            //                            }else{
            ...
            $select_madification_status =mysqli_query($conn,"SELECT *
              ...
              WHERE Patient_Payment_Result_ID = '".$Patient_Payment_Result_ID."' and Laboratory_Parameter_ID ='".$Laboratory_Parameter_ID."'");
                                                ...
                                                if($num> 0){
                                                    echo "<span style='color:red;''>
            <a href='laboratory_result_modification_details.php?Status_From=".$_GET['Status_From']."&payment_id=".$_GET['payment_id']."&details_for=modification&Laboratory_Parameter_ID=".$Laboratory_Parameter_ID."&Item_ID=".$_GET['Item_ID']."&patient_id=".filter_input(INPUT_GET, 'patient_id')."'  style='color:blue;'>Click To View</a></span>";
                                                    //echo '<span style="color:red;">M</span>';
                                                }else{
                                                    echo "No Previous Results";
                                                }
                                    ...
                                    <td style="width:150px;font-size:14px;text-align: center">
                                        ...
                                        if(mysqli_num_rows($sql8) > 0){
                                            ...
                                            echo "<span style='color:#037cb0;'>". $row['Employee_Name'];
                                        }else{
                                            ?>
                                            <input name="" disabled="disabled" type="checkbox" onchange="validateResult('<?php echo $Patient_Payment_Result_ID; ?>','<?php echo $Employee_ID; ?>','<?php echo $Laboratory_Parameter_ID; ?>')">
                                        <?php
                                        }
                                        ?>
                                    </td>
...
//                }else{
//                    ?>
<!--                    <td><a href="laboratory_results_validation.php?Status_From=--><?php
...
//                }
//                ?>
<!--                <td colspan="4" width="100%" style="text-align:right;border-bottom:1px solid black;padding-bottom:4px;">-->
<!--                    --><?php
//                    // if(isset($Results_values)){
//                    //  echo '<input name="Submit" value="Update Results" type="submit">';
//                    // }else{
//                    echo '<input name="Submit" value="Submit Results" type="submit">';
//                    // }
//                    ?>
<!--                </td>-->
<!--            </tr>-->
            ...
            <tr>
              ...
              WHERE Patient_Payment_Result_ID = '".$Patient_Payment_Result_ID."' and Laboratory_Parameter_ID ='".$Laboratory_Parameter_ID."'");
                                                $num = mysqli_num_rows($select_madification_status);
                                                if($num> 0){
                                                    echo "<b style='color:red'>Click Later M Above To View Result Modification</b>";
                                                }
                    ?>
                </td>
            </tr>
