...
//  
        ...
        if ($_GET['position'] == 'out') {
            ...
            echo "<a href='Patientfile_Record_Detail.php?Registration_ID=" . $_GET['Registration_ID'] . "&consultation_ID=" . $_GET['consultation_ID'] . "&item_ID=" . $GET['item_ID'] . "' class='art-button-green'>BACK</a>";
        }
    }
