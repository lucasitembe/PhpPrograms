...
<fieldset>
	...
	$female=$row['female'];
        echo "<tr><td>".($i+1)."</td>";
        echo "<td><a href='patientsRevisitedPreviousDaysDetails.php?sponsorID=$sponsorID&SponsorDetails=SponsorDetailsThisPage' target='_blank'>".$row['Guarantor_Name']."</a></td>";
                        ...
                        <table>
                            <tr>
                                <td style='text-align: center;border: 0'>
                                    <a href="revisitedMultipleBarChart.php" target="_blank">
                                        <button>
