...
<?php
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        echo "<td width=4%><a href='previousreagentrequisition.php?Requisition_ID=".$row['Requisition_ID']."&PreviousReagentsRequisition=PreviousReagentsRequisitionThisPage' class='art-button-green' target='_blank'>&nbsp;&nbsp;&nbsp;Preview Requisition&nbsp;&nbsp;&nbsp;</a></td></tr>";
        $temp++;
    }
?>
</table>