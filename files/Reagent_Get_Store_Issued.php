 <?php
    ...
    if($Requisition_ID != 0){
        $select_store_issue = mysqli_query($conn,"select Store_Issue from tbl_reagents_requisition where Requisition_ID = '$Requisition_ID'") or die(mysqli_error($conn));
    ...
    if($no > 0){
        ...
        $select_department = mysqli_query($conn,"select * from tbl_sub_department where
