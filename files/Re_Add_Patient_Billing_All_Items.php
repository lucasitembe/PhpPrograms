<?php
	...
	$update = mysqli_query($conn,"update tbl_item_list_cache set ePayment_Status = 'pending' where Payment_Item_Cache_List_ID = '$Payment_Item_Cache_List_ID'") or die(mysqli_error($conn));
?>
