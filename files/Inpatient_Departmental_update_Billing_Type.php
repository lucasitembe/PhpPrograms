<?php
    ...
    //get sponsor name 
    $select = mysqli_query($conn,"select Guarantor_Name from tbl_patient_registration pr, tbl_sponsor s where
...
?>
        <select name="Billing_Type" id="Billing_Type">
            <option selected="selected">Inpatient Cash</option>
        </select>
<?php
        }else{
?>
            <select name="Billing_Type" id="Billing_Type">
                <option selected="selected">Inpatient Credit</option>
