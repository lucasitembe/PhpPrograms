...
if (isset($_POST['action'])) {
    if ($_POST['action'] == 'save') {
        ...
        $date_TT1date = date_format(date_create($TT1date),'Y-m-d');
        $date_TT2date = date_format(date_create($TT2date),'Y-m-d');
        $date_rufaa = date_format(date_create($rufaatarehe),'Y-m-d');
        // $date_rufaa = date_format(date_create($rufaatarehe),'Y-m-d');
        // $date_rufaa = date_format(date_create($rufaatarehe),'Y-m-d');
