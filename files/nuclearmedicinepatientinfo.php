...
if (isset($_POST['process_procedure'])) {
    ...
    echo "<script type='text/javascript'>
            ...
            window.location='nuclearmedicinepatientinfo.php?" . $queryString . "'
        </script>";
}
            ...
            <tr>
                ...
                <td style='text-align: right;'>
                    ...
                    if (isset($_GET['section']) && ($_GET['section'] == 'doctor' || $_GET['section'] == 'Doctorlist')) {
                        ...
                        ?>
                        <a href="Patient_File_Attach.php?Registration_ID=<?=$Registration_ID?>&Patient_Payment_ID=<?=$Patient_Payment_ID?>&Fromprocedure=Fromprocedure"  class="art-button-green" >ATTACHMENT </a>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div id="patientItemsList" style='height:200px;overflow-x:hidden;overflow-y:scroll;  '>
                            <?php include "nuclearmedicine_iframe.php"; ?>
    ...
    function checkStatus() {
        ...
        if ($('.notpaid').length) {
            if ($('.Procedureprogress').length) {
                ...
                alert("What are you trying to do? The patient hasn't paid and you are processing!! Don't do that.");
                exit;
            }
        }
...
<script type="text/javascript">
  ...
  function Prosedure_Map_List(Product_Name,Procedure,Patient_Payment_ID){
    $("#Display_Item_List").dialog({autoOpen: false, width: '60%', height: 450, title: 'SERVICE ITEM LIST FOR: '+Product_Name, modal: true});
...
function open_nuclear_medicine(Payment_Item_Cache_List_ID) {
    var Registration_ID = '<?php echo $Registration_ID; ?>';
