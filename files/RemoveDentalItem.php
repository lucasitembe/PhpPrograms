<?php
    ...
    if($Payment_Item_Cache_List_ID != ''){
        ...
        if(!mysqli_query($conn,$Remove_Item)){
            ...
            header("location: ./dentalitems.php?section=Dental&Registration_ID=$Registration_ID&Transaction_Type=$Transaction_Type&Payment_Cache_ID=$Payment_Cache_ID&NR=True&DentalWorks=DentalWorksThisPage");
        }
    }else{
        header("location: ./dentalitems.php?section=Dental&Registration_ID=$Registration_ID&Transaction_Type=$Transaction_Type&Payment_Cache_ID=$Payment_Cache_ID&NR=True&DentalWorks=DentalWorksThisPage");
    }
