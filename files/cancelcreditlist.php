<?php
    ...
    if(isset($_SESSION['userinfo'])){
	if(isset($_SESSION['userinfo']['Modify_Credit_Information'])){
	    if($_SESSION['userinfo']['Modify_Credit_Information'] != 'yes'){
		header("Location: ./index.php?InvalidPrivilege=yes");
	    }
	}else{
	    header("Location: ./index.php?InvalidPrivilege=yes");
...
<!-- CHECK USER PRIVILEGES BEFORE TO CONTINUE THE PROCESS-->
    <?php
//	if(isset($_GET['userinfo']['Modify_Credit_Information'])){
...
//	}else{
//            @session_destroy();
//            header("Location: ./index.php?InvalidPr");
//        }
    ?>
...
<!--    Datepicker script-->
	...
	function Search_Receipt_Number(Receipt_No) {
		...
		document.getElementById('Cancel_Receipt').innerHTML = "<iframe width='100%' height=400px src='cancel_patient_credit_billing_iframe.php?Receipt_No="+Receipt_No+"'></iframe>";
	    }
	}
    </script>
    <script>
	function Search_Patient_Name(Patient_Name) {
		...
		document.getElementById('Cancel_Receipt').innerHTML = "<iframe width='100%' height=400px src='cancel_patient_cash_billing_iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
	    }
	}
    </script>
            ...
            <table width=100% border=1>
                <tr>
                    <td id="Cancel_Receipt">
                        <iframe width='100%' height=400px src="cancel_patient_credit_billing_iframe.php?Branch=<?php echo $Branch; ?>&Date_From=<?php echo $Date_From; ?>&Date_To=<?php echo $Date_To; ?>&Insurance=<?php echo $Insurance; ?>&Patient_Name =<?php echo $Patient_Name; ?>"></iframe>
                    </td>
                </tr>
            </table>
        </center>
