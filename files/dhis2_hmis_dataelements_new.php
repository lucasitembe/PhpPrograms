...
?>
<a href="dhis2_report_configuration.php?dhis2_auto_dataset_id=<?= $dhis2_auto_dataset_id ?>&&dhis2_dataset_name=<?= $dhis2_dataset_name ?>&&dataset_id=<?= $dataset_id ?>" class="art-button-green">REPORT CONFIGURATION</a>
...
<script>
    ...
    function filter_list_of_patient_sent_to_cashier() {
        ...
        $.ajax({
            type: 'POST',
            url: 'ajax_dhis2_hmis_dataelements_new.php',
