...
?>
<fieldset>  
            <legend align=center><b>RECEIVED ENGINEERING REQUISITIONS</b></legend>
          ...
          $display_table="<table width=100%> 
				<tr> 
					...
					<th>Equipment Name</th>
                                        <th>Reported  by</th>
        			        <thRequested Department</th>
					<th>Floor/Room/Place</th>
                                        
                                          ";
             $display_table.="<th width='7%'>Action</th>";
			...
			while($result_query=mysqli_fetch_array($query_data)){
                                                 $employee_name=$result_query['select_dept'];
