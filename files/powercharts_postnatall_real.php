            ...
            <center>
                <table  class="" border="0"  align="left" style="width:100%;margin-top:-5px;"  >
                    <tr>
                        ...
                        <td  width="40%" colspan="2">
                            ...
                            <input style="width:240px;" id="postnatal_Date" class="date" name="" type="text" >
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="20%" class="powercharts_td_left" style="text-align:right">Umri</td><td><input name="umri" value="<?php echo $age;?>" id="umri" type="text"></td>
                ...
                <table style="margin-top:0px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width:240px" readonly="true" id="tarehe_hudhurio" class="date">
                        </td>
                    </tr>
                </table>
                </td>
    ...
    $('#save_data').click(function () {
        ...
        $.ajax({
            ...
            data: 'action=save&rchNo=' + rchNo + '&postnatal_Date=' + postnatal_Date + '&mtaa_jina=' + mtaa_jina + '&para=' + para + '&birth_date=' + birth_date + '&hali_mama=' + hali_mama + '&hali_mtoto=' + hali_mtoto + '&saa_1_nyonyesha=' + saa_1_nyonyesha + '&vvu_hali=' + vvu_hali + '&vvuPostnatal=' + vvuPostnatal + '&alipojifungulia=' + alipojifungulia + '&mzalishaji_kada=' + mzalishaji_kada + '&BP=' + BP + '&HB=' + HB + '&Matiti=' + Matiti + '&uzazi_tumbo=' + uzazi_tumbo + '&Lochia=' + Lochia + '&Hudhurio='
                    ...
                    + muda + '&ulishaje_mtoto=' + ulishaje_mtoto + '&alikopelekwa=' + alikopelekwa + '&alikotokea=' + alikotokea + '&rufaa_sababu=' + rufaa_sababu + '&motherID=' + motherID+'&umri='+umri,
            cache: false,
