                    ...
                    <td>
                        ...
                        <select name='Item_Category_ID' id='Item_Category_ID' onchange='getItemsList_Laboratory(this.value)' onchange='Calculate_Amount()' onkeypress='Calculate_Amount()'>
                            ...
                            $data = mysqli_query($conn,"SELECT cat.Item_Category_Name, cat.Item_Category_ID
                                                    ...
                                                    i.Consultation_Type = 'Laboratory' and
                                                    i.Can_Be_Sold = 'yes'
                ...
                <tr>
                    <td>
                        <fieldset style='overflow-y: scroll; height: 330px;' id='Items_Fieldset'>
                            <table width=100%>
                                <?php
                                    $result = mysqli_query($conn,"SELECT Product_Name, Item_ID from tbl_items where Consultation_Type = 'Laboratory' and Status = 'Available' and Can_Be_Sold = 'yes' AND Item_ID IN (SELECT Item_ID FROM tbl_item_price WHERE Sponsor_ID = '$Sponsor_ID' AND Items_Price <> 0) order by Product_Name limit 150");
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style='text-align: right;'>
                        <input type='button' name='Submit' id='Submit' class='art-button-green' value='ADD INVESTIGATION' onclick='Get_Selected_Item_Laboratory()'>
                    </td>
                </tr>
            </table><br/>
