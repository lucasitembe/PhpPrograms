...
<center>
		...
		echo "<tr id='thead'>
			    ...
			    <td style='text-align: left;' width=20%><b>CHECK IN</b></td>
                            <td style='text-align: left;' width=20%><b>DOCTOR'S SAVE</b></td>
                            <td style='text-align: left;' width=20%><b>SIGN OFF</b></td>
			    <td style='text-align: left;' width=25%><b>EPISODE OF CARE(HRS)</b></td>
		     </tr>";
		    echo "<tr>
				<td colspan=4></td></tr>";
                                     ...
                                     $Signoff_Date_And_Time=$select_patient_item_list_row['Signedoff_Date_And_Time'];
                                        ...
                                        while($select_patient_payment_row=mysqli_fetch_array($select_patient_payment)){
                                            ...
                                            while($select_patient_row=mysqli_fetch_array($select_patient)){//select patient details
                                                ...
                                                echo "<td>".date('d/m/Y H:i:s',strtotime($Check_In_Date_And_Time))."</td>";
                                                echo "<td>".date('d/m/Y H:i:s',strtotime($Consultation_Date_And_Time))."</td>";
                                                echo "<td>".date('d/m/Y H:i:s',strtotime($Signoff_Date_And_Time))."</td>";
                                                echo "<td>".($time)."</td>";
                                                echo "</tr>";
