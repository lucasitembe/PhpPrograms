    ...
    if (!empty($assigned_engineer)){
        $filter .= " AND assigned_engineer LIKE '%" . $assigned_engineer . "%'";
                    ...
                    $display_table="<table width=100% class='row'> 
                      ...
                      $query_data=mysqli_query($conn,"SELECT * FROM tbl_engineering_requisition WHERE completed = 'completed' $filter
          ...
          <?php
                          ...
                          <tr class='done'> 
                              ...
                              <td>".$result_query['equipment_name']."</td>
                                                  ...
                                                  <td><a href='PreviewMRVdetails.php?New_Preview_Requisition=True&Requisition_ID=".$requisition_ID."' class='art-button-green' target='_blank'>PREVIEW COMPLETED MRV</a></td>"
                                                  ;
                                  if(isset($_GET['lForm']))
