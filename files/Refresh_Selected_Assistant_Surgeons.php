    ...
    ?>
        <tr>
            ...
            <td width="12%" style="text-align: center;">
                <input type="button" name="SelectedSurgeon" id="SelectedSurgeon" value="REMOVE" class="art-button-green" onclick="Remove_Assistant_Surgeon(<?php echo $dtz['Participant_ID']; ?>)">
            </td>
        </tr>
    <?php 
        }
