...
<?php
	...
	if(isset($_GET['Payment_Cache_ID']) && isset($_GET['Payment_Item_Cache_List_ID'])){
	    ...
	    $Supervisor_ID = $_SESSION['Theater_Supervisor']['Employee_ID'];
		...
		$select_from_cache = "SELECT * FROM tbl_item_list_cache il, tbl_items i
			...
			document.location = "theaterclinicalnotes.php?Theaterclinicalnotes=TheaterPageclinicalnotes&Patient_Payment_ID=<?php echo $Patient_Payment_ID;?>&Registration_ID=<?php echo $Registration_ID;?>";
		    </script>
		    <?php
	    }   
	}
...
<fieldset><legend align='right'><b>Theater Works</b></legend>
	<table width=100%>
		<tr>
