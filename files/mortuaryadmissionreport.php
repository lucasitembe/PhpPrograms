...
if ($section == 'Admission') {
    echo "<a href='admissionworkspage.php?from=mogueReport&section=" . $section . "&SearchListDirectCashPatientBilling=SearchListDirectCashPatientBillingThisPage' class='art-button-green'>
            ADMISSION MAIN WORKPAGE
            </a>
            <a href='admissionreports.php?from=mogueReport&section=" . $section . "&SearchListDirectCashPatientBilling=SearchListDirectCashPatientBillingThisPage' class='art-button-green'>
            ADMISSION REPORTS
            </a>
            ";
}
                ...
                <tr>
                    <td>
                        <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                            <?php include 'admittedmortuaryreport_iframe.php'; ?>
                        </div>
                    </td>
                </tr>
            </table>
...
//            var Sponsor = document.getElementById("Sponsor_ID").value;
            ...
            $('#print_preview').attr('href', 'mortuaryadmissionreportprint.php?Patient_Name=' + Patient_Name + '&Date_From=' + Date_From + '&Date_To=' + Date_To + '&ward=' + ward + '&case_type=' + case_type + '&Gender=' + Gender + '&Branch_ID=' + Branch_ID + '&row_num=' + row_num + '&start_age=' + start_age + '&end_age=' + end_age + '&diagnosis_time=' + diagnosis_time);
            ...
            $.ajax({
                type: 'GET',
                url: 'admittedmortuaryreport_iframe.php',
