...
<?php
    ...
    if(isset($_SESSION['userinfo'])){
    	/*if(strtolower($section) == 'dhis'){
    		echo "<a href='opdmappingreport.php?section=DHIS&OpdMappingReport=OpdMappingReportThisForm' class='art-button-green'>OPD MAPPING REPORT</a>";
    		echo "<a href='adddiseasegroup.php?section=DHIS&AddNewItemCategory=AddNewItemCategoryThisPage' class='art-button-green'>ADD DISEASE GROUP</a>";
    		echo "<a href='editdiseasegrouplist.php?EditDiseaseList=EditDiseaseListThisPage' class='art-button-green'>EDIT DISEASE GROUP</a>";
    	}else{
    		echo "<a href='opdmappingreport.php?OpdMappingReport=OpdMappingReportThisForm' class='art-button-green'>OPD MAPPING REPORT</a>";
			echo "<a href='diseaseconfiguration.php?OtherConfigurations=OtherConfigurationsThisForm#?EditdiseaseMainCategory=EditMainDiseaseCategoryThisForm' class='art-button-green'>BACK</a>";
    	//}*/
    }
?>
...
<table width="100%">
	...
	<tr>
		<td width="33%">
			<table width="100%">
				...
				<?php
					...
					$select_disease_group = mysqli_query($conn,"select disease_group_name,disease_group_id from tbl_disease_group limit 200") or die(mysqli_error($conn));
				...
				?>
							<tr>
								<td>
									<input type='radio' name='Disease_Group_Selection' id='<?php echo $data['disease_group_id']; ?>' value='<?php echo $data['disease_group_name']; ?>' onclick="Get_Disease_Group_Name(this.value,'<?php echo $data['disease_group_id']; ?>')">
								</td>
								<td>
		...
		<td width="33%">
			<table width="100%">
				<tr><td><input type="text" name="Search_Disease" id="Search_Disease" autocomplete='off' placeholder='Search Assigned Disease' style="text-align: center;" oninput="Search_Disease_Groups_Assigned()"></td></tr>
				<tr><td style="text-align: center;"><b id='Group_Name'></b></td></tr>
		...
		<td width="33%">
			<table width="100%">
				<tr><td><input type="text" name="Search_Disease_Unassigned" id="Search_Disease_Unassigned" autocomplete='off' placeholder='Search Unassigned Disease' style="text-align: center;" oninput="Search_Disease_Groups_Unassigned()"></td></tr>
				<tr>
					<td>
...
<script type="text/javascript">
	function showDiseasesInGroupUnassigned(disease_group_id){
	    ...
	    myobjectShowUnassigend.open('GET','show_Diseases_In_Group_Unassigned.php?disease_group_id='+disease_group_id,true);
...
<script type="text/javascript">
	function Add_Disease(disease_id){
	    ...
	    myObjectAddDisease.open('GET','Add_Disease.php?disease_id='+disease_id+'&disease_group_id='+disease_group_id_value+'&Search_Disease_Unassigned='+Search_Disease_Unassigned,true);
...
<script type="text/javascript">
	function Search_Disease_Groups(){
	    ...
	    myObjectSearchDiseaseGroup.open('GET','Search_Disease_Groups.php?Search_Disease_Group_Value='+Search_Disease_Group_Value,true);
...
<script type="text/javascript">
	function Search_Disease_Groups_Assigned(){
	    ...
	    myObjectSearchAssigned.open('GET','Search_Disease_Groups_Assigned.php?Search_Disease='+Search_Disease+'&disease_group_id_value='+disease_group_id_value,true);
...
<script type="text/javascript">
	function Search_Disease_Groups_Unassigned(){
	    ...
	    myObjectSearchAssigned.open('GET','Search_Disease_Groups_Unassigned.php?Search_Disease_Unassigned='+Search_Disease_Unassigned+'&disease_group_id_value='+disease_group_id_value,true);
	    myObjectSearchAssigned.send();
	}
</script>
<?php
