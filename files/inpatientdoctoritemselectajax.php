...
if (isset($_POST['submitted'])) {
    ...
    $finance_department_id=$_SESSION['finance_department_id'];
        ...
        if (mysqli_query($conn,$insert_query2)) {
            $url = "inpatientdoctoritemselect.php?Consultation_Type=$Consultation_Type&Round_ID=$Round_ID&Registration_ID=$Registration_ID&payment_cache_ID=$payment_cache_ID";
            ?>
...
<script type='text/javascript'>
    ...
    function getPrice(bill_type) {
    if (document.getElementById("Item_Name").value != '' && bill_type == 'Cash'){
...
<script type='text/javascript'>
    ...
    document.location = "inpatientdoctordetaileditemselect.php?Consultation_Type=<?php
...
<script type="text/javascript" language="javascript">
    ...
    mm.onreadystatechange = AJAXP2; //specify name of function that will handle server response....
    mm.open('GET', "inpatientdoctordetaileditemselect_Iframe.php?sponsor_id=" + Sponsor_ID + "&test_name=" + test_name + "&Item_Subcategory_ID=" + Item_Subcategory_ID + "&Item_Category_ID=" + Item_Category_ID + "&Consultation_Type=<?php echo $Consultation_Type; ?>&Patient_Payment_ID=<?php
                echo $Patient_Payment_ID;
                ?>&Round_ID=<?php echo $Round_ID; ?>&Consultation_Type=<?php echo $Consultation_Type; ?>&Registration_ID=<?php echo $Registration_ID; ?>&consultation_ID=<?php echo $consultation_ID; ?>", true);
    mm.send();
    function AJAXP2() {
    var data1 = mm.responseText;
...
<script>
    ...
    var Sponsor_ID=$("#new_sponsor_to_bill").val();
    mm.onreadystatechange = AJAXP2; //specify name of function that will handle server response....
    mm.open('GET', "inpatientdoctordetaileditemselect_Iframe.php?sponsor_id=" + Sponsor_ID + "&Consultation_Type=<?php echo $Consultation_Type; ?>&Round_ID=<?php echo $Round_ID; ?>&Consultation_Type=<?php echo $Consultation_Type; ?>&Registration_ID=<?php echo $Registration_ID; ?>&consultation_ID=<?php echo $consultation_ID; ?>", true);
    mm.send();
    function AJAXP2() {
    var data1 = mm.responseText;
    document.getElementById('frmaesearch').innerHTML = data1;
        ...
        <center>
            <form method='post' action=''>
                <table style='width: 100%;'>
                    <td>
                        <table>
                            ...
                            <tr class="hide">
                                ...
                                <td>
                                    <select id='bill_type' name='bill_type' onchange='getPrice(this.value)' required='required' style='width: 300px;text-align: left;'>
                                        <!--<option></option>-->
                                        <?php
					...
					";
					  ...
					  ";
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="new_sponsor_to_bill"  style='width: 400px;text-align: left;' onchange="searchItem(this.value)">
                                        <?php
                            ...
                            <tr>
                                <td style="text-align: right;">Service Date and Time</td>
                                <td style=''>
                                    <input type='text' id='Service_Date_And_Time' name='Service_Date_And_Time' value="<?php echo date('Y-m-d H:i:s') ?>">
                                    <!--functions to display date and time for filters-->
                                    <script>
                                        $('#Service_Date_And_Time').datetimepicker({
                                        dayOfWeekStart : 1,
                                                lang:'en',
                                                startDate:	'now'
                                        });
					    ...
					    ";
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id='Item_Subcategory_ID' name='Item_Subcategory_ID' onchange='searchItem()'  required='required' style='width: 100%'>
                                        <option>All</option>
                                        <?php
                                        if ($Consultation_Type == 'Pharmacy') {
					...
					group by iss.Item_Subcategory_ID LIMIT 200";
                                        } else {
                                            $qr = "SELECT * FROM tbl_item_subcategory as iss
					WHERE iss.Item_Subcategory_ID IN
					(SELECT Item_Subcategory_ID FROM tbl_items where $Consultation_Condition2)
					group by iss.Item_Subcategory_ID";
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type='text' onkeyup='searchItem()'  placeholder='-----Search an item-----' id='test_name' name='test_name'>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table>
                            <tr>
                                <td colspan="6">
                                    <select onchange="consultChange(this.value)" id="consType" style="padding:5px;margin:5px;font-size:18px;font-weight:100;width:100%;text-align: center ">
                                        <option <?php echo $OthersSelect; ?>>Pharmacy</option>
                            ...
                            <tr>
                                ...
                                <?php if (strtolower($Consultation_Type) == 'surgery') { ?>
                                    ...
                                    <td style=''>
                                        <input type='text' id='service_hour' name='service_hour'>
                                    </td>
                            ...
                            <tr>
                                ...
                                <?php if (strtolower($Consultation_Type) == 'laboratory' || strtolower($Consultation_Type) == 'surgery') { ?>
                                    <td>Priority</td>
                                    <td>
                ...
                <tr>
                    <td width=35%>
                        ...
                        <script type='text/javascript'>
                            ...
                            if ((Consultation_Type.toLowerCase() == 'procedure' && document.getElementById("procedurelocation").value == '') || (Consultation_Type.toLowerCase() == 'surgery' && document.getElementById("procedurelocation").value == '')) {
                            ...
                            var Procedure_Location =<?php if ((strtolower($Consultation_Type) == 'procedure')) { ?>document.getElementById("procedurelocation").value; <?php
                                } else {
                                    echo '0;'
                                    ?>; <?php } ?>

                            var balance =<?php if ((strtolower($Consultation_Type) == 'pharmacy')) { ?>document.getElementById("Balance").value; <?php
                                } else {
                                    echo '\'nil;\''
                                    ?>; <?php } ?>
                            ...
                            var Priority =<?php if ((strtolower($Consultation_Type) == 'laboratory') || (strtolower($Consultation_Type) == 'surgery')) { ?>document.getElementById("Priority").value; <?php
                                } else {
                                    echo '0;'
                                    ?>; <?php } ?>
                            if (balance != 'nil'){
...
?>
                            ...
                            alert("You must specify surgery date before Saving This Surgery");
                            ...
                            if (bill_type != '' && Sub_Department_ID != '') {
                                var Sponsor_IDs=$("#new_sponsor_to_bill").val();
                            myObject.onreadystatechange = sendOrRemove_AJAX; //specify name of function that will handle server response....
                            myObject.open('GET', 'InpatientsendOrRemove.php?action=' + action + '&quantity=' + quantity + '&Consultation_Type=<?php echo $_GET['Consultation_Type']; ?>&Sub_Department_ID=' + Sub_Department_ID + '&Round_ID=<?php echo $Round_ID; ?>&Sponsor_ID='+Sponsor_IDs+'&Item_ID=' + Item_ID + '&bill_type=' + bill_type + '&Guarantor_Name=' + Guarantor_Name + '&Registration_ID=' + Registration_ID + '&comments=' + comments + '&Discount=' + Discount + '&Priority=' + Priority + "&consultation_ID=" + consultation_ID + '&Service_Date_And_Time=' + Service_Date_And_Time + '&service_hour=' + service_hour + '&service_min=' + service_min + '&Procedure_Location=' + Procedure_Location + '&must_pay=' + must_pay +'&Admision_ID=' + Admision_ID, true);
                            myObject.send();
                            ...
                            // document.getElementById('doctoritemcache').innerHTML='InpatientsendOrRemove.php?action='+action+'&quantity='+quantity+'&Patient_Payment_ID='+Patient_Payment_ID+'&Consultation_Type=<?php echo $_GET['Consultation_Type']; ?>&Sub_Department_ID='+Sub_Department_ID+'&Round_ID=<?php echo $Round_ID; ?>&Sponsor_ID=<?php echo $Sponsor_ID; ?>&Item_ID='+Item_ID+'&bill_type='+bill_type+'&Guarantor_Name='+Guarantor_Name+'&Registration_ID='+Registration_ID+'&comments='+comments+'&Discount='+Discount+'&Priority='+Priority+'&Service_Date_And_Time='+Service_Date_And_Time;
                            }
                            ...
                            //alert(data);
                            //document.getElementById("doctoritemcache").innerHTML=data;
                            searchItemAfterAdd(); //refreshitem
                            refreshDoctorCache();
...
//                            var Sponsor_ID='<?php echo $Sponsor_ID; ?>';
                            var Sponsor_ID=$("#new_sponsor_to_bill").val();
                            myObject.open('GET', 'Get_Items_price.php?Item_ID=' + Item_ID + '&Guarantor_Name=<?php echo $Guarantor_Name; ?>&Billing_Type=' + Billing_Type+"&Sponsor_ID="+Sponsor_ID, true);
                            myObject.send();
                            }
                        ...
                        <script type='text/javascript'>
                            ...
                            if ((document.getElementById("Item_Name").value != '' || document.getElementById("Item_Name").value == '') && $('#bill_type').val() == 'Cash' && exists == true){
                            if (!confirm("The Bill type selected, patient will pay cash. Do you want to continue?")){
                            $('#bill_type').val('Credit');
                            exit;
                            }
...
?>
                        ...
                        <script>
                            ...
                            $.ajax({
                            type:'GET',
                                    url:'inpatientdoctoritemcache.php',
                                    data:'Round_ID=<?php echo $Round_ID; ?>&Consultation_Type=<?php echo $Consultation_Type; ?>&Registration_ID=<?php echo $Registration_ID; ?>&Payment_Cache_ID=<?php echo $payment_cache_ID; ?>&Guarantor_Name=<?php echo $Guarantor_Name ?>&SearchListDoctorsPagePatientBilling=SearchListDirectCashPatientBillingThisPage',
                                ...
                                <td>
                                    <fieldset>
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <div  style="width:100%; height:250px; overflow-y:scroll;overflow-x:hidden" id='frmaesearch'>
                                                        <?php include 'inpatientdoctordetaileditemselect_Iframe.php'; ?>
                                                    </div>
                                ...
                                <table width=100%>
                                    ...
                                    <form action='' method='POST'>
                                        <tr>
                                            ...
                                            <?php //if ($Consultation_Type != 'Others') { ?>
                                                <td>
                                                    <select style='width: 100%;' name='Sub_Department_ID' id='Sub_Department_ID' required='required' onchange='getLocationQueSize();<?php if ($Consultation_Type == 'Laboratory' && $Consultation_Type == 'Radiology') { ?>Get_Item_Status();<?php } else { ?>Get_ItemM_Balance();<?php } ?>'>
                                                        <option value="">Select</option>
                                                        <?php
                                                        if($Consultation_Type == 'Others'){
                                                            $filter_dpt_cond="";
                                                        }else{
                                                            $filter_dpt_cond="and $Consultation_Condition";
                                                        }
                                                        $qr = "SELECT * FROM tbl_department d,tbl_sub_department s
								where
								d.Department_ID = s.Department_ID  $filter_dpt_cond and s.Sub_Department_Status='active'";
                                                        $result = mysqli_query($conn,$qr);
                                                        while ($row = mysqli_fetch_assoc($result)) {
...
<!--<td>-->
                                            ...
                                            <?php //if (strtolower($Consultation_Type) == "pharmacy") { ?>
                                            <td>
                                                <input type='text' name='Quantity' class='numberOnly' id='Quantity' required='required' autocomplete="off" placeholder='Quantity' value='0' onchange='Calculate_Amount()' onkeyup='Calculate_Amount()' required='required'>
                                            </td>
                                            <?php //}
                                            ?>
                                            ...
                                            <?php if (strtolower($Consultation_Type) != "pharmacy") { ?>
                                                <td>
                                                    <input type='text' name='Price' id='QueuSize' placeholder='Queu Size' readonly='readonly'>
                                                </td>
                                            <?php }
                                            ?>
                                            <td>
                                            ...
                                            <td style='text-align: center;'>
                                                <input type="button" name='submint' id="add" value='ADD' class='art-button-green' onclick="sendOrRemoveItem()"/>
                ...
                <tr>
                    <td colspan=2>
                        <div  style="width:100%; height:250px; overflow-y:scroll;overflow-x:hidden" id='doctoritemcache'>
                            <?php include 'inpatientdoctoritemcache.php'; ?>
                        </div>
               <!--<iframe src='./inpatientdoctoritemcache.php?Round_ID=<?php echo $Round_ID; ?>&Consultation_Type=<?php echo $Consultation_Type; ?>&Registration_ID=<?php echo $Registration_ID; ?>&Payment_Cache_ID=<?php echo $payment_cache_ID; ?>&Guarantor_Name=<?php echo $Guarantor_Name ?>&SearchListDoctorsPagePatientBilling=SearchListDirectCashPatientBillingThisPage' width='100%' height='300px' id='doctoritemcache'></iframe>	-->
                    </td>
                </tr>
                <tr>
    ...
    <?php
      $Patient_Payment_Item_List_ID = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Patient_Payment_Item_List_ID FROM tbl_consultation WHERE consultation_ID = '$consultation_ID'"))['Patient_Payment_Item_List_ID'];
    ?>
    <script>
        $('#date').datetimepicker({
        dayOfWeekStart : 1,
    ...
    <script>
        $("#service_hour,#service_min,.numberOnly").bind("keydown", function (event) {
