...
<fieldset style='overflow-y: scroll; height: 500px; background-color:white; margin-top:20px;' id='Fieldset_List'>
<?php
	$temp1 = 0;
	$temp2 = 0;
	$Paid = '<span style="font-size: small;"><b><u>PATIENTS LIST ~ OTHER PAYMENTS</u></b></span>';
	$Unpaid = '<span style="font-size: small;"><b><u>UNPAID PATIENTS LIST</u></b></span>
...
?>
						...
						<?php
							...
							$items =  mysqli_query($conn,"select pp.Patient_Payment_ID, pp.Billing_Type, pp.Payment_Date_And_Time, emp.Employee_Name, i.Product_Name, ppl.Price, ppl.Discount, ppl.Quantity, ppl.Quantity from
							...
							if($this_num > 0){
								...
								$Paid .= '	<table width="100%" border=1 style="border-collapse: collapse;">
									<tr>
										<td style="text-align: left;" width="24%" colspan="3"><span style="font-size: small;">'.++$temp1.'<b>.</b> Patient Name ~ '.ucwords(strtolower($Patient_Name)).'</span></td>
										<td style="text-align: left;" width="43%" colspan="2"><span style="font-size: small;">Visit Date & Time ~ '.$Check_In_Date_And_Time.'</span></td>
										<td style="text-align: left;" width="28%" colspan="3"><span style="font-size: small;">Employee checked in ~ '.ucwords(strtolower($Employee_Checked_In)).'</span></td>
									</tr>
                                    <tr><td colspan="8"><hr></td></tr>
									<tr>
										<td width="3%"><span style="font-size: small;"><b>SN</b></span></td>
                                        <td width="5%"><span style="font-size: small;"><b>Receipt#</b></span></td>
										<td width="12%"><span style="font-size: small;"><b>Receipt Date</b></span></td>
										<td width="10%"><span style="font-size: small;"><b>Billing Type</b></span></td>
										<td><span style="font-size: small;"><b>Item Name</b></span></td>
										<td width="8%" style="text-align: right;"><span style="font-size: small;"><b>Quantity</b></span></td>
										<td width="8%" style="text-align: right;"><span style="font-size: small;"><b>Amount Paid</b></span></td>
										<td><span style="font-size: small;">&nbsp;&nbsp;&nbsp;&nbsp;<b>Cashier Name</b></span></td></tr>
										';
								...
								while ($tm = mysqli_fetch_array($items)) {
									...
									$Paid .=	'<tr>
											...
											<td><span style="font-size: small;">'.$tm['Payment_Date_And_Time'].'</span></td>
    	...
    	$Unpaid .= '<tr><td colspan="4"><hr></td></tr></table><br/><br/>';
        if($Control_Paid == 'yes' && $Control_Unpaid = 'yes'){
            $htm = $Paid.'<br/><br/>'.$Unpaid;
        }else if($Control_Paid == 'yes' && $Control_Unpaid == 'no'){
            $htm = $Paid;
        }else if($Control_Unpaid == 'yes' && $Control_Paid == 'no'){
            $htm = $Unpaid;
        }else{
            $htm = '<b>NO PATIENTS DETAILS FOUND</b>';
        }    	
    }
    echo $htm;
?>
