...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Patient_Record_Works'] == 'yes'){ 
?>
    <a href='radiotherapy_treatment.php?PatientRecords=PatientRecordsThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<center>
    <table width=100%>
        <tr>
            <td width=30%>
                <input type='text' name='Search_Patient' id='Search_Patient' style='text-align: center;' onkeyup='searchPatient()' placeholder='Search Patient Name'>
            </td>
            <td width=30%>
            ...
            <td width=30%>
                <input type='text' name='Phone_Number' id='Phone_Number' style='text-align: center;' onkeyup='searchPatient()' placeholder='Search Phone Number'>
            </td>
        </tr>
                    ...
                    <table width=100% border=0>
                        <tr>
                            <td style="border: 1px #ccc solid;">
                                <iframe id='Search_Iframe' width='100%' height="460px"></iframe>
                            </td>
                        </tr>
                    </table>
                </center>
   ...
   document.location = "./index.php";
    ...
    <script language="javascript" type="text/javascript">
        function searchPatient(){
            ...
            document.getElementById('Search_Iframe').src = 'treatment_devery_Iframe2.php?Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name+'&Phone_Number='+Phone_Number+'&section=<?php echo $section; ?>';
        }
    </script>
<script language="javascript" type="text/javascript">
