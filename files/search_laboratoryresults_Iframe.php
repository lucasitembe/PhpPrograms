...
$select_Filtered_Patients = mysqli_query($conn,"SELECT 'payment' AS Status_From,pr.Registration_ID,pr.Patient_Name,pr.Member_Number,pr.Gender,pr.Sponsor_ID,sp.Sponsor_ID,sp.Guarantor_Name,pr.Date_Of_Birth,pr.Phone_Number,ppr.Item_ID,ppr.Patient_Payment_ID
                                          ...
                                          SELECT 'cache' AS Status_From,pr.Registration_ID,pr.Patient_Name,pr.Member_Number,pr.Gender,pr.Sponsor_ID,sp.Sponsor_ID,sp.Guarantor_Name,pr.Date_Of_Birth,pr.Phone_Number,pcr.Item_ID,pcr.Payment_Cache_ID
