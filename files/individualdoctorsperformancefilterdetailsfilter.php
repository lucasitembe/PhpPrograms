...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Doctors_Page_Outpatient_Work'] == 'yes'){ 
?>
    <a href='./individualdoctorsPerformanceSummary.php?Employee_ID=<?php echo $_GET['Employee_ID']?>&Date_From=<?php echo $_GET['Date_From'];?>&Date_To=<?php echo $_GET['Date_To'];?>&DoctorsWork=WorkThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<fieldset>
    ...
    <legend style="background-color:#006400;color:white;padding:5px;" align=center><b>PERFORMANCE DETAILS FOR DOCTOR </b><b style="color:blue;"><?php echo strtoupper($doctorName)?></b> <b>FROM </b><b style="color: blue;"><?php echo date('j F, Y H:i:s',strtotime($Date_From))?></b><b> TO </b><b style="color: blue;"><?php echo date('j F, Y H:i:s',strtotime($Date_To))?></b></legend>
        <iframe src="individualdoctorsperformancefilterdetails_Iframe.php?Employee_ID=<?php echo $doctorID?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>" width="100%" height="240px"></iframe>
