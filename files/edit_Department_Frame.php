<?php
    ...
    echo '<tr><td><b>SN</b></td><td><b>NATURE OF THE DEPARTMENT</b></td>
                <td><b>DEPARTMENT NAME</b></td></tr>';
    $select_sub_departments = mysqli_query($conn,"select * from tbl_department
                                            where Department_Name like '%$Department_Name%'
                                                order by department_id") or die(mysqli_error($conn));
