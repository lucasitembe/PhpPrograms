...
if (isset($_POST['process_procedure'])) {
    ...
    echo "<script type='text/javascript'>
                                ...
                                window.location='proceduredocotorremovedpatientinfo.php?" . $queryString . "'
                            </script>";
}
...
$doctorproce = '';
?>
<a href='doctorprocedurelist.php?<?php echo $section ?>' class='art-button-green'>
    BACK
</a>
<?php
                ...
                <tr>
                    <td>
                        ...
                        <div id="patientItemsList" style='height:200px;overflow-x:hidden;overflow-y:scroll;  '>
                            <?php include "proceduredoctorremoved_iframe.php"; ?>
