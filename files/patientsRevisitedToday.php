...
<fieldset>
    ...
    $query="SELECT sp.Sponsor_ID,sp.Guarantor_Name,
                ...
                WHERE pr.Registration_Date=ci.Check_In_Date AND 
                    ...
                    AND ci.Check_In_Date = '$currentDate' AND
	...
	$female=$row['female'];
        echo "<tr><td>".($i+1)."</td>";
        echo "<td><a href='patientsRevisitedTodayDetails.php?sponsorID=$sponsorID&SponsorDetails=SponsorDetailsThisPage' target='_blank'>".$row['Guarantor_Name']."</a></td>";
                        ...
                        <table>
                            <tr>
                                <td style='text-align: center;border: 0'>
                                    <a href="revisitingMultipleBarChart.php" target="_blank">
                                        <button>
