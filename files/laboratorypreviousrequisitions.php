...
<fieldset style='overflow-y: scroll; height: 350px;' id='Previous_Fieldset_List'>
    <legend align=right><b><?php if(isset($_SESSION['Laboratory_ID'])){ echo $Sub_Department_Name; }?>, Previous Requisitions Prepared By : <?php echo $Employee_Name; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></legend>
	<?php
	    $temp = 1;
					    ...
					    rq.store_issue = sd.sub_department_id and
						    emp.employee_id = rq.employee_id and rq.requisition_status = 'submitted' and
							    rq.Employee_ID = '$Employee_ID' and
                                    rq.store_need = '$Sub_Department_ID' order by rq.Requisition_ID desc") or die(mysqli_error($conn));
...
<script>
	...
	if (Start_Date != null && Start_Date != '' && End_Date != null && End_Date != '') {
	    ...
	    myObjectGetPrevious.open('GET','Laboratory_Get_Previous_Requisition.php?Start_Date='+Start_Date+'&End_Date='+End_Date,true);
