...
?>
    <a href='addnewemployee.php?AddNewEmployee=AddNewEmployeeThisPage' class='art-button-green'>
        ADD EMPLOYEE
    </a>
<?php  } } ?>
<?php
...
<script language="javascript" type="text/javascript">
    function searchEmployee(Employee_Name){
        ...
        document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=320px src='search_list_Of_Employee_To_Assign_Clinic_Iframe.php?Employee_Name="+Employee_Name+is_hr+"'></iframe>";
    }
</script>
<br/><br/>
<center>
    <table width=40%>
        <tr>
            <td>
                <input type='text' name='Search_Employee' id='Search_Employee' onclick='searchEmployee(this.value)' onkeyup='searchEmployee(this.value)' placeholder='~~~~~~~~~~~~~~~~~~~Search Employee Name~~~~~~~~~~~~~~~~~~'>
            </td> 
        </tr>
...
<fieldset>  
        ...
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
		<iframe width="100%" height=320px src="List_Of_Employee_To_Assign_Clinic_Iframe.php?<?php echo((isset($_GET['HRWork']) && $_GET['HRWork']=='true')?'&HRWork=true':''); ?>"></iframe>
            </td>
        </tr>
            </table>
        </center>
