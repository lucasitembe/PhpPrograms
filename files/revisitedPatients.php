...
<center>
    ...
    <fieldset style='overflow-y: scroll; height: 305px; background-color:white' id='Patient_List'>
        <legend align="right" style="background-color:#006400;color:white;padding:5px;" ><b>DEMOGRAPHIC REPORT (RE-VISITS / FOLLOW-UPS)</b></legend>
    ...
    <script type="text/javascript">
        function Preview_Report() {
            ...
            if (ageTo == null || ageTo == '' || ageFrom == null || ageFrom == '' || date_From == null || date_From == '' || date_To == null || date_To == '') {
                ...
                window.open('demographicrevisitsreport.php?Region_ID=' + Region_ID + '&District_ID=' + District_ID + '&ageFrom=' + ageFrom + '&ageTo=' + ageTo + '&Date_From=' + date_From + '&Date_To=' + date_To, '_blank');
            }
        }
    </script>
    ...
    <script type="text/javascript">
        function Filter_Patients() {
            ...
            if (Age_To == null || Age_To == '' || Age_From == null || Age_From == '' || Date_From == null || Date_From == '' || Date_To == null || Date_To == '') {
                ...
                myObject.open('GET', 'Demographic_Report_Revisits.php?Region_ID=' + Region_ID + '&District_ID=' + District_ID + '&Date_From=' + Date_From + '&Date_To=' + Date_To + '&Age_From=' + Age_From + '&Age_To=' + Age_To, true);
                myObject.send();
            }
        }
    </script>
