 <?php
    ...
    if(isset($_SESSION['userinfo'])){
        if(isset($_GET['Reagent_New_Grn_Open_Balance'])){
                unset($_SESSION['Reagent_Grn_Open_Balance_ID']);
            header("Location: ./reagentgrnopenbalance.php?status=new&GrnOpenBalance=GrnOpenBalanceThisPage");
