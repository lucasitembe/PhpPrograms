 ...
 <?php
	...
	while($data=mysqli_fetch_assoc($optical)){
	 ...
	 $k_scan=$data['k_scan'];
        ...
        ?>
        <a  href="eye_unit.php?Registration_ID=<?php echo $Registration_ID; ?>&consultation_ID=<?php echo  $consultation_ID; ?>&Admision_ID=<?php echo $Admision_ID; ?>"     class='art-button-green' >
            BACK
         </a>
        <center>
