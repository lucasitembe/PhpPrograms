...
<a href='./dialysiscashpatientlistRemoved.php' class='art-button-green'>REMOVED PATIENTS </a>
...
<center>
    ...
    <fieldset style="background-color:white">
        <legend align="center" style="background-color:#006400;color:white;padding:5px;"><b>DIALYSIS UN CONSULTED PATIENTS</b></legend> 
        <center>
            <table width='99%' style="border:none !important; border-color:transparent !important;background-color:white;">
                <tr>
                    <td style="text-align:center">
                        <input type="text" autocomplete="off" style='text-align: center;width:15%;display:inline' id="start_date" placeholder="Start Date" value="<?= $Start_Date ?>"/>
                        <input type="text" autocomplete="off" style='text-align: center;width:15%;display:inline' id="end_date" placeholder="End Date" value="<?= $End_Date ?>"/>&nbsp;
                        ...
                        <input type='text' name='Search_Patient' style='text-align: center;width:18%;display:inline' id='Search_Patient' onkeyup="filterPatient();" placeholder='~~~~~~~Search Patient Name~~~~~~~'>
                        <input type='text' name='Search_Patient_No' style='text-align: center;width:15%;display:inline' id='Search_Patient_No' onkeyup="filterPatient();" placeholder='~~~~Search Patient Number~~~~'>
                ...
                <tr>
                    <td>
                        ...
                        <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                            <?php include 'dialysiscashpatientlist_Iframe.php'; ?>
                        </div>
                    </td>
                </tr>
            </table>
 ...
 <script type="text/javascript">
    ...
    <script>
        function filterPatient() {
            ...
            $.ajax({
                type: 'GET',
                url: 'dialysiscashpatientlist_Iframe.php',
                data: datastring,
                cache: false,
