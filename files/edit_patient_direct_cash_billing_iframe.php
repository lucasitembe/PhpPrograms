<?php
	...
	echo '<tr><td>'.$temp.'</td>';
        ...
        echo "<td style='text-align: center;'><a href='patientbillingeditcashtransaction.php?Patient_Payment_ID=".$row['Patient_Payment_ID']."&Insurance=".$row['Guarantor_Name']."&Registration_ID=".$row['Registration_ID']."&Selected=Selected&EditPayment=EditPaymentThisForm' target='_Parent' style='text-decoration: none;'>".$row['Patient_Payment_ID']."</a></td>";
