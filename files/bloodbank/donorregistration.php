...
<fieldset>  
    ...
    <center>
			...
			<tr>
			    ...
			    <td><input type='text' name='Donor_Name'  id='Donor_Name'></td> 
			</tr>
			...
			<tr>
			    ...
			    <td><input type='text' name='Emergency_Name' id='Emergency_Name' required='required'></td>
			</tr>
			<tr>
			    <td style="text-align:right;"><b>Emergency Contact Number</b></td>
			    <td><input type='text' name='Emergency_Number' id='Emergency_Number' required='required'></td>
			</tr>
                            <?php
