...
<?php
        ...
        $Registration_ID = $_GET['Registration_ID']; 
			 ...
			 $select_Donors = mysqli_query($conn,"select Registration_ID,Patient_Name, Date_Of_Birth, Gender,Phone_Number,Registration_Date_And_Time
		from tbl_patient_registration where Registration_ID='$Registration_ID' ") or die(mysqli_error($conn));
...
<fieldset>  
            <legend align=center><b>BLOOD DONOR DATA</b></legend>
				...
				<td style="text-align:right;">Blood Batch</td>
					<td>
                                    <select name='Blood_Batch' id='Blood_Batch' >
