...
<fieldset style='margin-top:15px;'>
    <legend align="right" style="text-align:right;background-color:#006400;color:white;padding:5px;"><b>NUMBER OF RADIOLOGY DONE REPORT</b></legend>
            ...
            <tr>
                <td>
                    <div style="width:100%; height:300px;overflow-x: hidden;overflow-y: auto"  id="Search_Iframe">
                        <?php include './number_of_test_taken_radg_iframe.php'; ?> 
                    </div>
                </td>
            </tr>
        </table>
...
<script>
                        ...
                        function filterLabpatient() {
                            ...
                            $('#printPreview').attr('href', 'print_number_of_test_taken_radg.php?fromDate=' + fromDate + '&toDate=' + toDate + '&Sponsor=' + Sponsor + '&SubCategory=' + SubCategory);

                            $.ajax({
                                type: 'POST',
                                url: 'number_of_test_taken_radg_iframe.php',
