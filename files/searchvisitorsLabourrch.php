...
<script language="javascript" type="text/javascript">
    function searchPatient(Patient_Name) {
        ...
        if (Patient_Number != '' && Patient_Number != null) {
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_Labour_list_patient_billing_Iframe.php?Patient_Number=" + Patient_Number + "&Patient_Name=" + Patient_Name + "'></iframe>";
        } else {
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_Labour_list_patient_billing_Iframe.php?Patient_Name=" + Patient_Name + "'></iframe>";
        }
    }
</script>
<script language="javascript" type="text/javascript">
    function Search_Patient_Using_Number(Patient_Number) {
        ...
        if (Patient_Name != '' && Patient_Name != null) {
            ...
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_Labour_list_patient_billing_Iframe.php?Patient_Number=" + Patient_Number + "'></iframe>";
        }
    }
</script>
<script language="javascript" type="text/javascript">
    function Search_Patient_Phone_Number(Phone_Number) {
        ...
        if ((Patient_Name != '' && Patient_Name != null) && (Patient_Number != '' && Patient_Number != null)) {//All set
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_Labour_list_patient_billing_Iframe.php?Patient_Number=" + Patient_Number + "&Patient_Name=" + Patient_Name + "&Phone_Number=" + Phone_Number + "'></iframe>";
        } else if ((Patient_Name != '' && Patient_Name != null) && (Patient_Number == '' || Patient_Number == null)) {//Patient_Number not set
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_Labour_list_patient_billing_Iframe.php?Patient_Name=" + Patient_Name + "&Phone_Number=" + Phone_Number + "'></iframe>";
        } else if ((Patient_Name == '' || Patient_Name == null) && (Patient_Number != '' && Patient_Number != null)) {
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_Labour_list_patient_billing_Iframe.php?Patient_Number=" + Patient_Number + "&Phone_Number=" + Phone_Number + "'></iframe>";
        } else {
            document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=400px src='search_Labour_list_patient_billing_Iframe.php?Phone_Number=" + Phone_Number + "'></iframe>";
        }
    }
</script>
<br/><br/>
...
<fieldset>  
    ...
    <center>
        <table width=100% border=1>
            <tr>
                <td id='Search_Iframe'>
                    <iframe width='100%' height=400px src='search_Labour_visitors_outpatient_list_Iframerch.php?Patient_Name="+Patient_Name+"'></iframe>
                </td>
            </tr>
        </table>
    </center>
