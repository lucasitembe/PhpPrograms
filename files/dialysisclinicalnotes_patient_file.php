...
$Today_Date_now = mysqli_query($conn, "select now() as today");
while ($row = mysqli_fetch_array($Today_Date_now)) {
    $startoriginal = $row['today'];
}
...
if (isset($_GET['Attendance_Date'])) {
    ...
    echo '&this_page_from='.$this_page_from.'" class="art-button-green">BACK</a>
';
} else {;
