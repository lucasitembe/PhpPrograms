...
<fieldset>
    ...
    ?>
            <legend align=center><b>PATIENTS REVISITED FOR</b> <b style="color: blue"><?php echo $sponsorName;?></b><b>SPONSOR</b></legend>
        <center>
	...
	<!--End datetimepicker-->
	    ...
	    <br>
            <iframe src="revisitedPatients_Iframe.php?sponsorID=<?php echo $sponsorID?>" width="100%" height="340px"></iframe>
</fieldset><br/>
<?php
