<?php
    ...
    $result = mysqli_query($conn,"select t.Item_ID, t.Product_Name from tbl_items t, tbl_item_subcategory s, tbl_item_category c
                            ...
                            Item_ID not in ('$Filter_Value') order by t.Product_Name limit 100") or die(mysqli_error($conn));
    ?>
