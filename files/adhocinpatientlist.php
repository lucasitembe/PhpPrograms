...
<fieldset style='overflow-y: scroll; height: 400px;background-color:white;margin-top:20px;' id='Patient_Fieldset_List'>
    <legend align='right' style="background-color:#006400;color:white;padding:5px;"><b>Direct Departmental Payments ~ INPATIENTS LIST: REVENUE CENTER</b></legend>
    <table width=100% border=1>
        ...
        <?php
        //select patients
        $select = mysqli_query($conn,"select pr.Registration_ID, pr.Patient_Name, pr.Gender, pr.Date_Of_Birth, sp.Guarantor_Name, pr.Phone_Number, pr.Member_Number, ad.Admision_ID from
        ...
        if ($num > 0) {
            while ($data = mysqli_fetch_array($select)) {
                ...
                <tr id='thead'>
                    ...
                    <td>
                        <a href='adhocinpatientpage.php?<?php echo $location; ?>Registration_ID=<?php echo $data['Registration_ID']; ?>&Admision_ID=<?php echo $data['Admision_ID']; ?>&AdhocInpatientPage=AdhocInpatientPageThisForm' target='_parent' style='text-decoration: none;'>
...
<script type="text/javascript">
    function Search_Patients() {
        ...
        myObjectSearchPatient.open('GET', 'Inpatient_Search_Patients.php?<?php echo $location; ?>Sponsor_ID=' + Sponsor_ID, true);
...
<script type="text/javascript">
    function Search_Patients_Via_Name() {
        ...
        myObjectSearchPatient.open('GET', 'Inpatient_Search_Patients.php?<?php echo $location; ?>Sponsor_ID=' + Sponsor_ID + '&Patient_Name=' + Patient_Name, true);
        myObjectSearchPatient.send();
    }
</script>
...
<script type="text/javascript">
    function Search_Patients_Via_Number() {
        ...
        myObjectSearchPatient.open('GET', 'Inpatient_Search_Patients.php?<?php echo $location; ?>Sponsor_ID=' + Sponsor_ID + '&Patient_Number=' + Patient_Number, true);
        myObjectSearchPatient.send();
    }
</script>
