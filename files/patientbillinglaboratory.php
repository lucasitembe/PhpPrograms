...
<?php
    }//end of check make payment button visibility
}
...
?>
        <tr>
            ...
            <td><input type="text"class="hide" id="amount_required_for_payment" value="<?php echo $total; ?>"></td>
        </tr>
    </table>
</fieldset>
<table width="100%">
    <tr>
        <td style="text-align: right;" id="Removed_Button_Area" width="80%">
            ...
            ?>
        </td>  <input type="text" class="hide" id="total_txt" value="<?php echo $total; ?>"/>
...
<script>
    function open_gpg_dialog(){
      ...
      $.ajax({
          ...
          data:{Registration_ID:Registration_ID,Payment_Cache_ID:Payment_Cache_ID,Sub_Department_ID:Sub_Department_ID,Transaction_Type:Transaction_Type,Patient_Name:Patient_Name,Check_In_Type:'Laboratory'},
...
<script type="text/javascript">
    ...
    function get_terminals(trans_type){
        ...
        if(trans_type.value=="Manual"){
            ...
            if(result){
              document.location = 'Patient_Billing_Laboratory_Page.php?Transaction_Type='+Transaction_Type+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Billing_Type='+Billing_Type+'&manual_offline=manual';  
           }
        }else{
                $.ajax({
                type: 'GET',
      ...
      function offline_transaction(amount_required,reg_id){
        ...
        var uri = '../epay/patientbillinglaboratoryOfflinePayment.php';
        var Payment_Cache_ID = '<?php echo $Payment_Cache_ID; ?>';
        var Sub_Department_ID = '<?php echo $Sub_Department_ID; ?>';
        var Transaction_Type = '<?php echo $Transaction_Type; ?>';
        var Billing_Type = '<?php echo $Temp_Billing_Type2; ?>';
        ...
        if(comf){
            ...
            $.ajax({
                type: 'GET',
                url: uri,
                data: {amount_required:amount_required,registration_id:reg_id,Transaction_Type:Transaction_Type,Payment_Cache_ID:Payment_Cache_ID,Sub_Department_ID:Sub_Department_ID,Billing_Type:Billing_Type},
