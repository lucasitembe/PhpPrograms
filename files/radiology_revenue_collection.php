...
<fieldset style='margin-top:15px;'>
    <legend align="right" style="text-align:right;background-color:#006400;color:white;padding:5px;"><b>RADIOLOGY REVENUE COLLECTION REPORT</b></legend>
...
<!--                    <select id="subCatID" style='text-align: center;padding:4px; width:15%;display:inline'>
                    ...
                    <input type="button" value="Filter" class="art-button-green" onclick="filterLabpatient()">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="width:100%; height:300px;overflow-x: hidden;overflow-y: auto"  id="Search_Iframe">
                                                            <?php include './radiology_revenue_collection_iframe.php'; ?> 
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <center> 
                                            <a href="print_radiology_revenue_collection.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a>
                                        </center> 
                                        ...
                                        <script>
                                           ...
                                           function filterLabpatient(){
                                              ...
                                              var Sponsor = document.getElementById('sponsorID').value;
                                                ...
                                                $('#printPreview').attr('href', 'print_radiology_revenue_collection.php?fromDate=' + fromDate + '&toDate=' + toDate+ '&Sponsor=' + Sponsor);

                                                $.ajax({
                                                    type: 'POST',
                                                    url: 'radiology_revenue_collection_iframe.php',
