...
<form action='#' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
    <table width=90%>
		...
		if(strtolower($_SESSION['userinfo']['Session_Master_Priveleges']) == 'yes') { ?> 
                    <td width=10%><a href='perfomancelistofemployeerevenue.php?EmployeeList=EmployeeListThisPage' class='art-button-green'>Select Employee</a></td> 
                <?php } else { ?>
...
<fieldset>  
        <center>
            <table width=100% border=1>
                <tr>
                    <td>
                        <iframe width='100%' height=300px src="Employee_Performance_Report_Ifrmae.php?Employee_ID=<?php echo $Employee_ID; ?>&Date_From=<?php echo $Date_From; ?>&Date_To=<?php echo $Date_To; ?>&Transaction_Type=<?php echo $Transaction_Type; ?>"></iframe>
                    </td>
                </tr>
            </table>
	    <table width = 50%>
