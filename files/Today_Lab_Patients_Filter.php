                                                                ...
                                                                <table  class="hiv_table" style="width:100%">
                                                                    <tr>
                                                                        <td id='Search_Iframe'>
                                                                            ...
                                                                            ?>
                                                                                <iframe width='100%' height=420px src='Today_Lab_Patients_Iframe_Filter.php?Sub_Department_ID=<?php echo $Sub_Department_ID;?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>'></iframe>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </center>
