...
?>
    ...
    <a href='eramworks.php?Patienteramworks=Patienteramworks' class='art-button-green'>BACK</a>
<?php  } } ?>
<br/><br/>
<!-- get employee id-->
<?php
...
<fieldset>
        <iframe id='srchfrm' src='eramworkspatientfilelist_Iframe.php?Registration_ID=<?php echo $Registration_ID;?>&Patient_Payment_ID=<?php echo $Patient_Payment_ID; ?>&Patient_Payment_Item_List_ID=<?php echo $Patient_Payment_Item_List_ID; if(isset($_GET['doctorsworkpage'])){?>&doctorsworkpage=yes<?php }?>' style='width: 100%; height:320px;'>
        </iframe>
</fieldset>
<!--END HERE-->
<?php
