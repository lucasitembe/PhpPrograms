	...
	<legend align="center"><b>  ALL RADIOLOGY CONSULTED PATIENT LIST <?php if($PatientType == 'in'){ ?> - INPATIENTS <?php } else { ?> - OUTPATIENTS <?php } ?></b></legend>
		<script language="javascript" type="text/javascript">
			function searchPatient(Patient_Name=''){
				...
				Search_Iframe.innerHTML = "<iframe width='100%' height=350px src='RadiologyPatientsList_Served.php?PatientType="+PatientType+"&Sub_Department_ID="+Sub_Department_ID+"&Patient_Name="+Patient_Name+"&DateFrom="+DateFrom+"&DateTo="+DateTo+"'></iframe>";
			}
		</script>
			...
			<tr>
				...
				<td width="150px">
					...
					<select style='height:28px; width:190px; padding-left:8px;' id="ChangeSubDep" onChange="ChangeSubDep(this.value)">
						...
						<?php } ?>
						<option value='RadiologySubDepSession.php?Radiology_Sub_Dep_ID=0'>OTHERS</option>
					</select>
		...
		<table  class="hiv_table" style="width:100%">
			<tr>
				<td id='Search_Iframe'>
					...
					<iframe id="PatientListIframe" width='100%' height=350px src='RadiologyPatientsList_Served.php?Sub_Department_ID=<?php echo $Sub_Department_ID?>&PatientType=<?php echo $PatientType; ?>'></iframe>
				</td>
			</tr>
		</table>
	</center>
