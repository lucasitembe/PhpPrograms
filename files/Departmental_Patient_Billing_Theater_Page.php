    ...
    while($row = mysqli_fetch_array($result)){
        ...
        if(mysqli_query($conn,$insert)){ 
		    ...
		    //die(mysqli_error($conn));
                ...
                header("Location: ./theateritems.php?section=Theater&Registration_ID=$Registration_ID&Transaction_Type=$Transaction_Type&Payment_Cache_ID=$Payment_Cache_ID&NR=True&Billing_Type=$Billing_Type&Patient_Payment_ID=$Patient_Payment_ID&Payment_Date_And_Time=$Payment_Date_And_Time&Sub_Department_ID=$Sub_Department_ID&TheaterWorks=TheaterWorksThisPage"); 
            }
        }else{
            die(mysqli_error($conn));
        }
