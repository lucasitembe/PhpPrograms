...
<!--    Datepicker script-->
	...
	function Search_Receipt_Number(Receipt_No) {
		...
		document.getElementById('tranasction_Receipt').innerHTML = "<iframe width='100%' height=400px src='edit_transaction_patient_billing_iframe.php?Receipt_No="+Receipt_No+"'></iframe>";
	    }
	}
    </script>
	 <script>
	function Search_Patient_Name(Patient_Name) {
		...
		document.getElementById('tranasction_Receipt').innerHTML = "<iframe width='100%' height=400px src='edit_transaction_patient_billing_iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
	    }
	}
    </script>
...
?>
<fieldset>
    <legend align="right"><b>Transaction Receipts</b></legend>
            ...
            <table width=100% border=1>
                <tr>
                    <td id="tranasction_Receipt">
                        <iframe width='100%' height=400px src="edit_transaction_patient_billing_iframe.php?Branch=<?php echo $Branch; ?>&Date_From=<?php echo $Date_From; ?>&Date_To=<?php echo $Date_To; ?>&Insurance=<?php echo $Insurance; ?>&Patient_Name =<?php echo $Patient_Name; ?>"></iframe>
                    </td>
                </tr>
            </table>
        </center>
