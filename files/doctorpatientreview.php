...
?>
    ...
    if(isset($_GET['Patient_Payment_ID'])){
	echo "Patient_Payment_ID=".$_GET['Patient_Payment_ID']."&";
	} ?><?php if(isset($_GET['doctorsworkpage'])){ ?>&doctorsworkpage=yes<?php } ?>&Patient_Payment_Item_List_ID=<?php echo $Patient_Payment_Item_List_ID; if(isset($_GET[''])){} ?>SearchListDoctorsPagePatientBilling=SearchListDirectCashPatientBillingThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
<br/><br/>
