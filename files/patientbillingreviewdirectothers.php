    ...
    <table width=100%>
        <tr>
            <td style='text-align: right;'>
                <a href='directcashpaymentreportothers.php?Patient_Payment_ID=<?php echo $Patient_Payment_ID; ?>&IndividualSummaryReport=IndividualSummaryReportThisForm' class='art-button-green' target='_Blank'>Print Receipt</a>
            </td>
        </tr>
    </table>
</fieldset>
