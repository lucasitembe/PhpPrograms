...
<?php
    //get previous info
    $select_records = mysqli_query($conn,"select Admision_ID from tbl_nurse_notes where Admision_ID IS NULL and Registration_ID = '$Registration_ID'") or die(mysqli_error($conn));
