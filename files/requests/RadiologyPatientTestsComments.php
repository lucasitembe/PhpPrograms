           ...
           <tr>
             <td colspan='2' style='text-align:right;padding-left:10px;'>
					...
					<button class='art-button-green' Onclick='SendSMS(\"Radiology\", \"" . $Receiver . "\")'>
                        ...
                        <a href='Radiology_image_viewer.php?patient_name=".$Patient_Name."&gender=".$Gender."&age=".$age."&Registration_ID=".$Reg_ID."&item_ID=".$Item_ID."' class='art-button-green' target='_blank'>
						View Images
				        </a>
