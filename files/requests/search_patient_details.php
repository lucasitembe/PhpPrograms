...
//              }else{
   ...
   $temp = 1;
    ...
    $navFilter= '  DATE(Payment_Date_And_Time)=DATE(NOW())';
        ...
        $filter=" AND  Payment_Date_And_Time BETWEEN '". $Date_From."' AND '".$Date_To."'";
          $navFilter ="   Payment_Date_And_Time BETWEEN '". $Date_From."' AND '".$Date_To."'";
        }
...
$select_Filtered_Patients="SELECT pr.Patient_Name,pr.Date_Of_Birth,pr.Gender,pr.Phone_Number,pr.Registration_ID as registration_number,'cache' as Status_From,pc.Registration_ID,pc.Sponsor_Name,pc.Receipt_Date as Required_Date,
                                           pc.Payment_Cache_ID as payment_id FROM tbl_patient_registration pr,tbl_payment_cache pc  WHERE  pr.Registration_ID=pc.Registration_ID $filter GROUP BY payment_id ORDER BY Payment_Date_And_Time ASC  LIMIT 100";
   $result=mysqli_query($conn,$select_Filtered_Patients)or die(mysqli_error($conn));
                      ...
                      if($Priority=='Urgent'){
                         ...
                         $colo_urg="";
                          ...
                          if($row['Status'] =='Sample Collected'){
                                   ...
                                   <td>".$temp."</td>
                                   <td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;'>$priorities</a></td>
                                   <td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$Patient_Name."</a></td>";         
                                }else{
                                echo "<tr><td>".$temp."</td>
                                ...
                                <td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$Patient_Name."</a></td>";
                                 ...
                                 echo "<td><a class='viewDetails'  href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$Registration_ID."</a></td>";
                                echo "<td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$row['Sponsor_Name']."</a></td>";
                                echo "<td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'><center>".$age."</center></a></td>";
                                echo "<td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$Gender."</a></td>";
                                echo "<td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$Transaction_Date_And_Time."</a></td>";
                                echo "<td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$Phone_Number."</a></td>";
                                echo "<td><a class='viewDetails' href='inpatient_laboratory_sample_collection_details.php?Status_From=".$row['Status_From']."&patient_id=".$Registration_ID."&payment_id=".$row['payment_id']."&Required_Date=".$row['Required_Date']."&Date_From=".$Date_From."&Date_To=".$Date_To."&Sponsor=".$Sponsor."&subcategory_ID=".$subcategory_ID."' target='_parent' style='text-decoration: none;$colo_urg'>".$Consultant."</a></td>";
                                echo"<td>
