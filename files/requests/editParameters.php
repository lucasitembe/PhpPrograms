...
include("../includes/connection.php");
   $id=$_POST['id'];
  $select_lab_products = mysqli_query($conn,"SELECT * FROM tbl_parameters WHERE parameter_ID='".$id."'") or die(mysqli_error($conn));
                                                        ...
                                                        <table class="hiv_table" style="width:100%">
                                                            ...
                                                            <tr>
                                                                <td width=25%  style="color:black;border:1px solid #ccc;text-align:right;">Result type</td>
                                                                    <td width=75%  style="color:blue;border:1px solid #ccc;">
                                                                    	<select name="Parameter_Name" class="results" required="required">
                                                                            <option value="Quantitative"'; if(strtolower($row['result_type'])=="quantitative"){ echo 'selected'; } else echo "";  echo ' >Quantitative</option>
                                                                            <option value="Qualitative"'; if(strtolower($row['result_type'])=="qualitative"){ echo 'selected'; } else echo ""; echo ' >Qualitative</option>
                                                                         </select>
                                                                </td> 
                                                            </tr>
