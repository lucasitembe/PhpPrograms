  ...
  $data="<fieldset><center><table width='100%' cellspacing='0' cellpadding='0'>
		   <tr>
			 <td colspan='2' style='text-align:right;padding-left:10px;'>
			    <a style='' href='Radiology_image_viewer.php?patient_name=".$Patient_Name."&gender=".$Gender."&age=".$age."&Registration_ID=".$Reg_ID."&item_id=".$Item_ID."' class='art-button-green' target='_blank'>View Image</a>
