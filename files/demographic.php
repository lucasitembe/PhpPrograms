...
<fieldset>
  ...
  <center>
        ...
        <table width="90%" border="none">
          ...
          <fieldset>
            <legend style="font-Weight:bold; " align=center><div style="width:25vw;height:40px; margin:0px !important;padding:0px !important; ">OBSTRETIC HISTORY</legend>
          </fieldset>
...
<center>
  <fieldset style="padding:10px">
    <table id="left">
      ...
      <tr>
        <td class="bottom">Social History</td>
        <td><textarea name="social_history" id="social_history" rows="2" cols="80" style="padding-left:5px;" autocomplete="off" placeholder="Labour History" value=""><?php
         if(!empty($social_history)) echo $social_history;
        ?></textarea></td>
      </tr>
      <tr>
...
<center>
  <fieldset>
    <legend>HISTORY OF PREVIOUS PREGNANCY</legend>
    <table width="100%">
      <tr>
        ...
        <td>
          <select name="history_of_pregnancy"  id="history_of_pregnancy" style="height:100% !important; text-align:center !important">
              <option value="">history of previous pregnancy</option>
              <option value="full term delivery" <?php echo $fulltime; ?>>full term delivery</option>
              <option value="abortion" <?php echo $abortion; ?>>abortion</option>
