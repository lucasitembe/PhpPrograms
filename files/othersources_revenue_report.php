...
<?php
	    ...
	    $Section = '';
	    echo "<a href='customerbillingdirectcash.php?CUSTOMERNO=".$_GET['CUSTOMERNO']."&CUSTOMER_TYPE=".$_GET['CUSTOMER_TYPE']."&CustomerBillingDirectCash=CustomerBillingDirectCashThisPage' class='art-button-green'>BACK</a>";
	}
    }
