...
if (isset($_GET['pn'])) {
    ...
    $select_Patient_Details = mysql_query("
				select pr.Patient_Name,pr.Date_Of_Birth,pr.Member_Number,pr.Gender,pr.registration_id from
				    tbl_patient_registration pr
					where pr.registration_id ='$pn'") or die(mysql_error());
    //display all items
    while ($row2 = mysql_fetch_array($select_Patient_Details)) {
        $Today = Date("Y-m-d");
    ...
    $query=  mysql_query("SELECT * FROM tbl_wazazi WHERE wazazi_id='$sn'");
                ...
                <table  class="" border="0"  align="left" style="width:100%;margin-top:-5px;"  >
                    <tr>
                        ...
                        <td  width="40%" colspan="2">
                            ...
                            <input style="width:240px;" readonly="true" id="rch_no" name="" type="text" value="<?php echo $rch_no;?>">
                        </td>
                    </tr>
                    <tr>
                        <td width="20%" class="powercharts_td_left" style="text-align:right">
                        ...
                        <td>
                            <input name="" id="birth_datezx"  type="text">
                        </td> 
                    </tr>
                    <tr>
                        <td width="20%" class="powercharts_td_left" style="text-align:right">
...
<style>
   ...
   #spanmtotokufa,#spanmtotohai:hover,#spanmamakufa:hover,#spanmamahai:hover,#spanRF:hover,#spanEBF:hover,#spanmtotoARVhapana:hover,#spanmtotoARVpewa:hover,#spankipimoVVUjuli:hover,#spankipimoVVUnegat:hover,#spankipimoVVUpos:hover,#spanVVUjuli:hover,#spanVVUnegat:hover,#spanVVUpos:hover,#spanMVAhapana:hover,#spanMVAndiyo:hover,#spanFGMhapana:hover,#spanFGMndiyo:hover,#spandamuhapana:hover,#spandamundiyo:hover,#spansulhapana:hover,#spansulndiyo:hover,#spanmisohapana:hover,#spanmisondiyo:hover,#spanPPH:hover,#spanpree:hover,#spanecla:hover,#spanOL:hover,#spantear:hover,#spanRP:hover,#spanMK:hover,#spanKN:hover,#spannyonyandiyo:hover,#spannyonyahapana:hover,#spanantindiyo:hover,#spanantihapana:hover{
    cursor:pointer;
    }
</style>
 ...
 <script>
    ...
    $('#save_data').click(function () {
        ...
        $.ajax({
            ...
            data: 'action=save&patient_ID= '+patient_ID+'&jalada_no=' + jalada_no+'&rch_no='+rch_no+'&gravida='+gravida+'&para='+para+'&watoto_hai='+watoto_hai+'&admission_date='+admission_date+'&kujifungua_trh='+kujifungua_trh+'&mtotoUzito='+mtotoUzito+'&uchungu='+uchungu
                    ...
                    +'&mama_discharge='+mama_discharge+'&kifo_mama_sababu='+kifo_mama_sababu+'&mtoto_hali_details='+mtoto_hali_details+'&mtoto_discharge='+mtoto_discharge+'&kifo_mtoto_sababu='+kifo_mtoto_sababu+'&alikopelekwa='+alikopelekwa+'&sababu_rufaa='+sababu_rufaa+'&mzalishaji='+mzalishaji+'&wazazi_ID='+wazazi_ID,
            cache: false,
