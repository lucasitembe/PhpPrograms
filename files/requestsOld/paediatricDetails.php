<?php
 ...
 $regno=$_POST['regno'];
 $checkExist=mysql_query("SELECT * FROM  tbl_paediatric WHERE Registration_ID='$regno'");
 $getNumbers=mysql_num_rows($checkExist);
 if($getNumbers>0){
  //echo $getNumbers;
 }else{
 ...
 if(isset($_POST['view'])){
     if($_POST['view']=='view1'){
         echo '<center> 
	      ...
	      $regno=$_POST['regno'];
          $queryData=mysql_query("SELECT * FROM  tbl_paediatric WHERE Registration_ID='$regno'");
          $result= mysql_fetch_assoc($queryData);
...
<!--                        <tr>
 ...
 if(isset($_POST['action'])){
    ...
    $regno=$_POST['regno'];	
    $HadTT=  mysql_real_escape_string($_POST['HadTT']);
    $BCGVaccination=  mysql_real_escape_string($_POST['BCGVaccination']);
    $PentavalentaVaccination= mysql_real_escape_string($_POST['PentavalentaVaccination']);
    $PnueomoccocalVaccination= mysql_real_escape_string($_POST['PnueomoccocalVaccination']);
    $DoseReceived6Months= mysql_real_escape_string($_POST['DoseReceived6Months']);
    $DoseReceived12Months= mysql_real_escape_string($_POST['DoseReceived12Months']);
    $DoseReceived18Months= mysql_real_escape_string($_POST['DoseReceived18Months']);
    $DoseReceived24Months= mysql_real_escape_string($_POST['DoseReceived24Months']);
    $DoseReceived36Months= mysql_real_escape_string($_POST['DoseReceived36Months']);
    $DoseReceived48Months= mysql_real_escape_string($_POST['DoseReceived48Months']);
    $DoseReceived59Months= mysql_real_escape_string($_POST['DoseReceived59Months']);
    $Mabendazole6Months=  mysql_real_escape_string($_POST['Mabendazole6Months']);
    $Mabendazole12Months= mysql_real_escape_string($_POST['Mabendazole12Months']);
    $Mabendazole18Months= mysql_real_escape_string($_POST['Mabendazole18Months']);
    $Mabendazole24Months= mysql_real_escape_string($_POST['Mabendazole24Months']);
    $Mabendazole30Months= mysql_real_escape_string($_POST['Mabendazole30Months']);
    $IPTCReceived=  mysql_real_escape_string($_POST['IPTCReceived']);
    $OtherVaccination=  mysql_real_escape_string($_POST['OtherVaccination']);
    $HIVStatus=  mysql_real_escape_string($_POST['HIVStatus']);
    $OPC0VaccinationDate=  mysql_real_escape_string($_POST['OPC0VaccinationDate']);
    $MeaslesVaccinationDate=  mysql_real_escape_string($_POST['MeaslesVaccinationDate']);
     $query="UPDATE tbl_paediatric SET Have_TT='$HadTT',Current_Hiv_Status='$HIVStatus',Date_Of_BCG_Vaccination='$BCGVaccination',Date_Of_Pentavalent_Vaccination='$PentavalentaVaccination',Date_Of_Pnuemoccocal_Vaccination='$PnueomoccocalVaccination',Date_Of_OPC0_Vaccination='$OPC0VaccinationDate',Date_Of_Measles_Vaccination='$MeaslesVaccinationDate',Vitamin_Six_Months='$DoseReceived6Months',
		...
		$regno=$_POST['regno'];
        $partiner=  mysql_real_escape_string($_POST['partiner']);
        $consultation= mysql_real_escape_string($_POST['consultation']);
        $pastPregnaces= mysql_real_escape_string($_POST['pastPregnaces']);
        $births=  mysql_real_escape_string($_POST['births']);
        $stillbirths=  mysql_real_escape_string($_POST['stillbirths']);
        $sevendaysdeaths=  mysql_real_escape_string($_POST['sevendaysdeaths']);
        $currentChildren=  mysql_real_escape_string($_POST['currentChildren']);
        $lastChildAge=  mysql_real_escape_string($_POST['lastChildAge']);
        $contraceptionMethod= mysql_real_escape_string($_POST['contraceptionMethod']);
        $consultationRenewal= mysql_real_escape_string($_POST['consultationRenewal']);
        ...
        $Heart= mysql_real_escape_string($_POST['Heart']);
        ...
        $Extremities=  mysql_real_escape_string($_POST['Extremities']);
        $Genitalia=  mysql_real_escape_string($_POST['Genitalia']);
        $Skin=  mysql_real_escape_string($_POST['Skin']);
        $Neurological=  mysql_real_escape_string($_POST['Neurological']);
    ...
    $Hearing=  mysql_real_escape_string($_POST['Hearing']);
    $Speech=  mysql_real_escape_string($_POST['Speech']);
    $Vision=  mysql_real_escape_string($_POST['Vision']);
    $Vomiting=  mysql_real_escape_string($_POST['Vomiting']);
    $Social=  mysql_real_escape_string($_POST['Social']);
    $Posture=  mysql_real_escape_string($_POST['Posture']);
    $Largemovements=  mysql_real_escape_string($_POST['Largemovements']);
    $Finemovements=  mysql_real_escape_string($_POST['Finemovements']);
    $Recognition=  mysql_real_escape_string($_POST['Recognition']);
    $Comprehension=  mysql_real_escape_string($_POST['Comprehension']);
    $Interaction=  mysql_real_escape_string($_POST['Interaction']);
    $Othercomments=  mysql_real_escape_string($_POST['Othercomments']);
    ...
    $runQuery=  mysql_query($query);
	    ...
	    $regno=$_POST['regno'];
        $Feeding_Month1= mysql_real_escape_string($_POST['Feeding_Month1']);
        $Feeding_Month2= mysql_real_escape_string($_POST['Feeding_Month2']);
        $Feeding_Month3= mysql_real_escape_string($_POST['Feeding_Month3']);
        $Feeding_Month4= mysql_real_escape_string($_POST['Feeding_Month4']);
        $Feeding_Month5= mysql_real_escape_string($_POST['Feeding_Month5']);
        $Feeding_Month6= mysql_real_escape_string($_POST['Feeding_Month6']);
        $Formula_Month1= mysql_real_escape_string($_POST['Formula_Month1']);
        $Formula_Month2= mysql_real_escape_string($_POST['Formula_Month2']);
        $Formula_Month3= mysql_real_escape_string($_POST['Formula_Month3']);
        $Formula_Month4= mysql_real_escape_string($_POST['Formula_Month4']);
        $Formula_Month5= mysql_real_escape_string($_POST['Formula_Month5']);
        $Formula_Month6= mysql_real_escape_string($_POST['Formula_Month6']);
        $Breast_Month1=  mysql_real_escape_string($_POST['Breast_Month1']);
        $Breast_Month2=  mysql_real_escape_string($_POST['Breast_Month2']);
        $Breast_Month3=  mysql_real_escape_string($_POST['Breast_Month3']);
        $Breast_Month4=  mysql_real_escape_string($_POST['Breast_Month4']);
        $Breast_Month5=  mysql_real_escape_string($_POST['Breast_Month5']);
        $Breast_Month6=  mysql_real_escape_string($_POST['Breast_Month6']);
    ...
    $regno=$_POST['regno'];
    $Cotrimoxazole1_1=  mysql_real_escape_string($_POST['Cotrimoxazole1_1']);    
    $Cotrimoxazole1_3=  mysql_real_escape_string($_POST['Cotrimoxazole1_3']);
    $Cotrimoxazole1_5=  mysql_real_escape_string($_POST['Cotrimoxazole1_5']);
    $Cotrimoxazole1_7=  mysql_real_escape_string($_POST['Cotrimoxazole1_7']);
    $Cotrimoxazole1_9=  mysql_real_escape_string($_POST['Cotrimoxazole1_9']);
    $Cotrimoxazole1_11=  mysql_real_escape_string($_POST['Cotrimoxazole1_11']);
    $ARVTherapy= mysql_real_escape_string($_POST['ARVTherapy']);
    $HIVStatus= mysql_real_escape_string($_POST['HIVStatus']);
    $ARVComments= mysql_real_escape_string($_POST['ARVComments']);
    $Cotrimoxazole2_2= mysql_real_escape_string($_POST['Cotrimoxazole2_2']);
    $Cotrimoxazole2_4= mysql_real_escape_string($_POST['Cotrimoxazole2_4']);
    $Cotrimoxazole2_6= mysql_real_escape_string($_POST['Cotrimoxazole2_6']);
    $Cotrimoxazole2_8= mysql_real_escape_string($_POST['Cotrimoxazole2_8']);
    $Cotrimoxazole2_10= mysql_real_escape_string($_POST['Cotrimoxazole2_10']);
    $Cotrimoxazole2_12= mysql_real_escape_string($_POST['Cotrimoxazole2_12']);
    $HIVPositive= mysql_real_escape_string($_POST['HIVPositive']);
    ...
    if($runQuery){
	    ...
	    $regno=$_POST['regno'];
        $diahorrea=  mysql_real_escape_string($_POST['diahorrea']);
        $dehydration=  mysql_real_escape_string($_POST['dehydration']);
        $Bloodinstool=  mysql_real_escape_string($_POST['Bloodinstool']);
        $Fever=  mysql_real_escape_string($_POST['Fever']);
        $Vomitting=  mysql_real_escape_string($_POST['Vomitting']);
        $Anythingelse=  mysql_real_escape_string($_POST['Anythingelse']);
        $Vomitting=  mysql_real_escape_string($_POST['Vomitting']);
        $Treatment=  mysql_real_escape_string($_POST['Treatment']);
        $Oralsolution=  mysql_real_escape_string($_POST['Oralsolution']);
        $IVmedicaion=  mysql_real_escape_string($_POST['IVmedicaion']);
        $Zinc=  mysql_real_escape_string($_POST['Zinc']);
        $othertreatment=  mysql_real_escape_string($_POST['othertreatment']);
        $treatmentLength=  mysql_real_escape_string($_POST['treatmentLength']);
