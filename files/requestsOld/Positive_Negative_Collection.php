...
<?php
    include("../includes/connection.php");
     ...
     if($_POST['action']=='patientList'){
       ...
       $sn=1;
//       $query=  mysql_query("SELECT * FROM tbl_patient_payment_item_list AS tppit INNER JOIN tbl_patient_payments tpp ON tppit.Patient_Payment_ID=tpp.Patient_Payment_ID INNER JOIN tbl_patient_registration tpr ON tpr.Registration_ID=tpp.Registration_ID INNER JOIN tbl_items ti ON
