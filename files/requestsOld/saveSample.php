...
if(isset($_POST['action'])){
    if ($_POST['action']=='SaveSample'){
        ...
        $checkAvailability=mysql_query("SELECT * FROM tbl_laboratory_specimen WHERE Specimen_Name='$Sample_Name'");
        $rows=mysql_fetch_row($checkAvailability);
        $numRows=mysql_num_rows($checkAvailability);
        if ($numRows>0){
          if($rows[3]=='Inactive') {
            $insertsample=mysql_query("UPDATE tbl_laboratory_specimen SET Sample_Container='$Sample_Container',Status='Active' WHERE Specimen_Name='$Sample_Name'");  
          ...
          $insertsample=mysql_query("INSERT INTO tbl_laboratory_specimen (Specimen_Name,Sample_Container) VALUES ('$Sample_Name','$Sample_Container')");  
        ...
        $message="";
        $select_lab_products = mysql_query("SELECT * FROM tbl_laboratory_specimen WHERE Status='Active'");
        ...
        $id=$_POST['id'];
        $getSample=mysql_query("SELECT * FROM tbl_laboratory_specimen WHERE Specimen_ID='$id'");
