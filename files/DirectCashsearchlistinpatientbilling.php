...
<?php
	echo $Title;
	 $select_Filtered_Patients = mysqli_query($conn,"select * from tbl_patient_registration pr , tbl_admission ad,tbl_check_in ci, tbl_sponsor sp where
...
<script type="text/javascript">
	function Filter_Patients(){
        ...
        myObjectFilterPatient.open('GET','Direct_Cash_Inpatient_Filter_Patients.php?Sponsor_ID='+Sponsor_ID,true);
...
<script type="text/javascript">
	function Search_Patients(){
        ...
        myObjectSearchByName.open('GET','Direct_Cash_Inpatient_Search_Patients.php?Sponsor_ID='+Sponsor_ID+'&Patient_Name='+Patient_Name,true);
...
<script type="text/javascript">
	function Search_Patients_Via_Number(){
        ...
        myObjectSearchByNumber.open('GET','Direct_Cash_Inpatient_Search_Patients_Via_Number.php?Registration_ID='+Registration_ID,true);
