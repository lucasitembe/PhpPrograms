...
if (isset($_POST['action'])) {
    if ($_POST['action'] == 'save') {
        ...
        $insert = mysqli_query($conn,"INSERT INTO tbl_wazazi (Patient_No,jalada_no,rch_no,kijiji_kitongoji,gravida,para,watoto_hai,admission_date,kujifungua_trh,mtotoUzito,uchungu,jifungulia,kujifungua_njia,mtoto_jinsi,kupumua,apgar,nyonyeshwa,tathmin,MSB,AP,PPH,antibiotic,miso,sulfate,MVA,ongeza_damu,FGM,VVU_Kipimo,VVU_uchungu,ARV_mtoto,mtoto_ulishaji,mama_hali,mtoto_hali,mama_hali_details,mama_discharge,kifo_mama_sababu,mtoto_hali_details,mtoto_discharge,kifo_mtoto_sababu,alikopelekwa,sababu_rufaa,mzalishaji,kada)
