...
<script type="text/javascript">
	function Preview_Previous_Records(){
        ...
        myObjectPrevious.open('GET', 'outpatient_Pre_Operative_Preview_Previous_Records.php?Registration_ID='+Registration_ID+"&Admision_ID="+Admision_ID+"&consultation_ID="+consultation_ID, true);
...
<?php
	if(isset($_POST['submittedProActiveCheckList'])){
		...
		$insert_sql = mysqli_query($conn,"insert into tbl_pre_operative_checklist(
									Employee_ID, Registration_ID, consultation_ID,Theatre_Time,
									Ward_Signature, Theatre_Signature, Special_Information, Operative_Date_Time)
								values('$Employee_ID','$Registration_ID','$consultation_ID','$Theatre_Time',
