...
<fieldset style='margin-top:15px;'>
    <legend align="right" style="text-align:right;background-color:#006400;color:white;padding:5px;"><b>NUMBER OF TEST REPORT</b></legend>
...
<center>
    <a href="print_number_of_test_taken.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a>
    <input type='button' onclick='print_excell()' class="art-button-green" value='PRINT REPORT EXCEL'></center>
...
<script>
    ...
    function filterLabpatient() {
        ...
        $('#printPreview').attr('href', 'print_number_of_test_taken.php?fromDate=' + fromDate + '&toDate=' + toDate + '&Sponsor=' + Sponsor + '&SubCategory=' + SubCategory);

        $.ajax({
            type: 'POST',
            url: 'number_of_test_taken_iframe.php',
    ...
    function print_excell(){
            ...
            if(date_From == ""){
                ...
                window.open("print_number_of_test_taken_excell.php?date_From="+date_From+"&date_To="+date_To + "&sponsorID=" + sponsorID + '&subCatID='+subCatID);
            }
        }
</script>
