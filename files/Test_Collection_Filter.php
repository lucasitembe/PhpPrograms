...
?>
<a href="Test_Collection.php?LaboratoryReportThisPage=ThisPage" class="art-button-green">BACK</a>
<fieldset style='margin-top:10px;'>
                <legend align=right><b>TEST COLLECTION</b></legend>
                                                        ...
                                                        <hr width="100%">
                                                            ...
                                                            <center>
                                                                <table  class="hiv_table" style="width:100%">
                                                                    <tr>
                                                                        <td id='Search_Iframe'>
                                                                                <iframe width='100%' height=420px src='Test_Collection_Filter_Iframe.php?Sub_Department_ID=<?php echo $Sub_Department_ID;?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>'></iframe>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </center>
