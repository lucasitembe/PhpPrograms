...
<fieldset>
    <table width=100%>
		...
		<?php  
		       echo "<input type='button' name='Print_Receipt' id='Print_Receipt' value='Print Debit Note' onclick='Print_Receipt_Payment(".$Patient_Payment_ID.")' class='art-button-green'>";
		    }else{
		?>
		...
		<?php
		      echo "<input type='button' name='Print_Receipt' id='Print_Receipt' value='Print Receipt' onclick='Print_Receipt_Payment(".$Patient_Payment_ID.")' class='art-button-green'>";
		    }
		?>
            </td>
        </tr>
...
function popupwindow(url, title, w, h) {
  var  wLeft = window.screenLeft ? window.screenLeft : window.screenX;
   var wTop = window.screenTop ? window.screenTop : window.screenY;
    ...
    var mypopupWindow= window.showModalDialog(url, title, 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=' + w + ', height=' + h + ', top=' + top + ', left=' + left);
