...
$filter = " (ad.Admission_Status = 'Discharged' or ad.Discharge_Clearance_Status = 'cleared') and hw.Hospital_Ward_ID = '$Hospital_Ward_ID' and ";
...
$htm .= "<span style='font-size: x-small;'>CLEARED BILLS REPORT<br/>WARD NAME : ".strtoupper($Hospital_Ward_Name)."</span><br/>";
...
$htm .= "<span style='font-size: x-small;'>START DATE : ".@date("d F Y H:i:s",strtotime($Start_Date))."</span><br/>";
$htm .= "<span style='font-size: x-small;'>END DATE : ".@date("d F Y H:i:s",strtotime($End_Date))."</span><br/><br/>";
     ...
     $htm .= '<table width="100%" border=1 style="border-collapse: collapse;">
        ...
        if ($num > 0) {
            while ($row = mysqli_fetch_array($select)) {
                ...
                $htm .= '<tr>
                            ...
                            <td style="text-align: right;"><span style="font-size: x-small;">'.number_format($Total_Discount).'</span></td>
                            <td style="text-align: right;"><span style="font-size: x-small;">'.number_format($Total_Bill_Exemption).'</span></td>
                            <td style="text-align: right;"><span style="font-size: x-small;">'.number_format($Total_Dept).'</span></td>
        ...
        $htm .= '
                    ...
                    <td style="text-align: right;"><b><span style="font-size: x-small;">'.number_format($General_Total_Discount).'</span></b></td>
                    <td style="text-align: right;"><b><span style="font-size: x-small;">'.number_format($General_Total_Bill_Exemption).'</span></b></td>
                    
                    <td style="text-align: right;"><b><span style="font-size: x-small;">'.number_format($General_Total_Debt).'</span></b></td>
