...
<script type="text/javascript">
	...
	if(patientlist=='Checked In - Outpatient List'){
	    document.location = "searchlistofoutpatientbillingMobile.php?SearchListOfOutpatientBilling=SearchListOfOutpatientBillingThisPage";
...
<script language="javascript" type="text/javascript">
    function searchPatient(Patient_Name){
        document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=320px src='search_list_patient_billing_Mobile_Iframe2.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
<br/><br/>
<center>
...
<fieldset>  
        ...
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
		<iframe width='100%' height=320px src='search_list_patient_billing_Mobile_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>
            </td>
        </tr>
            </table>
        </center>
