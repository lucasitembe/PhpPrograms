   ...
   document.location = "./index.php";
    ...
    <script language="javascript" type="text/javascript">
        function searchPatient(){
            ...
            document.getElementById('Search_Iframe').src = 'radiotherapy_parameter_Iframe2.php?Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name+'&Phone_Number='+Phone_Number+'&section=<?php echo $section; ?>';
        }
    </script>
<script language="javascript" type="text/javascript">
                    ...
                    <table width=100% border=0>
                        <tr>
                            <td style="border: 1px #ccc solid;">
                                <iframe id='Search_Iframe' width='100%' height="460px" src='radiotherapy_parameter_Iframe2.php?section=<?php echo $section; ?>'></iframe>
                            </td>
                        </tr>
                    </table>
                </center>
