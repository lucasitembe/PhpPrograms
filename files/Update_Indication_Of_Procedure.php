<?php
    ...
    if($Employee_ID != 0 && $Payment_Item_Cache_List_ID != 0 && $consultation_ID != 0){
	    ...
	    $update = mysqli_query($conn,"update tbl_ogd_post_operative_notes set Indication_Of_Procedure = '$Indication_Of_Procedure',Others='$others' where Ogd_Post_operative_ID = '$Ogd_Post_operative_ID'") or die(mysqli_error($conn));
	}
?>