...
if(isset($_GET['mortuary'])){
    echo "<a href='searchlistofmortuaryadmited.php' class='art-button-green'>BACK</a>";
}else{
echo "<a href='searchlistofmortuaryadmited.php' class='art-button-green'>BACK</a>";
}
...
<center>
                ...
                <tr>
                    <td>
                        <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                            <?php include 'dischargemortuaryundo_iframe.php'; ?>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <script>
        function filterPatient() {
            ...
            $('#print_preview').attr('href', 'dischargedmortuaryreportprintlist.php?Patient_Name=' + Patient_Name + '&Date_From=' + Date_From + '&Date_To=' + Date_To + '&ward=' + ward + '&Gender=' + Gender + '&Branch_ID=' + Branch_ID + '&row_num='+row_num);
            ...
            $.ajax({
                type: 'GET',
                url: 'dischargemortuaryundo_iframe.php',
