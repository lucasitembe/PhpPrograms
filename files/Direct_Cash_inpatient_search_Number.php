...
<?php
	...
	if($Registration_ID != null && $Registration_ID != ''){
		$select = mysqli_query($conn,"SELECT pr.Gender, pr.Member_Number, pr.Phone_Number, pr.Date_Of_Birth, sp.Guarantor_Name, pr.Registration_ID, pr.Patient_Name, ci.Check_In_ID, ad.Admision_ID  from tbl_patient_registration pr , tbl_admission ad,tbl_check_in ci, tbl_sponsor sp where
