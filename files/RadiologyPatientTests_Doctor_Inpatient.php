...
<?php } ?>
    <a href='PatientRadiology_Served_Doctor_Inpatient.php?<?php echo $_SERVER['QUERY_STRING']?>' class='art-button-green'> BACK </a>
<br><br>
<?php
            ...
            <tr>
                <td id='Search_Iframe'>
                    ...
                    <div style="width:100%; height:200px;overflow-y:scroll;overflow-x:hidden">
                      <?php include 'RadiologyPatientTests_Iframe_Doctor_Inpatient.php'; ?>
                    </div>
...
<script >
    function radiologyviewimage(href, itemName) {
        ...
        $.ajax({
            type: 'GET',
            url: 'requests/radiologyviewimage_doctor_inpateint.php',
            data: datastring,
            success: function (result) {
                $('#my').html(result);
...
<script >
    function commentsAndDescription(href, itemName) {
        ...
        $.ajax({
            type: 'GET',
            url: 'requests/RadiologyPatientTestsComments_doctor_Inpatient.php',
            data: datastring,
            success: function (result) {
                //alert(result);
...
<script>
    function Show_Patient_File() {
        ...
        var winClose = popupwindow('Patientfile_Record_Detail_General.php?Section=Doctor&Registration_ID=<?php echo $Registration_ID; ?>', 'Patient File', 1300, 700);
        //winClose.close();
