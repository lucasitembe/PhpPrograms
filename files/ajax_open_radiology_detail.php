...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <table class="table">
                <tr>
                    <th width="30%">RADIOLOGY CATEGORY</th>
                    <th>CASH</th>
                    <th>CREDIT</th>
                    <th>MSAMAHA</th>
                    <th>TOTAL</th>
                ...
                <tbody>
                    <?php 
                        ...
                        ///////////////////////////////////////////////////////////////
                               ...
                               echo "<tr>
                                        <td class='department_row' onclick='open_radiology_laboratory_detail($Item_Subcategory_ID,$finance_department_id,\"$finance_department_name\",\"$Item_Subcategory_Name\")'><b>".strtoupper($Item_Subcategory_Name)."</b></td>
