...
<?php
        ...
        $select_data = "select dp.Disposal_ID, dp.Created_Date_And_Time, dp.Disposal_Description from
                            tbl_disposal dp where dp.Sub_Department_ID = '$Sub_Department_ID' and
                                dp.Employee_ID = '$Employee_ID' and
                                    dp.Disposal_Status= 'pending' and
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        echo "<td width=4%><a href='Control_Disposal_Items_Session.php?Disposal_ID=".$row['Disposal_ID']."&Pending_Disposal=True' class='art-button-green' target='_parent'>&nbsp;&nbsp;&nbsp;Process&nbsp;&nbsp;&nbsp;</a></td></tr>";
        $temp++;
    }
?>
</table>