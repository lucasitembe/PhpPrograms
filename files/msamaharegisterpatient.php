...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Reception_Works'] == 'yes'){ 
?>
    <a href='newsearchmsamahalist.php?RegisterPatient=RegisterPatientThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
        ...
        <center>
            <table width=100%>
                ...
                <tr>
				    ...
				    <option>Mrs</option>
                            ...
                            <tr>
                                ...
                                <td><input type='text' name='Patient_Name' autocomplete='off' id='Patient_Name' style='border-color: red' required='required' value='<?php echo $Patient_Name;?>'></td>
                            </tr> 
                            <tr>
                                <td style='text-align: right'><b style='color: red'>Date Of Birth</td>
                                <td><input type='text' name='Date_Of_Birth' autocomplete='off' id='date2' style='border-color: red' required='required' value='<?php echo $Date_Birth;?>'></td>
                            </tr>
                            <tr>
			    ...
			    <tr>
                                ...
                                <td><input type='text' name='Phone_Number' autocomplete='off' style='border-color: red' id='Phone_Number' required='required' value='<?php $Phone_Number;?>'></td> 
			    </tr>
                            <tr>
                                <td style='text-align: right'>Occupation</td>
                                <td><input type='text' name='Occupation' autocomplete='off' id='Occupation' value='<?php $Occupation;?>'></td>
                            </tr>
                        </table>
                    </td>
                    <td width=35%><table width=100%>
                            <tr>
                                ...
                                <td>
                                    <select name='region' id='region' onchange='getDistricts(this.value)' value='<?php $Region;?>'>
                                        <option selected='selected'></option>
				    ...
				    <input type='text' autocomplete='off' name='Ward' id='Ward'>
                            ...
                            <tr>
                                ...
                                <td><input type='text' name='Emergence_Contact_Name' autocomplete='off'  id='Emergence_Contact_Name' value='<?php $Emergence_Contact;?>'></td>
                            </tr>
                            <tr>
