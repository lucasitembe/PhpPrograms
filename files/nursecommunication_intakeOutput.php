...
if (isset($_POST['submitRadilogyform'])) {
	...
	$Day_Fluid=mysqli_real_escape_string($conn,$_POST['Day_Fluid']);
	$Amount_Fluid=mysqli_real_escape_string($conn,$_POST['Amount_Fluid']);
	$Amount_Oral=mysqli_real_escape_string($conn,$_POST['Amount_Oral']);
	$Stool=mysqli_real_escape_string($conn,$_POST['Stool']);
	$Vomit=mysqli_real_escape_string($conn,$_POST['Vomit']);
	...
	$Urine=mysqli_real_escape_string($conn,$_POST['Urine']);
        ...
        $insert_testing_record = "INSERT INTO tbl_input_output_nursecommunication(Registration_ID,consultation_ID,employee_ID,Date,Day_Fluid,Amount_Fluid,Amount_Oral,Urine,Stool,Vomit,Remarks)
				               VALUES('$Registration_ID','$consultation_ID','$Employee_ID',NOW(),'$Day_Fluid','$Amount_Fluid','$Amount_Oral','$Urine','$Stool','$Vomit','$Remarks')";
...
<script>
   ...
   window.location="nursecommunication_intakeOutput.php?<?php echo $_SERVER['QUERY_STRING']?>";
</script>
<?php
                        ...
                        <center>
                            <table style="width:100%" class="hiv_table"  >
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right;font-size:14px" width="13%"><b>Type of Fluid</b></td>
                                    <td>
                                        <input name="Day_Fluid" type="text" class="input_style"   />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;font-size:14px" width="13%"><b>Amount-I/V</b></td>
                                    <td>
                                      <input name="Amount_Fluid" type="text" class="input_style"  />
                                    </td> 
                                    <td style="text-align:right;font-size:14px" width="13%"><b>Amount-Oral</b></td>
                                    <td>
                                      <input name="Amount_Oral" type="text" class="input_style"  />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;font-size:14px" width="13%" required="required"><b>Urine</b></td>
                                    <td  ><input name="Urine" type="text" class="input_style"  /></td>
                                
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Stool</b></td>
                                    <td ><input name="Stool" type="text" class="input_style" /></td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;font-size:14px" width="13%" required="required"><b>Vomit</b></td>
                                    <td ><input name="Vomit" type="text" class="input_style" /></td>
                                
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Remarks</b></td>
        ...
        <table width='100%'>
            <tr>
                <td>    
                    ...
                    <a href="nursecommunication_intakeOut_print.php?Registration_ID=<?php echo $_GET['Registration_ID']?>&consultation_ID=<?php echo $_GET['consultation_ID']?>" id="printPreview" class="art-button-green" target="_blank" style="float:right">Preview</a>
...
<div id="Search_Iframe" <?php echo $divStyle ?>>
    <?php include 'nursecommunication_intakeOut_Iframe.php'; ?>
</div>
...
<script>
    function filterPatient() {
        ...
        if(start =='' || end==''){
         ...
         $('#printPreview').attr('href', 'nursecommunication_intakeOut_print.php?start=' + start + '&end=' + end + '&Registration_ID=' + Registration_ID + '&consultation_ID=' + consultation_ID);
         ...
         $.ajax({
            type: "GET",
            url: "nursecommunication_intakeOut_Iframe.php",
