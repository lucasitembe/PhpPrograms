...
?>
<a href='previous_engineering_works.php?section=Engineering_Works=Engineering_WorksThisPage' class='art-button-green'>
        BACK
    </a>
...
?>
<fieldset>  
            <legend align=center><b>PROCESSED ENGINEERING REQUISITIONS</b></legend>
...
<form name="myform" action="" method="POST">
	...
	<?php
          $display_table="<table width=100%> 
			...
			$query_data=mysqli_query($conn,"SELECT * FROM tbl_engineering_requisition WHERE completed = 'completed' AND employee_name = '$Employee_ID' AND satisfy < 1  ORDER BY requisition_ID DESC");
			...
			while($result_query=mysqli_fetch_array($query_data)){
				...
				<tr> 
					...
					<td><a href='requisition_report.php'>".$result_query['equipment_name']."</a></td>
                                        ...
                                        <td><a href='preview_progress.php?New_Process_Requisition=True&Requisition_ID=".$requisition_ID."' class='art-button-green'>PREVIEW PROGRESS</a></td>"
                                        ;
                        if(isset($_GET['lForm']))
