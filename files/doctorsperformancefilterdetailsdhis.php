...
<?php
echo "<a href='./doctorsPerformanceSummaryFilterdhis.php?Date_From=" . $_GET['Date_From'] . "&Date_To=" . $_GET['Date_To'] . "&Sponsor_ID=" . $_GET['Sponsor_ID'] . "' class='art-button-green'>
        BACK
    </a>
 <br/><br/>";
?>
...
<fieldset style='overflow-y:scroll; height:500px'>
    <center>
        ...
        <legend  align="right" style="background-color:#006400;color:white;padding:5px;">
            <br/>
            <form action='doctorsPerformanceSummaryFilterdhis.php' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data"></legend>
