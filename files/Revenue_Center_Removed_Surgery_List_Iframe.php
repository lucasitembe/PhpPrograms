...
<?php
    ...
    echo '<center><table id="removedSugery" width =100% border=0>';
		    ...
		    tbl_payment_cache pc, tbl_item_list_cache ilc, tbl_patient_registration preg, tbl_sub_department sd where
			    ...
			    preg.registration_id = pc.registration_id and
					...
					ilc.status = 'removed' and
					    ...
					    group by ilc.payment_cache_id,ilc.Sub_Department_ID order by pc.payment_cache_id";
	...
	echo "<td><a href='patientbillingRemovedsurgery.php?section=Surgery&Registration_ID=".$row['Registration_ID']."&Transaction_Type=".$row['Transaction_Type']."&Payment_Cache_ID=".$row['Payment_Cache_ID']."&NR=True&Billing_Type=".$Billing_Type2."&Sub_Department_ID=".$Sub_Department_ID."&SurgeryWorks=SurgeryWorksThisPage' target='_parent' style='text-decoration: none;'>".$row['Patient_Name']."</a></td>";
