...
<!--<br/>-->
<fieldset> <legend align='right'><b>Quick Purchase Order ~ <?php if(isset($_SESSION['Pharmacy'])){ echo $_SESSION['Pharmacy']; }?></b></legend>  
        <table width=100%>
		<tr>
    ...
    <fieldset style='overflow-y: scroll; height: 350px;' id='Items_Fieldset_List'>
            <?php
                    ...
                    if(isset($_SESSION['Pharmacy'])){
                        ...
                        $select_order_items = mysqli_query($conn,"select i.Product_Name, ib.Item_Balance, ib.Reorder_Level from tbl_items_balance ib, tbl_Items i where
...
<?php
	if(isset($_POST['Submitted_Grn_Purchase_Order_Form'])){
		...
		$Quantity = $_POST['Quantity']; //array values
		$Price = $_POST['Price']; //array values
