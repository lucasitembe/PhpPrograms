...
<?php
	...
	$select_Filtered_Patients = "select pp.Billing_Type, sp.Guarantor_Name, pr.Registration_ID, pp.Patient_Payment_ID, pp.Payment_Date_And_Time, sum((price - discount)*quantity) as Amount,
    ...
    echo '<tr id="thead"><td width=5%><b>SN</b></td><td width="25%"><b>PATIENT NAME</b></td>
				...
				<td width="20%" style="text-align: center;"><b>RECEIPT DATE</b></td>
	...
	echo '<tr><td>'.$temp.'</td>';
        echo "<td><a href='patientbillingcancel.php?Patient_Payment_ID=".$row['Patient_Payment_ID']."&Insurance=".$row['Guarantor_Name']."&Registration_ID=".$row['Registration_ID']."&Selected=Selected&EditPayment=EditPaymentThisForm' target='_Parent' style='text-decoration: none;'>".ucfirst($row['Patient_Name'])."</a></td>";
