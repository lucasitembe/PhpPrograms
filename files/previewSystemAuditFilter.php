...
$htm.="<fieldset>";
		...
		if($employeeID == 0){//no employee selected
			if(($Login_From != '' || $Login_From != null) && ($Login_To != '' || $Login_To != null)){//login range selected
				$htm.= "<tr id='thead'>
                                ...
                                <td style='text-align:left'><b>LOGGED IN</b></td>
                                <td style='text-align:left'><b>IP ADDR</b></td>
				...
				$htm.= "<tr id='thead'>
                                <td style='text-align:center;width: 3%'><b>SN</b></td>
                                <td style='text-align:left'><b>EMP NAME</b></td>
                                <td style='text-align:left'><b>LOGOUT</b></td>
                                <td style='text-align:left'><b>IP ADDR</b></td>
                                <td style='text-align:left'><b>PC NAME</b></td>
                                <td style='text-align:left'><b>BRANCH</b></td>
                             </tr>";
				...
				$htm.= "<tr id='thead'>
                                <td style='text-align:center;width: 3%'><b>SN</b></td>
                                <td style='text-align:left'><b>EMP NAME</b></td>
                                <td style='text-align:left'><b>AUTHENTICATED</b></td>
                                <td style='text-align:left'><b>AUTH LOCATION</b></td>
                                <td style='text-align:left'><b>IP ADDR</b></td>
                                <td style='text-align:left'><b>PC NAME</b></td>
                                <td style='text-align:left'><b>BRANCH</b></td>
                             </tr>";
				...
				$htm.= "<tr id='thead'>
                                ...
                                <td style='text-align:left'><b>LOGOUT</b></td>
                                <td style='text-align:left'><b>AUTHENTICATED</b></td>
                                <td style='text-align:left'><b>AUT LOCATION</b></td>
				...
				$htm.= "<tr id='thead'>
                                ...
                                <td style='text-align:left'><b>LOGOUT</b></td>
                                <td style='text-align:left'><b>AUTHENTICATED</b></td>
                                <td style='text-align:left'><b>AUTH</b></td>
                                 <td style='text-align:left'><b>ACTIVITY</b></td>
                                  <td style='text-align:left'><b>ACTIVITY DATE AND TIME</b></td>
                                <td style='text-align:left'><b>LOCATION</b></td>
                                <td style='text-align:left'><b>IP ADDR</b></td>
		...
		if($employeeID == 0){//no employee selected
			...
			if(($Login_From != '' || $Login_From != null) && ($Login_To != '' || $Login_To != null)){//login range selected
				...
				$htm.= "<tr id='thead'>
                                <td style='text-align:center;width: 3%'><b>SN</b></td>
                                <td style='text-align:left'><b>EMP NAME</b></td>
                                <td style='text-align:left'><b>LOGGGED IN</b></td>
                                <td style='text-align:left'><b>IP ADDR</b></td>
                                <td style='text-align:left'><b>PC NAME</b></td>
                                <td style='text-align:left'><b>BRANCH</b></td>
                             </tr>";
				...
				$htm.= "<tr id='thead'>
                                <td style='text-align:center;width: 3%'><b>SN</b></td>
                                <td style='text-align:left'><b>EMP NAME</b></td>
                                <td style='text-align:left'><b>LOGGED</b></td>
                                <td style='text-align:left'><b>LOGOUT</b></td>
                                <td style='text-align:left'><b>AUTHENTICATED</b></td>
                                <td style='text-align:left'><b>AUTH LOCATION</b></td>
                                <td style='text-align:left'><b>ACTIVITY</b></td>
	...
	while($audit_record_row=mysqli_fetch_array($audit_record)){
		...
		<?php }else{ ?>
			<?php $htm.= "<td>";?>
				<?php $htm.= date('jS F, Y H:i:s',strtotime($Login_Date_And_Time)); ?>
			<?php $htm.= "</td>";?>
		<?php }
		...
		<?php }else{?>
			<?php $htm.= "<td>";?>
				...
				if($Logout_Date_And_Time == '0000-00-00 00:00:00'){
					$htm.= "Not Yet Logged Out. ";
				}else{
					$htm.= date('jS F, Y H:i:s',strtotime($Logout_Date_And_Time));
				}
				?>
			<?php $htm.= "</td>";?>
		<?php }
		...
		<?php }else{ ?>
			<?php $htm.= "<td>";?>
				...
				if($Authentication_Date_And_Time == '0000-00-00 00:00:00' || $Authentication_Date_And_Time == ''){
					$htm.= "No Authentication Recorded.";
				}else{
					$htm.= $Authentication_Date_And_Time;
				}
				?>
			<?php $htm.= "</td>";?>
		<?php }
		...
		<?php }else { ?>
			...
			if (empty($Authentication)) {
				?>
				<?php $htm.= "<td>";?>
					<?php $htm.= "No Authentication Location requested"; ?>
				<?php $htm.= "</td>";?>

			<?php } else {//no filter ?>
				<?php $htm.= "<td>";?>
					<?php $htm.= $Authentication; ?>
				<?php $htm.= "</td>";?>
			<?php
			}
		}
		...
		if((($Login_From == '' || $Login_From == null) && (($Login_To == '' || $Login_To == null))) && ($Logout_From == '' || $Logout_From == null) && ($Auth_From == '' || $Auth_From == null)){?>
			...
			<?php $htm.= "<td>";?>
				<?php
				if(empty($Authentication)){
					$htm.= "No Authentication Location Recorded.";
				}else{
					$htm.= $Authentication;
				}
				?>
			...
			<?php $htm.= "<td>";?>
				...
				if(empty($Activity_Date_And_Time)){
					$htm.= "No Activity Recorded.";
				}else{
					$htm.= $Activity_Date_And_Time;
				}
				?>
			<?php $htm.= "</td>";?>
			<?php $htm.= "<td>";?>
...
$htm.="<br>";
$htm.= "<tr>
			<td colspan='3'><b>Printed By:</b></td>
			<td><b>$employeeName</b></td>
</tr>";
$htm.= "</table>";
$htm.= "<table>";
