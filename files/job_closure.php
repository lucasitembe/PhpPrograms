...
$engineering
?>
        <a href='job_closure_list.php?section=Engineering_Works=Engineering_WorksThisPage' class='art-button-green'>
            BACK
        </a>
      ...
      <td>
        ...
        <form action='' method='POST' name='' id='myForm' >
               ...
               //get details from tbl_enginnering_requisition
                                ...
                                if ($no > 0) {
                                    ...
                                    while ($data2 = mysqli_fetch_array($get_details)) {
                                        ...
                                        $Requested_by = mysqli_fetch_assoc(mysqli_query($conn,"SELECT Employee_Name from tbl_employee where Employee_ID = '$employee'"))['Employee_Name'];
                                }}
                                    ?>
            <tr>
		    ...
		    <td width='10%' style='text-align: right;'>Department Requesting</td>
                ...
                <td style='text-align: right; width:15%;'>
                    <?php
                        echo "<input type='text' name='reporter' value='{$Requested_by}'>";
                ...
                <tr>
                            ...
                            <tr>
                                <td colspan="2" style='text-align: center;'>
                                        ...
                                        if (strtolower($spare_required ) == 'yes') {
                                            ...
                                            <td colspan="2" style='text-align: center;'>
                                                <input type='checkbox' name='procurement_order' id='procurement_order' value='yes' <?php
                    ...
                    <!-- <button type="button" name="add_item" class="btn btn-primary" onclick="mantainance_drugs()" >Add Items  </button> -->
                        <table class="table" id='spare_list'>
                            ...
                            <tr>
                                <td colspan='6'><center>
                                    <input type='radio' name='final_status' value='Job Complete'><b>Job Complete</b>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type='radio' name='final_status' value='Beyond Repair'><b>Beyond Repair</b>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type='radio' name='final_status' value='Additional Assistance'><b>Additional Assistance Needed</b></center>
                                </td>
                            </tr>
                            <tr>
...
<script>
    ...
    function diaplay_maintanance(){
            ...
            $.ajax({
                type: 'POST',
                url: 'add_Engineering_item.php',
                data: {Requisition_ID:Requisition_ID, select_maintanance:''},
                cache: false,
                success: function (responce){                  
        ...
        function add_maintanance(Item_ID){
            ...
            $.ajax({
                type: 'POST',
                url: 'add_Engineering_item.php',
                data: {Item_ID:Item_ID,Requisition_ID:Requisition_ID, insert_maintanance:''},
                cache: false,
        ...
        function remove_maintanance(list_ID, Employee_ID){
            $.ajax({
                type: 'POST',
                url: 'add_Engineering_item.php',
                data: {list_ID:list_ID,Employee_ID:Employee_ID, removemaintanance:''},
                success: function (responce){                  
                    diaplay_maintanance();
                }
            });
        ...
        function update_maintanance_time(list_ID){
            ...
            $.ajax({
                type: 'POST',
                url: 'add_Engineering_item.php',
                data: {list_ID:list_ID,time:time, updatetimemaintanance:''},
                success: function (responce){                  
        ...
        function update_maintanance_Quantity(list_ID){
            ...
            $.ajax({
                type: 'POST',
                url: 'add_Engineering_item.php',
                data: {list_ID:list_ID,Quantity:Quantity, updateQuantitymaintanance:''},
                success: function (responce){                  
...
$update_requisition_for_engineering='';
 ...
 if(isset($_POST['submit_form'])){
     ...
     if(!empty($Requisition_ID)){
            $update_requisition_for_engineering = "UPDATE tbl_engineering_requisition SET issuer='$issuer', recommendations='$recommendations', date_done = NOW(), job_progress='performed', completed='$completed',final_status='$final_status' WHERE requisition_ID='$Requisition_ID'";
     ...
     if ($save_result)
     {
        ...
        document.location = './PreviewMRVdetails.php?New_Preview_Requisition=True&Requisition_ID=".$Requisition_ID."';
        </script>";
     }
     else 
     {
