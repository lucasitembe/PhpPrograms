<?php
    ...
    if($Employee_ID != 0 && $Payment_Item_Cache_List_ID != 0 && $consultation_ID != 0){
	    ...
	    //update Indication
	    $update = mysqli_query($conn,"update tbl_Bronchoscopy_notes set Indication = '$Indication',Comments='$Comments' where Bronchoscopy_Notes_ID = '$Bronchoscopy_Notes_ID'") or die(mysqli_error($conn));
	}
?>