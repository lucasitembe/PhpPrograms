...
<a href='./otherspaymentlist.php' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<br/><br/>
<fieldset>  
        <legend align='right'><b><?php echo strtoupper('Others Payments ~ '.$Page_Title); ?> </b></legend>
        <center>
             ...
             <tr>
                <td>
                    <div id="Search_Iframe" style="width: 100%;height: 350px">
                       ...
                       <?php include 'Revenue_Center_Unpaid_Others_List.php';?>
