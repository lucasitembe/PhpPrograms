...
<fieldset>
    <legend align=center><b>ATTACH FINANCE DEPARTMENT TO CLINIC</b></legend>
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="box box-primary" style="height: 400px;overflow: auto">
                <div class="box-header">
                    <div class="col-sm-8"> <h4 class="box-title">List of All Finance Department</h4></div>
                    <div class="col-sm-4">
                ...
                <div class="box-body" >
                    ...
                    <div id="all_category_list_body">
                        <table class="table">
                        <?php 
                            $sql_select_category_result=mysqli_query($conn,"SELECT * FROM tbl_finance_department") or die(mysqli_error($conn));
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <select class="form-control" id="idara_id"onchange="refresh_content()"> 
                        ...
                        <?php 
                            $sql_select_main_department_result=mysqli_query($conn,"SELECT * FROM tbl_clinic  WHERE Clinic_Status='Available'") or die(mysqli_error($conn));
 ...
 <script>
     ...
     function attach_clinic_lcation_to_main_clinic(){
        ...
        $.ajax({
            type:'POST',
            url:'ajax_attach_finance_dapartment_to_main_clinic.php',
     ...
     function refresh_content(){
         ...
         $("#category_list_tittle").html("List of Finance Department Location attached to <b>"+idara_name+"</b>")
         $.ajax({
             type:'POST',
             url:'refresh_finance_department_clinic_list.php',
         ...
         $.ajax({
             type:'POST',
             url:'refresh_all_finance_dapartment_list.php',
             data:{idara_id:idara_id},
             success:function(data){
...
function search_category_from_all_list(){
    var Item_Category_Name = $("#all_category_search_box").val();
     $.ajax({
             type:'POST',
             url:'search_all_finance_department_list.php',
