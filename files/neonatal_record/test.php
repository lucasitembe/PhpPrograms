...
<a href="Postnatal_Rejester.php?section=Rch&RchWorks=RchWorksThisPage" class="art-button-green" >BACK</a>


<fieldset style="margin-top:5px;">
<legend style="background-color:#006400;color:white;padding:2px;" align="right"><b>MTOTO NA MAMA BAADA YA KUJIFUNGUA RIPOTI</b></legend>
...
<script type="text/javascript">
    ...
    var to_date=$('#date2').val();
                $.ajax({
                    type: "POST",
                    url: 'postnatal_rch_reports_view.php',
                    data:"d1="+ from_date +"&d2="+ to_date+"&sel="+sel,
...
<table width="100%" class="hiv_table" border="0">
          <tr>
           <td colspan="2">
             From<input id="date" type="text" style="width: 150px;" >&nbsp;
             To&nbsp;<input id="date2" type="text" style="width: 150px;" >&nbsp;
             <input id="filt" style="height:25px; " type="submit" value="Filter" class="art-button-green">
...
<script>
   $('#print_report').click(function(){
     var from_date=$('#date').val();
     var to_date=$('#date2').val();
     window.open('PrintPostNatal.php?from_date='+from_date+'&to_date='+to_date+'');
   });
</script>
