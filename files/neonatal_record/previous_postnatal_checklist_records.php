...
if (isset($_GET['Registration_ID']) && isset($_GET['delivery_year']) && isset($_GET['Employee_ID']) && isset($_GET['consultation_ID']) && isset($_GET['Admision_ID'])) {
...
<?php echo Assets::btnPrintPostnatalChecklist($employee_ID,$registration_id,$delivery_year); ?>
<?php echo Assets::btnBackPreviousPostnatalChecklist($consultation_id,$employee_ID,$registration_id,$admission_id); ?>
              ...
              <fieldset>
                ...
                <table>
                   ...
                   <?php
                    ...
                    ?>
                   <tr>
                     <td><?php echo $Physical_Appearance;?></td>
                     <td><?php echo $Pallor;?></td>
                     <td><?php echo $Pain;?></td>
                      <td><?php echo $Complains;?></td>
                   </tr>
                </table>
              </fieldset><br><br>
            ...
            <fieldset>
                ...
                <table>
                  ...
                  $mode_of_delivery  = mysqli_fetch_assoc($sql_mode_of_delivery)['mode_of_delivery'];
                   ...
                   ?>
                  <!-- row1 Mode of Delivery-->
                  <tr>
                    <td><b>Mode of Delivery</b></td>
                    <td style="width:85%;"><?php echo $mode_of_delivery;?></td>
                  </tr>
                  <tr>
                            ...
                            <fieldset>
                              ...
                              <table>
                                 ...
                                 <?php
                                  ...
                                  ?>
                                 <tr>
                                   <td><?php echo $Perineal_Pad;?></td>
                                   <td><?php echo $Pv_Bleeding;?></td>
                                   <td><?php echo $Source_Of_Bleeding;?></td>
                                   <td><?php echo $Estimated_Blood_Loss;?></td>
                            ...
                            <fieldset>
                              ...
                              <table>
                                <?php
                                 ...
                                 ?>
                                <tr>
                                  <td><?php echo $Additional_Findings;?></td>
                                </tr>
                              </table>
                            </fieldset>
