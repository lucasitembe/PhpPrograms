...
if ($_POST['submit'] == 'Save') {
 ...
 ';
  ...
  $name_of_baby = mysqli_real_escape_string($conn,trim($_POST['name_of_baby']));
  $referral_from = mysqli_real_escape_string($conn,trim($_POST['referral_from']));
  $Employee_ID = mysqli_real_escape_string($conn,trim($_POST['Employee_ID']));
  $transer_from_maternity = mysqli_real_escape_string($conn,trim($_POST['transer_from_maternity']));
  $date_birth = mysqli_real_escape_string($conn,trim($_POST['date_birth']));
  $admission_date = mysqli_real_escape_string($conn,trim($_POST['admission_date']));
  $length_cm = mysqli_real_escape_string($conn,trim($_POST['length_cm']));
  $head_circumference_cm = mysqli_real_escape_string($conn,trim($_POST['head_circumference_cm']));
  $pmtct = mysqli_real_escape_string($conn,trim($_POST['pmtct']));
  $gender = mysqli_real_escape_string($conn,trim($_POST['gender']));
  $apgar_score = mysqli_real_escape_string($conn,trim($_POST['apgar_score']));
  ...
  $chronical_maternal_illiness = mysqli_real_escape_string($conn,trim($_POST['chronical_maternal_illiness']));
  $family_illnesses = mysqli_real_escape_string($conn,trim($_POST['family_illnesses']));
  $gravida = mysqli_real_escape_string($conn,trim($_POST['gravida']));
  $para = mysqli_real_escape_string($conn,trim($_POST['para']));
  $number_of_living_children = mysqli_real_escape_string($conn,trim($_POST['number_of_living_children']));
  $known_problem_of_living_children = mysqli_real_escape_string($conn,trim($_POST['known_problem_of_living_children']));
  $complication_during_previous_pregnancies = mysqli_real_escape_string($conn,trim($_POST['complication_during_previous_pregnancies']));
  ...
  $lnmp = mysqli_real_escape_string($conn,trim($_POST['lnmp']));
  $edd = mysqli_real_escape_string($conn,trim($_POST['edd']));
  $vdrl = mysqli_real_escape_string($conn,trim($_POST['vdrl']));
  $malaria = mysqli_real_escape_string($conn,trim($_POST['malaria']));
  $hep_b = mysqli_real_escape_string($conn,trim($_POST['hep_b']));
  $hb_level = mysqli_real_escape_string($conn,trim($_POST['hb_level']));
  $hypertension = mysqli_real_escape_string($conn,trim($_POST['hypertension']));
  $blood_pressure = mysqli_real_escape_string($conn,trim($_POST['blood_pressure']));
  $drug_abuse = mysqli_real_escape_string($conn,trim($_POST['drug_abuse']));
  $blood_group_rh = mysqli_real_escape_string($conn,trim($_POST['blood_group_rh']));
  $anc_attended = mysqli_real_escape_string($conn,trim($_POST['anc_attended']));
  $where_anc_done = mysqli_real_escape_string($conn,trim($_POST['where_anc_done']));
  $number_of_visits = mysqli_real_escape_string($conn,trim($_POST['number_of_visits']));
  $ga_at_1st_visit = mysqli_real_escape_string($conn,trim($_POST['ga_at_1st_visit']));
  ...
  $maternal_fever = mysqli_real_escape_string($conn,trim($_POST['maternal_fever']));
  $ab_treatment = mysqli_real_escape_string($conn,trim($_POST['ab_treatment']));
  $ab_treatment_yes_drug = mysqli_real_escape_string($conn,trim($_POST['ab_treatment_yes_drug']));
  $prom = mysqli_real_escape_string($conn,trim($_POST['prom']));
  $prom_yes_hrs = mysqli_real_escape_string($conn,trim($_POST['prom_yes_hrs']));
  $amniotic_fluid = mysqli_real_escape_string($conn,trim($_POST['amniotic_fluid']));
  $abnormalities_of_placenta = mysqli_real_escape_string($conn,trim($_POST['abnormalities_of_placenta']));
  $abnormalities_of_placenta_yes = mysqli_real_escape_string($conn,trim($_POST['abnormalities_of_placenta_yes']));
  $abnormal_presentation = mysqli_real_escape_string($conn,trim($_POST['abnormal_presentation']));
  $abnormal_presentation_yes = mysqli_real_escape_string($conn,trim($_POST['abnormal_presentation_yes']));
  $mode_of_delivery = mysqli_real_escape_string($conn,trim($_POST['mode_of_delivery']));
  $cs = mysqli_real_escape_string($conn,trim($_POST['cs']));
  $indication = mysqli_real_escape_string($conn,trim($_POST['indication']));
  $duration_of_cs = mysqli_real_escape_string($conn,trim($_POST['duration_of_cs']));
  $duration_of_labour_stage1 = mysqli_real_escape_string($conn,trim($_POST['duration_of_labour_stage1']));
  $duration_of_labour_stage2 = mysqli_real_escape_string($conn,trim($_POST['duration_of_labour_stage2']));
  $duration_of_labour_stage3 = mysqli_real_escape_string($conn,trim($_POST['duration_of_labour_stage3']));
  $obstructed_labour = mysqli_real_escape_string($conn,trim($_POST['obstructed_labour']));
  $place_of_delivery = mysqli_real_escape_string($conn,trim($_POST['place_of_delivery']));
  $delivery_attendant = mysqli_real_escape_string($conn,trim($_POST['delivery_attendant']));
  $if_assisted_delivery_why = mysqli_real_escape_string($conn,trim($_POST['if_assisted_delivery_why']));
  ...
  $problems_of_baby_after_birth = mysqli_real_escape_string($conn,trim($_POST['problems_of_baby_after_birth']));
  $resuscitation = mysqli_real_escape_string($conn,trim($_POST['$resuscitation']));
  $resuscitation_yes = mysqli_real_escape_string($conn,trim($_POST['resuscitation_yes']));
  $eye_prophylaxis = mysqli_real_escape_string($conn,trim($_POST['eye_prophylaxis']));
  $vitamin_K_given = mysqli_real_escape_string($conn,trim($_POST['vitamin_K_given']));
  $drugs_given = mysqli_real_escape_string($conn,trim($_POST['drugs_given']));
  $drugs_given_yes_which = mysqli_real_escape_string($conn,trim($_POST['drugs_given_yes_which']));
  $feeding_started_within_1_hour = mysqli_real_escape_string($conn,trim($_POST['feeding_started_within_1_hour']));
  $chief_complaints = mysqli_real_escape_string($conn,trim($_POST['chief_complaints']));
  ...
  $fever = mysqli_real_escape_string($conn,trim($_POST['fever']));
  $vomiting = mysqli_real_escape_string($conn,trim($_POST['vomiting']));
  $feeding = mysqli_real_escape_string($conn,trim($_POST['feeding']));
  $enough_breast_milk = mysqli_real_escape_string($conn,trim($_POST['enough_breast_milk']));
  $feeding_interval = mysqli_real_escape_string($conn,trim($_POST['feeding_interval']));
  $passage_of_urine = mysqli_real_escape_string($conn,trim($_POST['passage_of_urine']));
  $passage_of_stool = mysqli_real_escape_string($conn,trim($_POST['passage_of_stool']));
  $quality = mysqli_real_escape_string($conn,trim($_POST['quality']));
  $other_complaints = mysqli_real_escape_string($conn,trim($_POST['other_complaints']));
  $baby_recieve_any_vaccines = mysqli_real_escape_string($conn,trim($_POST['baby_recieve_any_vaccines']));
  ...
  $resp_rate = mysqli_real_escape_string($conn,trim($_POST['resp_rate']));
  $SpO2 = mysqli_real_escape_string($conn,trim($_POST['SpO2']));
  $rbg = mysqli_real_escape_string($conn,trim($_POST['rbg']));
  $appearance_condition = mysqli_real_escape_string($conn,trim($_POST['appearance_condition']));
  $appearance_activeness = mysqli_real_escape_string($conn,trim($_POST['appearance_activeness']));
  $appearance_nourished = mysqli_real_escape_string($conn,trim($_POST['appearance_nourished']));
  $appearance_Pathol = mysqli_real_escape_string($conn,trim($_POST['appearance_Pathol']));
  $appearance_comment = mysqli_real_escape_string($conn,trim($_POST['appearance_comment']));
  $skin_temperature = mysqli_real_escape_string($conn,trim($_POST['skin_temperature']));
  $skin_color = mysqli_real_escape_string($conn,trim($_POST['skin_color']));
  $skin_turgor = mysqli_real_escape_string($conn,trim($_POST['skin_turgor']));
  $skin_cyanosed = mysqli_real_escape_string($conn,trim($_POST['skin_cyanosed']));
  $skin_cyanosed_yes = mysqli_real_escape_string($conn,trim($_POST['skin_cyanosed_yes']));
  $skin_rashes = mysqli_real_escape_string($conn,trim($_POST['skin_rashes']));
  $skin_ctr = mysqli_real_escape_string($conn,trim($_POST['skin_ctr']));
  $head1 = mysqli_real_escape_string($conn,trim($_POST['head1']));
  $head1_shape = mysqli_real_escape_string($conn,trim($_POST['head1_shape']));
  $head1_fontanelle = mysqli_real_escape_string($conn,trim($_POST['head1_fontanelle']));
  $head1_sutures = mysqli_real_escape_string($conn,trim($_POST['head1_sutures']));
  $head1_swelling_trauma = mysqli_real_escape_string($conn,trim($_POST['head1_swelling_trauma']));
  $head1_size = mysqli_real_escape_string($conn,trim($_POST['head1_size']));
  $head2_other_malformation = mysqli_real_escape_string($conn,trim($_POST['head2_other_malformation']));
  $head2_eye_discharge = mysqli_real_escape_string($conn,trim($_POST['head2_eye_discharge']));
  $neck_lymphadenopathy = mysqli_real_escape_string($conn,trim($_POST['neck_lymphadenopathy']));
  $neck_lymphadenopathy_yes = mysqli_real_escape_string($conn,trim($_POST['neck_lymphadenopathy_yes']));
  ...
  $neck_clavicle_fractured = mysqli_real_escape_string($conn,trim($_POST['neck_clavicle_fractured']));
  $breathing_chest_movement = mysqli_real_escape_string($conn,trim($_POST['breathing_chest_movement']));
  $breathing_indrawing = mysqli_real_escape_string($conn,trim($_POST['breathing_indrawing']));
  $breathing_sounds = mysqli_real_escape_string($conn,trim($_POST['breathing_sounds']));
  $breathing_preterm = mysqli_real_escape_string($conn,trim($_POST['breathing_preterm']));
  $heart_rhythm = mysqli_real_escape_string($conn,trim($_POST['heart_rhythm']));
  $heart_murmurs = mysqli_real_escape_string($conn,trim($_POST['heart_murmurs']));
  $heart_describe = mysqli_real_escape_string($conn,trim($_POST['heart_describe']));
  $abdomen = mysqli_real_escape_string($conn,trim($_POST['abdomen']));
  $umbillical_cord = mysqli_real_escape_string($conn,trim($_POST['umbillical_cord']));
  $genitalia_male = mysqli_real_escape_string($conn,trim($_POST['genitalia_male']));
  $genitalia_testis = mysqli_real_escape_string($conn,trim($_POST['genitalia_testis']));
  $genitalia_ambiguous = mysqli_real_escape_string($conn,trim($_POST['genitalia_ambiguous']));
  $genitalia_female = mysqli_real_escape_string($conn,trim($_POST['genitalia_female']));
  $genitalia_female_describe = mysqli_real_escape_string($conn,trim($_POST['genitalia_female_describe']));
  $anus_patent = mysqli_real_escape_string($conn,trim($_POST['anus_patent']));
  $anus_patent_no_describe = mysqli_real_escape_string($conn,trim($_POST['anus_patent_no_describe']));
  $anus_abdnormality = mysqli_real_escape_string($conn,trim($_POST['anus_abdnormality']));
  $back_posture = mysqli_real_escape_string($conn,trim($_POST['back_posture']));
  $back_malformation = mysqli_real_escape_string($conn,trim($_POST['back_malformation']));
  $back_malformation_hints = mysqli_real_escape_string($conn,trim($_POST['back_malformation_hints']));
  $neurology_spotaneous_movement = mysqli_real_escape_string($conn,trim($_POST['neurology_spotaneous_movement']));
  $neurology_musde_tone = mysqli_real_escape_string($conn,trim($_POST['neurology_musde_tone']));
  $neurology_flexes_glasping = mysqli_real_escape_string($conn,trim($_POST['neurology_flexes_glasping']));
  $neurology_flexes_sucking = mysqli_real_escape_string($conn,trim($_POST['neurology_flexes_sucking']));
  $neurology_flexes_traction = mysqli_real_escape_string($conn,trim($_POST['neurology_flexes_traction']));
  $neurology_flexes_moro = mysqli_real_escape_string($conn,trim($_POST['neurology_flexes_moro']));
  $finnstroem_score = mysqli_real_escape_string($conn,trim($_POST['finnstroem_score']));
  $additional_findings = mysqli_real_escape_string($conn,trim($_POST['additional_findings']));
  $key_findings = mysqli_real_escape_string($conn,trim($_POST['key_findings']));
  ...
  $provisional_diagnoses = mysqli_real_escape_string($conn,trim($_POST['provisional_diagnoses']));
  $differential_diagnoses = mysqli_real_escape_string($conn,trim($_POST['differential_diagnoses']));
  $investigation = mysqli_real_escape_string($conn,trim($_POST['investigation']));
  $treatment = mysqli_real_escape_string($conn,trim($_POST['treatment']));
  $supportive_care = mysqli_real_escape_string($conn,trim($_POST['supportive_care']));
  $preventions = mysqli_real_escape_string($conn,trim($_POST['preventions']));
  ...
  $sql_management = "INSERT INTO tbl_neonatal_care_management(
                     ...
                     if ($success) {
                       header("Location:neonatal_care_admission.php?msg=saved&Registration_ID=".$Registration_ID."&consultation_ID".$consultation_ID."");
                     }elseif ($error) {
											 header("Location:neonatal_care_admission.php?msg=fail&error=".mysqli_error($conn)."&Registration_ID=".$Registration_ID."&consultation_ID".$consultation_ID."");
