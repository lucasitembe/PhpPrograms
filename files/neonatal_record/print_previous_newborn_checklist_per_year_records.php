...
$htm .= '<div class="container-fluid">';
 ...
 $htm .= '<fieldset>
   <legend><b>PATIENT DETAILS</b></legend>
      <table class="table" border="1">
        <tr>
          <td style=\'font-size: 16px;\'><b>Name:</b>'.$Patient_Name.'</td>
          <td style=\'font-size: 16px;\'><b>Birth weight:</b>'.$birth_weight.'kg</td>
          <td style=\'font-size: 16px;\'><b>Registration No.:</b>'.$registration_id.'</td>
        </tr>
        <tr>
          <td style=\'font-size: 16px;\'><b>Date of birth:</b>'.$date_birth.'</td>
          <td style=\'font-size: 16px;\'><b>PMTCT:</b>'.$pmtct.'</td>
          <td style=\'font-size: 16px;\'><b>Comment:</b>'.$comment.'</td>
        </tr>
      </table>
 </fieldset>
  <fieldset>
    <legend><b>1st Evaluation After Golden Hour(60-90 min after birth)</b>&nbsp;&nbsp;&nbsp;<b style=\'color:red;background-color:white;\'>Time:'.$first_time.'</b></legend>
      ...
      $employee_Name1 = mysqli_fetch_assoc($sql_employee_name1)['Employee_Name'];
        ...
        while($row = mysqli_fetch_assoc($first_evaluation))
        {
          $htm .= '<tr>';
            ...
            if($birth_weight < 1.8)
            {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$birth_weight."</td>";
            }
            elseif( $birth_weight >= 1.8 &&  $birth_weight < 2.4) {
              $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$birth_weight."</td>";
            }
            elseif($birth_weight >= 2.5 &&  $birth_weight <= 4.0) {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$birth_weight."</td>";
            }
            //End of birth_weight
            ...
            if($apgar < 7)
            {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$apgar."</td>";
            }
            elseif($apgar >= 7 &&  $apgar <= 8)
            {
              $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$apgar."</td>";
            }
            elseif($apgar > 8)
            {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$apgar."</td>";
            }
            //End of apgar
            ...
            {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$temp."</td>";
            }
            elseif($temp >= 36.0  && $temp <= 36.4)
            {
              $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$temp."</td>";
            }
            elseif($temp >= 36.5 && $temp < 37.5)
            {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$temp."</td>";
            }
            //End of temperature
            ...
            {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$maternal_factors."</td>";
            }
            elseif (empty($maternal_factors)) {
              $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$maternal_factors."</td>";
            }
            elseif ($maternal_factors == 'none') {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$maternal_factors."</td>";
            }
            ...
            {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$respiration."</td>";
            }
            elseif($respiration < 30 || $respiration > 60 || $respiration == 'difficult in breathing')
            {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$respiration."</td>";
            }
            elseif ($respiration == '') {
              $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$respiration."</td>";
            }
            ...
            {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$skin_circulation."</td>";
            }
            elseif(empty($skin_circulation))
            {
              $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$skin_circulation."</td>";
            }
            elseif($skin_circulation == 'normal colour' || $skin_circulation == 'capillary refill <= 3sec')
            {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$skin_circulation."</td>";
            }
            ...
            {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$movements."</td>";
            }
            elseif(empty($movements))
            {
              $htm .= "<td style='background-color:yellow;'>".$movements."</td>";
            }
            elseif($movements == 'normal movement')
            {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$movements."</td>";
            }
            //End of movements
            ...
            if ($others == 'congenital malformation' || $others == 'convulsion') {
              $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$others."</td>";
            }
            elseif (empty($others)) {
              $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$others."</td>";
            }
            elseif ($others == 'none') {
              $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$others."</td>";

            }
            $htm .= "<td>".$employee_Name1."</td>";
  ...
  $htm .= ' <legend><b>2nd Evaluation After(4-8 after birth)</b>&nbsp;&nbsp;<b style=\'color:red;background-color:white;\'>Time:'.$second_time.'</b></legend>';
  $htm .= '<table class="table table-hover">
      <tr>
        <th>Umbilicus</th>
        <th>Feeding</th>
        <th>Temp</th>
        ...
        <th>Checked by</th>
            ...
            while($row2 = mysqli_fetch_assoc($second_evaluation))
            {
              ...
              {
                $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$umbilicus."</td>";
              }
              elseif (empty($umbilicus)) {
                $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$umbilicus."</td>";
              }
              elseif ($umbilicus == 'no bleeding') {
                $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$umbilicus."</td>";
              }
              //End of umbilicus
              ...
              {
                $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$feeding."</td>";
              }
              elseif ($feeding == 'breast feeding problem') {
                $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$feeding."</td>";
              }
              elseif ($feeding == 'normal') {
                $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$feeding."</td>";
              }
              ...
              elseif(empty($movements))
              {
                $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$movements."</td>";
              }
              elseif($movements == 'normal movement')
              {
                $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$movements."</td>";
  ...
  $htm .= '<legend><b>3rd Evaluation After(20-24 hours after birth)</b>&nbsp;&nbsp;&nbsp;<b style=\'color:red;background-color:white;\'>Time:'.$third_time.'</b></legend>
    <table class="table table-hover">
      <tr>
        ...
        <th>Checked by</th>
            ...
            while($row3 = mysqli_fetch_assoc($third_evaluation))
            {
              ...
              if($current_weight < 1.8)
              {
                $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$current_weight."</td>";
              }
              elseif( $current_weight >= 1.8 &&  $current_weight < 2.4) {
                $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$birth_weight."</td>";
              }
              elseif($current_weight >= 2.5 &&  $current_weight <= 4.0) {
                $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$current_weight."</td>";
              }
              ...
              {
                $htm .= "<td style='background-color:#ff3333;font-size: 16px;font-weight: bold;'>".$temp3."</td>";
              }
              elseif($temp3 >= 36.0  && $temp3 <= 36.4)
              {
                $htm .= "<td style='background-color:yellow;font-size: 16px;font-weight: bold;'>".$temp3."</td>";
              }
              elseif($temp3 >= 36.5 && $temp3 < 37.5)
              {
                $htm .= "<td style='background-color:#4ce600;font-size: 16px;font-weight: bold;'>".$temp3."</td>";
              }
              //End of temperature
