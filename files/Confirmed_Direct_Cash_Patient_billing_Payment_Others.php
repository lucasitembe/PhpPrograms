            ...
            if($result){
                ...
                if($num_rows > 0 ){
                    ...
                    if($num_details > 0){
                        ...
                        header("Location: ./patientbillingreviewdirectothers.php?Registration_ID=$Registration_ID&Patient_Payment_ID=$Patient_Payment_ID&PatientBilling=PatientBillingThisPage");
                    }
                }
            }
        }
