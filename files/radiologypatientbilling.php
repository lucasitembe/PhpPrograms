...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Setup_And_Configuration'] == 'yes'){ 
?>
    <a href='revenuecenterradiologylist.php?Billing_Type=OutpatientCash&LaboratoryList=LaboratoryListThisForm' class='art-button-green'>
        BACK
    </a>
<?php } } ?>
...
<!--<br/>-->
<fieldset>  
            <legend align=right><b>DEPARTMENT PAYMENTS ~ RADIOLOGY</b></legend>
        <center>
            <table width=100%> 
                <tr> 
                    <td>
