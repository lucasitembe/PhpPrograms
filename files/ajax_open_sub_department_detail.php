...
<div class="row">
    <div class="col-md-12">
        <div id="selected_category_dept_progess_div"></div>
...
//                                           $number_of_service++;
                        ...
                        ///////////////////////////////////////////////////////////////
                               ...
                               echo "<tr>
                                        <td>$count_sn</td>
                                        <td class='department_row' onclick='open_category_detail($Item_Category_ID,$Department_ID,$finance_department_id,$Sub_Department_ID,\"$finance_department_name\",\"$Department_Name\",\"$Sub_Department_Name\",\"$Item_Category_Name\")'><b>".strtoupper($Item_Category_Name)."</b></td>
