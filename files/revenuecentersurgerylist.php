        ...
        <b>
            <?php 
                if(strtolower($B_Type) == 'inpatient cash'){
                    echo strtoupper('Surgery Payments ~ inpatient cash'); 
                }else{
                    echo strtoupper('Surgery Payments ~ outpatient cash'); 
                }
            ?> 
        </b>
    </legend>
<?php
        ...
        echo "<td><a href='patientbillingsurgery.php?section=Surgery&Registration_ID=".$row['Registration_ID']."&Transaction_Type=".$row['Transaction_Type']."&Payment_Cache_ID=".$row['Payment_Cache_ID']."&NR=True&Billing_Type=".$Billing_Type2."&Sub_Department_ID=".$Sub_Department_ID."&SurgeryWorks=SurgeryWorksThisPage' target='_parent' style='text-decoration: none;'>".$row['Patient_Name']."</a></td>";
...
<script>
    function Patient_List_Search(){
        ...
        myObjectSearchPatient.open('GET','Revenue_Center_Surgery_List_Iframe.php?Patient_Name='+Patient_Name+'&Billing_Type='+Billing_Type+'&Patient_Type='+Patient_Type+'&Start_Date='+Start_Date+'&End_Date='+End_Date,true);
...
<script type="text/javascript">
    function Patient_List_Search_Via_Number(){
        ...
        myObjectSearchP.open('GET','Revenue_Center_Surgery_List_Iframe.php?Patient_Number='+Patient_Number+'&Billing_Type='+Billing_Type+'&Patient_Type='+Patient_Type+'&Start_Date='+Start_Date+'&End_Date='+End_Date,true);
