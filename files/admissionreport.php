...
?>
    <fieldset style="background-color:white";>
        <legend align="center" style="background-color:#006400;color:white;padding:5px;"><b>ADMITTED PATIENTS</b></legend> 
     <center>
        <table width='99%' style="border:none !important; border-color:transparent !important;background-color:white;">
            <tr>
                <td style="text-align:center">
                    ...
                    <a href="admissionreportprint.php" id='print_preview' class='art-button-green' target='_blank'>PREVIEW DETAILS</a>
                </td>
            </tr>
        </table>
    </center>
                    ...
                    <tr>
                        <td>
                            <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                                <?php include 'admittedpatientreport_iframe.php'; ?>
                            </div>
                        </td>
                    </tr>
                </table>
...
<script>
    function filterPatient(){
       ...
       /*  if (Date_From == '' || Date_To == ''){
        ...
        $('#print_preview').attr('href','admissionreportprint.php?Patient_Name=' + Patient_Name + '&Date_From=' + Date_From + '&Date_To=' + Date_To + '&ward=' + ward + '&Gender=' + Gender + '&Branch_ID=' + Branch_ID+ '&Sponsor=' + Sponsor+'&row_num='+row_num);
        ...
        $.ajax({
            type: 'GET',
            url: 'admittedpatientreport_iframe.php',
