...
<?php
                    ...
                    <td><b>DATE OF BIRTH</b></td>
                        <td><b>GENDER</b></td>
                            <td><b>PHONE NUMBER</b></td>
                                ...
                                <td><b>DOCTOR'S ADMISSION DATE</b></td>
				</tr>";
    ...
    while($row = mysqli_fetch_array($select_Filtered_Patients)){
        ...
        <td><a href='doctorspageinpatientwork.php?Registration_ID=".$row['Registration_ID']."&Patient_Payment_ID=".$row['Patient_Payment_ID']."&Patient_Payment_Item_List_ID=".$row['Patient_Payment_Item_List_ID']."&NR=true&PatientBilling=PatientBillingThisForm' target='_parent' style='text-decoration: none;'>".$row['Patient_Name']."</a></td>";
        ...
        echo "<td><a href='doctorspageinpatientwork.php?Registration_ID=".$row['Registration_ID']."&Patient_Payment_ID=".$row['Patient_Payment_ID']."&Patient_Payment_Item_List_ID=".$row['Patient_Payment_Item_List_ID']."&NR=true&PatientBilling=PatientBillingThisForm' target='_parent' style='text-decoration: none;'>".$row['Consultation_Date_And_Time']."</a></td>";
	echo "<td>&nbsp;</td>";
    $sn++;
    }   echo "</tr>";
?></table></center>