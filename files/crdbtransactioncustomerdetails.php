...
<fieldset>  <br/>
    ...
    <center><br/><br/><br/>
        <table width = 70%>
            ...
            <tr>
                <td width="20%" style="text-align: right;">Customer Name</td>
        ...
        <table width="70%">
            <tr>
                <td colspan="4" >
                    ...
                    <input type="button" value="RE-SYNCHRONIZE"  style="float:right" class="art-button-green" onclick="sync_epayments('<?php echo EPAY_SERVER_URL; ?>', '<?php echo $remoteTransID; ?>',<?= $Payment_Cache_ID ?>,<?= $Registration_ID?>,'<?= $kutokaphamacy ?>','<?= $from_revenue_phamacy ?>')"/>&nbsp;&nbsp;
                    <img id="progressStatus"  src="images/ajax-loader_1.gif" style="margin: 0;border: 0; display:none;float: right">&nbsp;&nbsp;
                    <input type="button"   style="float:right"  class="art-button-green" value="PRINT DETAIL RECEIPT" onclick="Print_Receipt_Payment('<?php echo $Payment_Code ?>')">
