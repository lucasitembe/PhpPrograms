...
if ($Transaction_Status_Title == 'NOT PAID') {
   // echo '<button class="art-button-green" type="button" style="float:left;" onclick="Add_New_Items()">ADD ITEM</button><img id="loader" style="float:left;display:none" src="images/22.gif"/>';
}
			?>
...
<script type="text/javascript">
    function Re_Add_Item(Product_Name,Payment_Item_Cache_List_ID){
        ...
        if (Confirm_Message == true) {
            ...
            myObjectReAdd.open('GET','Patient_Billing_Procedure_Re_Add_Item_Removed.php?Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Transaction_Type='+Transaction_Type+'&Payment_Item_Cache_List_ID='+Payment_Item_Cache_List_ID,true);
            myObjectReAdd.send();
        }
    }
</script>
