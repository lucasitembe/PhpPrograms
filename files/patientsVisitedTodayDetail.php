...
<center>
	...
	<!--End datetimepicker-->
<fieldset>
            <legend align=center><b>VISITED PATIENTS REPORT</b></legend>
        <center>
            <?php
   ...
   $currentDate=date('Y-m-d');
    $select_patient = mysqli_query($conn,"SELECT * FROM tbl_patient_registration pr,tbl_check_in ci 
				    ...
				    AND pr.Registration_Date < '$currentDate'
	...
	echo "<form action='printPatientsVisitedToday.php?PrintPatientsVisitedTodayThisPage' method='POST'>
		<tr>
        ...
        echo "<tr><td colspan='9' style='text-align:center'><b style='color:red'>No patient visited today</b></td></tr>";
    }
	    ?>
