...
?>
<a href="print_pendapplic_procedure.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a>
<a href="procedurelistreport.php" class="art-button-green">BACK</a>
<fieldset style='margin-top:15px;'>
    <legend align=right style="background-color:#006400;color:white;padding:5px;"><b>PATIENTS WITH PROCEDURE ACTIVE / PENDING / NOT APPLICABLE  REPORT</b></legend>
                ...
                <tr>
                    <td>
                        <div style="width:100%; height:390px;overflow-x: hidden;overflow-y: auto"  id="Search_Iframe">
                            <?php include 'patient_pendapplic_porcedure_iframe.php'; ?> 
                        </div>
                    </td>
                </tr>
            </table>
...
<script>
    ...
    $('#filterDate').click(function(e){
       ...
       $('#printPreview').attr('href', 'print_pendapplic_procedure.php?fromDate=' + fromDate + '&toDate=' + toDate+ '&procedureStatus=' + procedureStatus+ '&sponsorID=' + sponsorID);

        $.ajax({
            type:'GET',
            url:'patient_pendapplic_porcedure_iframe.php',
