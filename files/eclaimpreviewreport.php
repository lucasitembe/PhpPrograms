...
//get insurance name
$select = mysqli_query($conn,"select Guarantor_Name, pr.Sponsor_ID from tbl_patient_registration pr, tbl_sponsor sp where
...
?>
<input  type='button' onclick="Print_Receipt_Payment('<?php echo $Sponsor_ID; ?>','<?php echo $Registration_ID; ?>','<?php echo $Check_In_ID; ?>')" class='btn btn-danger btn-sm' value='PRINT BILL' >
<input type="button" value="BACK" class="art-button-green" onclick="close_window()">
<script>
    function Print_Receipt_Payment(Insurance, Registration_ID,Check_In_ID){
        // alert(Registration_ID);
        // alert(Check_In_ID+'=='+Registration_ID);
        var winClose=popupwindow('eclaimprintgatepass.php?Insurance='+Insurance+'&Registration_ID='+Registration_ID+'&Check_In_ID='+Check_In_ID, 'PATIENT GATE PASS', 530, 400);    
...
$htm = "<br/><br/><fieldset><center>";
// $htm .= "<table width ='80%' height = '10%'>
//     <tr><td><img src='./branchBanner/branchBanner.png' width='100%' height='30%'></td></tr>
//     <tr><td>&nbsp;</td></tr></table>";
    //get visit date
...
$select_Transaction_Items = mysqli_query($conn," SELECT * from
    ...
    $htm .= "<table width=80% style='padding-top:-25px;'>";
    $htm .= "<tr><td colspan=12><hr style='color: #000000'></td></tr>"; // ehms2gpitg2014
...
while ($cat = mysqli_fetch_array($select_category_details)) {
    ...
    //display details
    $htm .= '<table width=80% border=1 style="border-collapse: collapse;">';
    $htm .= '<tr>
...
<script>
    // function Print_Receipt_Payment(Folio_Number, Insurance, Registration_ID,Check_In_ID){
    //     alert(Check_In_ID+'=='+Registration_ID);
    //     var winClose=popupwindow('eclaimprintgatepass.php?Folio_Number='+Folio_Number+'&Insurance='+Insurance+'&Registration_ID='+Registration_ID+'Check_In_ID='+Check_In_ID, 'PATIENT GATE PASS', 530, 400);    
