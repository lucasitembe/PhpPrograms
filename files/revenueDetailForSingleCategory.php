...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['General_Ledger'] == 'yes'){ 
?>
    <a href='./revenueCategoryDetails.php?categoryID=<?php echo $_GET['categoryID'];?>$Branch=<?php echo $_GET['Branch']?>&Date_From=<?php echo $_GET['Date_From']?>&Date_To=<?php echo $_GET['Date_To']?>&sponsorID=<?php echo $_GET['sponsorID']?>FinanceWork=FinanceWorkThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
