approved_list.php<?php
include("./includes/header.php");
include("./includes/connection.php");
?>
    <a href='./Approve_list.php?engineering_works=engineering_WorkThisPage' class='art-button-green'>
        BACK
    </a>
...
<fieldset>  
            <legend align=center><b>LIST OF APPROVED JOBCARDS</b></legend>
...
<form name="myform" action="" method="POST">
	...
	<?php
          $display_table="<table width=100% class='row'> 
			...
			$query_data=mysqli_query($conn,"SELECT * FROM tbl_jobcards WHERE status='Approved' ORDER BY jobcard_ID DESC");
			...
			while($result_query=mysqli_fetch_array($query_data)){
				...
				<tr> <td><center>".$num.".</center></td>
					...
					<td>".$result_query['requesting_engineer']."</td>
                                        ...
                                        <td><a href='project_boq.php?Process_Jobcard=True&jobcard_ID=".$result_query['jobcard_ID']."' class='art-button-green'>PROJECT BOQ</a></td>"
                                        ;
                        if(isset($_GET['lForm']))
