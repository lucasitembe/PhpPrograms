...
///////////////////////////////////////////////////////////////////////////////////////
    $query_string="section=".$_GET['section']."&Registration_ID=".$_GET['Registration_ID']."&Transaction_Type=".$_GET['Transaction_Type']."&Payment_Cache_ID=".$_GET['Payment_Cache_ID']."&NR=".$_GET['NR']."&Billing_Type=".$_GET['Billing_Type']."&Sub_Department_ID=".$_GET['Sub_Department_ID']."&SurgeryWorks=".$_GET['SurgeryWorks']."";
...
<!-- back button -->
<a href='revenuecentersurgerylist.php?Billing_Type=OutpatientCash&LaboratoryList=LaboratoryListThisForm' class='art-button-green'>BACK</a>
...
<script>
      ...
      $.ajax({
          ...
          data:{Registration_ID:Registration_ID,Payment_Cache_ID:Payment_Cache_ID,Sub_Department_ID:Sub_Department_ID,Transaction_Type:Transaction_Type,Patient_Name:Patient_Name,Check_In_Type:'Surgery'},
    ...
    function get_terminals(trans_type){
        ...
        if(trans_type.value=="Manual"){
            ...
            if(result){
                    ...
                    document.location = 'Patient_Billing_Surgery_Page.php?itemzero='+itemzero+'&Transaction_Type=<?php echo $Transaction_Type; ?>&Payment_Cache_ID=<?php echo $Payment_Cache_ID; ?>&Sub_Department_ID=<?php echo $Sub_Department_ID; ?>'+'&manual_offline=manual';
                    } else{
                     document.location = 'Patient_Billing_Surgery_Page.php?Payment_Cache_ID=<?php echo $Payment_Cache_ID ?>&Transaction_Type=<?php echo $Transaction_Type ?>&Sub_Department_ID=<?php echo $Sub_Department_ID?>"&Registration_ID=<?php echo $Registration_ID ?>&Billing_Type=<?php echo $Temp_Billing_Type2 ?>'+'&manual_offline=manual';
                     }
           }
        }else{
                $.ajax({
      ...
      function offline_transaction(amount_required,reg_id){
        ...
        var uri = '../epay/patientbillingsurgeryOfflinePayment.php';
...
<script>
 ...
 function removeitem(item){
    ...
    if(check){     
     $.ajax({
         type: 'POST',
         url: "change_items_info_surgery.php",
...
<script>
    function Pay_Via_Mobile_Function(Payment_Cache_ID){
        ...
        myObjectGetDetails.open('GET','ePayment_Patient_Details_Departmental.php?Section=Surgery&Employee_ID='+Employee_ID+'&Registration_ID='+Registration_ID+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID,true);
...
<script type="text/javascript">
    function Confirm_Create_ePayment_Bill(){
        ...
        myObjectConfirm.open('GET','Confirm_ePayment_Patient_Details_Departmental.php?Section=Surgery&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID,true);
            ...
            if(Payment_Mode != null && Payment_Mode != ''){
                if(Payment_Mode == 'Bank_Payment'){
                    ...
                    if (Confirm_Message == true) {
                        document.location = 'Departmental_Bank_Payment_Transaction.php?Section=Surgery&Registration_ID='+Registration_ID+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID;
                    }
