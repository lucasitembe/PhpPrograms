...
<?php
	//calculate total
	$get_total = mysqli_query($conn,"select sum((Price - Discount) * Quantity) as Amount from tbl_inpatient_items_list_cache where Employee_ID = '$Employee_ID' and Registration_ID = '$Registration_ID'") or die(mysqli_error($conn));
