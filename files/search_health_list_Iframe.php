...
$select_Filtered_Patients = mysqli_query(
    $conn,
    "SELECT pr.Patient_Name, pr.Old_Registration_Number, pr.Registration_ID, pr.Date_Of_Birth, pr.Gender, pr.Phone_Number, pr.Member_Number, sp.Guarantor_Name FROM tbl_patient_registration pr, tbl_sponsor sp, tbl_health_info hi WHERE pr.sponsor_id = sp.sponsor_id AND pr.Registration_ID = hi.registration_id  "
