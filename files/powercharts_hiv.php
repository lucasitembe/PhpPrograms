 ...
 if(isset($_SESSION['userinfo']))
	{
		...
		{
			if($_SESSION['userinfo']['Hiv_Works'] != 'yes'){ header("Location: ./index.php?InvalidPrivilege=yes");} 
		}else
			{
...
$.ajax({
    type: "POST",
    url: 'powercharts_hiv_insert.php',
...
//$('#hiv_status').change(
  //  function() {
	//var f = $('#hiv_status option:selected').val();
...
<a class="art-button-green" href="searchvisitorsoutpatientlistforhiv.php">Back</a>
...
$checkifyupo = "SELECT pr_r,status FROM tbl_hiv_first_visit WHERE pr_r= '$x' AND status='active'";
...
window.location.href="powercharts_hiv_re.php?ctcno=<?php echo $x; ?>";	
</script>
...
window.location.href="powercharts_hiv.php?ctcnox=<?php echo $x; ?>";	
</script>
...
<fieldset style="margin-top:5px;">
    <center>
                  <div id="ha" style="background: #000; color: #fff">What?</div>  <table width="100%" class="hiv_table" border="0" > 
                         <tr>
                             <td colspan=""><button  class="art-button-green" id="sv" >Save and Go Back</button></td>
			 ...
			 <td colspan="2"><input readonly value="<?php echo strtoupper( $fname." ".$mname." ".$lname); ?>" type="text"><input type="hidden" id="prid" value="<?php echo $pn; ?>"></td>
			    ...
			    <option value="none">Select From List</option>
                        ...
                        <tr>
                            ...
                            <td><input name="" type="text" id="date2"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input name="" type="text" id="date" ></td>
                        </tr>
                        <tr>
