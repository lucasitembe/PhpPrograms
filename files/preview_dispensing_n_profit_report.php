...
session_start();
    ...
    $htm = '<table align="center" width="100%">
                ...
                <tr><td style="text-align:center"><b>PHARMACY PROFIT AND LOSS REPORT</b></td></tr>
    ...
    $htm.="<table class='table' style='background: #FFFFFF' border=1 style='border-collapse: collapse;'>
            <tr>
...
<!--            <tr><td colspan="9"><hr></td></tr>
            ...
            <?php
                    ...
                    $grand_total_total_stock_value=number_format($grand_total_total_stock_value);
                        $htm.= "<tr class='rows_list' onclick='load_selected_dispencing_unit($Sub_Department_ID)'>
                                <td><b>$count.<b></td>
