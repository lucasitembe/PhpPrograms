...
<fieldset style='margin-top:30px;'>
    <legend id="resultsconsultationLablist" style="font-weight: bold;font-size: 16px;background-color: #006400; padding:10px; color:white;width: auto;" align="right">PENDING RADIOLOGY PATIENTS LIST</legend>
    <center>
        <hr width="100%">
    </center>
            ...
            <tr>
                <td id='Search_Iframe'>
                    <div id="iframeDiv" style="height: 460px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'radiologypendinglist_iframe.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
<center>
    <?php
        ...
        echo '<a href="searchpatientradiologylist.php" class="art-button-green">UN CONSULTED</a>';
   ?>
</center> 
<script>
    function filterLabpatient() {
        ...
        mm.open('GET', 'radiologypendinglist_iframe.php?filterlabpatientdate=true&Date_From=' + Date_From + '&Date_To=' + Date_To + '&Sponsor=' + Sponsor+ '&Patient_Name=' + Patient_Name+ '&SubCategory=' + SubCategory, true);
        mm.send();
    }
