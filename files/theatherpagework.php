...
<script language="javascript" type="text/javascript">
    function searchPatient(Patient_Name){
		...
		"<iframe width='100%' height=380px src='theatherpageworks_iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
<center>
<br/>
...
<fieldset>  
        ...
        <center>
            <table width=100% border=1>
                <tr>
					<td id='Search_Iframe'>
				<iframe width='100%' height=380px src='theatherpageworks_iframe.php' ></iframe>
					</td>
				</tr>
            </table>
        </center>
