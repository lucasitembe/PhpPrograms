      ...
      <td>
        ...
        <form action='' method='POST' name='' id='myForm' >
		    ...
		    <td width='10%' style='text-align: right;'>Department Requesting</td>
                ...
                <td>
                <?php
                            echo "<input type='text'  readonly='readonly' name='part_date' id='part_date' value='$issue_date'>";
                    ?>
                </td>
                <td style='text-align: right;'>Procurement Officer:</td>
                <td>
                <?php
                            echo "<input type='text'  readonly='readonly' name='part_date' id='part_date' value='$issuer'>";
                    ?>
                </td>
                <td style='text-align: right;'>Engineer Signature: </td>
                <td>
                <?php
                            echo "<input type='text'  readonly='readonly' name='part_date' id='part_date' value='$engineers'>";
                    ?>
                </td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td colspan='6'><center><label> Your Recent Staff Satisfaction Score was: <?php echo $satisfication ?></center>
                            </tr>
</table>
                        </form>
                            </table>
...
//         $final_status=$_POST['final_status'];
      ...
      if(!empty($Requisition_ID)){
//         //  if(!empty($completed)){
             $update_requisition_for_engineering = "UPDATE tbl_engineering_requisition SET satisfy='$satisfy' WHERE requisition_ID='$Requisition_ID'";
