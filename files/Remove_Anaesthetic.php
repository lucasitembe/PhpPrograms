...
<?php
    ...
    $selected_surgeon = mysqli_query($conn,"select emp.Employee_Name, Participant_ID from tbl_post_operative_participant pop, tbl_employee emp where
                                        ...
                                        pop.Employee_Type = 'Anaesthetics' and
    ...
    ?>
        <tr>
            ...
            <td width="12%" style="text-align: center;">
                <input type="button" name="SelectedAssistantSurgeons" id="SelectedAssistantSurgeons" value="REMOVE" class="art-button-green" onclick="Remove_Anaesthetic(<?php echo $dtz['Participant_ID']; ?>)">
            </td>
        </tr>
    <?php 
        }
