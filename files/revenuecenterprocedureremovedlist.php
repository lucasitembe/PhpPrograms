...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Revenue_Center_Works'] == 'yes'){ 
?>
     <a href="revenuecenterprocedureremovedlist.php" class="art-button-green">REMOVED ITEMS</a>
     <a href='revenuecenterprocedurelist.php' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
        ...
        <center>
            ...
            <td id='Search_Iframe'>
                <div style="width: 100%;height: 350px">
                    <?php include 'Revenue_Center_Procedure_Removed_List_Iframe.php';?>
                </div>
	    </td>
        </tr>
            </table>
