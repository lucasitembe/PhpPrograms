...
<!-- <input type="text" value="<?php echo $Spectacle_ID;?>"> -->
...
<br/><br/>
<fieldset>  
    <legend align="right"><b>Optical Patient List</b></legend>
    <center>
        <table width=100%>
            <tr>
      ...
      ?>
        ...
        // if($numrow > 0){
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:1em">
                ...
                <div class="one">
                <label style="text-align:left;">Remark</label><input type="text" class="form-control" value="<?php echo $add_remark ;?>"readonly>
                </div>
            </div>
        <?php 
        }
...
<script>
    function Save_Information(){
        ...
        if (r == true) {
            document.location = 'Optical_Save_Information.php?Registration_ID=' + Registration_ID + '&Folio_Number=' + Folio_Number + '&Claim_Form_Number=' + Claim_Form_Number + '&Consultant_ID=' + Consultant_ID+'&consultation_ID='+consultation_ID+'&Spectacle_ID='+Spectacle_ID+'&finance_department_id='+finance_department_id+'&Clinic_ID='+Clinic_ID;
        }
...
<script type='text/javascript'>
    ...
    function Save_Information555555() {
        // alert("gggggggg");
        // var Guarantor_Name = '< ?php echo $Guarantor_Name; ?>';
        // var Claim_Form_Number = document.getElementById("Claim_Form_Number").value;
        // var Folio_Number = document.getElementById("Folio_Number").value;
    ...
    function create_epayment_mobile_card_bill(){
        ...
        var Spectacle_ID = '<?php echo $Spectacle_ID; ?>';
            ...
            if(confirm("Are You sure you want to go to Mobile/Card Payment")){
                $.ajax({
                    type:'GET',
                    url:'optical_go_to_mobile_card.php',
                    data:{Registration_ID:Registration_ID,
                    Check_In_Type:Check_In_Type,
                    consultation_ID:consultation_ID,
                    Section:Section,
                    Spectacle_ID:Spectacle_ID,
                    finance_department_id:finance_department_id,
                    Folio_Number:Folio_Number,
                    Billing_Type:Billing_Type
                    },
                    success:function(data){
                        if(data=="success"){
                            document.location = "./patient_sent_to_cashier_payment.php?Registration_ID=" + Registration_ID + "&Check_In_Type="+Check_In_Type";
                        }else{
