...
<center><p style="margin-top:10px;color: #0079AE;font-weight:bold"><i> Click Jobcard Details in case you want to Approve it </i></p></center>
<fieldset>  
    <legend align=center><b>JOBCARD APPROVAL LIST</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
		    <td id='Search_Iframe'>
			<iframe width='100%' height=380px src='approval_jobcard_iframe.php?Patient_Name='></iframe>
		    </td>
		</tr>
            </table>
        </center>
...
<script language="javascript" type="text/javascript">
    function filterJobcard(){
        ...
        document.getElementById('Search_Iframe').innerHTML ="<iframe width='100%' height=380px src='approval_jobcard_iframe.php?Employee_ID="+Employee_ID+"&Jobcard_Number="+Jobcard_Number+"'></iframe>";
    }
