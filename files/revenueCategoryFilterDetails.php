...
if($_GET['categoryID']){
   // echo $catID=$_GET['categoryID']."<br>";
    //echo $Branch=$_GET['Branch']."<br>";
    //echo $Date_From=$_GET['Date_From']."<br>";
    //echo $Date_To=$_GET['Date_To']."<br>";
    //echo $sponsorID=$_GET['sponsorID']."<br>";    
}
?>
...
<form action='revenueCategoryDetailsAfterFilterResult.php' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
    <table width=80%>
        <tr>
...
<fieldset>  
    ...
    echo "<tr>
		...
		//get the values from the category
		$catID=$_GET['categoryID']."<br>";
		$Branch=$_GET['Branch']."<br>";
		$Date_From=$_GET['Date_From']."<br>";
		$Date_To=$_GET['Date_To']."<br>";
		$sponsorID=$_GET['sponsorID']."<br>";
	if($Branch ==0 && $sponsorID==0){
	    ...
	    $query="  SELECT *
				    ...
				    AND pr.Registration_ID=pp.Registration_ID
	...
	echo "<td style='text-align: center;'><a href='individualsummaryreport.php?Patient_Payment_ID=$receiptNo&IndividualSummaryReport=IndividualSummaryReportThisForm' target='_blank' style='text-decoration: none;'>$receiptNo</a></td>";
