...
function getFormDetails($consultation_ID, $Registration_ID, $Admission_ID){
    ...
    $query = "SELECT id FROM tbl_icu_form_six WHERE registration_id = '$Registration_ID' 
    ...
    if ($result){
        ...
        $query = "INSERT into tbl_icu_form_six (registration_id, consultation_id, admission_id, record_date, created_at)
...
function getFormData($formId){
    ...
    $query = "SELECT name, shift, value from tbl_icu_form_six_records WHERE record_id = $formId";
