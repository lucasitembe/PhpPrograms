...
?>
    <a href='./patientsRevisitedPreviousDays.php?Reception=ReceptionThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<br/><br/>
<center>
    <form action='patientsRevisitedPreviousDaysFilter.php?PatientsVisitedPreviousDaysThisPage' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
    <table width=60%>
        <tr>
...
<fieldset>
    ...
    ?>
            <legend align=center><b>PATIENTS REVISITED PREVIOUS DAYS REPORT FROM <?php echo "<b style='color:blue'>".date('j F, Y',strtotime($Date_From))."</b>" ?> TO <?php echo "<b style='color:blue;'>".date('j F, Y',strtotime($Date_To))."</b>";?></b></legend>
        <center>
            <?php
   ...
   $currentDate=date('Y-m-d');
    ...
    if(mysqli_num_rows($select_patient) > 0){
            ...
            for($i=0;$i<$res;$i++){
                ...
                $Check_In_Date=$row['Check_In_Date_And_Time'];
                ...
                echo "<td style='text-align:left; width:10%'>".$Check_In_Date."</td>";
        }
	echo "<form action='printPatientsRevisitedPreviousDaysFilter.php?PrintPatientsRevisitedPreviousFilterDayThisPage' method='POST'>
		<tr>
        ...
        echo "<tr><td colspan='9' style='text-align:center'><b style='color:red'>No patient revisited on the dates specified.</b></td></tr>";
    }
	    ?></table></center>
        </center>
</fieldset><br/>
