...
//    }
//    
//    0Cannot add or update a child row: a foreign key constraint fails (`database`.`tbl_items_balance`, CONSTRAINT `tbl_items_balance_ibfk_1` FOREIGN KEY (`Item_ID`) REFERENCES `tbl_items` (`Item_ID`))
    
//    Store_Issue  starts here

    $Balance = $Item_Balance2; // - $Item_Temporary_Balance;
    echo $Balance;
?>