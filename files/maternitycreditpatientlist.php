...
<script language="javascript" type="text/javascript">
    function seamaternityPatient(Patient_Name){
        document.getElementById('Seamaternity_Iframe').innerHTML = "<iframe width='100%' height=320px src='maternitycreditpatientlist_Iframe.php?Patient_Name="+Patient_Name+"'></iframe>";
    }
</script>
...
<fieldset>  
            <legend align=center><b>MATERNITY CREDIT PATIENT LIST</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Seamaternity_Iframe'>
		<iframe width='100%' height=320px src='maternitycreditpatientlist_Iframe.php?Patient_Name='></iframe>
            </td>
        </tr>
            </table>
        </center>
