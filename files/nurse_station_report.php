...
if (isset($_SESSION['userinfo'])) {
    if ($_SESSION['userinfo']['Nurse_Station_Works'] == 'yes') {
        ?>
        <a href='nurse_station_report_print.php' id='printreport' class='art-button-green' target='_blank'>
            PRINT REPORT
        </a>
    <?php }
}
...
<br/>
<fieldset>  
    <legend align=center><b id="dateRange">PATIENT VITALS REPORT <span class='dates'><?php echo date('Y-m-d')?></span> </b></legend>
    <center>
        <table width='100%' border='1'>
            <tr>
                <td >
                    <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'nurse_station_report_frame.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
<script>
    function filterPatient() {
        ...
        var datastring = 'Date_From=' + Date_From + '&Date_To=' + Date_To + '&Patient_Name=' + Patient_Name+'&Sponsor=' + Sponsor+ '&Patient_Number=' + Patient_Number + '&Patient_Old_Number=' +Patient_Old_Number;

        $('#printreport').attr('href','nurse_station_report_print.php?'+datastring);

        document.getElementById('dateRange').innerHTML = "PATIENT VITALS REPORT "+range;

        document.getElementById('Search_Iframe').innerHTML = '<div align="center" style="" id="progressStatus"><img src="images/ajax-loader_1.gif" width="" style="border-color:white "></div>';

        $.ajax({
            type: "GET",
            url: "nurse_station_report_frame.php",
            data: datastring,
