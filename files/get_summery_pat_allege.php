...
$data = "<center>
	...
	$allegies=mysqli_query($conn,"SELECT Allegies FROM tbl_nurse WHERE Registration_ID='$Registration_ID'");
    ...
    $data .='<tr>
		...
		<td><textarea style="resize:none;padding-left:5px;" readonly="readonly" id="maincomplain" name="maincomplain">' .$patient_allege. '</textarea></td>
	   </tr></table>';
