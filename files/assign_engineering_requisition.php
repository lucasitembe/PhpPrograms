...
<table id="spu_lgn_tbl" width='90%'>
    <tr>
      <td>
        <fieldset>
        <legend align=center><b>ASSIGN REQUISITION FOR ENGINEERING</b></legend>
...
<table width=90%>
                <tr>
                  <td>
                    <fieldset>
                        <legend align=center><b>JOB ASSGNMENT AND COLLECTION</b></legend>
                        ...
                        <table width=100% id='spu_lgn_tbl'>
                            ...
                            <tr>
                                <td colspan=4 style='text-align: center;'>
                                     <input type='submit' name='submit_form' id='submit_form' value='   ASSIGN ENGINEER   ' class='art-button-green'>
                                </td>
                            </tr>
...
$update_requisition_for_engineering='';
 ...
 if(isset($_POST['submit_form'])){
   ...
   $update_requisition_for_engineering="UPDATE tbl_engineering_requisition SET assigned_engineer='$assigned_engineer',assistance_engineer='$assistance_engineer',section_required='$section_required',helpdesk='$Employee_ID', type_of_work='$type_of_work',requisition_status='assigned', assigned_at = NOW() WHERE requisition_ID='$Requisition_ID'";
      $save_result= mysqli_query($conn,$update_requisition_for_engineering);
      
     if ($save_result)
     {
         echo "<script>alert('Engineering requisition Assigned successfully!');
         document.location = './received_engineering_requisition.php?section=Engineering_Works=Engineering_WorksThisPage'</script>";
    }
     else 
     {
