...
if (isset($_POST['submitRadilogyform'])) {
    ...
    $patient_Problem = mysqli_real_escape_string($conn,$_POST['patient_Problem']);
    $nursing_diagnosis = mysqli_real_escape_string($conn,$_POST['nursing_diagnosis']);
    ...
    $insert_testing_record = "INSERT INTO tbl_nursecommunication_paediatric(Registration_ID, consultation_ID, employee_ID, date_time, temp, Pr, Resp, So, patient_Problem, nursing_diagnosis, expected_outcome, implementation, outcome, investigation, Remarks)
                                    VALUES('$Registration_ID','$consultation_ID','$Employee_ID',NOW(),'$temp','$pr','$resp','$so','$patient_Problem','$nursing_diagnosis','$expected_outcome','$implementation','$outcome','$investigation','$remarks')";
    ...
    <script>
        ...
        window.location = "nursecommunication_paediatric.php?<?php echo $_SERVER['QUERY_STRING'] ?>";
    </script>
    <?php
}
?>
...
<fieldset>
    <legend align="center" style='padding:10px;color:white;background-color:#2D8AAF;text-align:center'><b>
            <b>PAEDIATRIC WARD-OBSERVATION CHART</b><br/>
                        ...
                        <center>
                            <table style="width:100%" class="hiv_table"  >
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right;font-size:14px" width="13%"><b>Resp(bpm)</b></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Patient problem</b></td>
                                    <td ><input type="text" name="patient_Problem" id="patient_Problem" class="input_style"  /></td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;font-size:14px" width="13%" required="required"><b>Nursing diagnosis</b></td>
                                    <td  ><input type="text" name="nursing_diagnosis" id="nursing_diagnosis" class="input_style"  /></td>

                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Expected outcome</b></td>
                                    <td ><input type="text" name="expected_outcome" id="expected_outcome" class="input_style"  /></td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;font-size:14px" width="13%" required="required"><b>Nursing implementation</b></td>
                                    <td  ><input type="text" name="implementation" id="implementation" class="input_style"  /></td>

                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Outcome</b></td>
                                    <td ><input type="text" name="outcome" id="outcome" class="input_style"  /></td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;font-size:14px" width="13%" required="required"><b>Investigation</b></td>
                                    <td  ><input type="text" name="investigation" id="investigation" class="input_style"  /></td>
        ...
        <table width='100%'>
            <tr>
                <td>    
                    ...
                    <a href="nursecommunication_paediatric__print.php?Registration_ID=<?php echo $_GET['Registration_ID'] ?>&consultation_ID=<?php echo $_GET['consultation_ID'] ?>" id="printPreview" class="art-button-green" target="_blank" style="float:right">Preview</a>
...
<?php include 'nursecommunication_paediatric_Iframe.php'; ?>
</div>
...
<script>
    function filterPatient() {
        ...
        $('#printPreview').attr('href', 'nursecommunication_paediatric__print.php?start=' + start + '&end=' + end + '&Registration_ID=' + Registration_ID + '&consultation_ID=' + consultation_ID);
        ...
        $.ajax({
            type: "GET",
            url: "nursecommunication_paediatric_Iframe.php",
