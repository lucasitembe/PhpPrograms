...
$Title = '<tr><td colspan="14"><hr></tr>
            <tr>
                ...
                <td style="text-align: right;" width="7%"><b>BALANCE</b></td>
                <td style="text-align: right;" width="7%"><b>REFUND</b></td>
                </tr>
            <tr><td colspan="14"><hr></tr>';
?>
<fieldset style='overflow-y: scroll; height: 400px; background-color:white'>
<legend style="background-color:#006400;color:white" align="right"><b>PENDING BILLS REPORT (WARD NAME : <?php echo strtoupper($Hospital_Ward_Name); ?>)</b></legend>
<center><table width =100% border=0>
    <?php
        ...
        echo $Title;
        $select = mysqli_query($conn,"select ad.Admision_ID, pr.Patient_Name, pr.Registration_ID, pr.Gender, pr.Date_Of_Birth, pr.Member_Number, sp.Guarantor_Name, sp.Exemption, cd.Check_In_ID, hw.Hospital_Ward_Name,TIMESTAMPDIFF(DAY,Admission_Date_Time,NOW()) AS NoOfDay, pending_set_time, pending_setter
    ...
    ?>
                ...
                ?>
                    <td style="text-align: right;"><label style="color: #037CB0;" onclick="Preview_Details(<?php echo $Registration_ID; ?>,<?php echo $Check_In_ID; ?>,<?php echo $Hospital_Ward_ID; ?>,<?php echo $Admision_ID; ?>,'<?php echo $Transaction_Type; ?>')"><?php echo number_format($balance_total); ?></label></td>
    ...
    <fieldset>
        <table width="100%">
            <tr>
                ...
                <td style="text-align: right;" width="15%"><b>TOTAL EXCEPTION : <?php echo number_format($General_Total_Exemption); ?></b></td>
                <td style="text-align: right;" width="20%"><b>TOTAL AMOUNT PAID : <?php echo number_format($General_Total_Paid); ?></b></td>
                <?php 
                ...
                ?>
                <td style="text-align: right;" width="15%"><b>BALANCE: <?php echo number_format($balance_general); ?></b></td>
