...
<br/>
<fieldset>
    <legend align=right><b><?php if(isset($_SESSION['Departmental_Requisition_Control'])){ echo $Sub_Department_Name; } ?>, Pending Reagent requisitions prepared by : <?php echo $Employee_Name; ?></b></legend>
    
    <iframe src='Reagent_Pending_Requisitions_Iframe.php?Employee_ID=<?php echo $Employee_ID; ?>&Date_From=<?php echo $Date_From; ?>&Date_To=<?php echo $Date_To; ?>' width=100% height=380px></iframe>
