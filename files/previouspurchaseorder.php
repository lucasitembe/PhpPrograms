...
<form action='#' method='post' name='myForm' id='myForm'>
    <table width=60%> 
        <tr> 
            <td><b>From</b></td>
            <td width=30%>
                <input type='text' name='Date_From' id='date' required='required'>
            </td>
            <td><b>To</b></td>
            <td width=30%>
                <input type='text' name='Date_To' id='date2' required='required'>
            </td>
...
<br/>
<fieldset>
    <legend align=right><b><?php if(isset($_SESSION['Storage'])){ echo $_SESSION['Storage']; }?>, Previous GRN - Open Balance, prepared by : <?php echo $Employee_Name; ?></b></legend>
    <iframe src='Previous_Grn_Open_Balance_Iframe.php?Employee_ID=<?php echo $Employee_ID; ?>&Date_From=<?php echo $Date_From; ?>&Date_To=<?php echo $Date_To; ?>' width=100% height=380px></iframe>
</fieldset>
