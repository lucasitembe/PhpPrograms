...
if (isset($_GET['fromDate'])) {
    ...
    $filter = " WHERE ilc.Transaction_Date_And_Time BETWEEN '$fromDate' AND '$toDate' AND ilc.Check_In_Type='Radiology' AND ilc.Status IN ('active','paid') ";
...
$htm.="<p align='center'><b>RADIOLOGY PATIENTS REPORT <br/>FROM</b> <b style=''>" . $fromDate . "</b> <b>TO</b> <b style=''>" . $toDate . "</b><br/> "
  ...
  //die($select_data);
    ...
    while ($row = mysqli_fetch_array($select_data_result)) {
        ...
        //Get items
         ...
         . "JOIN tbl_patient_registration pr ON pr.Registration_ID=pc.Registration_ID "
         . " WHERE ilc.Transaction_Date_And_Time BETWEEN '$fromDate' AND '$toDate' AND ilc.Check_In_Type='Radiology'  AND pr.Registration_ID='$Registration_ID' ORDER BY ilc.Transaction_Date_And_Time ASC";
 
 //die($select_data_items);
