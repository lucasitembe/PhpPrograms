...
?>
<fieldset>  
            <legend align=center><b>LIST OF ENGINEERING WORKS</b></legend>
...
<form name="myform" action="" method="POST">
	...
	<?php
          $display_table="<table width=100%> 
			...
			$query_data=mysqli_query($conn,"SELECT * FROM tbl_engineering_requisition WHERE job_progress = 'performed' AND completed = 'completed' ORDER BY requisition_ID DESC");
			...
			while($result_query=mysqli_fetch_array($query_data)){
				...
				<tr> 
					...
					<td><a href='requisition_report.php'>".$result_query['equipment_name']."</a></td>
                                        ...
                                        <td><a href='preview_job_done.php?New_Process_Requisition=True&Requisition_ID=".$requisition_ID."' class='art-button-green'>PREVIEW REQUISITION</a></td>"
                                        ;
                        if(isset($_GET['lForm']))
