...
$select_Transaction_Items = mysqli_query($conn,"select * from
				...
				pp.Patient_Payment_ID = '$Patient_Payment_ID' AND ts.Item_category_ID='$catID'") or die(mysqli_error($conn)); 

		 
	if(mysqli_num_rows($select_Transaction_Items)>0){
		    echo '<br/><table id="items">';
		
		  
	   echo "<tr>";
        echo "<td colspan='4' style='font-weight:bold'><b>".$catName."</b></td></tr>";
	...
	echo "<table><tr><td colspan='4'><hr height='3px'></td><br/></tr>";
