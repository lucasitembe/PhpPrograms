...
<?php
if (isset($_SESSION['userinfo'])) {
    echo "<a href='clearedbillingreport.php?ClearedBillingReport=ClearedBillingReportThisPage' class='art-button-green'>CLEARED BILLS REPORT</a>";
}
?>
<?php
if (isset($_SESSION['userinfo'])) {
    ...
    <center>
        <table width=100%>
            ...
            <tr>
                <td>
                   <center> 
                       <input type='text' name='Search_Patient' id='Search_Patient' style="text-align: center; width:17%" oninput='Patient_List_Search()' placeholder='~~ Enter Patient Name ~~'>
                        <input type="text" name="Patient_Number" id="Patient_Number" style="text-align: center; width:17%" oninput='Patient_List_Search2()' placeholder='~~ Enter Patient Number ~~'>
                   </center>
                </td>
            </tr>
        </table>
...
<fieldset style='overflow-y: scroll; height: 400px; background-color:white'>
    <legend style="background-color:#006400;color:white" align="right"><b>PENDING BILLS REPORT</b></legend>
    <table width="100%">
...
<script>
    function Patient_List_Search() {
        ...
        if(Hospital_Ward_ID != null && Hospital_Ward_ID != ''){
            ...
            myObjectSearchPatient.open('GET', 'Patient_Billing_List_Report.php?Patient_Name=' + Patient_Name + '&Sponsor_ID=' + Sponsor_ID + '&Hospital_Ward_ID=' + Hospital_Ward_ID + '&Transaction_Type=' + Transaction_Type+'&Item_Category_ID='+Item_Category_ID, true);
...
<script>
    function Patient_List_Search2() {
        ...
        if(Hospital_Ward_ID != null && Hospital_Ward_ID != ''){
            ...
            myObjectSearchPatient2.open('GET', 'Patient_Billing_List_Report.php?Patient_Number=' + Patient_Number + '&Sponsor_ID=' + Sponsor_ID + '&Hospital_Ward_ID=' + Hospital_Ward_ID+'&Item_Category_ID='+Item_Category_ID, true);
...
<script type="text/javascript">
    function Filter_Patient_List() {
        ...
        if(Hospital_Ward_ID != null && Hospital_Ward_ID != ''){
            ...
            myObjectFilter.open('GET', 'Patient_Billing_List_Report.php?Sponsor_ID=' + Sponsor_ID + '&Hospital_Ward_ID=' + Hospital_Ward_ID + '&Transaction_Type=' + Transaction_Type+'&Item_Category_ID='+Item_Category_ID, true);
            myObjectFilter.send();
        }
    }
</script>
...
<script type="text/javascript">
    function Preview_Report(){
        ...
        document.getElementById("Patient_Number").value = '';
        if(Hospital_Ward_ID != null && Hospital_Ward_ID != ''){
            window.open('pendingbillspreview.php?Patient_Name=' + Patient_Name + '&Sponsor_ID=' + Sponsor_ID + '&Hospital_Ward_ID=' + Hospital_Ward_ID + '&Transaction_Type=' + Transaction_Type+'&Patient_Number='+Patient_Number+'&Item_Category_ID='+Item_Category_ID,'_blank');
        }else{
            $("#Select_Ward").dialog("open");
        }
    }
...
<script>
    $(document).ready(function () {
        ...
        $("#Select_Ward").dialog({autoOpen: false, width: "25%", height: 130, title: 'eHMS 2.0', modal: true});
        $('select').select2();
    });
</script>
