...
<script language="javascript" type="text/javascript">
    function searchSponsor(Customer_Name){
    document.getElementById('Search_Iframe').innerHTML = "<iframe width='100%' height=430px src='edit_Customer_Pre_Iframe.php?Customer_Name="+Customer_Name+"'></iframe>";
    }
</script>
...
<center>
    <table width=40%>
        <tr>
            <td>
                <input type='text' name='Search_Employee' id='Search_Employee' style='text-align:center' onclick='searchSponsor(this.value)' onkeyup='searchSponsor(this.value)' placeholder='Enter Customer Name'>
            </td>
        </tr>
...
<fieldset>  
            <legend align=center><b>LIST OF CUSTOMERS</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
            <iframe width='100%' height=430px src='edit_Customer_Pre_Iframe.php'></iframe>
            </td>
        </tr>
            </table>
        </center>
