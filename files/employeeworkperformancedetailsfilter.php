...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Doctors_Page_Outpatient_Work'] == 'yes'){ 
?>
    <a href='./employeeworkperformancesummary.php?EmployeeWorkPerformance=EmployeeWorkPerformanceThisPage' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
...
<fieldset>
    ...
    ?>
    <br>
    <legend align=center><b>WORK PERFORMANCE DETAILS FOR </b><b style="color:blue;"><?php echo strtoupper($employeeName)?> </b> <?php echo "<b>FROM ".date('j F, Y',strtotime($Date_From))."</b>"?>  <?php echo "<b>TO ".date('j F, Y',strtotime($Date_To))."</b>"?></legend>
        <iframe src="employeeworkperformancedetailsfilter_Iframe.php?Employee_ID=<?php echo $doctorID;?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>" width="100%" height="340px"></iframe>
</fieldset><br/>
<?php
