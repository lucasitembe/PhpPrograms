...
<table width='100%'   border=0 id='Items_Fieldset'>
    ...
    if ($Report_Type == "SUMMARY") {
        ...
        echo "</tr>";
        echo "<tr style='font-size: 18px'>";
        echo "<td colspan=2 style='text-align: right;'><b>TOTAL VAT</b></td>";
        echo "<td colspan=1 style='text-align: right;'><b>" . number_format($Total_VAT, 2) . "</b></td>";
        echo "</tr>";
        echo "<tr style='font-size: 18px'>";
        echo "<td colspan=2 style='text-align: right;'><b>GRAND TOTAL WITH VAT</b></td>";
        ...
        echo "<td colspan=2 style='text-align: right;'><b>" . number_format($Grand_Total, 2) . "</b></td>";
        echo "</tr>";
        echo "<tr style='font-size: 18px'>";
        echo "<td colspan=4 style='text-align: right;'><b>TOTAL VAT</b></td>";
        echo "<td colspan=2 style='text-align: right;'><b>" . number_format($Total_VAT, 2) . "</b></td>";
        echo "</tr>";
        echo "</tr>";
        echo "<tr style='font-size: 18px'>";
        echo "<td colspan=4 style='text-align: right;'><b>TOTAL WITH VAT</b></td>";
        echo "<td colspan=2 style='text-align: right;'><b>" . number_format($total, 2) . "</b></td>";
        echo "</tr>";
    }
