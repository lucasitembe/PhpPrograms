...
<fieldset>  
    <legend align=center><b>LIST OF APPROVED SURGERY</b></legend>
...
<script language="javascript" type="text/javascript">
    ...
    function alert_consent(){
        alert("This Surgery Patient Did not Sign Consent Form, You can not perform this Surgery");
        exit();
    }
    ...
    function filterPatient(){
        ...
        myObjectPost.open('GET', 'Surgery_Appointments_filter.php?Current_Employee_ID='+Current_Employee_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Patient_Number='+Patient_Number+'&Patient_Name='+Patient_Name+'&Sponsor_ID='+Sponsor_ID+'&date_To='+date_To+'&date_From='+date_From+'&Surgical_Type='+Surgical_Type, true);
        myObjectPost.send();
    }
