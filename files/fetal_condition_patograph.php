...
var cervical_pointsy = [[]];
  ...
  var powPoints1= [[8,0],[8,10]];
  // var powPoints2 =[[0,4],[8,]];
  var powPoints3=[[0,4],[6,10]];
  var powPoints4 = [[4,4],[10,10]];
var points=[[]];
...
function plotFetalGraph(){
  ...
  var plot3 = $.jqplot('chart1', [powPoints1,powPoints3,powPoints4,cervical_pointsx,cervical_pointsy],
    {
