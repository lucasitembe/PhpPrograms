...
<fieldset>
    ...
    <center>
        <table class="">
            <tr>
                ...
                <td>
                <b>Age From</b><input type="number" id="start_age" name="start_age" min="0" max="200" placeholder="Start age" class="numberonly" />
                </td>
                <td>
                 <b>Age To</b><input type="number" id="end_age" name="end_age" min="0" max="200" placeholder="End age" class="numberonly"/> 
                </td>
                <td>
                <select id='agetype'>
                ...
                <td>
                <b>Gender</b>
                    <select id='gender' name="report_type">
    ...
    <table class="table" style="text-align: center;background: #FFFFFF">
        <tr>
            ...
            <th class="rotate" style="width:150px"><div><span>Wodi/idara</span></div></th>
            <th class="rotate"><div><span>Number of beds</span></div></th>
            <th class="rotate"><div><span>Admission</span></div></th>
            <th class="rotate"><div><span>Discharges live</span></div></th>
            <th class="rotate"><div><span>Deaths</span></div></b></th>
            <th class="rotate"><div><span>Abscondee</span></div></b></th>
            <th class="rotate"><div><span>%Deaths</span></div></th>
            <th class="rotate"><div><span>Avrg daily Admision(ADA)</span></div></th>
            <th class="rotate"><div><span>Avrg daily Discharge</span></div></th>
            <th class="rotate"><div><span>Inpatients/occupied Beds Days(OBD)</span></div></th>
            <th class="rotate" style="width:80px"><div><span>Avrg daily Inpatients Census</span></div></th>
            <th class="rotate"><div><span>Bed occupancy Rate %</span></div></th>
            <th class="rotate"><div><span>Avrg Length of stay in Hospital(days)</span></div></th>
            <th class="rotate"><div><span>Turn over Interval(TOI)</span></div></th>
            <th class="rotate"><div><span>Turn over per Bed(TOB)</span></div></th>
        </tr>
...
<script>
    ...
    function filter_report(){
        ...
        if(start_age != "" && end_age == ""){
            ...
            if(agetype==""){
                $("#agetype").css("border","2px solid red");
            exit;
            }
            else{
                var filter_age = " AND TIMESTAMPDIFF("+agetype+",reg_table.Date_Of_Birth,CURDATE()) BETWEEN "+ start_age+ " AND " + end_age;
            }
        }
        else{
            var filter_age = "";
