...
<fieldset style='margin-top:10px;'>
                            <legend align=right><b>  REVENUE CENTER PATIENT LAB LIST</b></legend>
                <script language="javascript" type="text/javascript">
                    function searchPatient(Patient_Name){
                        var from_value =<?php echo filter_input(INPUT_GET, 'from'); ?>
                        document.getElementById('Search_Iframe').innerHTML = 
                                                            "<iframe width='100%' height=320px src='search_revenuepatient_lablist.php?from="+from_value+"Patient_Name="+Patient_Name+"'></iframe>";
                    }
                </script>
                                                        ...
                                                        <hr width="100%">
                                                            ...
                                                            <center>
                                                                <table  class="hiv_table" style="width:100%">
                                                                    <tr>
                                                                        <td id='Search_Iframe'>
                                                                                <iframe width='100%' height=420px src='search_revenuepatient_lablist.php?from=<?php echo filter_input(INPUT_GET, 'from'); ?>'></iframe>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </center>
