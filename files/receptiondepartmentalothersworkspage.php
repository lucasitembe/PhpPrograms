...
<br/><br/>
<fieldset>  
    <legend align="right"><b>Reception ~ Direct Departmental Payments</b></legend>
    <center>
        <table width=100%>
            <tr>
...
<script>
    function Refresh_Items_Div() {
        ...
        myObjectRefreshDiv.open('GET','Refresh_Departmental_Payments_Div.php?Type_Of_Check_In='+Type_Of_Check_In+'&Guarantor_Name='+Guarantor_Name,true);
...
<script>
   function Get_Item_Price(Item_ID,Guarantor_Name){
	  ...
	  data11 = myObject.responseText;
	  
	  if (myObject.readyState == 4) { 
	      document.getElementById('Price').value = data11;
	      //alert(data);
	  }
      }; //specify name of function that will handle server response........
...
<script>
   function update_process_buttons(Registration_ID){
	 ...
	 my_Object_Update_Process.overrideMimeType('text/xml');
      ...
      my_Object_Update_Process.open('GET','Reception_Departmental_Update_Process_Button.php?Registration_ID='+Registration_ID,true);
...
<script>
   function getItemsList(Item_Category_ID){
      ...
      myObject.open('GET','Get_List_Of_Departmental_Items_List.php?Item_Category_ID='+Item_Category_ID+'&Guarantor_Name='+Guarantor_Name+'&Type_Of_Check_In='+Type_Of_Check_In,true);
      myObject.send();
   }
</script>
...
<script type="text/javascript">
    function Send_To_Cashier(){
        ...
        if(sms == true){
            document.location = 'Reception_Send_To_Cashier.php?Registration_ID='+Registration_ID;
        }
    }
</script>
...
<script>
   function getItemsListFiltered(Item_Name){
	 ...
	 if (myObject.readyState == 4) {
      ...
      myObject.open('GET','Get_List_Of_Departmental_Filtered_Items.php?Item_Category_ID='+Item_Category_ID+'&Item_Name='+Item_Name+'&Guarantor_Name='+Guarantor_Name+'&Type_Of_Check_In='+Type_Of_Check_In,true);
      myObject.send();
   }
</script>
                        ...
                        <script type='text/javascript'>
                            function Save_Information() {
                                ...
                                if ((Folio_Number_Status == 'mandatory' && (Folio_Number == '' || Folio_Number == null)) || (Claim_Number_Status == 'mandatory' && (Claim_Form_Number == '' || Claim_Form_Number == null))) {
                                    ...
                                    if (r == true) {
                                        document.location = 'Reception_Departmental_Save_Information.php?Registration_ID=' + Registration_ID + '&Folio_Number=' + Folio_Number + '&Claim_Form_Number=' + Claim_Form_Number + '&Consultant_ID=' + Consultant_ID;
                                    }
                                }
                            }
                        </script>
