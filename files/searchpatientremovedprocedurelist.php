...
<fieldset style='margin-top:30px;'>
    <legend id="resultsconsultationLablist" style="font-weight: bold;font-size: 16px;background-color: #006400; padding:10px; color:white;width: auto;" align="right">REMOVED PROCEDURE PATIENTS LIST</legend>
    <center>
        <hr width="100%">
    </center>
            ...
            <tr>
                <td id='Search_Iframe'>
                    <div id="iframeDiv" style="height: 460px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'removedprocedurelist_iframe.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
<center>
    <?php
        echo '<a href="searchpatientprocedurelist.php" class="art-button-green">UN CONSULTED PROCEDURE PATIENTS LIST</a>';
...
<script>
    function filterLabpatient() {
        ...
        mm.open('GET', 'removedprocedurelist_iframe.php?filterlabpatientdate=true&Date_From=' + Date_From + '&Date_To=' + Date_To + '&Sponsor=' + Sponsor, true);
        mm.send();
    }
...
<script >
    function searchPatient(Patient_Name) {
        ...
        mm.open('GET', 'removedprocedurelist_iframe.php?Patient_Name=' + Patient_Name + '&searchPartient=true' + filterDate, true);
        mm.send();
