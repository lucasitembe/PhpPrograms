...
<?php
    if(isset($_SESSION['userinfo'])){
        if($_SESSION['userinfo']['Patients_Billing_Works'] == 'yes'){ 
?>
    <a href='./inpatientbill.php?type=credit&Registration_ID=<?php echo $Registration_ID;?>&InPatientsBillingWorks=InPatientsBillingWorks' class='art-button-green'>
        BACK
    </a>
<?php  } } ?>
<style>
        ...
        <center>
            <table width=100% border=1>
                <tr>
                    <td colspan="2">
                        <div style="width:100%;height: 350px;overflow-x: hidden;overflow-y: scroll">
                            <?php include './creditbill_Iframe.php';?>
                        </div>
                ...
                <tr><td colspan='2'><hr/></td></tr>
                 <tr style="">
                     <td style="text-align: right;padding-right: 22px"><span style="font-size:17px">Total Balance Due</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:17px;"><?php echo number_format($toal_balance_Due);?></b></td>
                </tr>
            </table>
        </center>
</fieldset><br/>
