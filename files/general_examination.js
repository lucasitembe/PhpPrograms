...
// retrieve data
  $scope.getGeneralExamination = function(y)
  {
    ...
    var url = "http://192.168.112.1/ehmsbmc/files/save_general_examination.php?action=get_exemination&Registration_ID="+Registration_ID+"&year="+y+"";
...
$scope.saveGeneralExamination = function()
{
  ...
  var url = "http://192.168.112.1/ehmsbmc/files/save_general_examination.php";
