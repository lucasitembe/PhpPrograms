...
?>
<a href="Collected_Sample.php?LaboratoryReportThisPage=ThisPage" class="art-button-green">BACK</a>
                                                        ...
                                                        <hr width="100%">
                                                            ...
                                                            <center>
                                                                <table  class="hiv_table" style="width:100%">
                                                                    <tr>
                                                                        <td id='Search_Iframe'>
                                                                                <iframe width='100%' height=420px src='Collected_Sample_Filter_Iframe.php?Sub_Department_ID=<?php echo $Sub_Department_ID;?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>'></iframe>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </center>
