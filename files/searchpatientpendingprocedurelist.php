            ...
            <tr>
                <td id='Search_Iframe'>
                    <div id="iframeDiv" style="height: 460px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'pendingprocedurelist_iframe.php'; ?>
                    </div>
                </td>
            </tr>
        </table>
...
<center>
    <?php
        ...
        echo '<a href="searchpatientprocedurelist.php" class="art-button-green">UNCONSULTED PROCEDURES</a>';
   ?>
</center> 
...
<script>
    function filterLabpatient() {
        ...
        mm.open('GET', 'pendingprocedurelist_iframe.php?filterlabpatientdate=true&Date_From=' + Date_From + '&Date_To=' + Date_To + '&Sponsor=' + Sponsor, true);
        mm.send();
    }
...
<script >
    function searchPatient(Patient_Name) {
        ...
        mm.open('GET', 'pendingprocedurelist_iframe.php?Patient_Name=' + Patient_Name + '&searchPartient=true' + filterDate, true);
        mm.send();
