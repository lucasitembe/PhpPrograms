...
<?php
    ...
    */
    ...
    echo '<center><table id="removedradiology" width =100% border=0>';
		...
		<td><b>PATIENT NAME</b></td>
			...
			<td><b>SPONSOR</b></td>
				...
				<td><b>GENDER</b></td>
					...
					<td><b>MEMBER NUMBER</b></td></thead></tr>';
					    //<td><b>DATE</b></td>
	...
	echo "<td><a href='patientbillingremovedradiology.php?section=Radiology&Registration_ID=".$row['Registration_ID']."&Transaction_Type=".$row['Transaction_Type']."&Payment_Cache_ID=".$row['Payment_Cache_ID']."&NR=True&Billing_Type=".$Billing_Type2."&Sub_Department_ID=".$Sub_Department_ID."&RadiologyWorks=RadiologyWorksThisPage' target='_parent' style='text-decoration: none;'>".$row['Patient_Name']."</a></td>";
