...
<table class="table">
<?php
$sql_select_attached_category_result=mysqli_query($conn,"SELECT *FROM tbl_item_category  WHERE Item_Category_Name LIKE '%$Item_Category_Name%'") or die(mysqli_error($conn));
