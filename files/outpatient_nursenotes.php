...
<fieldset id="Button_Area">
    ...
    <?php
        //get previous info
        $select_records = mysqli_query($conn,"select Notes_ID from tbl_nurse_notes where Admision_ID IS NULL and Registration_ID = '$Registration_ID'") or die(mysqli_error($conn));
...
<script type="text/javascript">
    function Save_Information(){
        ...
        if(Consultation_ID != null && Consultation_ID != '' && Admision_ID != null && Admision_ID != '' && Notes != null && Notes != ''){
            ...
            myObjectSave.open('GET','Save_outPatient_Notes_Info.php?Consultation_ID='+Consultation_ID+'&Admision_ID='+Admision_ID+'&Notes='+Notes+'&Registration_ID='+Registration_ID,true);
            myObjectSave.send();
        }
    }
</script>
...
<script type="text/javascript">
    function Update_Buttons(){
        ...
        myObjectUpdate.open('GET', 'outPatient_Notes_Update_Button.php?Registration_ID='+Registration_ID+"&Admision_ID="+Admision_ID, true);
        myObjectUpdate.send();
    }
</script>
...
<script type="text/javascript">
    function Preview(){
        ...
        myObjectPreview.open('GET', 'outPatient_Notes_Preview.php?Registration_ID='+Registration_ID+"&Admision_ID="+Admision_ID+"&Consultation_ID="+Consultation_ID, true);
...
<script type="text/javascript">
    function Preview_General_Report(){
        ...
        var Admision_ID = '<?php echo $Admision_ID; ?>';
        var Registration_ID = '<?php echo $Registration_ID; ?>';
        window.open("outpatientnotesgeneralreport.php?Registration_ID="+Registration_ID+"&Admision_ID="+Admision_ID+"&Consultation_ID="+Consultation_ID+"PatientNotesGeneralReport=PatientNotesGeneralReportThisPage","_blank");
    }
</script>
