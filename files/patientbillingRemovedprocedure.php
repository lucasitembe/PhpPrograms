		...
		<tr>
			...
			<?php if(isset($_GET['Sub_Department_ID'])) { $Sub_Department_ID = $_GET['Sub_Department_ID']; }else{ $Sub_Department_ID = 0; } ?>
                        <div id="patientItemsList" style='height:200px;overflow-y:scroll;overflow-x:hidden'>
                            ...
                            <?php include "Patient_Billing_Procedure_Removed_Iframe.php";?>
                        </div>
                    </td>
		</tr> 
                 <tr id="totalAmount">
...
<script>
    function Make_Payment_Laboratory() {
        ...
        if (Confirm_Message == true) {
            document.location = 'Patient_Billing_Procedure_Page.php?Transaction_Type=<?php echo $Transaction_Type; ?>&Payment_Cache_ID=<?php echo $Payment_Cache_ID; ?>&Sub_Department_ID=<?php echo $Sub_Department_ID; ?>';
        }
    }
