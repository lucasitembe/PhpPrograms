...
$dhamanaa="";
$aliwahikutoroka="";
$exemptiondata  = mysqli_query($conn, "SELECT ushauriwabima,time_of_treatment,mode_of_treatment,taarifa_za_mgonjwa,patient_next_kin,next_kin_phoneNo,Next_kin_relationship,Anaombewa,previous_hospital_treatment ,Exemption_ID, tathiminiyamsaada,alishawahikupewa, kiasikinachoombewamshamaha, kiwango_cha_msamaha, mapendekezomsamaha FROM tbl_temporary_exemption_form WHERE Registration_ID ='$Registration_ID' AND Exemption_ID='$Exemption_ID' ") or die(mysqli_error($conn));
if((mysqli_num_rows($exemptiondata))>0){
...
///======  haifanyi kazi in calculate uongo ila ukiitoa kunavitu havitafanya kazi ============///
...
<table  width="90%">
    ...
    ?><input type="text" id="Nurse_Exemption_ID" hidden value="<?php echo $Nurse_Exemption_ID; ?>">
    <tr>
...
<table width="90%">
<caption  align="center" id="th"><h4 align="center" > SOCIAL WELFARE UNIT </h4></caption>
<?php 
$checked_ndio="";
$checked_hapana="";
...
<td ><b><center>
<span>Ndio<input type="radio" name="ushauriwabima"  <?php echo $checked_ndio; ?> id="ushaurindio" value="<?php echo $ushauriwabima; ?>"></span>
<span>Hapana<input type="radio" name="ushauriwabima"  <?php  echo $checked_hapana; ?> id="ushaurihapana" value="<?php echo $ushauriwabima; ?>"></span></center>
</b>
</td>
...
<td>
<textarea name="tathiminiyamsaada" id="tathiminiyamsaada"  rows="1" class="form-control"><?php echo $tathiminiyamsaada; ?></textarea>
</td>
</tr>
</table>
<table width="90%">
        ...
        <tr>
            <td style='text-align:right;'>
                ...
                <input type="text" style="display: inline; width:40%;" name="previous_hospital_treatment" value="<?php echo $previous_hospital_treatment; ?>" id="previous_hospital_treatment">                   
            </td>
            <td style='text-align:right;'>
                <label for="">Kwa muda gani</label>
                <input  type="text" style="display: inline; width:40%;" name="time_of_treatment"  value="<?php echo $time_of_treatment; ?>" id="time_of_treatment">                   
            </td>
            <td style='text-align:right;'>
                <span>Amekuwa akichangia matibabu kwa mfumo upi
                    <label for="">Taslimu</label>
                    <input type="checkbox" name="mode_of_treatment" id="Sponsor_cash" <?php echo $Taslimu; ?> >
                </span>                      
            <span>
                    <label for="">Bima</label>
                    <input type="checkbox" name="mode_of_treatment" id="Sponsor_credit"  <?php echo $Bima; ?> >
            </span>                         
            </td>
        </tr>
        <tr>
            ...
            <td style='text-align:right;'><b>
                <span>Msamaha(Exemption)<input type="checkbox" name="alishawahikupewa" id="Msamaha" <?php echo $msamahaa; ?> value="<?php echo $ushauri1; ?>"></span>
                <span>Dhamana<input type="checkbox" name="alishawahikupewa" id="Dhamana" <?php echo $dhamanaa; ?> value="<?php echo $ushauri2; ?>"></span>
                <span>/Aliwahi kutoroka<input type="checkbox"  name="alishawahikupewa" id="Kutoroka"<?php echo $aliwahikutoroka; ?> value="<?php echo $ushauri3; ?>"></span><b>
            </td>
            <td ><span ><b>Kiwango</b><input type="text" id="kiwango_cha_msamaha" style="display: inline; width:60%;" name="kiwango_cha_msamaha"  value="<?php echo $kiwango_cha_msamaha; ?>"></span></td>
        </tr>
    </table>
<table width="90%" >
<tr >
...
<td colspan="5">
<textarea name="mapendekezomsamaha" id="mapendekezomsamaha"  rows="1" class="form-control"><?php echo $mapendekezomsamaha; ?></textarea>
</td>
</tr>
<tr>
...
<tr>
    ...
    <td style='text-align:right;'><b>kiasi anachostahili</b></td>
    <td><input class="form-control" name="" id="kiasi_anachostahili" disabled='disabled'value="<?php echo $kiasi_anachostahili;?>"></td>
</tr>
<tr>
    ...
    ?>
    <td style='text-align:right;'>
       <span><b>kiasi kinachoombewa</b>
    </td>
    <td> </span><span><input class="form-control" style="display: inline; width:60%;" name="kiasikinachoombewamshamaha" id="kiasikinachoombewamshamaha" value="<?php echo $kiasikinachoombewamshamaha;?>" ></span></td>
</tr>
<tr>
    <td colspan=""  style='text-align:right;'><b>Anaombewa</b></td>
    <td colspan="5">
        
            <span>Dhamana 
                <input type="radio" class="" name="Anaombewa"  id="anaombewa_Dhamana" <?php echo $checked_Dhamana;?>>
            </span> 
            <span>Msamaha 
                <input type="radio" class="" name="Anaombewa" id="anaombewa_Msamaha" <?php echo $checked_Msamaha;?>>
            </span>
...
<button id="exemptionsaves" type="button" name="exemption_update" class="art-button-green pull-right" onclick="Exemption_Update('<?php echo $Registration_ID;?>', '<?php echo $Exemption_ID; ?>')">UPDATE</button>
<div id="div_responce"></div>  
</form>
...
<script>
    ...
    function Exemption_Update(Registration_ID, Exemption_ID){
       ...
       if(kiasikinachoombewamshamaha > kiasi_anachostahili ){
        alert("Kiasi kinachoombewa Anaombewa " +Anaombewa+ " Hakiwezikuwa kuwa zaidi ya kiasi anachodaiwa mgonjwa"); exit()
       }
      // alert(  kiasi_anachostahili < kiasikinachoombewamshamaha);exit();;
       $.ajax({
           type:'POST',
           url:'ajax_exemptionform.php',
           data:{ushauriwabima:ushauriwabima,patient_next_kin:patient_next_kin,next_kin_phoneNo:next_kin_phoneNo,Next_kin_relationship:Next_kin_relationship,previous_hospital_treatment:previous_hospital_treatment, time_of_treatment:time_of_treatment, Anaombewa:Anaombewa,taarifa_za_mgonjwa:taarifa_za_mgonjwa, tathiminiyamsaada:tathiminiyamsaada,alishawahikupewa:alishawahikupewa,mode_of_treatment:mode_of_treatment, kiasikinachoombewamshamaha:kiasikinachoombewamshamaha,kiwango_cha_msamaha:kiwango_cha_msamaha,mapendekezomsamaha:mapendekezomsamaha, Registration_ID:Registration_ID,Exemption_ID:Exemption_ID, exemption_update:""},
           success:function(responce){
                //$("#exemptionsaves").hide();
                //document.location.reload();
                $("#div_responce").html(responce);
           }
       });
    }
