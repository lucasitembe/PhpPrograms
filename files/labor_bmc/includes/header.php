...
$autoupdatesignedoff = mysqli_query($conn, "SELECT configvalue FROM tbl_config WHERE configname='AutoLogout'")
    or die(mysqli_error($conn));

if (mysqli_num_rows($autoupdatesignedoff) > 0) {
        ...
        function user_multiple_loged_in_control() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    Employee_logedin_id: Employee_logedin_id,
                    employee_session_time: employee_session_time
                },
                                    ...
                                    <div class="art-content-layout-wrapper layout-item-0">
                                        ...
                                        <div class="art-content-layout">
                                            ...
                                            <?php if (isset($_SESSION['userinfo'])) { ?>
                                                <span>
                                                    <a href='../logout.php?emp_id=<?= $_SESSION['userinfo']['Employee_ID']; ?>' class='art-button-green' id="ConfirmLogout" onclick='return ConfirmLogout()'>LOGOUT</a>
                                                </span>
                                            <?php } ?>
