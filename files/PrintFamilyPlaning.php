...
//    //Mimba kuharibika
  ...
  if($result['Uzazi_njia']=='Njia nyingine' &&  ($age>=10 && $age<=14) && $result['Patient_type']=='Mpya'){
    ...
    $disp.= "<tr><th>Na</th><th>Aina ya Huduma</th><th>Aina ya Wateja</th></tr>";
    $disp.= "<tr><th></th><th>Maelezo</th><th>Wateja wapya</th><th>Marudio</th><th>Jumla</th></tr>";
    $disp.= "<tr><th></th><th></th><th><table><tr><th style='width:50px;text-align:center'>Miaka<br />10-14</th><th style='width:50px;text-align:center'>Miaka<br />15-19</th><th style='width:50px;text-align:center'>Miaka<br />20-24</th><th style='text-align:center'>Miaka<br />25 na Zaidi</th></tr></table></th></tr>";
    
    
     $disp.= "<tr><th style='text-align:center;background-color:#006400;color:white;padding:2px'>1</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Idadi ya wateja waliopatiwa unasihi (MPYA)</th></tr>";
     $disp.= "<tr><th style='text-align:center;background-color:#006400;color:white;padding:2px'>1</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Sindano</th></tr>";
     
     
     $disp.= "<tr><td style='text-align:center'>1a</td><td>Idadi ya Wateja wa Sindano</td><td><table><tr><td style='width:60px;text-align:center'>$sindano10</td><td style='width:60px;text-align:center'>$sindano15</td><td style='width:60px;text-align:center'>$sindano20</td><td style='width:60px;text-align:center'>$sindano25</td></tr></table></td><td><center>$marudiosindano</center></td><td><center>$sindanoTotal</center></td></tr>";
     
     $disp.= "<tr><th style='text-align:center;background-color:#006400;color:white;padding:2px'>2</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Vidonge</th></tr>";
     
     
      $disp.= "<tr><td style='text-align:center'>2a</td><td>Idadi ya wateja wa Vidonge Kituoni</td><td><table><tr><td style='width:60px;text-align:center'>$sindano10</td><td style='width:60px;text-align:center'>$sindano15</td><td style='width:60px;text-align:center'>$sindano20</td><td style='width:60px;text-align:center'>$sindano25</td></tr></table></td><td></td>
    ...
    <tr><td style='text-align:center'>2b</td><td>Idadi ya wateja wa Vidonge wa CBD</td><td></td><td></td>
     ...
     <td></td></tr>";
      ...
      $disp.= "<tr><th style='background-color:#006400;color:white;padding:2px;text-align:center'>3</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Kondom</th></tr>";

      $disp.= "<tr><td style='text-align:center'>3a</td><td>Idadi ya wateja waliochukua kondom Kituoni Me</td><td></td><td></td>
    ...
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>4</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Njia za muda Mrefu na za kudumu za Uzazi wa Mpango</th></tr>";
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>4</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Kufunga Uzazi</th></tr>";

    $disp.= "<tr><td style='text-align:center'>4a</td><td>Kufunga uzazi mama (ML/LA)-kituoni</td><td><table><tr><td style='width:60px;text-align:center'>$Uzazimamakituon10</td><td style='width:60px;text-align:center'>$Uzazimamakituon15</td><td style='width:60px;text-align:center'>$Uzazimamakituon20</td><td style='width:60px;text-align:center'>$Uzazimamakituon25</td></tr></table></td><td><center>$marudioUzazimamakituon</center></td>
...
";
      ...
      $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>5</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Vipandikizi</th></tr>";
      $disp.= "<tr><td style='text-align:center'>5a</td><td>Kuweka vipandikizi-kituoni</td><td><table><tr><td style='width:60px;text-align:center'>$kuwekavipandikizi10</td><td style='width:60px;text-align:center'>$kuwekavipandikizi15</td><td style='width:60px;text-align:center'>$kuwekavipandikizi20</td><td style='width:60px;text-align:center'>$kuwekavipandikizi25</td></tr></table></td><td><center>$marudiokuwekavipandikizi</center></td>
    ...
    ";
     ...
     $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>6</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Kitanzi(IUCD)</th></tr>";

     $disp.= "<tr><td style='text-align:center'>6a</td><td>Kuweka Kitanzi-kituoni</td><td><table><tr><td style='width:60px;text-align:center'>$kuwekakitanzi10</td><td style='width:60px;text-align:center'>$kuwekakitanzi15</td><td style='width:60px;text-align:center'>$kuwekakitanzi20</td><td style='width:60px;text-align:center'>$kuwekakitanzi25</td></tr></table></td><td><center>$marudiokuwekakitanzi</center></td>
    ...
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>7</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Njia Nyinginezo</th></tr>";
    
    $disp.= "<tr><td style='text-align:center'>7a</td><td>Njia za maumbile mfano (LAM)</td><td></td><td></td>
    ...
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'></th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Jumla ya Aina zote za Uzazi wa Mpango</th></tr>";
    $disp.= "<tr><td style='text-align:center'></td><td>Jumla ya Wateja wa njia zote za Uzazi wa Mpango</td><td></td><td></td>
     
     <td></td></tr>
     
    ";
    
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>8</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Jumla ya Mizunguko ya Vidonge Iliyotolewa</th></tr>";
    $disp.= "<tr><td style='text-align:center'>8a</td><td>Jumla ya mizunguko iliyotolewa</td><td></td><td></td>
    ...
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>10</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Huduma baada ya mimba kuharibika(cPAC)/ Baada ya kujifungua</th></tr>";

    $disp.= "<tr><td style='text-align:center'>10a</td><td>Waliopata huduma baada ya mimba kuharibika</td><td><table><tr><td style='width:60px;text-align:center'>$mimbakuharibika10</td><td style='width:60px;text-align:center'>$mimbakuharibika15</td><td style='width:60px;text-align:center'>$mimbakuharibika20</td><td style='width:60px;text-align:center'>$mimbakuharibika25</td></tr></table></td><td><center>$marudiomimbakuharibika</center></td>
    ...
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>11</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Huduma baada ya mimba kuharibika(cPAC)/ Baada ya kujifungua</th></tr>";
    $disp.= "<tr><td style='text-align:center'>11a</td><td>Waliochunguzwa Titi</td><td><table><tr><td style='width:60px;text-align:center'>$chunguzwatiti10</td><td style='width:60px;text-align:center'>$chunguzwatiti15</td><td style='width:60px;text-align:center'>$chunguzwatiti20</td><td style='width:60px;text-align:center'>$chunguzwatiti25</td></tr></table></td><td><center>$marudiochunguzwatiti</center></td>
    ...
    $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'>12</th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>PITC</th></tr>";
    $disp.= "<tr><td style='text-align:center'>12a</td><td>Tayari wana uambukizo wa VVU</td><td><table><tr><td style='width:60px;text-align:center'>$VVUtiyari10</td><td style='width:60px;text-align:center'>$VVUtiyari15</td><td style='width:60px;text-align:center'>$VVUtiyari20</td><td style='width:60px;text-align:center'>$VVUtiyari25</td></tr></table></td><td><center>$marudioVVUtiyari</center></td>
    ...
    <tr><td style='text-align:center'>12b</td><td>Wateja waliopima VVU</td><td><table><tr><td style='width:60px;text-align:center'>$WaliopimaVVU10</td><td style='width:60px;text-align:center'>$WaliopimaVVU15</td><td style='width:60px;text-align:center'>$WaliopimaVVU20</td><td style='width:60px;text-align:center'>$WaliopimaVVU25</td></tr></table></td><td><center>$marudioWaliopimaVVU</center></td>
     ...
     <td></td></tr>
     ";
     $disp.= "<tr><th style='background-color:#006400;color:white;text-align:center'></th><th  style='background-color:#006400;color:white;padding:2px;text-align:left' colspan='7'>Maudhui Madogo madogo/madhara ya dawa za Uzazi wa Mpango</th></tr>";
