...
$select_details=mysqli_query($conn,"SELECT * FROM tbl_employee WHERE Employee_ID='$doctorID'");
$Doctor_Name=mysqli_fetch_array($select_details)['Employee_Name'];
?>
	    ...
	    $html="<img src='branchBanner/branchBanner1.png'>";
            $html.="<fieldset>";
            $html.="<legend><b>".$Doctor_Name." Performance Report From ".date('j F,Y H:i:s',strtotime($_GET['Date_From']))." TO ".date('j F,Y H:i:s',strtotime($_GET['Date_To']))."</b></legend>";
		$html.= "<center>";
		...
		$html.= "<tr id='thead'>
			...
			$html.= "<table align='center' width='60%'>
				...
				<td style='text-align:center;font-size: large;font-weight: bold'>50% Of Consultation</td>
