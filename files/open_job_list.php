...
<center>
    <table width=100%>
        <tr>
            ...
            <td width=20%>
                <input type='text' name='Search_Section' id='Search_Section' style='text-align: center;' oninput='searchPatient(this.value)'  placeholder="~~~~~~~~~~~~~  Search By Required Section  ~~~~~~~~~~~~~~~~~~~" autocomplete="off">
            </td>
        </td>
        </tr>
...
<br/>
<fieldset>  
            <legend align=center><b>OPEN JOB LIST</b></legend>
        <center>
            <table width=100% border=1>
                <tr>
            <td id='Search_Iframe'>
		<iframe width='100%' height=400px src='search_engineers_list_Iframe.php?assigned_engineer="+assigned_engineer+"'></iframe>
            </td>
        </tr>
            </table>
        </center>
