<?php
	...
	$htm .='<tr><td>Receipt Date: </td>
		<td>'.$Receipt_Date.'</td></tr>';
...
$select_Transaction_Items = mysqli_query($conn,
            "select * from
				...
				tbl_patient_payments_others pp, tbl_patient_payment_item_list_others ppl,
	...
	$htm .= "<tr><td>Item / Service: </td>";
        $htm .= "<td>".$row['Product_Name']."</td></tr>";
	
	$htm .= "<tr><td>Price: </td>";
        $htm .= "<td>".$row['Price']."</td></tr>";
	
	$htm .= "<tr><td>Discount: </td>";
        $htm .= "<td>".$row['Discount']." (@Item)</td></tr>";
