<?php
    ...
    while ($row = mysqli_fetch_array($engineers)) {
        ...
        echo "<tr>
            ...
            <td style='color: red; font-weight: bold; text-align:center; padding:10px;'><a href='#' id='menu' onclick='section_dialogy($name)' style='text-decoration: none; color: red;'>".$yes."</td>
