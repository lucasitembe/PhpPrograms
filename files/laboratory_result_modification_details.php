...
if(isset($_SESSION['userinfo'])){
    ...
    {
        echo "<a href='detailed_laboratory_result.php?Status_From=".filter_input(INPUT_GET, 'Status_From')."&patient_id=".$_GET['patient_id']."&payment_id=".filter_input(INPUT_GET,'payment_id')."&Item_ID=".$_GET['Item_ID']."&DetailedLaboratoryResultThisPage=ThisPage' class='art-button-green'>BACK</a>";
    }
    $already = false;                                                                                     }
