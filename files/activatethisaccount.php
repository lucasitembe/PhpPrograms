...
<br/><br/><br/>
        <center>
            <fieldset>
                <legend align='right'><b>ACTIVATE EMPLOYEE ACCOUNT</b></legend>
                    ...
                    <table width = 50%>
                        ...
                        <tr>
                            <td style="color:black; border:2px solid #ccc;text-align:right;" colspan=4>
                                <input type='submit' name='submit' id='submit' value='ACTIVATE THIS ACCOUNT' class='art-button-green'>
                                ...
                                <input type='hidden' name='submittedActivateEmployeeAccountForm' value='true'>
                            </td>
                        </tr>
                </table>
        </center>
...
<?php
	if(isset($_POST['submittedActivateEmployeeAccountForm'])){
		...
		$sql = "update tbl_employee set Account_Status = 'active' where employee_id = '$Employee_ID'";  
		   if(!mysqli_query($conn,$sql)){
		        
		   }else {
                if(isset($_GET['HRWork']) && $_GET['HRWork']){
            ...
            if(isset($_GET['HRWork']) && $_GET['HRWork']){
                echo "<script type='text/javascript'>
                   ...
                   document.location = './activatethisaccount.php?Employee_ID=".$Employee_ID."&InvalidPrivileges=InvalidPrivilegeThisPage&HRWork=true';
               </script>";
            }else{
                echo "<script type='text/javascript'>
                   alert('INVALID USERNAME OR PASSWORD. NO PRIVILEGE TO SAVE CHANGES');
                   document.location = './activatethisaccount.php?Employee_ID=".$Employee_ID."&InvalidPrivileges=InvalidPrivilegeThisPage';
               </script>";
            }
