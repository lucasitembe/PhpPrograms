<?php
    ...
    if($Percentage < 0){
        echo "<center><br/><br/><h3>INVALID PERCENTAGE 
                <br/><br/>To decrease price please inter required percentage then select \"DECREASE\"
                <br/><br/>To increase price please inter required percentage then select \"INCREASE\"</h3></center>"; exit();
    }
