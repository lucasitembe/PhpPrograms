...
<?php
	...
	$laundry_type_name = mysqli_real_escape_string($conn,$_POST['laundry_type_name']);
	$Insert_New_Laundry_Type = "insert into tbl_laundry_type(laundry_type_name)
				    Values('$laundry_type_name')";
...
<table width=50%>
    <tr>
        <td>
            <fieldset>  
            <legend align=center><b>NEW LAUNDRY TYPE</b></legend>
        <form action='#' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
            <table width=100%>
                <tr>
                    <td width=25%><b>Type Name</b></td>
                    <td width=75%>
                        <input type='text' name='laundry_type_name' id='laundry_type_name' required='required' placeholder='Enter Category Name'>
                    </td> 
                </tr>
                <tr>
