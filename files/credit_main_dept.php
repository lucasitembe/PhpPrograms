		...
		while ($cat = mysqli_fetch_array($get_categories)) {
			...
			if($num_quantity > 0){
				while($Det = mysqli_fetch_array($get_Quantiry)){
			        ...
			        }elseif((strtolower($Det['Billing_Type']) == 'outpatient credit') or (strtolower($Det['Billing_Type']) == 'outpatient cash' && $Det['Pre_Paid'] = '1') or (strtolower($Det['Billing_Type']) == 'inpatient credit') or (strtolower($Det['Billing_Type']) == 'inpatient cash' && strtolower($Det['payment_type']) == 'post')){
			            $Total_Credit += $Total;
...
<?php
                ...
                $grand_grand_total_all = $all_Grand_Total_Credit;
                ?>
               </tr>
               <tr><td colspan="9"><hr></td></tr>
	<tr>
