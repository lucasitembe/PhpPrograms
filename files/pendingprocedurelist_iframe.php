...
echo '<center>
            ...
            <thead>
                <tr>
                    ...
                    <th><b>STATUS</b></th>
                    <th style="width:15%;"><b>PATIENT</b></th>
                    <th><b>REG#</b></th>
...
$select_Filtered_Patients = "SELECT pr.Patient_Name,pc.Sponsor_Name,pr.Date_Of_Birth,il.transaction_Type,il.payment_Type,
                                    ...
                                    WHERE Check_In_Type = 'Procedure' AND il.Status IN ('pending','not applicable') $filter $doctorproce GROUP BY pr.Registration_ID ORDER BY Transaction_Date_And_Time ASC  LIMIT 10";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<tr><td>" . $temp . "</td>
                                ...
                                <td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>$statusPay</a></td>
                                <td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>" . $row['Patient_Name'] . "</a></td>";

    echo "<td><a class='viewDetails'  href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>" . $row['registration_number'] . "</a></td>";
    echo "<td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>" . $row['Sponsor_Name'] . "</a></td>";
    echo "<td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'><center>" . $age . "</center></a></td>";
    echo "<td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>" . $row['Gender'] . "</a></td>";
    echo "<td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>" . $row['Transaction_Date_And_Time'] . "</a></td>";
    echo "<td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>" . $row['Phone_Number'] . "</a></td>";
    echo "<td><a class='viewDetails' href='pendingprocedurepatientinfo.php?" . $section . "Registration_id=" . $row['registration_number'] . "&Date_From=" . $Date_From . "&Date_To=" . $Date_To . "&Sponsor=" . $Sponsor . "&Sub_Department_ID=" . $Sub_Department_ID . "' style='text-decoration: none;'>" . $row['Doctors_Name'] . "</a></td>";
