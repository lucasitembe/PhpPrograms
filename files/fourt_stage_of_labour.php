...
if (isset($_SESSION['userinfo'])) {
  if ($_SESSION['userinfo']['Admission_Works'] == 'yes') {
    ...
    $backlink = $_SERVER['HTTP_REFERER'];
      ?>
      <a href="labour_atenal_neonatal_record.php?consultation_id=<?= $consultation_id;?>&patient_id=<?=$Registration_ID;?>&admission_id=<?=$Admision_id?>" class="art-button-green">BACK</a>
  <?php }
}
...
if (isset($_POST['submitRadilogyform'])) {
	...
	$Urine=mysqli_real_escape_string($conn,$_POST['Urine']);    //
        ...
        $state_perinium = mysqli_real_escape_string($conn,$_POST['state_perinium']);
        $suture_type = mysqli_real_escape_string($conn,$_POST['suture_type']);
        $stiches_number = mysqli_real_escape_string($conn,$_POST['stiches_number']);
        $blood_loss = mysqli_real_escape_string($conn,$_POST['blood_loss']);
        $bleeding_incision = mysqli_real_escape_string($conn,$_POST['bleeding_incision']);
        $vagina_bleeding = mysqli_real_escape_string($conn,$_POST['vagina_bleeding']);
        $fluid = mysqli_real_escape_string($conn,$_POST['fluid']);
        $fundamental_height = mysqli_real_escape_string($conn,$_POST['fundamental_height']);
        $state_uterus = mysqli_real_escape_string($conn,$_POST['state_uterus']);
        $input = mysqli_real_escape_string($conn,$_POST['input']);
        $output = mysqli_real_escape_string($conn,$_POST['output']);
        $doctor_recomendation = mysqli_real_escape_string($conn,$_POST['doctor_recomendation']);
	...
	$insert_testing_record = "INSERT INTO tbl_nursecommunication_observation(Registration_ID,employee_ID,date,Blood_Pressure,Pulse_Blood,Temperature,Resp_Bpressure,Fluid_Drug,fbg,Drainage,rbg,Urine,oxygen_saturation,consultation_ID,body_weight,blood_transfusion,state_perinium,suture_type,stiches_number,blood_loss,bleeding_incision,vagina_bleeding,fluid,fundamental_height,state_uterus,input,output,doctor_recomendation)
				               VALUES('$Registration_ID','$Employee_ID',NOW(),'$Blood_Pressure','$Pulse_Blood','$Temperature','$Resp_Bpressure','$Fluid_Drug','$fbg','$Drainage','$rbg','$Urine','$oxygen_saturation','$consultation_id','$body_weight','$blood_transfusion','$state_perinium','$suture_type','$stiches_number','$blood_loss','$bleeding_incision','$vagina_bleeding','$fluid','$fundamental_height','$state_uterus','$input','$output','$doctor_recomendation')";
...
<script>
   ...
   window.location="fourt_stage_of_labour.php?<?php echo $_SERVER['QUERY_STRING']?>";
</script>
<?php
...
<fieldset>
    <legend align="center" style='padding:10px;color:white;background-color:#2D8AAF;text-align:center'><b>
            <b>FOURTH STAGE OF LABOUR OBSERVATION CHART</b><br/>
...
<!--                                    <td style="text-align:right;font-size:14px " width="13%" class="hide"><b>Gastric</b></td>
                                    ...
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>State Of Perinium</b></td>
                                    <td ><input type="text" name="state_perinium" class="input_style"  /></td>
                                    
<!--                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Oxygen saturation</b></td>
                                    <td><input type="text" name="oxygen_saturation" class="input_style"  /></td>-->
                                </tr>
                                <tr>
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>If Repared TYpe Of Suture</b></td>
                                    <td ><input type="text" name="suture_type" class="input_style"  /></td>
<!--                                    <td style="text-align:right;font-size:14px " width="13%" class="hide"><b>Gastric</b></td>
                                    <td ><input type="text" name="Gas_Tric" class="input_style hide"  /></td>-->
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>How Many Stiches </b></td>
                                    <td ><input type="text" name="stiches_number" class="input_style"  /></td>
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Blood Loss</b></td>
                                    <td ><input type="text" name="blood_loss" class="input_style"  /></td>
...
<!--                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Oxygen saturation</b></td>
                                ...
                                <tr>
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Bleeding In Incision Site</b></td>
                                    <td ><input type="text" name="bleeding_incision" class="input_style"  /></td>
<!--                                    <td style="text-align:right;font-size:14px " width="13%" class="hide"><b>Gastric</b></td>
                                    <td ><input type="text" name="Gas_Tric" class="input_style hide"  /></td>-->
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Per Vaginal Bleeding </b></td>
                                    <td ><input type="text" name="vagina_bleeding" class="input_style"  /></td>
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Fluid</b></td>
                                    <td ><input type="text" name="fluid" class="input_style"  /></td>
...
<!--                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Oxygen saturation</b></td>
                                ...
                                <tr>
                                <td style="text-align:right;font-size:14px " width="13%" ><b>State Of Uterus</b></td>
                                    <td ><input type="text" name="state_uterus" class="input_style"  /></td>
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Fundamental Height</b></td>
                                    <td ><input type="text" name="fundamental_height" class="input_style"  /></td>
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>State Of Cervix</b></td>
                                    <td ><input type="text" name="state_uterus" class="input_style"  /></td>
...
<!--                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Oxygen saturation</b></td>
                                ...
                                <tr>
                                <td style="text-align:right;font-size:14px " width="13%" ><b>Input</b></td>
                                    <td ><input type="text" name="input" class="input_style"  /></td>
<!--                                    <td style="text-align:right;font-size:14px " width="13%" class="hide"><b>Gastric</b></td>
                                    <td ><input type="text" name="Gas_Tric" class="input_style hide"  /></td>-->
                                    <td style="text-align:right;font-size:14px " width="13%" ><b>Output </b></td>
                                    <td ><input type="text" name="output" class="input_style"  /></td>
                                    <td style="text-align:right;font-size:14px " width="13%" ><b> 	Doctor/Midwife Recommendation:</b></td>
                                    <td ><textarea name="doctor_recomendation" class="input_style"></textarea></td>
                                    <td style='text-align: center;' colspan="4">
                                       ...
                                       <input type='submit' name='submitRadilogyform' id='submit' value='ADD' onclick="return confirm('Are you sure you want to save infos?')" class='art-button pull-right' style="width:15%">
        ...
        <table width='100%'>
            <tr>
                <td>    
                    ...
                    <a href="fourth_stage_observation_print.php?Registration_ID=<?php echo $_GET['Registration_ID']?>&consultation_ID=<?php echo $_GET['consultation_ID']?>" id="printPreview" class="art-button-green" target="_blank" style="float:right">Preview</a>
