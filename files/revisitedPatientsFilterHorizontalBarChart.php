...
<fieldset style="width: 93%">
     <legend align="right"><b>MALE AND FEMALE HORIZONTAL BAR CHART</b></legend>
     <br>
...
//new pie chart instance
    $chart = new HorizontalBarChart( 800, 300 );
    ...
    //finalize dataset
        ...
        //set chart title
        $chart->setTitle("REVISITED TOTAL PATIENTS HORIZONTAL BAR CHART");
	...
	<table width="93%">
		...
		<td style='text-align: center;border: 0; width: 30%;'>
		    <a href="revisitedPatients.php"> 
			<input type='submit' name='back.php' id='back.php' class='art-button-green' value='HOME' style="width: 88%;"> 
		    </a>
		</td>
		<td style='text-align: center;border: 0; width: 30%;'>
		    <a href="revisitedPatientsFilterLineGraph.php?&branchID=<?php echo $branchID?>&Region_ID=<?php echo $regionID?>&District_ID=<?php echo $districtID?>&ageFrom=<?php echo $ageFrom?>&ageTo=<?php echo $ageTo?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>">
			    <input type='submit' name='graph' id='praph' class='art-button-green' value='TOTAL PATIENTS LINE GRAPHS' style="width: 88%;">
			
		    </a>
		</td>
		<td style='text-align: center;border: 0; width: 30%;'>
		    <a href="revisitedPatientsFilterPieChart.php?&branchID=<?php echo $branchID?>&Region_ID=<?php echo $regionID?>&District_ID=<?php echo $districtID?>&ageFrom=<?php echo $ageFrom?>&ageTo=<?php echo $ageTo?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>">
		...
		<td style='text-align: center;border: 0'>
		    <a href="revisitedPatientsFilterHorizontalBarChart.php?&branchID=<?php echo $branchID?>&Region_ID=<?php echo $regionID?>&District_ID=<?php echo $districtID?>&ageFrom=<?php echo $ageFrom?>&ageTo=<?php echo $ageTo?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>">
		...
		<td style='text-align: center;border: 0'>
		    <a href="revisitedPatientsFilterVerticalBarChart.php?&branchID=<?php echo $branchID?>&Region_ID=<?php echo $regionID?>&District_ID=<?php echo $districtID?>&ageFrom=<?php echo $ageFrom?>&ageTo=<?php echo $ageTo?>&Date_From=<?php echo $Date_From?>&Date_To=<?php echo $Date_To?>">
