...
<table class="table">
<?php
$sql_select_attached_category_result=mysqli_query($conn,"SELECT * FROM  tbl_finance_department  WHERE finance_department_name LIKE '%$Item_Category_Name%'") or die(mysqli_error($conn));
