				...
				<table width="100%">
					<tr>
						...
						<td style="text-align: center; background-color: #eeeebb;" width="10%">
							<a href="patientprogresspreviewsubreport.php?Progress_ID=<?php echo $data['Progress_ID']; ?>&PatientProgressPreviewSubReport=PatientProgressPreviewSubReportThisPage" target="_blank" style="text-decoration: none;"><button>Preview Report</button></a>
						</td>
					</tr>
