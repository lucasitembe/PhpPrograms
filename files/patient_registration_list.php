...
?>
 <a href="patient_list_report.php" target="_blank" id="printPreview" class="art-button-green">PRINT REPORT</a>
<?php if ($Section == 'Reception') { ?>
    <a href='receptionReports.php?Section=Reception&Reception=ReceptionThisPage' class='art-button-green'>
        BACK
    </a>
...
<?php }else{
    ?>
      <a href="receptionworkspage.php?ReceptionWork=ReceptionWorkThisPage" target="_blank" id="printPreview" class="art-button-green">BACK</a>
    <?php
    } ?>
<br/><br/><br/>
<center>
...
<br/>
<fieldset>  
    <legend align=center ><b id="dateRange">PATIENT LIST TODAY <?php echo date('Y-m-d'); ?></b></legend>
    <center>
            ...
            <tr>
                ...
                <div align="center" style="display:none" id="progressStatus"><img src="images/ajax-loader_1.gif" width="" style="border-color:white "></div>
                    <div id="Search_Iframe" style="height: 400px;overflow-y: auto;overflow-x: hidden">
                        <?php include 'patient_registration_list_iframe.php'; ?>
                    </div>
...
<script>
    function filterPatient($from) {
        ...
        $.ajax({
            type: "GET",
            url: "patient_registration_list_iframe.php",
            data: datastring,
            beforeSend: function (){
              $('#progressStatus').show();
            },
