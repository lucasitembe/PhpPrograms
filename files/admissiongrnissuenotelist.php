<?php
    ...
    if(isset($_SESSION['userinfo'])){
	if($_SESSION['userinfo']['Admission_Works'] == 'yes'){ 
	    echo "<a href='admissionpreviousissuenoteslist.php?lform=sentData&page=issue_list' class='art-button-green'>PREVIOUS GRN</a>";
	}
    }
	...
	<?php 
		...
		while($row = mysqli_fetch_array($sql_select)){
		    ...
		    echo '<tr><td style="text-align: center;">'.$temp.'</td>
			    ...
			    <a href="Control_Admission_Grn_Session.php?New_Grn=New&Issue_ID='.$row['Issue_ID'].'" class="art-button-green">&nbsp;&nbsp;&nbsp;Process&nbsp;&nbsp;&nbsp;</a>
			    </td>
			</tr>';
                    $temp++;
		}
