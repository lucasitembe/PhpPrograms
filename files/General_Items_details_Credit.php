<center>
    <table width="100%">
        ...
        $get_transactions = mysqli_query($conn,"select pp.Registration_ID, ppl.Price, ppl.Discount,sp.Exemption, ppl.Quantity, pp.Patient_Payment_ID, pp.Payment_Date_And_Time, pr.Patient_Name, pr.Date_Of_Birth, sp.Guarantor_Name, pp.Billing_Type, pp.payment_type, pp.Pre_Paid
        ...
        <tr>
            ...
            <td style="text-align: right;">
                <b><?php if ($_SESSION['systeminfo']['price_precision'] == 'yes') {
            echo number_format($Grand_Total_Credit, 2);
        } else {
            echo number_format($Grand_Total_Credit);
        } ?></b>
            </td>
        </tr>
    </table>