...
<fieldset style='margin-top:10px;'>
	...
	<?php
		$select_item = mysqli_query($conn,"SELECT Product_Name FROM tbl_items WHERE Item_ID = '$Item_ID'");
			...
			<table  class="hiv_table" style="width:100%;">
				<tr>
					<td id='Search_Iframe' >
						...
						<iframe frameborder="0" id="PatientListIframe" width='100%' height=350px src='Radiology_Management_Report_Iframe_Patients.php?Item_ID=<?php echo $Item_ID; ?><?php if($Sponsor != '') echo "&Sponsor=".$Sponsor; ?>'></iframe>
					</td>
				</tr>
			</table>
		</div>
