...
<a href="all_patient_file_link_station.php?Registration_ID=<?= $Registration_ID; ?>&section=Patient&PatientFile=PatientFileThisForm&fromPatientFile=true&this_page_from=<?= $this_page_from; ?>" class='art-button-green'>BACK</a>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <table class="table">
                    ...
                    <tr>
                        <td>
                            <a><button style="width:100%" onclick="open_eye_refraction()">EYE REFRACTION</button></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a><button style="width:100%" onclick="open_data_records()">VA RECORDS</button></a>
                        </td>
                    </tr>
                        <td>
                            <a><button style="width:100%" onclick="open_ioct()">IOCT RECORDS</button></a>
                        </td>
                    </tr>
                    <tr>
                    <td>
                            <a><button style="width:100%" onclick="Previous_Records2()">EXAMINATION OF OPERATED EYE</button></a>
                        </td>
                    </tr>
                </table>
...
<script>
     ...
     function open_eye_refraction(){
        var Registration_ID = $(".Registration_ID").val();
        //  alert(Registration_ID);
        $.ajax({
                type:'post',
                url: 'optical_records.php',
                data : {
                     Registration_ID:Registration_ID
               },
               success : function(data){
