...
<html dir="ltr" lang="en-US">
    ...
    <body>
        ...
        /*
            ...
            if(mysqli_num_rows($sql_check_if_user_logged_in2)>1){
                ...
                if(mysqli_num_rows($sql_select_maximum_time_for_this_this_user_result)>0){
                    ...
                    $employee_session_id_loged=mysqli_fetch_assoc($sql_select_maximum_time_for_this_this_user_result)['employee_session_id'];
        ...
        ?>
        <script>
              var user_session_control;
//            $(document).ready(function () {
//                user_session_control = setInterval(function () {
//                   // user_multiple_loged_in_control();
//                }, 60000);
//                // $.notifyBar({ cssClass: "success", html: "Your data has been changed!" }); 
//            });
            function user_multiple_loged_in_control(){
                var employee_session_id='<?= $employee_session_id ?>';
                var Employee_logedin_id='<?= $Employee_logedin_id ?>';
                var employee_session_time='<?= $employee_session_time ?>';

                 $.ajax({
                    type: 'GET',
                    url: 'user_multiple_loged_in_control.php',
                    data: {employee_session_id:employee_session_id,Employee_logedin_id:Employee_logedin_id,employee_session_time:employee_session_time},
                    success: function (data) {
                        console.log(data);
                        if(data=="logout_this_user"){
                            location.href = "logout.php";
                        }
                                        ...
                                        <div class="art-content-layout-wrapper layout-item-0">
                                            <div class="art-content-layout">
                                                <?php if (isset($_SESSION['userinfo'])) { ?>
                                                    <span><a href='./logout.php?emp_id=<?=$_SESSION['userinfo']['Employee_ID'];?>' class='art-button-green' id="ConfirmLogout" onclick='return ConfirmLogout()'>LOGOUT</a></span>
                                                <?php } ?>
