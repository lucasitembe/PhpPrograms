...
//                                                where Registration_ID = '$Registration_ID'") or die(mysqli_error($conn));
                    $select_sp = mysqli_query($conn,"select pr.Sponsor_ID, Guarantor_Name as Sponsor_Name from tbl_patient_registration pr, tbl_sponsor sp where
