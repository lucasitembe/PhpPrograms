...
<legend align="right" style="background-color:#006400;color:white;padding:5px;">LIST OF GROUPS AND ASSIGNED DISEASES</legend>
	<?php
		...
		$select_disease_group = mysqli_query($conn,"select disease_group_name,disease_group_id from tbl_disease_group where 
												disease_group_name like '%$Search_Value%' order by disease_group_name limit 200 ") or die(mysqli_error($conn));
