...
function Get_Item_Purchase_History_From_GRN_With_PO($Supplier_ID, $Classification, $Item_ID, $Start_Date, $End_Date, $Limit = 0) {
    ...
    $filter = "AND DATE(gpo.Created_Date_Time) BETWEEN '{$Start_Date}' AND '{$End_Date}'";

    if (is_null($Start_Date)) {
        $filter = "AND DATE(gpo.Created_Date_Time) <= '{$End_Date}'";
    }
    ...
    if ($Start_Date != null && $Start_Date != "" && $End_Date != null && $End_Date != "") {
        ...
        $Start_End_Date_Statement = $filter;
    } else {
        $Start_End_Date_Statement = $filter;
    }
...
function Get_ReturnInward_Item_History($Supplier_ID, $Classification, $Item_ID, $Start_Date, $End_Date, $Limit = 0) {
    ...
    $Item_Purchase_History_Result = Query_DB("SELECT i.Item_ID, i.Product_Name,i.Product_Code, i.Unit_Of_Measure, i.Classification,tri.Inward_Date,trii.Quantity_Returned
...
function Get_ReturnOutward_Item_History($Supplier_ID, $Classification, $Item_ID, $Start_Date, $End_Date, $Limit = 0) {
    ...
    $Item_Purchase_History_Result = Query_DB("SELECT i.Item_ID, i.Product_Name,i.Product_Code, i.Unit_Of_Measure, i.Classification,tro.Outward_Date,troi.Quantity_Returned
...
function Get_Disposal_Item_History($Supplier_ID, $Classification, $Item_ID, $Start_Date, $End_Date, $Limit = 0) {
    ...
    $Item_Purchase_History_Result = Query_DB("SELECT i.Item_ID, i.Product_Name,i.Product_Code, i.Unit_Of_Measure, i.Classification,td.Disposed_Date,tdi.Quantity_Disposed
...
function Get_Item_Purchase_History_From_GRN_Without_PO($Supplier_ID, $Classification, $Item_ID, $Start_Date, $End_Date, $Limit = 0) {
    ...
    $filter = "AND DATE(gwpo.Grn_Date_And_Time) BETWEEN '{$Start_Date}' AND '{$End_Date}'";

    if (is_null($Start_Date)) {
        $filter = "AND DATE(gwpo.Grn_Date_And_Time) <= '{$End_Date}'";
    }
    ...
    if ($Start_Date != null && $Start_Date != "" && $End_Date != null && $End_Date != "") {
        $Start_Date = Get_Day_Beginning($Start_Date);
        $End_Date = Get_Day_Ending($End_Date);
        $Start_End_Date_Statement = $filter; //"AND gwpo.Grn_Date_And_Time BETWEEN '{$Start_Date}' AND '{$End_Date}'";
    } else {
        $Start_End_Date_Statement = $filter;
    }
