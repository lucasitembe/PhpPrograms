<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="<?= site_url('gledger') ?>"> Ledgers</a></li>
              ...
              if(count($suppliers)){
                ...
                foreach ($suppliers as $supplier) { 
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="#" onclick="getSupplierInvoiceDetails('<?= $supplier->supplier_id ?>','30')"><?= number_format($total_30,2) ?></a></td>
                    <td class="text-center"><a href="#" onclick="getSupplierInvoiceDetails('<?= $supplier->supplier_id ?>','60')"><?= number_format($total_60,2) ?></a></td>
                    <td class="text-center"><a href="#" onclick="getSupplierInvoiceDetails('<?= $supplier->supplier_id ?>','90')"><?= number_format($total_90,2) ?></a></td>
                    <td class="text-center"><a href="#" onclick="getSupplierInvoiceDetails('<?= $supplier->supplier_id ?>','120')"><?= number_format($total_120,2) ?></a></td>
                    <td class="text-center"><a href="#" onclick="getSupplierInvoiceDetails('<?= $supplier->supplier_id ?>','150')"><?= number_format($total_150,2) ?></a></td>
                    <td class="text-center"><a href="#" onclick="getSupplierInvoiceDetails('<?= $supplier->supplier_id ?>','other')"><?= number_format($total_other,2) ?></a></td>
                  </tr>
            <?php    }
