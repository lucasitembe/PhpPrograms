                            ...
                            foreach ($invoice_List as $dt) {
                                ...
                                echo "<td><a href='../assets/invoice_image/".$dt->invoice_image. "' target='blank'>".$dt->invoice_image. "</a></td>";
                                  ...
                                  <div class='btn-group-sm'>
                                            <a class='btn btn-primary btn-xs editInvoiceBtn' href='".base_url('gledger/edit_invoice/'.$dt->invoice_id)."'><i class='fa fa-pencil-square-o'></i> Edit</a>
                                            <a class='btn btn-danger btn-xs' onclick='return delete_invoice()' href='./delete_invoice/".$dt->invoice_id."'><i class='fa fa-close'></i> Delete</a>
                            ...
                            <div class="modal-body">
                                <div class="x_content" id="currform_modal">
                                   ...
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="currncy-name">Client Name <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  type="text" id="client" name="client" maxlength="45" required class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="currncy-name">Client Phone/Mobile <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="currncy-name">Client Adress <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  type="text" id="adress" name="adress" maxlength="45" required class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
