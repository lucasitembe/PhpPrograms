    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>Registered Ledgers Based on Sponsors From eHMS</h3>
            </div>
                ...
                <div class="modal fade  model-reload" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            echo form_open('gledger/ledgerOnSponsors', $attributes);
                            ?>
                            ...
                            <div class="modal-body">
                                <div class="x_content" id="currform_modal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="sponsor">Sponsor Name<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="sponsor" name="sponsor"   required class="chosen-select form-control col-md-7 col-xs-12">
                                                <option></option>
                                                <?php foreach ($sponsors as $value) { ?>
