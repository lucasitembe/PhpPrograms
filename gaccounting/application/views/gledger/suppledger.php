    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>Registered Ledgers Based on Suppliers From eHMS </h3>
            </div>
                ...
                <div class="modal fade  model-reload" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            echo form_open('gledger/suppledger', $attributes);
                            ?>
                            ...
                            <div class="modal-body">
                                <div class="x_content" id="currform_modal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="supp_name">Supplier Name<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="supp_name" name="supp_name" onchange="setLedgerName(this);" required data-placeholder="Choose a supplier..." class="chosen-select form-control col-md-7 col-xs-12">
                                                <option></option>
                                                <?php foreach ($suppliers as $sup) { ?>
                                                    <option><?php echo $sup; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <script type="text/javascript">
                                        function setLedgerName(obj){
                                            $('#ledger_name').val($(obj).val());
                                        }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="currency_code" name="acc_code"   required class="chosen-select form-control col-md-7 col-xs-12">
                                                <option></option>
