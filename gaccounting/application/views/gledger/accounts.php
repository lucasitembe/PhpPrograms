                ...
                <div class="modal fade  model-reload" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            echo form_open('gledger/accounts', $attributes);
                            ?>
                            ...
                            <div class="modal-body">
                                <div class="x_content" id="currform_modal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="section_name">Account Group<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="group-name">Description 
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="form-control col-md-7 col-xs-12" required id="description" name="description"></textarea>
<!--                                            <input  type="text" id="description" name="description" maxlength="60" required class="form-control col-md-7 col-xs-12">-->
                                        </div>
                                    </div>
