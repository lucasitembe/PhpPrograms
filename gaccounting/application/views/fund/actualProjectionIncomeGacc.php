        ...
        <div class="panel panel-primary ">
            ...
            <div class="panel-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active"><a class="btn btn-primary" href="#actual" aria-controls="home" role="tab" data-toggle="tab">
                            Actual vs Projected</a></li>
                </ul>
                <!-- Tab panes -->
                        ...
                        <div class="row"  style="margin-top:0px">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group ">
                                    <select id="alloc_yob_gacc"name="alloc_yob_gacc"  class="form-control" placeholder="GFS code" aria-describedby="basic-addon1" required >
                            ...
                            <div class="col-xs-3"> 
                                <input type="button" onclick="getBudgetedActualGacc()" class="btn btn-primary" value="Get Data"/>
                            </div>
                        </div>
                        <br/>
                        <div class="row" style="">
                            <div id="ajaxUpdateContainergacc" class="col-xs-12">
