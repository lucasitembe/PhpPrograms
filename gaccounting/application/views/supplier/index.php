<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-briefcase"></i> Suppliers</li>						  	
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Suppliers </h3>
            </div>
                        ...
                        <tbody> 
                            ...
                            if (!empty($supplierList)) {
                                foreach ($supplierList as $dt) {
                                    echo "<tr>";
                                    echo "<td>" . $i++ . "</td>";
                                    echo "<td>" . $dt->suppliername . "</td>";
                                    echo "<td>" . $dt->address .",<br> ".$dt->country_name. "</td>";
                                    ...
                                    echo "<td>
                                    <div class='btn-group'>
                                      <a class='btn btn-primary btn-xs editSupplierBtn' href='".base_url('supplier/supplierform/'.$dt->supplier_id)."' ><i class='fa fa-pencil-square-o'></i> Edit</a>
                ...
                <div class="modal fade model-reload" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <?php
                            $attributes = array('autocomplete' => 'off', 'class' => 'form-horizontal form-label-left', 'data-toggle' => 'validator', 'role' => 'form', 'id' => 'supplierform');
                            echo form_open('supplier/index', $attributes);
                            ?>
                                ...
                                <div class="x_content" id="currform_modal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input  type="text" id="supplier_name" name="supplier_name" maxlength="45" required class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input  type="text" id="fax" name="fax" maxlength="45" required class="form-control col-md-7 col-xs-12 numberonly">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input  type="email" id="contact_email" name="contact_email" required class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input  type="text" id="web_url" name="web_url" required class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
 ...
 <!-- update supplier modal -->
                 <!-- Modal -->
               <div class="modal fade  model-reload" id="editSupplierModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                             ...
                             <?php
                            $attributes = array('autocomplete' => 'off', 'class' => 'form-horizontal form-label-left', 'data-toggle' => 'validator', 'role' => 'form', 'id' => 'updateSupplierForm');
                            echo form_open('supplier/updateSupplier', $attributes);
                            ?>
                             <div class="modal-body">
                                <div class="x_content">
                                    <br />
