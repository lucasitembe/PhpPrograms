<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-search"></i> Asset Tracking Report</li>						  	
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Asset Tracking Report </h3>
            </div>
            ...
            <div class="row form-inline ">
                ...
                <div class="form-group">
                    <div class="col-md-4">
                        <button class="btn btn-primary" onclick="gettrackingReport()"><i class="fa fa-search"></i> Filter</button>
                    </div>
                </div> 
                </div>
            </div>
