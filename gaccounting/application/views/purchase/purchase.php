<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-reply"></i><a href="<?= base_url()?>/payable"> Payable</a></li>						  	
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-lg-12 form-inline ">
        ...
        <div class="form-group">
            <div class="col-md-4 col-sm-4 col-xs-12">
                <input type="button" onclick="getPurchases()" class="btn btn-primary" value="Get Data"/>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i> Purchases </h3>
            </div>
