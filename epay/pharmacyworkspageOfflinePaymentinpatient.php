...
<script type="text/javascript">
    $("#saveOfflinePaymentBtn").click(function(e){
       ...
       // Departmental_Patient_Billing_Pharmacy_Page
          ...
          document.location = 'Inpatient_Pharmacy_Bill_Patient.php?Registration_ID=' + Registration_ID + '&Folio_Number=' + Folio_Number + '&Claim_Form_Number=' + Claim_Form_Number + '&Consultant_ID=' + Consultant_ID+"&post_payment=false"+"&manual_offline=offline&approve_yes=yes"+"&auth_code="+auth_code+"&terminal_id="+terminal_id;
              
        
            // document.location = "Departmental_Patient_Billing_Pharmacy_Page.php?Payment_Cache_ID="+Payment_Cache_ID+"&Transaction_Type="+Transaction_Type+"&Sub_Department_ID="+Sub_Department_ID+"&Registration_ID="+Registration_ID+"&Billing_Type="+Billing_Type+"&manual_offline=offline&approve_yes=yes"+"&auth_code="+auth_code+"&terminal_id="+terminal_id;
