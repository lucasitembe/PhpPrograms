    ...
    $("#saveOfflinePaymentBtn").click(function(e){
        ...
        if(auth_code==''){
         ...
         if (itemzero != '' && itemzero != null){
                      ...
                      document.location = 'Patient_Billing_Pharmacy_Page.php?itemzero='+itemzero+'&Transaction_Type='+Transaction_Type+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Registration_ID='+Registration_ID+'&Billing_Type='+Billing_Type+'&manual_offline=offline'+'&auth_code='+auth_code+'&terminal_id='+terminal_id;
                    } else{
                       
                      document.location = 'Patient_Billing_Pharmacy_Page.php?Payment_Cache_ID='+Payment_Cache_ID+'&Transaction_Type='+Transaction_Type+'&Sub_Department_ID='+Sub_Department_ID+'&Registration_ID='+Registration_ID+'&Billing_Type='+Billing_Type+'&manual_offline=offline'+'&auth_code='+auth_code+'&terminal_id='+terminal_id;
                 }  
        });
