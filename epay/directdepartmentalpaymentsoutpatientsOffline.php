...
<table  width="100%" cellpadding="6" cellspacing="0" border="0">
    ...
    <input type="text" hidden="hidden"   name="Sponsor_ID" id="Sponsor_ID" value="<?php echo $_GET['Sponsor_ID']; ?>">
    ...
    <input type="text" hidden="hidden"   name="Visit_Type" id="Visit_Type" value="<?php echo $_GET['Visit_Type']; ?>">  
    <input type="text" hidden="hidden"   name="Visit_Controler" id="Visit_Controler" value="<?php echo $_GET['Visit_Controler']; ?>">  
...
<script type="text/javascript">
    $("#saveOfflinePaymentBtn").click(function(e){
        ...
        var terminal_id = $("#terminal_id").val();
         ...
         var Visit_Controler = $("#Visit_Controler").val();
        if(terminal_id==''){
