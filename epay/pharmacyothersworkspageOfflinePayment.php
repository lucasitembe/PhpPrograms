...
<script type="text/javascript">
    $("#saveOfflinePaymentBtn").click(function(e){
        ...
        if(auth_code==''){
            ...
            document.location = 'Pharmacy_Make_Payment.php?Registration_ID=' + registration_id + '&Folio_Number=' + Folio_Number + '&Claim_Form_Number=' + Claim_Form_Number + '&Consultant_ID=' + Consultant_ID+'&manual_offline=offline'+'&auth_code='+auth_code+'&terminal_id='+terminal_id;   
