...
<script type="text/javascript">
    $("#saveOfflinePaymentBtn").click(function(e){
       ...
       /* $.ajax({
            type: 'POST',
            url : '../epay/SaveOfflineTransactions.php',
            data: {amount:amount,registration_id:registration_id,auth_code:auth_code,terminal_id:terminal_id},
