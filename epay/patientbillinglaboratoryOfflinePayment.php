    ...
    $("#saveOfflinePaymentBtn").click(function(e){
        ...
        if(auth_code==''){
            ...
            return;
             ...
             document.location = 'Patient_Billing_Laboratory_Page.php?Transaction_Type='+Transaction_Type+'&Payment_Cache_ID='+Payment_Cache_ID+'&Sub_Department_ID='+Sub_Department_ID+'&Billing_Type='+Billing_Type+'&manual_offline=offline'+'&auth_code='+auth_code+'&terminal_id='+terminal_id;    
        });
