...
<table  width="100%" cellpadding="6" cellspacing="0" border="0">
    ...
    <input type="text" hidden="hidden"   name="Patient_Payment_Cache_ID" id="Patient_Payment_Cache_ID" value="<?php echo $_GET['Patient_Payment_Cache_ID']; ?>">
...
<script type="text/javascript">
    $("#saveOfflinePaymentBtn").click(function(e){
        ...
        var Patient_Payment_Cache_ID = $("#Patient_Payment_Cache_ID").val();
        ...
        if(auth_code==''){
            ...
            return;
             ...
             document.location = 'Patient_Billing_Prepared_Make_Payment.php?Patient_Payment_Cache_ID=' + Patient_Payment_Cache_ID+'&manual_offline=offline'+'&auth_code='+auth_code+'&terminal_id='+terminal_id;  
        });
