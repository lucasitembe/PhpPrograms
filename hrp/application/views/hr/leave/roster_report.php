<div class="formdata" style="width: 100%;">
    <div class="formdata-title" >
        Search in Roster List
    </div>
    <div class="formdata-content" style="margin: 0px;   padding-top: 0px; ">
        
        <?php echo form_open('hr/rosterreport/','style="width:97%;"'); ?>
            ...
            ?>
                <tr>
                 ...
                 <img    style="cursor: pointer;"
                    ...
                    <td>Employee ID</td>
                    <td><input type="text" id="employee" name="employee" value="<?php echo set_value('employee') ;?>"/>
                    <img    style="cursor: pointer;"
...
<tr <?php echo ($i%2 == 0 ? 'class="even_tr"':''); ?> >
    ...
    <td><?php echo anchor('hr/addroster/'.$value->id,'Edit','style="color:blue;"');?></td>
