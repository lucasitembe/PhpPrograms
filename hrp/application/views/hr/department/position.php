<h2 style="padding:0px; margin: 0px;">Manage Position</h2><hr/>


<div class="col-md-6 col-md-offset-3 formdata">
    <div class="formdata-title">
        <?php $edit='';
        if(isset($id)){$edit=$id; echo 'Edit Position Information'; }else{ echo 'Add New Position';} ?>
    </div>
    <div class="formdata-content">
        
        <?php echo form_open('hr/position/'.$edit); ?>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="name" value="<?php echo (isset ($positiondata) ? $positiondata[0]->Name:set_value('name')) ;?>"/>
...
<tr <?php echo ($i%2 == 0 ? 'class="even_tr"':''); ?> >
    ...
    <td>
    <a href="<?php echo site_url()?>/hr/position/<?php echo $value->id?>" class="btn"><span><i class="fa fa-edit"></i> Edit</span> </a>
