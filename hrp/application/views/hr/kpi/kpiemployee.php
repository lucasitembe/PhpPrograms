<h2 style="padding:0px; margin: 0px;"> Assign KPIs to Employee</h2><hr/>
...
<div class="formdata">
    ...
    <div class="formdata-content" style="width: 97%;">
        ...
        <?php echo form_open('hr/kpiemployee/','style="width:100%;"'); ?>
...
<div style="height: 10px;">&nbsp;</div>
 <?php
  if(isset ($id)){
   ...
   ?>
 <?php echo form_open('hr/kpiemployee/','style="width:100%;padding:30px 0px;"'); ?>
...
<table style="width: 100%; margin-left: 0px;" class="formdata">
    ...
    foreach ($kpicategory as $key => $value) { ?>
                <div style="float: left; width: 480px; padding: 10px;  margin: 0px 10px 20px 10px; border: 1px solid #ccc;">
                    <div style="margin-left: 20px; font-weight: bold; font-size: 17px;">KPI Category : <?php echo $value->name; ?></div>
                    <table style="width: 100%;" class="view_data" cellspacing="0" cellpadding="0">
                        <tr><th style="width: 40px;">S/No</th><th>Indicator</th><th style="width: 100px;">Assign</th></tr>
             <?php
              $list = $this->HR->kpi_indicator_list(null,$value->id);
            ...
            if(count($list) > 0){
                ...
                foreach ($list as $k => $v) { ?>
                        <tr>
                            ...
                            <td><input type="checkbox" <?php echo (isset ($assigned_kpi) ? (array_key_exists($v->id, $assigned_kpi) ? 'checked="checked"':''): '') ?> name="indicators[]" value="<?php echo $v->id ?>">
                                   </td>
                        </tr>
              <?php   }
                } ?>
     ...
     <?php } }          ?>
                ...
                <div style=" text-align: right; margin: 10px 20px 20px 0px;"><input type="submit" name="record_kpi" value="Assign Indicators"/></div>
