...
<script type="text/javascript">
    ...
    function accept(){
        con = confirm("Are you sure you want to Deliver this Loan ??");
        if(con){
            return true;
        }else{
            return false;
...
<tr <?php echo ($i%2 == 0 ? 'class="even_tr"':''); ?> >
    ...
    <td><?php echo anchor('account/deliverloan/'.$value->id,'Deliver','id="loan_deliver"','onclick="return accept()"'); ?></td>
