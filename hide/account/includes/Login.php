...
<html>
<head>
	<title>Finance and Accounting Works - Login Screen</title>
...
<div id="container" style="width:80%">
	...
	<div id="login_box" style="width:750px">
	...
	<?php
	    if (isset($CompanyList) AND is_array($CompanyList)) {
	        ...
	        if ($AllowCompanySelectionBox === 'Hide'){
			    ...
			    echo '<input style="width:100px" type="hidden" name="CompanyNameField"  value="' .  $CompanyNameField . '" />';
                ...
                //echo _('eHMS Finance & Accounting') . ':<br /><br/>';
	...
	<input style="width:400px" type="text" name="UserNameEntryField" required="required" autofocus="autofocus" maxlength="20" placeholder="<?php echo _('User name'); ?>" /><br />
	<span><?php echo _('Password'); ?>:</span><br />
	<input style="width:400px" type="password" required="required" name="Password" placeholder="<?php echo _('Password'); ?>" /><br />
	<div id="demo_text">
	<?php
	if (isset($demo_text)){
		echo $demo_text;
	...
	<a href='../files/index.php?HomePage=HomePageThisForm' style='text-decoration: none;'>
		<input class="button" type="submit" value="<?php echo _('Back To Dashboard'); ?>" name="Ehms_Button" />
	</a>
	    </div>
	</form>
	</div>
...
<br/><br/><br/><br/><br/><br/>
<!--<legend align="center" style="background-color:#006400; color:white; padding:20px; width:100%">All Rights Reserved</legend>';-->
</body>
</html>
<?php
