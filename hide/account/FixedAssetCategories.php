...
or deletion of the records*/
	...
	//echo '<br/>';
	//echo '<center><fieldset style="width:80%;" >';
	//echo '<legend align="center" style="background-color:#006400; color:white; padding:20px; width:100%">Adding or Modifying Asset Categories</legend>';
	echo '<br />
			<table class="selection"; style="width:60%">';
...
echo '<br /><div class="centre"><a href="' . htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '">' ._('Back to Fixed Asset Categories') . '</a></div>';
}
...
if (isset($SelectedCategory) and !isset($_POST['submit'])) {
	...
	echo '<table class="selection" style="width:60%">
			<tr>
				<td>' . _('Category Code') . ':</td>
