...
echo '<div class="page_help_text">' . _('Update Bank Account details.  Account Code is for SWIFT or BSB type Bank Codes.  Set Default for Invoices to Currency Default  or Fallback Default to print Account details on Invoices (only one account should be set to Fall Back Default).') . '.</div>';
...
if (isset($SelectedBankAccount) AND !isset($_GET['delete'])) {
	...
	echo '<table class="selection" style="width:80%">
			<tr>
