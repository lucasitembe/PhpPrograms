...
//Adelard Inclusions
echo '<legend align="center" style="background-color:#006400; color:white; padding:18px; width:100%">Company Management</legend>';
echo '<br/>';
...
//Adelard Inclusions
echo '<br/>';
echo '<legend align="center" style="background-color:#006400; color:white; padding:18px; width:100%">All Rights Reserved</legend>';
?>
