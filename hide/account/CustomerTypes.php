...
//Adelard Inclusions
echo '<legend align="center" style="background-color:#006400; color:white; padding:20px">Add/edit/delete Customer Types</legend>';
//echo '<legend>Add/edit/delete Customer Types</legend>';
...
echo '<br/><br/>';
echo '<legend align="center" style="background-color:#006400; color:white; padding:20px">All Rights Reserved</legend>';
