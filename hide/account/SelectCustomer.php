...
if ($_SESSION['CustomerID'] != '' AND !isset($_POST['Search']) AND !isset($_POST['CSV'])) {
	...
	echo '<table cellpadding="4" class="selection" style="width:80%">
			<tr>
	...
	echo '<a href="' . $RootPath . '/CustomerInquiry.php?CustomerID=' . $_SESSION['CustomerID'] . '">' . _('Customer Transaction Inquiries') . '</a>';
	echo '<a href="' . $RootPath . '/Customers.php?DebtorNo=' . $_SESSION['CustomerID'] . '&amp;Modify=No">' . _('View Customer Details') . '</a>';
...
echo '<table cellpadding="3" class="selection" style="width:80%">';
...
if (isset($result)) {
	...
	if (!isset($_POST['CSV'])) {
		...
		echo '<br />
				<table cellpadding="2" class="selection" style="width:80%">';
...
if (isset($_SESSION['CustomerID']) AND $_SESSION['CustomerID'] != '') {
	...
	if ($_SESSION['Extended_CustomerInfo'] == 1) {
		if ($_SESSION['CustomerID'] != '') {
			...
			echo '<table cellpadding="4" style="width:80%" >';
