...
//Adelard Inclusions
echo '<legend align="center" style="background-color:#006400; color:white; padding:10px">Banking Management</legend>';
echo '<br/>';
...
echo '<table>
        <tr>
        <td colspan="5"><table class="selection" style="width:60%">
						<tr>
...
//Adelard Inclusions
echo '<br/>';
echo '<legend align="center" style="background-color:#006400; color:white; padding:15px">All Rights Reserved</legend>';
//include('includes/footer.inc');
?>
